import{A,a as D}from"./chunk.AlohaExample.B95p2ibG.js";import{A as $}from"./chunk.AlohaTableProps.BDwC0GEx.js";import{A as v}from"./chunk.AlohaTableTranslate.ClAHSQpR.js";import{q as P,_ as p,g as C,A as H}from"./bundle.index.7Gm8ngMZ.js";import{r as u,V as c,aT as i,e as t,W as f,_ as r,Z as T,aU as I,d as R}from"./chunk.vendor.D2EiI1BL.js";import"./chunk.vendor-lodash.Wop2AkRA.js";import"./chunk.APageTabTitle.DRSOBdvA.js";import"./chunk.AlohaHighlightjs.B_1iuPG1.js";import"./chunk.ATable.q3RyArlj.js";import"./chunk.translations-ar.DEWt73y8.js";import"./chunk.translations-de.CN5eAU-4.js";import"./chunk.translations-en.CPCEcTAP.js";import"./chunk.translations-es.BKTK5PUv.js";import"./chunk.translations-fr.CslimZmU.js";import"./chunk.translations-hr.CiJ7_Y2m.js";import"./chunk.translations-it.H45F8miC.js";import"./chunk.translations-ru.o-dOzdYz.js";function L(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<div>model:</div>
...
};`}}const Y={name:"PageTextareaErrors",components:{AlohaExample:A,ATextarea:P},setup(){const e=u("Aloha"),{codeHtml:a}=M(),{codeJs:o}=F();return{codeHtml:a,codeJs:o,model:e}}};function Z(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return f(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[r(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=p(Y,[["render",Z]]);function W(){return{codeHtml:`<a-textarea
  v-model="model"
  help-text="Aloha"
  label="Textarea"
...
></a-textarea>
<div>model:</div>
<pre>{{ model }}</pre>`}}function xe(){return{codeJs:`import {
  ref,
} from "vue";
