import{A as y,a as C}from"./chunk.AlohaExample.CMUUEVcN.js";import{a9 as o,_ as s,A as N}from"./bundle.index.DOWaPX07.js";import{P as f,a as A,b as x}from"./chunk.PageFilterTest.CqA3wSrh.js";import{B as i,C as d,m as t,L as E,G as n}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function w(){return{codeJs:`getTotalNestedCount({ array: ["hello", "Aloha"], keyChildren: "" });
...
`,I={name:"PageUtilsGetTotalNestedCount",components:{AlohaPage:C,ATranslation:N,PageFilterArguments:x,PageFilterImportFunction:A,PageFilterTest:f,PageUtilsGetTotalNestedCountExample:G},setup(){const{pageTitle:e}=U(),{argumentsText:a}=$();return{argumentsText:a,pageTitle:e,test:S}}};function B(e,a,r,c,u,h){const l=t("a-translation"),p=t("page-filter-import-function"),_=t("page-filter-arguments"),m=t("page-utils-get-total-nested-count-example"),g=t("page-filter-test"),T=t("aloha-page");return i(),d(T,{"page-title":e.pageTitle},{body:E(()=>[n(l,{tag:"p",html:"_PAGE_UTILS_GET_TOTAL_NESTED_COUNT_DESCRIPTION_"}),n(p,{"function-name":"getTotalNestedCount","type-import":"utils"}),n(_,{"arguments-text":e.argumentsText,"function-description":"getTotalNestedCount({ array, keyChildren })"},null,8,["arguments-text"]),n(m),n(g,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const b=s(I,[["render",B]]);export{b as default};
