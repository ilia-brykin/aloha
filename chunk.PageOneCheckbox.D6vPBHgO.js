...
};`}}const $={name:"PageJsonBasic",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=U(),{codeJs:t}=D();return{codeHtml:o,codeJs:t,model:e}}};function V(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return h(),i(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:p(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),label:"Aloha"},null,8,["modelValue"]),A("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const B=u($,[["render",V]]);function J(){return{codeHtml:`<a-one-checkbox
  :change="changeModel"
  :model-value="model"
  label="Aloha"
></a-one-checkbox>
...
};`}}const y={name:"PageOneCheckboxChange",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=m(void 0),o=({model:s,id:_,props:a})=>{e.value=s,console.log(_,a)},{codeHtml:t}=J(),{codeJs:r}=L();return{changeModel:o,codeHtml:t,codeJs:r,model:e}}};function q(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return h(),i(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:p(()=>[l(a,{change:e.changeModel,"model-value":e.model,label:"Aloha"},null,8,["change","model-value"]),A("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const j=u(y,[["render",q]]);function X(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  errors="Aloha"
  label="Aloha"
...
};`}}const M={name:"PageOneCheckboxErrors",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=X(),{codeJs:t}=G();return{codeHtml:o,codeJs:t,model:e}}};function K(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return h(),i(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:p(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),errors:"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=u(M,[["render",K]]);function F(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
...
};`}}const oe={name:"PageOneCheckboxHelpText",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=Z(),{codeJs:t}=ee();return{codeHtml:o,codeJs:t,model:e}}};function ne(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return h(),i(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:p(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),"help-text":"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=u(oe,[["render",ne]]);function ae(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
  label="false-value='false'"
></a-one-checkbox>
...
};`}}const me={name:"PageOneCheckboxTrueValue",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=se(),{codeJs:t}=_e();return{codeHtml:o,codeJs:t,model:e}}};function ue(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return h(),i(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_DESCRIPTION_",props:["true-value"]},{default:p(()=>[l(a,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),"true-value":1,label:"Aloha"},null,8,["modelValue"]),A("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const ie=u(me,[["render",ue]]);function pe(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :is-width-auto="true"
...
></a-one-checkbox>`}}function he(){return{codeJs:`import {
  ref,
} from "vue";
