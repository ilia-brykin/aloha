import{am as g,_ as i,A as R}from"./bundle.index.CWJbIJ4K.js";import{A as y,a as h}from"./chunk.AlohaExample.B_2bvYKv.js";import{A as P}from"./chunk.AlohaTableProps.DKEcqHSI.js";import{A as v}from"./chunk.AlohaTableTranslate.Cb74VTA5.js";import{r as m,U as c,aS as p,e as l,V as f,Z as a,Y as b,aT as C}from"./chunk.vendor.w-kCrpQl.js";import{P as T,T as $,a as I,E as L}from"./chunk.TranslateAPI.DOC1CCZo.js";import"./chunk.vendor-lodash.GmlDDh1v.js";import"./chunk.translations-ar.C8xAF5pd.js";import"./chunk.translations-de.eUvDf8xn.js";import"./chunk.translations-en.DEpj9U8S.js";import"./chunk.translations-es.BUvs_K_5.js";import"./chunk.translations-fr.Qi6uRa8b.js";import"./chunk.translations-hr.hUcxziT-.js";import"./chunk.translations-it.DFfE6hGj.js";import"./chunk.translations-ru.CS-1tvJT.js";import"./chunk.APageTabTitle.COHJDAnG.js";import"./chunk.AlohaHighlightjs.Cjego80K.js";import"./chunk.ATable.BcEbZJ6k.js";function N(){return{codeHtml:`<a-router-link-config
  v-model="model"
  :required="true"
  label="Aloha"
...
};`}}const H={name:"PageRouterLinkConfigBasic",components:{AlohaExample:y,ARouterLinkConfig:g},setup(){const e=m({route:"NotFoundTest",query:{key:"Aloha"}}),{codeHtml:o}=N(),{codeJs:n}=E();return{codeHtml:o,codeJs:n,model:e}}};function J(e,o,n,r,u,_){const t=l("a-router-link-config"),d=l("aloha-example");return f(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:p(()=>[a(t,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=s=>e.model=s),required:!0,label:"Aloha"},null,8,["modelValue"]),b("div",null,"model: "+C(e.model),1)]),_:1},8,["code-html","code-js"])}const O=i(H,[["render",J]]);function q(){return{codeHtml:`<a-router-link-config
  :model-value="model1"
  :readonly="true"
  label="Router 1"
