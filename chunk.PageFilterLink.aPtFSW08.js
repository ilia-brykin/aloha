...
// ${o("example.com",{protocol:"http://"})}`}}const V={name:"PageFilterLinkProtocol",components:{AlohaExample:x},setup(){const{codeJs:e}=O();return{codeJs:e}}};function D(e,l,i,c,m,_){const n=t("aloha-example");return s(),p(n,{"code-js":e.codeJs,header:"protocol","is-code-visible-default":!0},null,8,["code-js"])}const W=r(V,[["render",D]]);function X(){return{codeJs:`filterLink("example.com", { target: "_blank" });
