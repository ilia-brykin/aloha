...
};`}}const Q={name:"PageRateColor",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Z(),{codeJs:t}=K();return{codeHtml:e,codeJs:t}}};function ee(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return R(),f(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Color",description:"_A_RATE_DESCRIPTION_COLOR_",props:"color"},{default:h(()=>[r(a,{color:"gray",text:"gray"})]),_:1},8,["code-html","code-js"])}const te=p(Q,[["render",ee]]);function oe(){return{codeHtml:`<a-rate 
  :half-icon="true">
