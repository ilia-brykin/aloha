import{A as f,a as N}from"./chunk.AlohaExample.DQald-L_.js";import{A as L}from"./chunk.AlohaTableProps.nxAQILM8.js";import{a2 as P,ah as u,aM as $,a3 as H}from"./bundle.index.D1OA29U_.js";import"./chunk.vendor-lodash.DHCI5OYQ.js";import{bc as c,aQ as m,br as o,bi as n,aV as i,aP as a,bn as b,aN as O}from"./chunk.vendor.B7xidcyX.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function y(){return{codeHtml:`<a-tooltip
...
};`}}const B={name:"PageTooltipArrowPaddingFunction",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=x(),{codeJs:t}=M();return{arrowPaddingCallback:({popper:_,reference:d,placement:s})=>(console.log("placement",s),console.log("popper",_),console.log("reference",d),_.width/d.width+400),codeHtml:e,codeJs:t,title:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus.`}}};function G(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_ARROW_PADDING_FUNCTION_HEADER_",description:"_A_TOOLTIP_GROUP_ARROW_PADDING_FUNCTION_DESCRIPTION_",props:"arrow-padding"},{default:o(()=>[i(s,{class:"a_btn a_btn_primary",tag:"button","arrow-padding":e.arrowPaddingCallback},{title:o(()=>[a("div",null,b(e.title),1)]),default:o(()=>[t[0]||(t[0]=a("span",null,"Aloha",-1))]),_:1},8,["arrow-padding"])]),_:1},8,["code-html","code-js"])}const j=u(B,[["render",G]]);function k(){return{codeHtml:`<a-tooltip>
  <span>Aloha</span>
...
};`}}const W={name:"PageDisclosureBasic",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=k(),{codeJs:t}=F();return{codeHtml:e,codeJs:t}}};function X(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",slots:["default","title"]},{default:o(()=>[i(s,null,{title:o(()=>t[0]||(t[0]=[a("div",null,"Aloha",-1)])),default:o(()=>[t[1]||(t[1]=a("span",null,"Aloha",-1))]),_:1})]),_:1},8,["code-html","code-js"])}const Q=u(W,[["render",X]]);function V(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :show-arrow="false"
>
...
};`}}const z={name:"PageTooltipHideArrow",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=V(),{codeJs:t}=K();return{codeHtml:e,codeJs:t}}};function Y(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_HIDE_ARROW_HEADER_",description:"_A_TOOLTIP_GROUP_HIDE_ARROW_DESCRIPTION_",props:"show-arrow"},{default:o(()=>[i(s,{class:"a_btn a_btn_primary",tag:"button","show-arrow":!1},{title:o(()=>t[0]||(t[0]=[a("div",null,"Aloha",-1)])),default:o(()=>[t[1]||(t[1]=a("span",null,"Aloha",-1))]),_:1})]),_:1},8,["code-html","code-js"])}const Z=u(z,[["render",Y]]);function tt(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :max-width="300"
>
...
};`}}const ot={name:"PageTooltipMaxWidth",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=tt(),{codeJs:t}=et();return{codeHtml:e,codeJs:t,title:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}};function at(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_MAX_WIDTH_HEADER_",description:"_A_TOOLTIP_GROUP_MAX_WIDTH_DESCRIPTION_",props:"max-width"},{default:o(()=>[i(s,{class:"a_btn a_btn_primary",tag:"button","max-width":300},{title:o(()=>[a("div",null,b(e.title),1)]),default:o(()=>[t[0]||(t[0]=a("span",null,"Aloha",-1))]),_:1})]),_:1},8,["code-html","code-js"])}const nt=u(ot,[["render",at]]);function it(){return{codeHtml:`<a-tooltip
...
};`}}const lt={name:"PageTooltipOffsetDistance",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=it(),{codeJs:t}=st();return{codeHtml:e,codeJs:t}}};function rt(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_OFFSET_DISTANCE_HEADER_",description:"_A_TOOLTIP_GROUP_OFFSET_DISTANCE_DESCRIPTION_",props:"offset-distance"},{default:o(()=>[i(s,{class:"a_btn a_btn_secondary",tag:"button","offset-distance":30},{title:o(()=>t[0]||(t[0]=[a("div",null,':offset-distance="30"',-1)])),default:o(()=>[t[1]||(t[1]=a("span",null,':offset-distance="30"',-1))]),_:1}),i(s,{class:"a_btn a_btn_secondary a_ml_3",tag:"button","offset-distance":6},{title:o(()=>t[2]||(t[2]=[a("div",null,':offset-distance="6"',-1)])),default:o(()=>[t[3]||(t[3]=a("span",null,':offset-distance="6"',-1))]),_:1}),i(s,{class:"a_btn a_btn_secondary a_ml_3",tag:"button","offset-distance":0},{title:o(()=>t[4]||(t[4]=[a("div",null,':offset-distance="0"',-1)])),default:o(()=>[t[5]||(t[5]=a("span",null,':offset-distance="0"',-1))]),_:1}),i(s,{class:"a_btn a_btn_secondary a_ml_3",tag:"button","offset-distance":-10},{title:o(()=>t[6]||(t[6]=[a("div",null,':offset-distance="-10"',-1)])),default:o(()=>[t[7]||(t[7]=a("span",null,':offset-distance="-10"',-1))]),_:1})]),_:1},8,["code-html","code-js"])}const pt=u(lt,[["render",rt]]);function _t(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :offset-skidding="30"
>
...
};`}}const Tt={name:"PageTooltipTag",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=ft(),{codeJs:t}=Pt();return{codeHtml:e,codeJs:t,title:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}};function bt(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_TAG_HEADER_",description:"_A_TOOLTIP_GROUP_TAG_DESCRIPTION_",props:"tag"},{default:o(()=>[i(s,{class:"a_btn a_btn_primary",tag:"button"},{title:o(()=>[a("div",null,b(e.title),1)]),default:o(()=>[t[0]||(t[0]=a("span",null,"Aloha",-1))]),_:1})]),_:1},8,["code-html","code-js"])}const Ot=u(Tt,[["render",bt]]);function St(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :time-close="0"
>
...
};`}}const It={name:"PageTooltipTag",components:{AlohaExample:f,ATooltip:P},setup(){const{codeHtml:e}=St(),{codeJs:t}=gt();return{codeHtml:e,codeJs:t}}};function At(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return c(),m(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_TIME_CLOSE_HEADER_",description:"_A_TOOLTIP_GROUP_TIME_CLOSE_DESCRIPTION_",props:"time-close"},{default:o(()=>[i(s,{class:"a_btn a_btn_primary",tag:"button","time-close":0},{title:o(()=>t[0]||(t[0]=[a("div",null,"0",-1)])),default:o(()=>[t[1]||(t[1]=a("span",null,"0",-1))]),_:1}),i(s,{class:"a_btn a_btn_primary a_ml_3",tag:"button","time-close":100},{title:o(()=>t[2]||(t[2]=[a("div",null,"100",-1)])),default:o(()=>[t[3]||(t[3]=a("span",null,"100",-1))]),_:1}),i(s,{class:"a_btn a_btn_primary a_ml_3",tag:"button","time-close":1e3},{title:o(()=>t[4]||(t[4]=[a("div",null,"1000",-1)])),default:o(()=>[t[5]||(t[5]=a("span",null,"1000",-1))]),_:1})]),_:1},8,["code-html","code-js"])}const Et=u(It,[["render",At]]);function Rt(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :width="200"
>
