...
};`}}const K={name:"PageProgressBasic",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=z(),{codeJs:a}=Z();return{codeHtml:s,codeJs:a}}};function Q(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_BASIC_USAGE_",props:"value"},{default:c(()=>[e(r,{value:50})]),_:1},8,["code-html","code-js"])}const Y=p(K,[["render",Q]]);function ss(){return{codeHtml:`<a-progress
  class="a_bg_primary"
  :value="30"
...
</a-progress>`}}function Ws(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const Xs={name:"PageProgressSlotText",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Fs(),{codeJs:a}=Ws();return{codeHtml:s,codeJs:a}}};function ks(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_HEADER_",description:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_DESCRIPTION_",slots:"progressText"},{default:c(()=>[e(r,{value:20},{progressText:c(({valuePercent:P})=>[S("span",null,"Aloha "+A(P),1)]),_:1}),e(r,{class:"a_mt_4",value:40},{progressText:c(({valuePercent:P})=>[S("span",null,"$$$ "+A(P),1)]),_:1})]),_:1},8,["code-html","code-js"])}const zs=p(Xs,[["render",ks]]);function Zs(){return{codeHtml:`<a-progress
  :value="50"
  class-progress-bar="a_bg_primary"
  :striped="true"
></a-progress>
...
<a-progress
  ...
  class-progress-bar="a_bg_danger"
  :striped="true"
></a-progress>`}}function Ks(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
