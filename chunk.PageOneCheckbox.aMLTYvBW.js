...
};`}}const B={name:"PageJsonBasic",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=_(void 0),{codeHtml:o}=J(),{codeJs:a}=V();return{codeHtml:o,codeJs:a,model:e}}};function L(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:u(()=>[t(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=c=>e.model=c),label:"Aloha"},null,8,["modelValue"]),E("div",null,"model: "+A(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(B,[["render",L]]);function j(){return{codeHtml:`<a-one-checkbox
  :change="changeModel"
  :model-value="model"
  label="Aloha"
></a-one-checkbox>
...
};`}}const X={name:"PageOneCheckboxChange",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=_(void 0),o=({model:s,id:m,props:l})=>{e.value=s,console.log(m,l)},{codeHtml:a}=j(),{codeJs:r}=G();return{changeModel:o,codeHtml:a,codeJs:r,model:e}}};function M(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:u(()=>[t(l,{change:e.changeModel,"model-value":e.model,label:"Aloha"},null,8,["change","model-value"]),E("div",null,"model: "+A(e.model),1)]),_:1},8,["code-html","code-js"])}const K=i(X,[["render",M]]);function w(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  errors="Aloha"
  label="Aloha"
...
};`}}const ee={name:"PageOneCheckboxFalseValue",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=_(!0),o=_(!0),{codeHtml:a}=Q(),{codeJs:r}=Z();return{codeHtml:a,codeJs:r,model1:e,model2:o}}};function oe(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_FALSE_VALUE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_FALSE_VALUE_DESCRIPTION_",props:["false-value"]},{default:u(()=>[t(l,{modelValue:e.model1,"onUpdate:modelValue":o[0]||(o[0]=c=>e.model1=c),"false-value":!1,label:"false-value='false'"},null,8,["modelValue"]),E("div",null,"model1: "+A(e.model1),1),t(l,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":o[1]||(o[1]=c=>e.model2=c),"false-value":0,label:"false-value='0'"},null,8,["modelValue"]),E("div",null,"model2: "+A(e.model2),1)]),_:1},8,["code-html","code-js"])}const ne=i(ee,[["render",oe]]);function ae(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  help-text="Aloha"
  label="Aloha"
...
};`}}const fe={name:"PageOneCheckboxReadonly",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=_(!0),o=_(!1),a=_(void 0),{codeHtml:r}=ie(),{codeJs:s}=pe();return{codeHtml:r,codeJs:s,model1:e,model2:o,model3:a}}};function he(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:u(()=>[t(l,{"model-value":e.model1,readonly:!0,label:"Checkbox 1"},null,8,["model-value"]),t(l,{class:"a_mt_3","false-value":!1,"model-value":e.model2,readonly:!0,label:"Checkbox 2"},null,8,["model-value"]),t(l,{class:"a_mt_3","false-value":!1,"model-value":e.model3,readonly:!0,label:"Checkbox 3"},null,8,["model-value"]),t(l,{class:"a_mt_3","false-value":!1,"model-value":e.model3,readonly:!0,"help-text":"Aloha",label:"Checkbox 4","readonly-default":"-"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const Oe=i(fe,[["render",he]]);function Ee(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  label="Aloha"
  slot-name="aloha"
>
...
};`}}const be={name:"PageOneCheckboxSlotName",components:{AElement:H,AlohaExample:h,AOneCheckbox:O},setup(){const e=_(void 0),{codeHtml:o}=Ee(),{codeJs:a}=Ae();return{codeHtml:o,codeJs:a,model:e}}};function Pe(e,o,a,r,s,m){const l=n("a-element"),d=n("a-one-checkbox"),c=n("aloha-example");return f(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_SLOT_NAME_HEADER_",description:"_A_UI_GROUP_SLOT_NAME_DESCRIPTION_",props:["slot-name"]},{default:u(()=>[t(d,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=b=>e.model=b),label:"Aloha","slot-name":"aloha"},{aloha:u(({id:b,labelClass:P,label:I,labelScreenReader:C,required:R,props:x})=>[E("span",{class:y(P)},[E("span",null,A(I),1),t(l,{class:"a_ml_2","is-title-html":!0,"icon-left":"Window",tabindex:"0","text-screen-reader":"Aloha",title:"Aloha",type:"text"})],2)]),_:1},8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Ie=i(be,[["render",Pe]]);function Ce(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :true-value="1"
  class="a_mt_3"
  label="Aloha"
...
};`}}const xe={name:"PageOneCheckboxTrueValue",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=_(void 0),{codeHtml:o}=Ce(),{codeJs:a}=Re();return{codeHtml:o,codeJs:a,model:e}}};function Se(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_DESCRIPTION_",props:["true-value"]},{default:u(()=>[t(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=c=>e.model=c),"true-value":1,label:"Aloha"},null,8,["modelValue"]),E("div",null,"model: "+A(e.model),1)]),_:1},8,["code-html","code-js"])}const ke=i(xe,[["render",Se]]);function Ne(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :is-width-auto="true"
