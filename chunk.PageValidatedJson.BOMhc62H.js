...
};`}}const V={name:"PageValidatedJsonModeJson",components:{AlohaExample:E,AValidatedJson:T},setup(){const{codeHtml:e}=N(),{codeJs:o}=C(),n=[{type:"text",label:"Key",id:"key",required:!0},{type:"oneCheckbox",label:"Checkbox",id:"checkbox"},{type:"currency",label:"Currency",id:"currency"}],a=c({aloha1:{key:"aloha1"}}),r=c(void 0);return{children:n,codeHtml:e,codeJs:o,model1:a,model2:r}}};function g(e,o,n,a,r,p){const d=i("a-validated-json"),m=i("aloha-example");return A(),f(m,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","type"]},{default:S(()=>[s(d,{modelValue:e.model1,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model1=l),"id-prefix":"aloha4",children:e.children,"key-id":"key","unique-children-ids":["key"],label:"_A_VALIDATED_JSON_COMPONENT_LABEL_JSON_",mode:"json"},null,8,["modelValue","children"]),o[2]||(o[2]=t("div",null,"model1:",-1)),t("pre",null,u(e.model1),1),s(d,{modelValue:e.model2,"onUpdate:modelValue":o[1]||(o[1]=l=>e.model2=l),"id-prefix":"aloha5",children:e.children,"unique-children-ids":["key"],label:"_A_VALIDATED_JSON_COMPONENT_LABEL_JSON_",mode:"json"},null,8,["modelValue","children"]),o[3]||(o[3]=t("div",null,"model2:",-1)),t("pre",null,u(e.model2),1)]),_:1},8,["code-html","code-js"])}const R=_(V,[["render",g]]);function J(){return{codeHtml:`<a-select-icon
  v-model="model1"
  label="Select"
  type="select"
></a-select-icon>
...
};`}}const $={name:"PageValidatedJsonModeList",components:{AlohaExample:E,AValidatedJson:T},setup(){const{codeHtml:e}=J(),{codeJs:o}=D(),n=[{type:"text",label:"Text",id:"text",required:!0},{type:"oneCheckbox",label:"Checkbox",id:"checkbox"},{type:"currency",label:"Currency",id:"currency"}],a=c([{text:"Aloha1"},{text:"Aloha2"}]),r=c(void 0);return{children:n,codeHtml:e,codeJs:o,model1:a,model2:r}}};function j(e,o,n,a,r,p){const d=i("a-validated-json"),m=i("aloha-example");return A(),f(m,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","type"]},{default:S(()=>[s(d,{modelValue:e.model1,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model1=l),"id-prefix":"aloha1",children:e.children,"unique-children-ids":["text"],label:"_A_VALIDATED_JSON_COMPONENT_LABEL_LIST_",mode:"list"},null,8,["modelValue","children"]),o[2]||(o[2]=t("div",null,"model1:",-1)),t("pre",null,u(e.model1),1),s(d,{modelValue:e.model1,"onUpdate:modelValue":o[1]||(o[1]=l=>e.model1=l),"id-prefix":"aloha2",children:e.children,readonly:!0,label:"_A_VALIDATED_JSON_COMPONENT_LABEL_LIST_",mode:"list"},null,8,["modelValue","children"])]),_:1},8,["code-html","code-js"])}const M=_($,[["render",j]]);function k(){return{codeHtml:`<a-select-icon
  v-model="model1"
  label="Select"
  type="select"
></a-select-icon>
...
};`}}const B={name:"PageValidatedJsonModeListTyped",components:{AlohaExample:E,AValidatedJson:T},setup(){const{codeHtml:e}=k(),{codeJs:o}=x(),n=[{type:"select",label:"Aloha",id:"aloha",required:!0,data:[{label:"Foo",value:"foo"},{label:"Bar",value:"bar"}],keyLabel:"label",keyId:"value"},{type:"oneCheckbox",label:"Checkbox",id:"checkbox"},{type:"currency",label:"Currency",id:"currency"}],a=c(void 0);return{children:n,codeHtml:e,codeJs:o,model1:a,typedChildren:{foo:[{id:"text_foo",type:"text",label:"Text foo"},{type:"oneCheckbox",label:"Checkbox foo",id:"checkbox_foo"}],bar:[{id:"text_bar",type:"text",label:"Text bar"}]}}}};function H(e,o,n,a,r,p){const d=i("a-validated-json"),m=i("aloha-example");return A(),f(m,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","type"]},{default:S(()=>[s(d,{modelValue:e.model1,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model1=l),"id-prefix":"aloha1",children:e.children,"typed-children":e.typedChildren,"unique-children-ids":["text"],label:"_A_VALIDATED_JSON_COMPONENT_LABEL_LIST_",mode:"list","typed-base-id":"aloha"},null,8,["modelValue","children","typed-children"]),o[1]||(o[1]=t("div",null,"model1:",-1)),t("pre",null,u(e.model1),1)]),_:1},8,["code-html","code-js"])}const q=_(B,[["render",H]]);function U(){return{codeHtml:`<a-select-icon
  v-model="model1"
  label="Select"
  type="select"
></a-select-icon>
