import{A as R,a as N}from"./chunk.AlohaExample.DKBt6BF9.js";import{A as O}from"./chunk.AlohaTableProps.DkJtq6j7.js";import{l as A,_ as i,A as C}from"./bundle.index.hzSDncRt.js";import{r as u,k as t,J as l,aO as p,H as s,O as _,N as g,aP as S}from"./chunk.vendor.CwuJ9Ljq.js";import{u as k}from"./chunk.vendor-lodash.BBRAkY5X.js";import"./chunk.ATable.Cuiv0i4K.js";import"./chunk.translations-ar.CGH9gktb.js";import"./chunk.translations-de.S4PF1KYg.js";import"./chunk.translations-en.Ck05aPwN.js";import"./chunk.translations-es.CN4IYWAw.js";import"./chunk.translations-fr.CCwWtZH3.js";import"./chunk.translations-hr.C7fo1LlO.js";import"./chunk.translations-it.BFH_rAJL.js";import"./chunk.translations-ru.C3zXigta.js";function G(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
</a-datepicker-range>
...
};`}}const K={name:"PageDatepickerRangeBasic",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=G(),{codeJs:a}=y(),n=u(void 0);return{codeHtml:e,codeJs:a,model:n}}},b={class:"a_mt_3"};function h(e,a,n,E,c,m){const r=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_BASIC_HEADER_",description:"_PAGE_DATEPICKER_RANGE_BASIC_DESCRIPTION_",props:["v-model","label"]},{default:p(()=>[_(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=o=>e.model=o),label:"Aloha"},null,8,["modelValue"]),g("div",b,"model: "+S(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(K,[["render",h]]);function H(){return{codeHtml:`<a-datepicker-range
  v-model="model"
...
};`}}const $={name:"PageDatepickerRangeCustomFirstDay",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=H(),{codeJs:a}=L(),n=u(void 0);return{codeHtml:e,codeJs:a,model:n}}};function U(e,a,n,E,c,m){const r=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_HEADER_",description:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_DESCRIPTION_",props:["v-model","label","firstDayOfWeek"]},{default:p(()=>[_(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=o=>e.model=o),label:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_EXAMPLE_","first-day-of-week":4},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const B=i($,[["render",U]]);function M(){return{codeHtml:`<a-datepicker-range
 v-model="model"
  :disabled="true">
</a-datepicker-range>
<a-datepicker-range
...
};`}}const F={name:"PageDatepickerRangeDisabledVariants",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=M(),{codeJs:a}=v(),n=u(void 0);return{codeHtml:e,codeJs:a,model:n}}};function V(e,a,n,E,c,m){const r=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_DISABLED_VARIANTS_HEADER_",description:"_PAGE_DATEPICKER_RANGE_DISABLED_VARIANTS_DESCRIPTION_",props:["v-model","disabled","disabledFrom","disabledUntil"]},{default:p(()=>[_(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=o=>e.model=o),disabled:!0},null,8,["modelValue"]),_(r,{modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=o=>e.model=o),"disabled-from":!0},null,8,["modelValue"]),_(r,{modelValue:e.model,"onUpdate:modelValue":a[2]||(a[2]=o=>e.model=o),"disabled-until":!0},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=i(F,[["render",V]]);function J(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  format="DD.MM.YY"
...
};`}}const x={name:"PageDatepickerRangeFormatCustomization",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=J(),{codeJs:a}=j(),n=u(void 0);return{codeHtml:e,codeJs:a,model:n}}};function X(e,a,n,E,c,m){const r=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_HEADER_",description:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_DESCRIPTION_",props:["v-model","format","formatSave"]},{default:p(()=>[_(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=o=>e.model=o),format:"DD.MM.YY","format-save":"YY-MM-DD"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const W=i(x,[["render",X]]);function z(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
