...
// ${s([{label:"label 1"},{label:"label 2"},{label:"label 3"},{label:"label 4"}],{keyLabel:"label"})}`}}const Z={name:"PageFilterListKeyLabel",components:{AlohaExample:b},setup(){const{codeJs:e}=X();return{codeJs:e}}};function ee(e,t,r,n,_,u){const i=l("aloha-example");return c(),p(i,{"code-js":e.codeJs,header:"keyLabel","is-code-visible-default":!0},null,8,["code-js"])}const le=o(Z,[["render",ee]]);function te(){return{codeJs:`const ITEMS = [
  {
    label: "label 1",
  },
  {
