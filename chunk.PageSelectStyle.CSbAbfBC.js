import{A as U,a as I}from"./chunk.AlohaExample.B95p2ibG.js";import{A as V}from"./chunk.AlohaTableProps.BDwC0GEx.js";import{A as f}from"./chunk.AlohaTableTranslate.ClAHSQpR.js";import{a0 as P,_ as C,g as N,A as y}from"./bundle.index.7Gm8ngMZ.js";import{r as o,V as i,aT as n,e as S,W as c,_ as E,Z as r,aU as s,d as m}from"./chunk.vendor.D2EiI1BL.js";import"./chunk.vendor-lodash.Wop2AkRA.js";import{A as D}from"./chunk.AList.CFdaDz7Y.js";import"./chunk.APageTabTitle.DRSOBdvA.js";import"./chunk.AlohaHighlightjs.B_1iuPG1.js";import"./chunk.ATable.q3RyArlj.js";import"./chunk.translations-ar.DEWt73y8.js";import"./chunk.translations-de.CN5eAU-4.js";import"./chunk.translations-en.CPCEcTAP.js";import"./chunk.translations-es.BKTK5PUv.js";import"./chunk.translations-fr.CslimZmU.js";import"./chunk.translations-hr.CiJ7_Y2m.js";import"./chunk.translations-it.H45F8miC.js";import"./chunk.translations-ru.o-dOzdYz.js";function G(){return{codeHtml:`<a-select-style
  v-model="model1"
  label="Select"
  type="select"
></a-select-style>
...
};`}}const g={name:"PageSelectStyleBasic",components:{AlohaExample:U,ASelectStyle:P},setup(){const{codeHtml:_}=G(),{codeJs:e}=B(),L=o(void 0),T=o(void 0);return{codeHtml:_,codeJs:e,model1:L,model2:T}}};function M(_,e,L,T,a,u){const t=S("a-select-style"),l=S("aloha-example");return c(),i(l,{"code-html":_.codeHtml,"code-js":_.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","type"]},{default:n(()=>[E(t,{modelValue:_.model1,"onUpdate:modelValue":e[0]||(e[0]=A=>_.model1=A),label:"Select",type:"select"},null,8,["modelValue"]),r("div",null,"model1: "+s(_.model1),1),E(t,{class:"a_mt_3",modelValue:_.model2,"onUpdate:modelValue":e[1]||(e[1]=A=>_.model2=A),label:"Multiselect",type:"multiselect"},null,8,["modelValue"]),r("div",null,"model2: "+s(_.model2),1)]),_:1},8,["code-html","code-js"])}const b=C(g,[["render",M]]);function F(){return{codeHtml:`<a-select-style
  v-model="model1"
...
<a-select-style
  ...
  type="multiselect"
></a-select-style>
<div>model2: {{ model2 }}</div>`}}function $(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const J={name:"PageSelectStyleFilterGroups",components:{AList:D,AlohaExample:U,ASelectStyle:P},setup(){const{codeHtml:_}=h(),{codeJs:e}=$(),L=[["display",["mobile","tablet","touch","desktop","widescreen","fullhd","large"]],["flex",["flex_direction","justify_content","align_items","align_self","justify_self","flex_wrap","align_content"]],["text_align",["mobile","tablet","touch","desktop","widescreen","fullhd","large"]],["button",["basic","outline","transparent","size"]],"text_wrapping","line_limiting","text_transform","font_weight","line_height","font_size","margin","padding","color","background_color"],T=o(void 0),a=o(void 0);return{codeHtml:_,codeJs:e,groups:L,model1:T,model2:a}}};function x(_,e,L,T,a,u){const t=S("a-list"),l=S("a-select-style"),A=S("aloha-example");return c(),i(A,{"code-html":_.codeHtml,"code-js":_.codeJs,header:"_A_SELECT_STYLE_GROUP_FILTER_GROUPS_HEADER_",description:"_A_SELECT_STYLE_GROUP_FILTER_GROUPS_DESCRIPTION_",props:["filter-groups"]},{prepend:n(()=>[E(t,{data:_.groups,"is-data-simple-array":!0},null,8,["data"])]),default:n(()=>[E(l,{modelValue:_.model1,"onUpdate:modelValue":e[0]||(e[0]=d=>_.model1=d),"filter-groups":["display","color"],label:"Select",type:"select"},null,8,["modelValue"]),r("div",null,"model1: "+s(_.model1),1),E(l,{class:"a_mt_3",modelValue:_.model2,"onUpdate:modelValue":e[1]||(e[1]=d=>_.model2=d),"filter-groups":{flex:["align_items","justify_content"],background_color:!0},label:"Multiselect",type:"multiselect"},null,8,["modelValue"]),r("div",null,"model2: "+s(_.model2),1)]),_:1},8,["code-html","code-js"])}const K=C(J,[["render",x]]);function k(){return{codeHtml:`<a-select-style
  :model-value="model1"
  :readonly="true"
  label="Select 1"
  type="select"
