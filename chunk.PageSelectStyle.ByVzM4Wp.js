...
};`}}const b={name:"PageSelectStyleBasic",components:{AlohaExample:U,ASelectStyle:p},setup(){const{codeHtml:_}=B(),{codeJs:e}=g(),L=o(void 0),T=o(void 0);return{codeHtml:_,codeJs:e,model1:L,model2:T}}};function M(_,e,L,T,a,i){const t=S("a-select-style"),l=S("aloha-example");return r(),s(l,{"code-html":_.codeHtml,"code-js":_.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","type"]},{default:n(()=>[E(t,{modelValue:_.model1,"onUpdate:modelValue":e[0]||(e[0]=A=>_.model1=A),label:"Select",type:"select"},null,8,["modelValue"]),c("div",null,"model1: "+u(_.model1),1),E(t,{class:"a_mt_3",modelValue:_.model2,"onUpdate:modelValue":e[1]||(e[1]=A=>_.model2=A),label:"Multiselect",type:"multiselect"},null,8,["modelValue"]),c("div",null,"model2: "+u(_.model2),1)]),_:1},8,["code-html","code-js"])}const F=d(b,[["render",M]]);function X(){return{codeHtml:`<a-select-style
  v-model="model1"
...
};`}}const q={name:"PageSelectStyleDataExtended",components:{AlohaExample:U,ASelectStyle:p},setup(){const{codeHtml:_}=X(),{codeJs:e}=H(),L=[{label:"_A_SELECT_STYLES_VALUE_BG_ALOHA_",value:"a_bg_aloha",group:"background_color",groupName:"_A_SELECT_STYLES_GROUP_BACKGROUND_COLOR_"}],T=o(void 0);return{codeHtml:_,codeJs:e,dataExtended:L,model1:T}}};function h(_,e,L,T,a,i){const t=S("a-select-style"),l=S("aloha-example");return r(),s(l,{"code-html":_.codeHtml,"code-js":_.codeJs,header:"_A_SELECT_STYLE_GROUP_DATA_EXTENDED_HEADER_",description:"_A_SELECT_STYLE_GROUP_DATA_EXTENDED_DESCRIPTION_",props:["data-extended"]},{default:n(()=>[E(t,{modelValue:_.model1,"onUpdate:modelValue":e[0]||(e[0]=A=>_.model1=A),"data-extended":_.dataExtended,"filter-groups":["background_color"],label:"Select",type:"select"},null,8,["modelValue","data-extended"]),c("div",null,"model1: "+u(_.model1),1)]),_:1},8,["code-html","code-js"])}const v=d(q,[["render",h]]);function $(){return{codeHtml:`<a-select-style
  v-model="model1"
  :filter-groups="['display', 'color']"
  label="Select"
  type="select"
...
<a-select-style
  ...
  type="multiselect"
></a-select-style>
<div>model2: {{ model2 }}</div>`}}function J(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const j={name:"PageSelectStyleFilterGroups",components:{AList:G,AlohaExample:U,ASelectStyle:p},setup(){const{codeHtml:_}=$(),{codeJs:e}=J(),L=[["display",["mobile","tablet","touch","desktop","widescreen","fullhd","large"]],["flex",["flex_direction","justify_content","align_items","align_self","justify_self","flex_wrap","align_content"]],["text_align",["mobile","tablet","touch","desktop","widescreen","fullhd","large"]],["button",["basic","outline","transparent","size"]],"text_wrapping","line_limiting","text_transform","font_weight","line_height","font_size","margin","padding","color","background_color"],T=o(void 0),a=o(void 0);return{codeHtml:_,codeJs:e,groups:L,model1:T,model2:a}}};function x(_,e,L,T,a,i){const t=S("a-list"),l=S("a-select-style"),A=S("aloha-example");return r(),s(A,{"code-html":_.codeHtml,"code-js":_.codeJs,header:"_A_SELECT_STYLE_GROUP_FILTER_GROUPS_HEADER_",description:"_A_SELECT_STYLE_GROUP_FILTER_GROUPS_DESCRIPTION_",props:["filter-groups"]},{prepend:n(()=>[E(t,{data:_.groups,"is-data-simple-array":!0},null,8,["data"])]),default:n(()=>[E(l,{modelValue:_.model1,"onUpdate:modelValue":e[0]||(e[0]=C=>_.model1=C),"filter-groups":["display","color"],label:"Select",type:"select"},null,8,["modelValue"]),c("div",null,"model1: "+u(_.model1),1),E(l,{class:"a_mt_3",modelValue:_.model2,"onUpdate:modelValue":e[1]||(e[1]=C=>_.model2=C),"filter-groups":{flex:["align_items","justify_content"],background_color:!0},label:"Multiselect",type:"multiselect"},null,8,["modelValue"]),c("div",null,"model2: "+u(_.model2),1)]),_:1},8,["code-html","code-js"])}const K=d(j,[["render",x]]);function k(){return{codeHtml:`<a-select-style
  v-model="model"
  :is-label-float="false"
  label="Select"
  label-description="Aloha"
  type="select"
></a-select-style>`}}function W(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const w={name:"PageSelectStyleLabelDescription",components:{AlohaExample:U,ASelectStyle:p},setup(){const{codeHtml:_}=k(),{codeJs:e}=W(),L=o(void 0);return{codeHtml:_,codeJs:e,model:L}}};function Z(_,e,L,T,a,i){const t=S("a-select-style"),l=S("aloha-example");return r(),s(l,{"code-html":_.codeHtml,"code-js":_.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:n(()=>[E(t,{modelValue:_.model,"onUpdate:modelValue":e[0]||(e[0]=A=>_.model=A),"is-label-float":!1,label:"Select","label-description":"Aloha",type:"select"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const z=d(w,[["render",Z]]);function Q(){return{codeHtml:`<a-select-style
  :model-value="model1"
  :readonly="true"
  label="Select 1"
  type="select"
...
<a-select-style
  ...
  readonly-default="-"
  type="select"
></a-select-style>`}}function __(){return{codeJs:`import {
  ref,
} from "vue";
