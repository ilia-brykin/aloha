import{A as _,a as A}from"./chunk.AlohaExample.CMUUEVcN.js";import{aO as n,_ as c,A as P}from"./bundle.index.DOWaPX07.js";import{P as E,a as T,b as v}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as F}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as p,C as u,m as t,L as N,G as r}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function S(){return{codeJs:`filterJson({ x: 5, y: 6 });
// ${n({x:5,y:6})}
...
// ${n(o,{replacer:["week","month","model"]})}`}}const b={name:"PageFilterJsonReplacer",components:{AlohaExample:_},setup(){const{codeJs:e}=O();return{codeJs:e}}};function k(e,o,i,l,s,f){const a=t("aloha-example");return p(),u(a,{"code-js":e.codeJs,header:"replacer","is-code-visible-default":!0},null,8,["code-js"])}const w=c(b,[["render",k]]);function G(){return{codeJs:`filterJson({ x: 5, y: 6 }, { space: 0 });
// ${n({x:5,y:6},{space:0})}
...
`,V={name:"PageFilterJson",components:{AlohaPage:A,ATranslation:P,PageFilterArguments:v,PageFilterImportCompositionApi:F,PageFilterImportFunction:T,PageFilterJsonExample:j,PageFilterJsonReplacer:w,PageFilterJsonSpace:L,PageFilterTest:E},setup(){const{pageTitle:e}=U(),{argumentsText:o}=M();return{argumentsText:o,pageTitle:e,test:z}}};function D(e,o,i,l,s,f){const a=t("a-translation"),m=t("page-filter-import-function"),d=t("page-filter-import-composition-api"),g=t("page-filter-arguments"),J=t("page-filter-json-example"),x=t("page-filter-json-space"),h=t("page-filter-json-replacer"),$=t("page-filter-test"),y=t("aloha-page");return p(),u(y,{"page-title":e.pageTitle},{body:N(()=>[r(a,{tag:"p",html:"_PAGE_FILTER_JSON_DESCRIPTION_"}),r(m,{"function-name":"filterJson","type-import":"filters"}),r(d,{"function-name":"filterJson"}),r(g,{"arguments-text":e.argumentsText,"function-description":"filterJson(value, { [replacer], [space=2] })"},null,8,["arguments-text"]),r(J),r(x),r(h),r($,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const Z=c(V,[["render",D]]);export{Z as default};
