import{A as g,a as G}from"./chunk.AlohaExample.DVnVMcKR.js";import{P,a as T,b as I}from"./chunk.PageFilterTest.uesadPPG.js";import{aZ as o,_ as r,A as E}from"./bundle.index.z5gwPU4G.js";import{Y as s,W as p,f as e,aU as J,$ as n}from"./chunk.vendor.CWr53wb5.js";import"./chunk.vendor-lodash.CWoM99Se.js";import{P as v}from"./chunk.PageFilterImportCompositionApi.BXKeHZBz.js";import"./chunk.APageTabTitle.CEPAqBab.js";import"./chunk.AlohaHighlightjs.Cyb5M4zM.js";import"./chunk.translations-ar.CG00cKrz.js";import"./chunk.translations-de.jRMdBWJu.js";import"./chunk.translations-en.Ccpp2c3W.js";import"./chunk.translations-es.Bh9mDab1.js";import"./chunk.translations-fr.B3yhrsaC.js";import"./chunk.translations-hr.B5_cxohh.js";import"./chunk.translations-it.DDcVOPnN.js";import"./chunk.translations-ru.BxzwpxMH.js";function S(){return{codeJs:`filterFloat(1000222.55, { digitGrouping: false });
// ${o(100022255e-2,{digitGrouping:!1})}

filterFloat(1000222.55, { digitGrouping: true });
// ${o(100022255e-2,{digitGrouping:!0})}`}}const b={name:"PageFilterFloatDigitGrouping",components:{AlohaExample:g},setup(){const{codeJs:t}=S();return{codeJs:t}}};function L(t,l,a,f,c,u){const i=e("aloha-example");return s(),p(i,{"code-js":t.codeJs,header:"digitGrouping","is-code-visible-default":!0},null,8,["code-js"])}const R=r(b,[["render",L]]);function j(){return{codeJs:`filterFloat(2000, { digits: 0 });
// ${o(2e3,{digits:0})}

filterFloat("25.53451", { digits: 4 });
// ${o("25.53451",{digits:4})}`}}const N={name:"PageFilterFloatDigits",components:{AlohaExample:g},setup(){const{codeJs:t}=j();return{codeJs:t}}};function U(t,l,a,f,c,u){const i=e("aloha-example");return s(),p(i,{"code-js":t.codeJs,header:"digits","is-code-visible-default":!0},null,8,["code-js"])}const D=r(N,[["render",U]]);function O(){return{codeJs:`filterFloat(123456);
// ${o(123456)}
...
// ${o(void 0)}`}}const y={name:"PageFilterFloatExample",components:{AlohaExample:g},setup(){const{codeJs:t}=O();return{codeJs:t}}};function C(t,l,a,f,c,u){const i=e("aloha-example");return s(),p(i,{"code-js":t.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const M=r(y,[["render",C]]);function k(){return{codeJs:`filterFloat(2000, { suffix: "€" });
// ${o(2e3,{suffix:"€"})}

filterFloat("25.5", { suffix: "%" });
// ${o("25.5",{suffix:"%"})}`}}const w={name:"PageFilterFloatSuffix",components:{AlohaExample:g},setup(){const{codeJs:t}=k();return{codeJs:t}}};function V(t,l,a,f,c,u){const i=e("aloha-example");return s(),p(i,{"code-js":t.codeJs,header:"suffix","is-code-visible-default":!0},null,8,["code-js"])}const W=r(w,[["render",V]]);function X(){return{argumentsText:[{value:"value",types:["Number","String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_VALUE_"},{value:'[suffix=""]',types:["String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_SUFFIX_"},{value:"[digits=2]",types:["Number"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGITS_"},{value:"[digitGrouping=true]",types:["Boolean"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGIT_GROUPING_"}]}}function Y(){return{pageTitle:"filterFloat"}}const Z=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
...
`,q={name:"PageFilterFloat",components:{AlohaPage:G,ATranslation:E,PageFilterArguments:I,PageFilterFloatDigitGrouping:R,PageFilterFloatDigits:D,PageFilterFloatExample:M,PageFilterFloatSuffix:W,PageFilterImportCompositionApi:v,PageFilterImportFunction:T,PageFilterTest:P},setup(){const{pageTitle:t}=Y(),{argumentsText:l}=X();return{argumentsText:l,pageTitle:t,test:Z}}};function z(t,l,a,f,c,u){const i=e("a-translation"),_=e("page-filter-import-function"),d=e("page-filter-import-composition-api"),F=e("page-filter-arguments"),x=e("page-filter-float-example"),m=e("page-filter-float-suffix"),B=e("page-filter-float-digits"),$=e("page-filter-float-digit-grouping"),A=e("page-filter-test"),h=e("aloha-page");return s(),p(h,{"page-title":t.pageTitle},{body:J(()=>[n(i,{tag:"p",html:"_PAGE_FILTER_FLOAT_DESCRIPTION_"}),n(_,{"function-name":"filterFloat","type-import":"filters"}),n(d,{"function-name":"filterFloat"}),n(F,{"arguments-text":t.argumentsText,"function-description":'filterFloat(value, { [suffix=""], [digits=2], [digitGrouping=true] })'},null,8,["arguments-text"]),n(x),n(m),n(B),n($),n(A,{test:t.test},null,8,["test"])]),_:1},8,["page-title"])}const gt=r(q,[["render",z]]);export{gt as default};
