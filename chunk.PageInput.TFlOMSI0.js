import{A as P,a as C}from"./chunk.AlohaExample.DQald-L_.js";import{A as v}from"./chunk.AlohaTableProps.nxAQILM8.js";import{A as H}from"./chunk.AlohaTableTranslate.CSmDkKaH.js";import{v as f,ah as m,aM as L,a3 as w}from"./bundle.index.D1OA29U_.js";import{bf as _,bc as i,aQ as c,br as I,bi as t,aV as a,aP as R,bn as S,aN as E}from"./chunk.vendor.B7xidcyX.js";import"./chunk.vendor-lodash.DHCI5OYQ.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function J(){return{codeHtml:`<a-input
  v-model="model"
  label="Input"
></a-input>
...
};`}}const V={name:"PageInputBasic",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha"),{codeHtml:o}=J(),{codeJs:n}=q();return{codeHtml:o,codeJs:n,model:e}}};function B(e,o,n,s,p,u){const l=t("a-input"),d=t("aloha-example");return i(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:I(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),label:"Input"},null,8,["modelValue"]),R("div",null,"model: "+S(e.model),1)]),_:1},8,["code-html","code-js"])}const j=m(V,[["render",B]]);function G(){return{codeHtml:`<a-input
  :change="changeModel"
  :model-value="model"
  label="Input"
></a-input>
...
};`}}const k={name:"PageInputErrors",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha"),{codeHtml:o}=Y(),{codeJs:n}=X();return{codeHtml:o,codeJs:n,model:e}}};function Q(e,o,n,s,p,u){const l=t("a-input"),d=t("aloha-example");return i(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:I(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),errors:"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const z=m(k,[["render",Q]]);function K(){return{codeHtml:`<a-input
  v-model="model"
  help-text="Aloha"
  label="Input"
...
};`}}const ee={name:"PageInputHelpText",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha"),{codeHtml:o}=K(),{codeJs:n}=Z();return{codeHtml:o,codeJs:n,model:e}}};function oe(e,o,n,s,p,u){const l=t("a-input"),d=t("aloha-example");return i(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:I(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),"help-text":"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=m(ee,[["render",oe]]);function ne(){return{codeHtml:`<a-input
  v-model="model"
...
};`}}const ue={name:"PageInputLabelFloat",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha"),{codeHtml:o}=se(),{codeJs:n}=pe();return{codeHtml:o,codeJs:n,model:e}}};function _e(e,o,n,s,p,u){const l=t("a-input"),d=t("aloha-example");return i(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_IS_LABEL_FLOAT_HEADER_",description:"_A_UI_GROUP_IS_LABEL_FLOAT_DESCRIPTION_",props:["is-label-float"]},{default:I(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),"is-label-float":!1,label:"Input"},null,8,["modelValue"]),a(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":o[1]||(o[1]=r=>e.model=r),"is-label-float":!0,label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const me=m(ue,[["render",_e]]);function ie(){return{codeHtml:`<a-input
  v-model="model"
  label="Input"
></a-input>
<a-input
...
};`}}const Ne={name:"PageInputReadonly",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha1"),o=_("Aloha2"),n=_(void 0),{codeHtml:s}=he(),{codeJs:p}=Te();return{codeHtml:s,codeJs:p,model1:e,model2:o,model3:n}}};function ye(e,o,n,s,p,u){const l=t("a-input"),d=t("aloha-example");return i(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:I(()=>[a(l,{"model-value":e.model1,readonly:!0,label:"Input1",type:"text"},null,8,["model-value"]),a(l,{class:"a_mt_3","model-value":e.model2,readonly:!0,label:"Input2",type:"text"},null,8,["model-value"]),a(l,{class:"a_mt_3","model-value":e.model3,readonly:!0,"help-text":"Aloha",label:"Input3","readonly-default":"-",type:"text"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const be=m(Ne,[["render",ye]]);function De(){return{codeHtml:`<a-input
  :model-value="model"
  :readonly="true"
  :show-password="false"
  label="Input1"
