import{A as x,a as A}from"./chunk.AlohaExample.DQIiBf4s.js";import{aM as o,_ as s,A as E}from"./bundle.index.DwwGfdde.js";import{P as I,a as J,b as F}from"./chunk.PageFilterTest.CUW-907H.js";import{P as b}from"./chunk.PageFilterImportCompositionApi.D1tlLZN4.js";import{m as t,C as r,B as c,L as C,G as a}from"./chunk.vendor.D-Y3mz6a.js";import"./chunk.vendor-lodash.ClBXVCWL.js";import"./chunk.vendor-tinymce.2RT9eEW9.js";function R(){return{codeJs:`filterLink("example.com");
// ${o("example.com")}

filterLink("https://example.com");
// ${o("https://example.com")}`}}const N={name:"PageFilterLinkExample",components:{AlohaExample:x},setup(){const{codeJs:e}=R();return{codeJs:e}}};function S(e,l,i,p,m,_){const n=t("aloha-example");return c(),r(n,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const B=s(N,[["render",S]]);function G(){return{codeJs:`filterLink("example.com", { linkClass: "a_btn a_btn_link" });
// ${o("example.com",{linkClass:"a_btn a_btn_link"})}`}}const v={name:"PageFilterLinkLinkClass",components:{AlohaExample:x},setup(){const{codeJs:e}=G();return{codeJs:e}}};function j(e,l,i,p,m,_){const n=t("aloha-example");return c(),r(n,{"code-js":e.codeJs,header:"linkClass","is-code-visible-default":!0},null,8,["code-js"])}const K=s(v,[["render",j]]);function U(){return{codeJs:`filterLink("example.com", { linkText: "example" });
// ${o("example.com",{linkText:"example"})}

filterLink("https://example.com", { linkText: "Aloha" });
// ${o("https://example.com",{linkText:"Aloha"})}`}}const y={name:"PageFilterLinkLinkText",components:{AlohaExample:x},setup(){const{codeJs:e}=U();return{codeJs:e}}};function M(e,l,i,p,m,_){const n=t("aloha-example");return c(),r(n,{"code-js":e.codeJs,header:"linkText","is-code-visible-default":!0},null,8,["code-js"])}const w=s(y,[["render",M]]);function O(){return{codeJs:`filterLink("example.com", { protocol: "" });
