import{A as f,a as Y}from"./chunk.AlohaExample.cx08GSwV.js";import{A as q}from"./chunk.AlohaTableProps.BGy_hrFy.js";import{A as G}from"./chunk.AlohaTableTranslate.RZnJviGD.js";import{ak as R,_ as s,g as j,A as M}from"./bundle.index.1IWyi0gn.js";import{r as m,V as _,aT as i,e as l,W as I,_ as r,Z as P,aU as y,d as A}from"./chunk.vendor.D7UxhUfn.js";import"./chunk.vendor-lodash.BbaK34MN.js";import"./chunk.APageTabTitle.uc4lhmn-.js";import"./chunk.AlohaHighlightjs.dFk8X2lo.js";import"./chunk.ATable.DK3GkIoK.js";import"./chunk.translations-ar.BXWv90e-.js";import"./chunk.translations-de.JSU2GZ-A.js";import"./chunk.translations-en.CviwQZZj.js";import"./chunk.translations-es.D2AGpadl.js";import"./chunk.translations-fr.DQLlT60U.js";import"./chunk.translations-hr.EjwgafbT.js";import"./chunk.translations-it.fnRPaBQW.js";import"./chunk.translations-ru.DfHWC88K.js";function B(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="Input"
></a-input-currency>
...
};`}}const X={name:"PageInputCurrencyBasic",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=B(),{codeJs:a}=F();return{codeHtml:n,codeJs:a,model:e}}};function k(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return I(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:i(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const w=s(X,[["render",k]]);function W(){return{codeHtml:`<a-input-currency
  :change="changeModel"
  :model-value="model"
  label="Input"
></a-input-currency>
