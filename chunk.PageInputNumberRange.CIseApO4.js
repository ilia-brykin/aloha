...
};`}}const C={name:"PageInputNumberRangeBasic",components:{AlohaExample:g,AInputNumberRange:R},setup(){const{codeHtml:e}=$(),{codeJs:n}=y(),o=h(void 0);return{codeHtml:e,codeJs:n,model:o}}},L={class:"a_columns a_columns_count_12"},H={class:"a_column a_column_6 a_columns_count_12_touch"},U={class:"a_mt_3"};function D(e,n,o,u,d,A){const l=a("a-input-number-range"),_=a("aloha-example");return i(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["v-model","label"]},{default:c(()=>[t("div",L,[t("div",H,[s(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=r=>e.model=r),label:"Aloha"},null,8,["modelValue"]),t("div",U,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const G=m(C,[["render",D]]);function J(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
  placeholder-max="Max"
  placeholder-min="Min"
...
};`}}const X={name:"PageInputNumberRangeTypeInteger",components:{AlohaExample:g,AInputNumberRange:R},setup(){const{codeHtml:e}=k(),{codeJs:n}=F(),o=h(void 0);return{codeHtml:e,codeJs:n,model:o}}},w={class:"a_columns a_columns_count_12"},K={class:"a_column a_column_6 a_columns_count_12_touch"},z={class:"a_mt_3"};function Q(e,n,o,u,d,A){const l=a("a-input-number-range"),_=a("aloha-example");return i(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_DESCRIPTION_",props:"type='integerRange'"},{default:c(()=>[t("div",w,[t("div",K,[s(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=r=>e.model=r),label:"Aloha",type:"integerRange"},null,8,["modelValue"]),t("div",z,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const W=m(X,[["render",Q]]);function Z(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
