...
};`}}const z={name:"PageInputHelpText",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=Y(),{codeJs:o}=Q();return{codeHtml:t,codeJs:o,model:e}}};function K(e,t,o,p,s,_){const l=n("a-input"),r=n("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),"help-text":"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=u(z,[["render",K]]);function ee(){return{codeHtml:`<a-input
  v-model="model"
