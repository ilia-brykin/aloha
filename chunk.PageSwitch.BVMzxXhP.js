import{A as f,a as v}from"./chunk.AlohaExample.BUpKYs6e.js";import{A as b}from"./chunk.AlohaTableProps.BYeSAOC9.js";import{A as y}from"./chunk.AlohaTableTranslate.DCK8v7Pf.js";import{a as S,_ as m,g as J,A as V}from"./bundle.index.BecyEjsf.js";import{r as i,Y as u,W as p,aU as h,f as o,$ as l,_ as A,aV as P,d as E}from"./chunk.vendor.Byi294Mq.js";import"./chunk.vendor-lodash.BZTvCWYY.js";import"./chunk.APageTabTitle.DeH86sFI.js";import"./chunk.AlohaHighlightjs.D8Y-nfDK.js";import"./chunk.ATable.D0UXae0g.js";import"./chunk.translations-ar.CEE2zr9E.js";import"./chunk.translations-de.B5EkW3Bn.js";import"./chunk.translations-en.By5OazNK.js";import"./chunk.translations-es.BBwYsoM6.js";import"./chunk.translations-fr.sIUOe09m.js";import"./chunk.translations-hr.BW2q_4Qp.js";import"./chunk.translations-it.BpY7vfJm.js";import"./chunk.translations-ru.j7n72CSV.js";function B(){return{codeHtml:`<a-switch
  v-model="model"
></a-switch>
...
};`}}const j={name:"PageSwitchBasic",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=B(),{codeJs:a}=q();return{codeHtml:t,codeJs:a,model:e}}};function F(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s)},null,8,["modelValue"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const G=m(j,[["render",F]]);function W(){return{codeHtml:`<a-switch
  :change="changeModel"
  :model-value="model"
></a-switch>
...
};`}}const z={name:"PageSwitchDefault",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(void 0),t=({init:c})=>{console.log("changeModel init",c)},{codeHtml:a}=k(),{codeJs:r}=Q();return{changeModel:t,codeHtml:a,codeJs:r,model:e}}};function K(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_DEFAULT_HEADER_",description:"_A_UI_GROUP_DEFAULT_DESCRIPTION_",props:["default"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),change:e.changeModel,default:!0},null,8,["modelValue","change"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const Z=m(z,[["render",K]]);function ee(){return{codeHtml:`<a-switch
  v-model="model"
  errors="Aloha"
  label="ASwitch"
...
};`}}const oe={name:"PageSwitchErrors",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=ee(),{codeJs:a}=te();return{codeHtml:t,codeJs:a,model:e}}};function ae(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const le=m(oe,[["render",ae]]);function ne(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
...
};`}}const se={name:"PageSwitchHelpText",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=ne(),{codeJs:a}=de();return{codeHtml:t,codeJs:a,model:e}}};function re(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"help-text":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ce=m(se,[["render",re]]);function _e(){return{codeHtml:`<a-switch
  v-model="model"
  label="Switch"
...
};`}}const me={name:"PageSwitchLabelDescription",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=_e(),{codeJs:a}=ie();return{codeHtml:t,codeJs:a,model:e}}};function ue(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),label:"Switch","label-description":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const pe=m(me,[["render",ue]]);function he(){return{codeHtml:`<a-switch
  v-model="model"
  label="ASwitch"
></a-switch>
<a-switch
...
};`}}const Se={name:"PageSwitchLabelScreenReader",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=he(),{codeJs:a}=fe();return{codeHtml:t,codeJs:a,model:e}}};function Ae(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_SCREEN_READER_HEADER_",description:"_A_UI_GROUP_LABEL_SCREEN_READER_DESCRIPTION_",props:["label-screen-reader"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),label:"ASwitch"},null,8,["modelValue"]),l(n,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":t[1]||(t[1]=s=>e.model=s),"label-screen-reader":"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Pe=m(Se,[["render",Ae]]);function Ie(){return{codeHtml:`<a-switch
  :model-value="model1"
  :readonly="true"
  label="Switch 1"
></a-switch>
...
};`}}const $e={name:"PageSwitchTitle",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(0),{codeHtml:t}=Le(),{codeJs:a}=Ce();return{codeHtml:t,codeJs:a,model:e}}};function Ne(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_SWITCH_GROUP_TITLE_HEADER_",description:"_A_SWITCH_GROUP_TITLE_DESCRIPTION_",props:["title","is-title-html"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"is-title-html":!0,title:"Aloha"},null,8,["modelValue"]),l(n,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":t[1]||(t[1]=s=>e.model=s),"is-title-html":!1,title:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ve=m($e,[["render",Ne]]);function be(){return{codeHtml:`<a-switch
  v-model="model"
  false-label="0"
  true-label="1"
...
};`}}const Je={name:"PageSwitchTrueFalseLabel",components:{AlohaExample:f,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=be(),{codeJs:a}=ye();return{codeHtml:t,codeJs:a,model:e}}};function Ve(e,t,a,r,c,_){const n=o("a-switch"),d=o("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_SWITCH_GROUP_TRUE_FALSE_LABEL_HEADER_",description:"_A_SWITCH_GROUP_TRUE_FALSE_LABEL_DESCRIPTION_",props:["false-label","true-label"]},{default:h(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"false-label":"0","true-label":"1"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Be=m(Je,[["render",Ve]]);function qe(){return{codeHtml:`<a-switch
  v-model="model"
  :false-value="0"
  :true-value="1"
></a-switch>
