...
};`}}const J={name:"PageInputBasic",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=y(),{codeJs:o}=v();return{codeHtml:t,codeJs:o,model:e}}};function q(e,t,o,s,p,_){const l=n("a-input"),r=n("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),label:"Input"},null,8,["modelValue"]),S("div",null,"model: "+R(e.model),1)]),_:1},8,["code-html","code-js"])}const V=u(J,[["render",q]]);function B(){return{codeHtml:`<a-input
  :change="changeModel"
  :model-value="model"
  label="Input"
></a-input>
...
};`}}const W={name:"PageInputErrors",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=F(),{codeJs:o}=x();return{codeHtml:t,codeJs:o,model:e}}};function X(e,t,o,s,p,_){const l=n("a-input"),r=n("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),errors:"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const k=u(W,[["render",X]]);function Y(){return{codeHtml:`<a-input
  v-model="model"
  help-text="Aloha"
  label="Input"
...
};`}}const Q={name:"PageInputHelpText",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=Y(),{codeJs:o}=K();return{codeHtml:t,codeJs:o,model:e}}};function z(e,t,o,s,p,_){const l=n("a-input"),r=n("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),"help-text":"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=u(Q,[["render",z]]);function ee(){return{codeHtml:`<a-input
  v-model="model"
...
};`}}const ne={name:"PageInputLabelFloat",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=ee(),{codeJs:o}=te();return{codeHtml:t,codeJs:o,model:e}}};function oe(e,t,o,s,p,_){const l=n("a-input"),r=n("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_IS_LABEL_FLOAT_HEADER_",description:"_A_UI_GROUP_IS_LABEL_FLOAT_DESCRIPTION_",props:["is-label-float"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),"is-label-float":!1,label:"Input"},null,8,["modelValue"]),a(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":t[1]||(t[1]=d=>e.model=d),"is-label-float":!0,label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ae=u(ne,[["render",oe]]);function le(){return{codeHtml:`<a-input
  v-model="model"
  label="Input"
></a-input>
<a-input
