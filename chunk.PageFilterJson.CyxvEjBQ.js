import{A as m,a as S}from"./chunk.AlohaExample.Di1hQFwd.js";import{P as O,a as T,b as N}from"./chunk.PageFilterTest.Mq29Z2Zn.js";import{P as j}from"./chunk.PageFilterImportCompositionApi.Csk5TLpT.js";import{aW as n,_ as i,A as E}from"./bundle.index.mluylX0A.js";import{Y as p,W as u,f as t,aU as F,$ as a}from"./chunk.vendor.BEEJbev-.js";import"./chunk.vendor-lodash.CwOx-Q_g.js";import"./chunk.APageTabTitle.BbbhJnhY.js";import"./chunk.AlohaHighlightjs.De6fh8wy.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function H(){return{codeJs:`filterJson({ x: 5, y: 6 }, { isHtml: true, class: "aloha" });
// ${n({x:5,y:6},{isHtml:!0})}`}}const I={name:"PageFilterJsonClass",components:{AlohaExample:m},setup(){const{codeJs:e}=H();return{codeJs:e}}};function R(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"jsonClass","is-code-visible-default":!0},null,8,["code-js"])}const k=i(I,[["render",R]]);function w(){return{codeJs:`filterJson({ x: 5, y: 6 });
// ${n({x:5,y:6})}
...
// ${n([NaN,null,1/0,void 0])}`}}const C={name:"PageFilterJsonExample",components:{AlohaExample:m},setup(){const{codeJs:e}=w();return{codeJs:e}}};function G(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const L=i(C,[["render",G]]);function b(){return{codeJs:`filterJson({ x: 5, y: 6 }, { isHtml: true });
// ${n({x:5,y:6},{isHtml:!0})}

filterJson({ x: 5, y: 6 }, { isHtml: false });
// ${n({x:5,y:6},{isHtml:!1})}`}}const B={name:"PageFilterJsonIsHtml",components:{AlohaExample:m},setup(){const{codeJs:e}=b();return{codeJs:e}}};function M(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"isHtml","is-code-visible-default":!0},null,8,["code-js"])}const U=i(B,[["render",M]]);function z(){function e(c,r){if(typeof r!="string")return r}const s={foundation:"Mozilla",model:"box",week:45,transport:"car",month:7};return{codeJs:`function replacer(key, value) {
...
// ${n(s,{replacer:["week","month","model"]})}`}}const V={name:"PageFilterJsonReplacer",components:{AlohaExample:m},setup(){const{codeJs:e}=z();return{codeJs:e}}};function W(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"replacer","is-code-visible-default":!0},null,8,["code-js"])}const D=i(V,[["render",W]]);function Y(){return{codeJs:`filterJson({ x: 5, y: 6 }, { space: 0 });
// ${n({x:5,y:6},{space:0})}
...
// ${n({x:5,y:6},{space:"	"})}`}}const q={name:"PageFilterJsonSpace",components:{AlohaExample:m},setup(){const{codeJs:e}=Y();return{codeJs:e}}};function K(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"space","is-code-visible-default":!0},null,8,["code-js"])}const Q=i(q,[["render",K]]);function X(){return{codeJs:`filterJson({ x: 5, y: 6 }, { isHtml: true, tag: "pre" });
// ${n({x:5,y:6},{isHtml:!0,tag:"pre"})}

filterJson({ x: 5, y: 6 }, { isHtml: true, tag: "div" });
// ${n({x:5,y:6},{isHtml:!0,tag:"div"})}`}}const Z={name:"PageFilterJsonTag",components:{AlohaExample:m},setup(){const{codeJs:e}=X();return{codeJs:e}}};function ee(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"tag","is-code-visible-default":!0},null,8,["code-js"])}const te=i(Z,[["render",ee]]);function ne(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_JSON_ARGUMENTS_VALUE_"},{value:"[replacer]",types:["Function","Array"],text:"_PAGE_FILTER_JSON_ARGUMENTS_REPLACER_"},{value:"[space=2]",types:["Number","String"],text:"_PAGE_FILTER_JSON_ARGUMENTS_SPACE_"},{value:"[isHtml=false]",types:["Boolean"],text:"_PAGE_FILTER_JSON_ARGUMENTS_IS_HTML_"},{value:"[jsonClass=a_code_content]",types:["String"],text:"_PAGE_FILTER_JSON_ARGUMENTS_JSON_CLASS_"},{value:"[tag=pre]",types:["String"],text:"_PAGE_FILTER_JSON_ARGUMENTS_TAG_"}]}}function oe(){return{pageTitle:"filterJson"}}const se=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
...
`,ae={name:"PageFilterJson",components:{AlohaPage:S,ATranslation:E,PageFilterArguments:N,PageFilterImportCompositionApi:j,PageFilterImportFunction:T,PageFilterJsonClass:k,PageFilterJsonExample:L,PageFilterJsonIsHtml:U,PageFilterJsonReplacer:D,PageFilterJsonSpace:Q,PageFilterJsonTag:te,PageFilterTest:O},setup(){const{pageTitle:e}=oe(),{argumentsText:s}=ne();return{argumentsText:s,pageTitle:e,test:se}}};function re(e,s,l,c,r,_){const o=t("a-translation"),f=t("page-filter-import-function"),d=t("page-filter-import-composition-api"),J=t("page-filter-arguments"),g=t("page-filter-json-example"),x=t("page-filter-json-space"),$=t("page-filter-json-replacer"),y=t("page-filter-json-is-html"),v=t("page-filter-json-class"),h=t("page-filter-json-tag"),P=t("page-filter-test"),A=t("aloha-page");return p(),u(A,{"page-title":e.pageTitle},{body:F(()=>[a(o,{tag:"p",html:"_PAGE_FILTER_JSON_DESCRIPTION_"}),a(f,{"function-name":"filterJson","type-import":"filters"}),a(d,{"function-name":"filterJson"}),a(J,{"arguments-text":e.argumentsText,"function-description":'filterJson(value, { [replacer], [space=2], [isHtml=false], [jsonClass="a_code_content"], [tag="pre"] })'},null,8,["arguments-text"]),a(g),a(x),a($),a(y),a(v),a(h),a(P,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const Pe=i(ae,[["render",re]]);export{Pe as default};
