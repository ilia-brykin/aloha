import{A as b,a as N}from"./chunk.AlohaExample.DvNteu_Q.js";import{A as T}from"./chunk.AlohaTableProps.CooZObID.js";import{_,g,A as I}from"./bundle.index.C9ZOQ16P.js";import{Z as p,Y as u,aV as l,f as e,a0 as o,d as O}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import{c as m}from"./chunk.ATable.D1y2A6X7.js";import"./chunk.APageTabTitle.DAqWP6fw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function k(){return{codeHtml:`<a-group-button-dropdown
  :actions="actions"
...
export default {
  ...
  :index-first-dropdown-action="2"
  :index-first-dropdown-action-mobile="2"
></a-group-button-dropdown>`}}function z(){return{codeJs:`import { 
  AGroupButtonDropdown,
} from "aloha-vue";
...
};`}}const K={name:"PageGroupButtonDropdownExtraClasses",components:{AGroupButtonDropdown:m,AlohaExample:b},setup(){const{codeHtml:t}=Z(),{codeJs:a}=z();return{actions:[{text:"Action 1",type:"button",callback:()=>{},classExtra:"test_action1"},{text:"Action 2",type:"button",callback:()=>{},classExtra:"test_action2"},{text:"Action 3",type:"button",callback:()=>{},classExtra:"test_action3"},{text:"Action 4",type:"button",callback:()=>{},classExtra:"test_action4"},{text:"Action 5",type:"button",callback:()=>{},classExtra:"test_action5"},{text:"Action 6",type:"button",callback:()=>{},classExtra:"test_action6"}],codeHtml:t,codeJs:a}}};function Q(t,a,c,r,i,d){const n=e("a-group-button-dropdown"),s=e("aloha-example");return p(),u(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_GROUP_BUTTON_DROPDOWN_GROUP_EXTRA_CLASSES_HEADER_",description:"_A_GROUP_BUTTON_DROPDOWN_GROUP_EXTRA_CLASSES_DESCRIPTION_",props:["actions.classExtra"]},{default:l(()=>[o(n,{actions:t.actions,"index-first-dropdown-action":2,"index-first-dropdown-action-mobile":2},null,8,["actions"])]),_:1},8,["code-html","code-js"])}const tt=_(K,[["render",Q]]);function ot(){return{codeHtml:`<a-group-button-dropdown
  :actions="actions"
  :index-first-dropdown-action="1"
  :index-first-dropdown-action-mobile="1"
