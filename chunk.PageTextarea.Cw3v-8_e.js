import{A,a as v}from"./chunk.AlohaExample.BZeZthkV.js";import{A as C}from"./chunk.AlohaTableProps.BP-QrYCJ.js";import{A as H}from"./chunk.AlohaTableTranslate.CSBHe8xv.js";import{ac as P,_ as p,g as L,A as y}from"./bundle.index.BhEeXSAb.js";import{r as c,Z as u,Y as i,aV as f,f as o,a0 as l,$ as I,aW as T,d as R}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import"./chunk.APageTabTitle.C6WQ6Ehw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.ATable.TDP6pXBu.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function J(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<div>model:</div>
...
};`}}const Z={name:"PageTextareaErrors",components:{AlohaExample:A,ATextarea:P},setup(){const e=c("Aloha"),{codeHtml:a}=F(),{codeJs:t}=Y();return{codeHtml:a,codeJs:t,model:e}}};function W(e,a,t,s,_,m){const r=o("a-textarea"),d=o("aloha-example");return u(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:f(()=>[l(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const k=p(Z,[["render",W]]);function Q(){return{codeHtml:`<a-textarea
  v-model="model"
...
Hola`),a=c(void 0),{codeHtml:t}=Ne(),{codeJs:s}=Ue();return{codeHtml:t,codeJs:s,model1:e,model2:a}}};function $e(e,a,t,s,_,m){const r=o("a-textarea"),d=o("aloha-example");return u(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:f(()=>[l(r,{"model-value":e.model1,readonly:!0,label:"Textarea 1"},null,8,["model-value"]),l(r,{class:"a_mt_3","model-value":e.model2,readonly:!0,label:"Textarea 2"},null,8,["model-value"]),l(r,{class:"a_mt_3","model-value":e.model2,readonly:!0,"help-text":"Aloha",label:"Textarea 3","readonly-default":"-"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const ve=p(De,[["render",$e]]);function Ce(){return{codeHtml:`<a-textarea
  v-model="model"
  label="resize='v'"
  resize="v"
></a-textarea>
