import{A as f,a as U}from"./chunk.AlohaExample.6MOrG3Se.js";import{A as D}from"./chunk.AlohaTableProps.1A4-QNLp.js";import{A as C}from"./chunk.AlohaTableTranslate.DITekohq.js";import{j as P,_ as p,g as $,A as v}from"./bundle.index.B-PSK0iN.js";import{r as E,k as t,J as u,aQ as i,H as c,O as n,N as A,aR as I,a as R}from"./chunk.vendor.HBCvOOnN.js";import"./chunk.APageTabTitle.DTfMSue5.js";import"./chunk.AlohaHighlightjs.BxXkXuRz.js";import"./chunk.vendor-lodash.D68MLJHd.js";import"./chunk.ATable.BOrGLLFE.js";import"./chunk.translations-ar.CGL8aVo9.js";import"./chunk.translations-de.RdwLQ5AB.js";import"./chunk.translations-en.DDBINhYl.js";import"./chunk.translations-es.Db8DPcgi.js";import"./chunk.translations-fr.Bj0H1VLd.js";import"./chunk.translations-hr.D6Hyl4N8.js";import"./chunk.translations-it.BR5rbHtH.js";import"./chunk.translations-ru.BkDZ_0rg.js";function H(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<div>model:</div>
...
};`}}const F={name:"PageTextareaErrors",components:{AlohaExample:f,ATextarea:P},setup(){const e=E("Aloha"),{codeHtml:a}=X(),{codeJs:o}=M();return{codeHtml:a,codeJs:o,model:e}}};function k(e,a,o,s,_,m){const r=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=l=>e.model=l),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=p(F,[["render",k]]);function Z(){return{codeHtml:`<a-textarea
  v-model="model"
  help-text="Aloha"
  label="Textarea"
...
};`}}const W={name:"PageTextareaHelpText",components:{AlohaExample:f,ATextarea:P},setup(){const e=E("Aloha"),{codeHtml:a}=Z(),{codeJs:o}=Q();return{codeHtml:a,codeJs:o,model:e}}};function Y(e,a,o,s,_,m){const r=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=l=>e.model=l),"help-text":"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const K=p(W,[["render",Y]]);function ee(){return{codeHtml:`<a-textarea
  v-model="model"
  :is-scalable="true"
  label="Textarea"
></a-textarea>
