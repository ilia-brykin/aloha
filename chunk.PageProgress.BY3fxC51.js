...
};`}}const Z={name:"PageProgressBasic",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=z(),{codeJs:a}=Q();return{codeHtml:s,codeJs:a}}};function K(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_BASIC_USAGE_",props:"value"},{default:c(()=>[e(r,{value:50})]),_:1},8,["code-html","code-js"])}const Y=p(Z,[["render",K]]);function ss(){return{codeHtml:`<a-progress
  class="a_bg_primary"
  :value="30"
...
<a-progress
  ...
  class-progress-bar="a_bg_danger"
  :striped="true"
></a-progress>`}}function Zs(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
