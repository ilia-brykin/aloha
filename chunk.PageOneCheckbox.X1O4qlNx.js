import{A as f,a as g}from"./chunk.AlohaExample.DQald-L_.js";import{A as H}from"./chunk.AlohaTableProps.nxAQILM8.js";import{Q as O,ah as i,j as U,aM as D,a3 as $}from"./bundle.index.D1OA29U_.js";import{bf as _,bc as p,aQ as h,br as u,bi as n,aV as t,aP as b,bn as E,b7 as y,aN as S}from"./chunk.vendor.B7xidcyX.js";import"./chunk.vendor-lodash.DHCI5OYQ.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function J(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  label="Aloha"
></a-one-checkbox>
...
};`}}const W={name:"PageOneCheckboxErrors",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=_(void 0),{codeHtml:o}=w(),{codeJs:a}=F();return{codeHtml:o,codeJs:a,model:e}}};function Y(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return p(),h(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:u(()=>[t(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=c=>e.model=c),errors:"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Q=i(W,[["render",Y]]);function z(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
...
};`}}const he={name:"PageOneCheckboxReadonly",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=_(!0),o=_(!1),a=_(void 0),{codeHtml:r}=ie(),{codeJs:s}=pe();return{codeHtml:r,codeJs:s,model1:e,model2:o,model3:a}}};function fe(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return p(),h(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:u(()=>[t(l,{"model-value":e.model1,readonly:!0,label:"Checkbox 1"},null,8,["model-value"]),t(l,{class:"a_mt_3","false-value":!1,"model-value":e.model2,readonly:!0,label:"Checkbox 2"},null,8,["model-value"]),t(l,{class:"a_mt_3","false-value":!1,"model-value":e.model3,readonly:!0,label:"Checkbox 3"},null,8,["model-value"]),t(l,{class:"a_mt_3","false-value":!1,"model-value":e.model3,readonly:!0,"help-text":"Aloha",label:"Checkbox 4","readonly-default":"-"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const Oe=i(he,[["render",fe]]);function be(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  label="Aloha"
  slot-name="aloha"
>
...
};`}}const Re={name:"PageOneCheckboxTrueValue",components:{AlohaExample:f,AOneCheckbox:O},setup(){const e=_(void 0),{codeHtml:o}=Ce(),{codeJs:a}=xe();return{codeHtml:o,codeJs:a,model:e}}};function ke(e,o,a,r,s,m){const l=n("a-one-checkbox"),d=n("aloha-example");return p(),h(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_DESCRIPTION_",props:["true-value"]},{default:u(()=>[t(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=c=>e.model=c),"true-value":1,label:"Aloha"},null,8,["modelValue"]),b("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const Se=i(Re,[["render",ke]]);function Ne(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :is-width-auto="true"
