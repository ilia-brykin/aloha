...
};`}}const G={name:"PageProgressCircleBasic",components:{AlohaExample:R,AProgressCircle:S},setup(){const{codeHtml:e}=b(),{codeJs:t}=L();return{codeHtml:e,codeJs:t}}};function q(e,t,s,o,_,a){const r=c("a-progress-circle"),l=c("aloha-example");return P(),f(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:"value"},{default:g(()=>[i(r,{value:20}),i(r,{class:"a_mt_3",value:50})]),_:1},8,["code-html","code-js"])}const w=m(G,[["render",q]]);function B(){return{codeHtml:`<a-progress-circle
  :value="20"
  :indeterminate="true"
></a-progress-circle>
<a-progress-circle
