import{A as c}from"./chunk.AList.Bnk3hPcu.js";import{A as L,a as C}from"./chunk.AlohaExample.ChxWiDiP.js";import{A as O}from"./chunk.AlohaTableProps.D8vLipvz.js";import{_ as p,b as k,M as J,g as D,A as N}from"./bundle.index.C2NUxb1F.js";import{k as a,J as u,aQ as d,H as b,O as t,N as r,r as f,aR as j,a as P}from"./chunk.vendor.DTe1dwcY.js";import"./chunk.vendor-lodash.DYgvgMhr.js";import"./chunk.APageTabTitle.DIecKEHM.js";import"./chunk.AlohaHighlightjs.BnoxTF5z.js";import"./chunk.ATable.hE8M53xS.js";import"./chunk.translations-ar.BN5q-o8a.js";import"./chunk.translations-de.CbcaW5-6.js";import"./chunk.translations-en.D0gUYDYQ.js";import"./chunk.translations-es.CdQwNuNd.js";import"./chunk.translations-fr.DtMvhluH.js";import"./chunk.translations-hr.BYXQ86E6.js";import"./chunk.translations-it.B_ya8rE6.js";import"./chunk.translations-ru.CoPIOQIk.js";function G(){return{codeHtml:`<a-list
  :data="items"
  key-label="label"
...
};`}}const B={name:"PageListClassGroup",components:{AList:c,AlohaExample:L},setup(){const{codeHtml:e}=G(),{codeJs:l}=K();return{codeHtml:e,codeJs:l,items:[{label:"label 1"},{label:"label 2"},{label:"label 3"},{label:"label 4"}]}}};function M(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return b(),u(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["data","label"]},{default:d(()=>[t(s,{data:e.items,"key-label":"label"},null,8,["data"])]),_:1},8,["code-html","code-js"])}const U=p(B,[["render",M]]);function q(){return{codeHtml:`<a-list
  :data="items"
  key-label="label"
...
};`}}const Ke={name:"PageListTag",components:{AList:c,AlohaExample:L,ARadio:J},setup(){const{codeHtml:e}=je(),{codeJs:l}=Ge(),o=[{label:"label 1"},{label:"label 2"},{label:"label 3"},{label:"label 4"}],n=f("ol");return{codeHtml:e,codeJs:l,items:o,modelTag:n}}},Be={class:"a_columns a_columns_count_12"},Me={class:"a_column a_column_4 a_column_12_tablet"};function Ue(e,l,o,n,m,_){const s=a("a-radio"),i=a("a-list"),h=a("aloha-example");return b(),u(h,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_LIST_GROUP_TAG_HEADER_",description:"_A_LIST_GROUP_TAG_DESCRIPTION_",props:["tag"]},{default:d(()=>[r("div",Be,[r("div",Me,[t(s,{class:"a_mb_4",modelValue:e.modelTag,"onUpdate:modelValue":l[0]||(l[0]=I=>e.modelTag=I),data:["ol","ul"],"is-data-simple-array":!0},null,8,["modelValue"]),t(i,{data:e.items,"key-label":"label",tag:e.modelTag},null,8,["data","tag"])])])]),_:1},8,["code-html","code-js"])}const qe=p(Ke,[["render",Ue]]);function Ye(){return{codeHtml:`<a-list
  :data="items"
  key-children="items"
>
  <template
