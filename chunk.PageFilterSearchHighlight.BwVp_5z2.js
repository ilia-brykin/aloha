...
// ${i("Lorem ipsum dolor sit amet consectetur adipisicing elit.",{searchModel:"aloha"})}`}}const K={name:"PageFilterSearchHighlightSearchModel",components:{AlohaExample:p},setup(){const{codeJs:e}=q();return{codeJs:e}}};function Q(e,r,n,c,u,g){const s=t("aloha-example");return l(),h(s,{"code-js":e.codeJs,header:"searchModel","is-code-visible-default":!0},null,8,["code-js"])}const X=o(K,[["render",Q]]);function Y(){return{codeJs:`filterSearchHighlight("Lorem ipsum dolor sit amet consectetur adipisicing elit.", { searchModel: "ipsum", tag: "strong" });
