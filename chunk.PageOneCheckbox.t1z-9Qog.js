import{A as h,a as N}from"./chunk.AlohaExample.BT0L4sPf.js";import{A as g}from"./chunk.AlohaTableProps.AKmRY_Bl.js";import{_ as u,g as v,A as U}from"./bundle.index.CgpAdSdY.js";import{b as O}from"./chunk.AForm.CpIOokJc.js";import{r as m,m as n,C as i,L as p,B as f,G as l,F as A,M as E,a as I}from"./chunk.vendor.D-Y3mz6a.js";import"./chunk.vendor-lodash.ClBXVCWL.js";import"./chunk.ATable.DALhqzqJ.js";import"./chunk.utilsMath.7PmiGUbm.js";import"./chunk.vendor-tinymce.2RT9eEW9.js";import"./chunk.ADatepicker.BS_Ghotq.js";import"./chunk.UiMixinProps.BVfs3aDc.js";import"./chunk.AInputNumber.C93fy0SX.js";import"./chunk.ATinymce.1a39zYU1.js";function H(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  label="Aloha"
></a-one-checkbox>
...
};`}}const M={name:"PageOneCheckboxErrors",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=X(),{codeJs:t}=G();return{codeHtml:o,codeJs:t,model:e}}};function K(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return f(),i(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:p(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),errors:"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=u(M,[["render",K]]);function F(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
