...
};`}}const Ya={name:"PageCheckboxHelpText",components:{ACheckbox:f,AlohaExample:k},setup(){const a=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],l=i([]),{codeHtml:t}=Ma(),{codeJs:n}=Xa();return{codeHtml:t,codeJs:n,data:a,model:l}}};function wa(a,l,t,n,r,c){const o=d("a-checkbox"),s=d("aloha-example");return p(),b(s,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:A(()=>[_(o,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=e=>a.model=e),data:a.data,"help-text":"Aloha",label:"Checkbox"},null,8,["modelValue","data"]),h("div",null,"model: "+m(a.model),1)]),_:1},8,["code-html","code-js"])}const Fa=u(Ya,[["render",wa]]);function Wa(){return{codeHtml:`<a-checkbox
  v-model="model"
  :data="data"
  :inline="true"
  key-id="id"
...
};`}}const Ml={name:"PageCheckboxLabelScreenReader",components:{ACheckbox:f,AlohaExample:k},setup(){const{codeHtml:a}=jl(),{codeJs:l}=ql(),t=[{label:"Aloha 0",id:"aloha_0"},{label:"Aloha 1",id:"aloha_1"},{label:"Aloha 2",id:"aloha_2"},{label:"Aloha 3",id:"aloha_3"},{label:"Aloha 4",id:"aloha_4"},{label:"Aloha 5",id:"aloha_5"},{label:"Aloha 6",id:"aloha_6"},{label:"Aloha 7",id:"aloha_7"},{label:"Aloha 8",id:"aloha_8"}],n=i(void 0);return{codeHtml:a,codeJs:l,data:t,model:n}}},Xl={class:"a_columns a_columns_count_12"},Yl={class:"a_column a_column_6 a_columns_count_12_touch"};function wl(a,l,t,n,r,c){const o=d("a-checkbox"),s=d("aloha-example");return p(),b(s,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_LABEL_SCREEN_READER_HEADER_",description:"_A_UI_GROUP_LABEL_SCREEN_READER_DESCRIPTION_",props:"label-screen-reader"},{default:A(()=>[h("div",Xl,[h("div",Yl,[_(o,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=e=>a.model=e),data:a.data,"key-id":"id","key-label":"label",label:"Aloha"},null,8,["modelValue","data"]),_(o,{class:"a_mt_3",modelValue:a.model,"onUpdate:modelValue":l[1]||(l[1]=e=>a.model=e),data:a.data,"key-id":"id","key-label":"label","label-screen-reader":"Aloha"},null,8,["modelValue","data"]),h("div",null,"model: "+m(a.model),1)])])]),_:1},8,["code-html","code-js"])}const Fl=u(Ml,[["render",wl]]);function Wl(){return{codeHtml:`<a-checkbox
  v-model="model"
  :data="data"
  :key-group="['alohaBR', 'aloha']"
  :search="true"
