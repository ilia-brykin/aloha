import{A as d,a as x}from"./chunk.AlohaExample.BVPccFCr.js";import{P as A,a as P,b as T}from"./chunk.PageFilterTest.C7zimzcm.js";import{P as $}from"./chunk.PageFilterImportCompositionApi.BkUvg23v.js";import{aE as e,_ as o,A as b}from"./bundle.index.DoG8zCpg.js";import{U as l,e as n,V as c,aS as y,Z as s}from"./chunk.vendor.COYgx38y.js";import"./chunk.vendor-lodash.xyEKcfD7.js";import"./chunk.APageTabTitle.Cf4ot2uq.js";import"./chunk.AlohaHighlightjs.CW1W2LCP.js";import"./chunk.translations-ar.DEWt73y8.js";import"./chunk.translations-de.B16ttyfK.js";import"./chunk.translations-en.CPCEcTAP.js";import"./chunk.translations-es.BKTK5PUv.js";import"./chunk.translations-fr.CslimZmU.js";import"./chunk.translations-hr.CiJ7_Y2m.js";import"./chunk.translations-it.H45F8miC.js";import"./chunk.translations-ru.o-dOzdYz.js";function E(){return{codeJs:`filterMask("1234567812345678");
// ${e("1234567812345678")}
...
// ${e("12345678",{chars:10})}`}}const B={name:"PageFilterMaskExample",components:{AlohaExample:d},setup(){const{codeJs:t}=E();return{codeJs:t}}};function v(t,a,i,p,u,m){const r=n("aloha-example");return c(),l(r,{"code-js":t.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const S=o(B,[["render",v]]);function F(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_MASK_ARGUMENTS_VALUE_"},{value:"[chars=4]",types:["Number"],text:"_PAGE_FILTER_MASK_ARGUMENTS_CHARS_"},{value:'[mask="*"]',types:["String"],text:"_PAGE_FILTER_MASK_ARGUMENTS_MASK_"}]}}function I(){return{pageTitle:"filterMask"}}const R=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
