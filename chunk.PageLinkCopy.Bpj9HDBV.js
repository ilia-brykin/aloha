...
};`}}const V={name:"PageLinkCopyButtonPosition",components:{ALinkCopy:h,AlohaExample:m},setup(){const{codeHtml:t}=M(),{codeJs:o}=X();return{codeHtml:t,codeJs:o}}};function z(t,o,c,_,l,i){const e=n("a-link-copy"),a=n("aloha-example");return d(),u(a,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_COPY_GROUP_BUTTON_POSITION_HEADER_",description:"_A_LINK_COPY_GROUP_BUTTON_POSITION_DESCRIPTION_",props:"button-position"},{default:p(()=>[s(e,{"button-position":"left","link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"}},null,8,["link-options"]),s(e,{class:"a_ml_2","button-position":"right","link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"}},null,8,["link-options"])]),_:1},8,["code-html","code-js"])}const Q=r(V,[["render",z]]);function W(){return{codeHtml:`<a-link-copy
...
};`}}const ht={name:"PageLinkCopyLinkOptions",components:{ALinkCopy:h,AlohaExample:m},setup(){const{codeHtml:t}=ut(),{codeJs:o}=mt();return{codeHtml:t,codeJs:o}}};function yt(t,o,c,_,l,i){const e=n("a-link-copy"),a=n("aloha-example");return d(),u(a,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_COPY_GROUP_LINK_OPTIONS_HEADER_",description:"_A_LINK_COPY_GROUP_LINK_OPTIONS_DESCRIPTION_",props:"link-options"},{default:p(()=>[s(e,{"link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"}},null,8,["link-options"])]),_:1},8,["code-html","code-js"])}const kt=r(ht,[["render",yt]]);function bt(){return{codeHtml:`<a-link-copy
...
};`}}const It={name:"PageLinkCopySlotLink",components:{ALinkCopy:h,AlohaExample:m},setup(){const{codeHtml:t}=Ot(),{codeJs:o}=At();return{codeHtml:t,codeJs:o}}},Tt=f("strong",null,"github.com",-1);function Nt(t,o,c,_,l,i){const e=n("a-link-copy"),a=n("aloha-example");return d(),u(a,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_COPY_GROUP_SLOT_LINK_HEADER_",description:"_A_LINK_COPY_GROUP_SLOT_LINK_DESCRIPTION_",slots:"link"},{default:p(()=>[s(e,{"link-options":{class:"a_btn a_btn_secondary",href:"https://github.com/"}},{link:p(()=>[Tt]),_:1},8,["link-options"])]),_:1},8,["code-html","code-js"])}const $t=r(It,[["render",Nt]]);function St(){return{codeHtml:`<a-link-copy
  :link-options="{ class: 'a_btn a_btn_secondary', text: 'https://github.com/', href: 'https://github.com/' }"
  text-copy="github"
></a-link-copy>
<a-link-copy
