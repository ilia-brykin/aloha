import{A as g,a as G}from"./chunk.AlohaExample.CMUUEVcN.js";import{aS as o,_ as r,A as P}from"./bundle.index.DOWaPX07.js";import{P as T,a as I,b as E}from"./chunk.PageFilterTest.CqA3wSrh.js";import{B as s,C as f,m as e,L as J,G as n}from"./chunk.vendor.9_E-x6sT.js";import{P as S}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function v(){return{codeJs:`filterFloat(1000222.55, { digitGrouping: false });
// ${o(100022255e-2,{digitGrouping:!1})}

filterFloat(1000222.55, { digitGrouping: true });
// ${o(100022255e-2,{digitGrouping:!0})}`}}const L={name:"PageFilterFloatDigitGrouping",components:{AlohaExample:g},setup(){const{codeJs:t}=v();return{codeJs:t}}};function R(t,l,a,p,c,u){const i=e("aloha-example");return s(),f(i,{"code-js":t.codeJs,header:"digitGrouping","is-code-visible-default":!0},null,8,["code-js"])}const b=r(L,[["render",R]]);function N(){return{codeJs:`filterFloat(2000, { digits: 0 });
// ${o(2e3,{digits:0})}

filterFloat("25.53451", { digits: 4 });
// ${o("25.53451",{digits:4})}`}}const j={name:"PageFilterFloatDigits",components:{AlohaExample:g},setup(){const{codeJs:t}=N();return{codeJs:t}}};function U(t,l,a,p,c,u){const i=e("aloha-example");return s(),f(i,{"code-js":t.codeJs,header:"digits","is-code-visible-default":!0},null,8,["code-js"])}const D=r(j,[["render",U]]);function O(){return{codeJs:`filterFloat(123456);
// ${o(123456)}
...
// ${o(void 0)}`}}const y={name:"PageFilterFloatExample",components:{AlohaExample:g},setup(){const{codeJs:t}=O();return{codeJs:t}}};function C(t,l,a,p,c,u){const i=e("aloha-example");return s(),f(i,{"code-js":t.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const M=r(y,[["render",C]]);function k(){return{codeJs:`filterFloat(2000, { suffix: "€" });
// ${o(2e3,{suffix:"€"})}

filterFloat("25.5", { suffix: "%" });
// ${o("25.5",{suffix:"%"})}`}}const w={name:"PageFilterFloatSuffix",components:{AlohaExample:g},setup(){const{codeJs:t}=k();return{codeJs:t}}};function V(t,l,a,p,c,u){const i=e("aloha-example");return s(),f(i,{"code-js":t.codeJs,header:"suffix","is-code-visible-default":!0},null,8,["code-js"])}const X=r(w,[["render",V]]);function q(){return{argumentsText:[{value:"value",types:["Number","String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_VALUE_"},{value:'[suffix=""]',types:["String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_SUFFIX_"},{value:"[digits=2]",types:["Number"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGITS_"},{value:"[digitGrouping=true]",types:["Boolean"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGIT_GROUPING_"}]}}function z(){return{pageTitle:"filterFloat"}}const H=`import filterFloat from "../filterFloat";
...
`,K={name:"PageFilterFloat",components:{AlohaPage:G,ATranslation:P,PageFilterArguments:E,PageFilterFloatDigitGrouping:b,PageFilterFloatDigits:D,PageFilterFloatExample:M,PageFilterFloatSuffix:X,PageFilterImportCompositionApi:S,PageFilterImportFunction:I,PageFilterTest:T},setup(){const{pageTitle:t}=z(),{argumentsText:l}=q();return{argumentsText:l,pageTitle:t,test:H}}};function Q(t,l,a,p,c,u){const i=e("a-translation"),_=e("page-filter-import-function"),d=e("page-filter-import-composition-api"),F=e("page-filter-arguments"),x=e("page-filter-float-example"),m=e("page-filter-float-suffix"),B=e("page-filter-float-digits"),$=e("page-filter-float-digit-grouping"),A=e("page-filter-test"),h=e("aloha-page");return s(),f(h,{"page-title":t.pageTitle},{body:J(()=>[n(i,{tag:"p",html:"_PAGE_FILTER_FLOAT_DESCRIPTION_"}),n(_,{"function-name":"filterFloat","type-import":"filters"}),n(d,{"function-name":"filterFloat"}),n(F,{"arguments-text":t.argumentsText,"function-description":'filterFloat(value, { [suffix=""], [digits=2], [digitGrouping=true] })'},null,8,["arguments-text"]),n(x),n(m),n(B),n($),n(A,{test:t.test},null,8,["test"])]),_:1},8,["page-title"])}const nt=r(K,[["render",Q]]);export{nt as default};
