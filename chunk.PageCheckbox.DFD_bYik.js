import{A,a as w}from"./chunk.AlohaExample.BZeZthkV.js";import{A as W}from"./chunk.AlohaTableProps.BP-QrYCJ.js";import{A as Q}from"./chunk.AlohaTableTranslate.CSBHe8xv.js";import{l as f,_ as u,g as Z,A as z}from"./bundle.index.BhEeXSAb.js";import{r as i,Z as m,Y as b,aV as p,f as d,a0 as s,$ as _,aW as k,d as P}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import"./chunk.APageTabTitle.C6WQ6Ehw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.ATable.TDP6pXBu.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function aa(){return{codeHtml:`<a-checkbox
  v-model="model"
  :data="data"
  label="Aloha"
></a-checkbox>
...
};`}}const Rl={name:"PageCheckboxIsDataSimpleArray",components:{ACheckbox:f,AlohaExample:A},setup(){const{codeHtml:a}=fl(),{codeJs:l}=kl(),t=["Aloha 1","Aloha 2","Aloha 3","Aloha 4","Aloha 5","Aloha 6"],n=i(void 0);return{codeHtml:a,codeJs:l,data:t,model:n}}},Il={class:"a_columns a_columns_count_12"},Pl={class:"a_column a_column_6 a_columns_count_12_touch"};function El(a,l,t,n,r,c){const o=d("a-checkbox"),h=d("aloha-example");return m(),b(h,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_IS_DATA_SIMPLE_ARRAY_HEADER_",description:"_A_UI_GROUP_IS_DATA_SIMPLE_ARRAY_DESCRIPTION_",props:"is-data-simple-array"},{default:p(()=>[_("div",Il,[_("div",Pl,[s(o,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=e=>a.model=e),data:a.data,"is-data-simple-array":!0,label:"Aloha"},null,8,["modelValue","data"]),_("div",null,"model: "+k(a.model),1)])])]),_:1},8,["code-html","code-js"])}const Cl=u(Rl,[["render",El]]);function gl(){return{codeHtml:`<a-checkbox
  v-model="model"
  :data="data"
  :is-width-auto="true"
  key-id="id"
...
};`}}const Ee={name:"PageCheckboxSearch",components:{ACheckbox:f,AlohaExample:A},setup(){const{codeHtml:a}=Ie(),{codeJs:l}=Pe(),t=[{label:"Aloha 0",id:"aloha_0",aloha:"",alohaBR:"Köln"},{label:"Aloha 1",id:"aloha_1",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 2",id:"aloha_2",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 3",id:"aloha_3",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 4",id:"aloha_4",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 5",id:"aloha_5",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 6",id:"aloha_6",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 7",id:"aloha_7",aloha:"Alex",alohaBR:"Düsseldorf"},{label:"Aloha 8",id:"aloha_8",aloha:"Alex",alohaBR:"Düsseldorf"}],n=i(void 0);return{codeHtml:a,codeJs:l,data:t,model:n}}},Ce={class:"a_columns a_columns_count_12"},ge={class:"a_column a_column_6 a_columns_count_12_touch"};function ye(a,l,t,n,r,c){const o=d("a-checkbox"),h=d("aloha-example");return m(),b(h,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_SEARCH_HEADER_",description:"_A_UI_GROUP_SEARCH_DESCRIPTION_",props:"search"},{default:p(()=>[_("div",Ce,[_("div",ge,[s(o,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=e=>a.model=e),data:a.data,"key-group":["alohaBR","aloha"],search:!0,"search-in-group":!0,"key-id":"id","key-label":"label",label:"Aloha group"},null,8,["modelValue","data"]),s(o,{class:"a_mt_3",modelValue:a.model,"onUpdate:modelValue":l[1]||(l[1]=e=>a.model=e),data:a.data,search:!0,"key-id":"id","key-label":"label",label:"Aloha"},null,8,["modelValue","data"]),_("div",null,"model: "+k(a.model),1)])])]),_:1},8,["code-html","code-js"])}const Se=u(Ee,[["render",ye]]);function xe(){return{codeHtml:`<a-checkbox
  v-model="model"
  :data="data"
  :key-group="['alohaBR', 'aloha']"
  :search-in-group="true"
