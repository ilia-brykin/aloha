import{A as R,a as N}from"./chunk.AlohaExample.CMUUEVcN.js";import{A as O}from"./chunk.AlohaTableProps.DwOUDlIA.js";import{_ as i,A as C}from"./bundle.index.DOWaPX07.js";import{d as A}from"./chunk.AForm.BMBXIC54.js";import{r as u,B as l,C as s,L as p,G as _,m as t,F as g,M as S}from"./chunk.vendor.9_E-x6sT.js";import{u as k}from"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.ATable.BiLWW37G.js";import"./chunk.utilsMath.D900FRx8.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";import"./chunk.ADatepicker.DXR-Bzfp.js";import"./chunk.UiMixinProps.3z5E7Tu9.js";import"./chunk.AInputNumber.CmREK6bZ.js";import"./chunk.ATinymce.BcMFUTFk.js";function G(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
</a-datepicker-range>
...
};`}}const K={name:"PageDatepickerRangeBasic",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=G(),{codeJs:a}=y(),n=u(void 0);return{codeHtml:e,codeJs:a,model:n}}},b={class:"a_mt_3"};function h(e,a,n,E,c,m){const r=t("a-datepicker-range"),d=t("aloha-example");return l(),s(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_BASIC_HEADER_",description:"_PAGE_DATEPICKER_RANGE_BASIC_DESCRIPTION_",props:["v-model","label"]},{default:p(()=>[_(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=o=>e.model=o),label:"Aloha"},null,8,["modelValue"]),g("div",b,"model: "+S(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(K,[["render",h]]);function H(){return{codeHtml:`<a-datepicker-range
  v-model="model"
...
};`}}const $={name:"PageDatepickerRangeCustomFirstDay",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=H(),{codeJs:a}=L(),n=u(void 0);return{codeHtml:e,codeJs:a,model:n}}};function U(e,a,n,E,c,m){const r=t("a-datepicker-range"),d=t("aloha-example");return l(),s(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_HEADER_",description:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_DESCRIPTION_",props:["v-model","label","firstDayOfWeek"]},{default:p(()=>[_(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=o=>e.model=o),label:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_EXAMPLE_","first-day-of-week":4},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const B=i($,[["render",U]]);function M(){return{codeHtml:`<a-datepicker-range
 v-model="model"
  :disabled="true">
</a-datepicker-range>
<a-datepicker-range
