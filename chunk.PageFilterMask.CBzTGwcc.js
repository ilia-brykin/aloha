import{A as d,a as x}from"./chunk.AlohaExample.Dqr7aiL7.js";import{P as A,a as P,b as T}from"./chunk.PageFilterTest.DpkfkUMc.js";import{P as $}from"./chunk.PageFilterImportCompositionApi.BfIBrcPX.js";import{aP as e,_ as o,A as b}from"./bundle.index.C9vm360W.js";import{W as l,V as c,e as n,aT as y,_ as s}from"./chunk.vendor.7qYoMuVo.js";import"./chunk.vendor-lodash.CDw4fzB6.js";import"./chunk.APageTabTitle.Cg0b92cj.js";import"./chunk.AlohaHighlightjs.CqftpDCI.js";import"./chunk.translations-ar.D2jq8d0Y.js";import"./chunk.translations-de.hnP5xpB5.js";import"./chunk.translations-en.BrVZaecZ.js";import"./chunk.translations-es.DtTl-e9g.js";import"./chunk.translations-fr.DuHMBvXM.js";import"./chunk.translations-hr.CHfI5uP-.js";import"./chunk.translations-it.B1ulf93E.js";import"./chunk.translations-ru.B3vSYu8F.js";function B(){return{codeJs:`filterMask("1234567812345678");
// ${e("1234567812345678")}
...
// ${e("12345678",{chars:10})}`}}const E={name:"PageFilterMaskExample",components:{AlohaExample:d},setup(){const{codeJs:t}=B();return{codeJs:t}}};function v(t,a,i,p,u,m){const r=n("aloha-example");return l(),c(r,{"code-js":t.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const F=o(E,[["render",v]]);function S(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_MASK_ARGUMENTS_VALUE_"},{value:"[chars=4]",types:["Number"],text:"_PAGE_FILTER_MASK_ARGUMENTS_CHARS_"},{value:'[mask="*"]',types:["String"],text:"_PAGE_FILTER_MASK_ARGUMENTS_MASK_"}]}}function I(){return{pageTitle:"filterMask"}}const R=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
...
`,G={name:"PageFilterMask",components:{AlohaPage:x,ATranslation:b,PageFilterArguments:T,PageFilterImportCompositionApi:$,PageFilterImportFunction:P,PageFilterMaskExample:F,PageFilterTest:A},setup(){const{pageTitle:t}=I(),{argumentsText:a}=S();return{argumentsText:a,pageTitle:t,test:R}}};function C(t,a,i,p,u,m){const r=n("a-translation"),f=n("page-filter-import-function"),_=n("page-filter-import-composition-api"),g=n("page-filter-arguments"),h=n("page-filter-mask-example"),k=n("page-filter-test"),M=n("aloha-page");return l(),c(M,{"page-title":t.pageTitle},{body:y(()=>[s(r,{tag:"p",html:"_PAGE_FILTER_MASK_DESCRIPTION_"}),s(f,{"function-name":"filterMask","type-import":"filters"}),s(_,{"function-name":"filterMask"}),s(g,{"arguments-text":t.argumentsText,"function-description":'filterMask(value, { [chars=4], [mask="*"] })'},null,8,["arguments-text"]),s(h),s(k,{test:t.test},null,8,["test"])]),_:1},8,["page-title"])}const Y=o(G,[["render",C]]);export{Y as default};
