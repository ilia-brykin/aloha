import{A as f,a as U}from"./chunk.AlohaExample.DQald-L_.js";import{A as J}from"./chunk.AlohaTableProps.nxAQILM8.js";import{X as A,ah as b,aM as K,a3 as M,u as j}from"./bundle.index.D1OA29U_.js";import{bf as u,bc as m,aQ as E,br as p,bi as n,aP as a,aV as o,bn as c,aN as v,aS as T}from"./chunk.vendor.B7xidcyX.js";import"./chunk.vendor-lodash.DHCI5OYQ.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function x(){return{codeHtml:`<a-select
  v-model="model"
  :data="data"
  key-id="id"
  key-label="label"
...
};`}}const W={name:"PageSelectDataExtra",components:{AlohaExample:f,ASelect:A},setup(){const{codeHtml:l}=Q(),{codeJs:e}=z(),s=[{label:"Aloha -1",id:"aloha_-1",aloha:""},{label:"Aloha 0",id:"aloha_0",aloha:"",alohaBR:"Köln"},{label:"Aloha 1",id:"aloha_1",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 2",id:"aloha_2",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 3",id:"aloha_3",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 4",id:"aloha_4",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 5",id:"aloha_5",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 6",id:"aloha_6",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 7",id:"aloha_7",aloha:"Alex",alohaBR:"Düsseldorf"},{label:"Aloha 8",id:"aloha_8",aloha:"Alex",alohaBR:"Düsseldorf"}],r=[["extra_id_1","Extra 1"],["extra_id_2","Extra 2"]],i=[{label:"Extra 1",id:"extra_id_1"},{label:"Extra 2",id:"extra_id_2"}],h=u(void 0),t=u(void 0);return{codeHtml:l,codeJs:e,data:s,dataExtraArrayOfArrays:r,dataExtraArrayOfObjects:i,model1:h,model2:t}}},Z={class:"a_columns a_columns_count_12"},ll={class:"a_column a_column_6 a_columns_count_12_touch"};function el(l,e,s,r,i,h){const t=n("a-select"),_=n("aloha-example");return m(),E(_,{"code-html":l.codeHtml,"code-js":l.codeJs,header:"_A_SELECT_GROUP_DATA_EXTRA_HEADER_",description:"_A_SELECT_GROUP_DATA_EXTRA_DESCRIPTION_",props:"data-extra"},{default:p(()=>[a("div",Z,[a("div",ll,[o(t,{modelValue:l.model1,"onUpdate:modelValue":e[0]||(e[0]=d=>l.model1=d),data:l.data,"data-extra":l.dataExtraArrayOfArrays,"key-id":"id","key-label":"label",label:"Data extra (Array of Arrays)",search:!0},null,8,["modelValue","data","data-extra"]),a("div",null,"model1: "+c(l.model1),1),o(t,{class:"a_mt_3",modelValue:l.model2,"onUpdate:modelValue":e[1]||(e[1]=d=>l.model2=d),data:l.data,"data-extra":l.dataExtraArrayOfObjects,"key-id":"id","key-label":"label",label:"Data extra (Array of Objects)",search:!0},null,8,["modelValue","data","data-extra"]),a("div",null,"model2: "+c(l.model2),1)])])]),_:1},8,["code-html","code-js"])}const al=b(W,[["render",el]]);function ol(){return{codeHtml:`<a-select
  v-model="model"
  :data="data"
...
*/`}}const Wl={name:"PageSelectRetrieve",components:{AlohaExample:f,ASelect:A},setup(){const{codeHtml:l}=Ql(),{codeJs:e}=zl(),s=u("aloha_10"),r=u(["aloha_2","aloha_10","aloha_11","aloha_998","aloha_999"]);return{codeHtml:l,codeJs:e,model1:s,model2:r,url:"/aloha/assets/mock/select-base.json",urlRetrieve:"/aloha/assets/mock/select-retrieve.json"}}},Zl={class:"a_columns a_columns_count_12"},le={class:"a_column a_column_6 a_columns_count_12_touch"},ee={class:"a_column a_column_6 a_columns_count_12_touch"};function ae(l,e,s,r,i,h){const t=n("a-select"),_=n("aloha-example");return m(),E(_,{"code-html":l.codeHtml,"code-js":l.codeJs,description:"_A_SELECT_GROUP_RETRIEVE_DESCRIPTION_",header:"_A_SELECT_GROUP_RETRIEVE_HEADER_"},{default:p(()=>[a("div",Zl,[a("div",le,[o(t,{modelValue:l.model1,"onUpdate:modelValue":e[0]||(e[0]=d=>l.model1=d),"show-not-found":!0,"key-id":"id","key-label":"label",label:"Select with retrieve","label-not-found":"_A_SELECT_LABEL_NOT_FOUND_",type:"select",url:l.url,"url-retrieve":l.urlRetrieve},null,8,["modelValue","url","url-retrieve"]),a("div",null,"model1: "+c(l.model1),1)]),a("div",ee,[o(t,{modelValue:l.model2,"onUpdate:modelValue":e[1]||(e[1]=d=>l.model2=d),"show-not-found":!0,"key-id":"id","key-label":"label",label:"Multiselect with retrieve","label-not-found":"_A_SELECT_LABEL_NOT_FOUND_",type:"multiselect",url:l.url,"url-retrieve":l.urlRetrieve},null,8,["modelValue","url","url-retrieve"]),a("div",null,"model2: "+c(l.model2),1)])])]),_:1},8,["code-html","code-js"])}const oe=b(Wl,[["render",ae]]);function te(){return{codeHtml:`<a-select
  v-model="model"
  :data="data"
  :key-group="['alohaBR', 'aloha']"
  :search="true"
