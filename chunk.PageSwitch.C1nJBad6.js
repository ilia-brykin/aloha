import{A as h,a as N}from"./chunk.AlohaExample.B95p2ibG.js";import{A as v}from"./chunk.AlohaTableProps.BDwC0GEx.js";import{A as $}from"./chunk.AlohaTableTranslate.ClAHSQpR.js";import{a as S,_ as m,g as b,A as y}from"./bundle.index.7Gm8ngMZ.js";import{r as i,V as u,aT as p,e as o,W as f,_ as l,Z as A,aU as P,d as E}from"./chunk.vendor.D2EiI1BL.js";import"./chunk.vendor-lodash.Wop2AkRA.js";import"./chunk.APageTabTitle.DRSOBdvA.js";import"./chunk.AlohaHighlightjs.B_1iuPG1.js";import"./chunk.ATable.q3RyArlj.js";import"./chunk.translations-ar.DEWt73y8.js";import"./chunk.translations-de.CN5eAU-4.js";import"./chunk.translations-en.CPCEcTAP.js";import"./chunk.translations-es.BKTK5PUv.js";import"./chunk.translations-fr.CslimZmU.js";import"./chunk.translations-hr.CiJ7_Y2m.js";import"./chunk.translations-it.H45F8miC.js";import"./chunk.translations-ru.o-dOzdYz.js";function J(){return{codeHtml:`<a-switch
  v-model="model"
></a-switch>
...
};`}}const G={name:"PageSwitchChange",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),t=({model:_,id:c,props:n})=>{e.value=_,console.log(c,n)},{codeHtml:a}=F(),{codeJs:r}=W();return{changeModel:t,codeHtml:a,codeJs:r,model:e}}};function M(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:p(()=>[l(n,{change:e.changeModel,"model-value":e.model},null,8,["change","model-value"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const x=m(G,[["render",M]]);function X(){return{codeHtml:`<a-switch
  v-model="model"
  errors="Aloha"
  label="ASwitch"
