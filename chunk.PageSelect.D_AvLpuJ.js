import{A as S,a as I}from"./chunk.AlohaExample.BcPB8Qry.js";import{A as v}from"./chunk.AlohaTableProps.B6_mPHyq.js";import{C as b,_ as E,g as k,A as $,a as N}from"./bundle.index.q0oygsl8.js";import{r as p,k as d,Q as f,aQ as u,O as c,U as e,V as o,aR as h,a as P,R as y}from"./chunk.vendor.C_nZR3i9.js";import"./chunk.APageTabTitle.YhYn5T6u.js";import"./chunk.AlohaHighlightjs.zzXDUp_j.js";import"./chunk.vendor-lodash.BzDRedSD.js";import"./chunk.ATable.Dm0jLwEE.js";import"./chunk.translations-ar.CGL8aVo9.js";import"./chunk.translations-de.RdwLQ5AB.js";import"./chunk.translations-en.DDBINhYl.js";import"./chunk.translations-es.Db8DPcgi.js";import"./chunk.translations-fr.Bj0H1VLd.js";import"./chunk.translations-hr.D6Hyl4N8.js";import"./chunk.translations-it.BR5rbHtH.js";import"./chunk.translations-ru.BkDZ_0rg.js";function H(){return{codeHtml:`<a-select
  v-model="model"
  :data="data"
  key-id="id"
  key-label="label"
...
};`}}const V={name:"PageSelectBasic",components:{AlohaExample:S,ASelect:b},setup(){const{codeHtml:a}=H(),{codeJs:l}=K(),t=[{label:"Aloha 1",id:"aloha_1"},{label:"Aloha 2",id:"aloha_2"},{label:"Aloha 3",id:"aloha_3"},{label:"Aloha 4",id:"aloha_4"},{label:"Aloha 5",id:"aloha_5"}],n=p(void 0);return{codeHtml:a,codeJs:l,data:t,model:n}}},M={class:"a_columns a_columns_count_12"},J={class:"a_column a_column_6 a_columns_count_12_touch"};function U(a,l,t,n,m,A){const _=d("a-select"),r=d("aloha-example");return c(),f(r,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","data","key-id","key-label","label","type"]},{default:u(()=>[e("div",M,[e("div",J,[o(_,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=s=>a.model=s),data:a.data,"key-id":"id","key-label":"label",label:"Aloha",type:"select"},null,8,["modelValue","data"]),e("div",null,"model: "+h(a.model),1)])])]),_:1},8,["code-html","code-js"])}const x=E(V,[["render",U]]);function j(){return{codeHtml:`<a-select
  v-model="model1"
  :data="data"
