...
import KeyLabelCallbackAPI from "./compositionAPI/KeyLabelCallbackAPI";
...
export default {
  ...
  props: {
    ...
    type: {
      ...
      validator: value => ["select", "selectStyle", "multiselect", "multiselectStyle"].indexOf(value) !== -1,
    },
  },
  emits: [
    "blur",
