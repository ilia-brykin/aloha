import{A as x,a as A}from"./chunk.AlohaExample.CMUUEVcN.js";import{aM as o,_ as s,A as E}from"./bundle.index.DOWaPX07.js";import{P as I,a as J,b as F}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as b}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as r,C as c,m as t,L as C,G as a}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function R(){return{codeJs:`filterLink("example.com");
// ${o("example.com")}

filterLink("https://example.com");
// ${o("https://example.com")}`}}const N={name:"PageFilterLinkExample",components:{AlohaExample:x},setup(){const{codeJs:e}=R();return{codeJs:e}}};function S(e,l,i,p,m,_){const n=t("aloha-example");return r(),c(n,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const B=s(N,[["render",S]]);function G(){return{codeJs:`filterLink("example.com", { linkClass: "a_btn a_btn_link" });
// ${o("example.com",{linkClass:"a_btn a_btn_link"})}`}}const v={name:"PageFilterLinkLinkClass",components:{AlohaExample:x},setup(){const{codeJs:e}=G();return{codeJs:e}}};function j(e,l,i,p,m,_){const n=t("aloha-example");return r(),c(n,{"code-js":e.codeJs,header:"linkClass","is-code-visible-default":!0},null,8,["code-js"])}const K=s(v,[["render",j]]);function U(){return{codeJs:`filterLink("example.com", { linkText: "example" });
// ${o("example.com",{linkText:"example"})}

filterLink("https://example.com", { linkText: "Aloha" });
// ${o("https://example.com",{linkText:"Aloha"})}`}}const y={name:"PageFilterLinkLinkText",components:{AlohaExample:x},setup(){const{codeJs:e}=U();return{codeJs:e}}};function M(e,l,i,p,m,_){const n=t("aloha-example");return r(),c(n,{"code-js":e.codeJs,header:"linkText","is-code-visible-default":!0},null,8,["code-js"])}const w=s(y,[["render",M]]);function O(){return{codeJs:`filterLink("example.com", { protocol: "" });
// ${o("example.com",{protocol:""})}

filterLink("https://example.com", { protocol: "http://" });
// ${o("example.com",{protocol:"http://"})}`}}const D={name:"PageFilterLinkProtocol",components:{AlohaExample:x},setup(){const{codeJs:e}=O();return{codeJs:e}}};function V(e,l,i,p,m,_){const n=t("aloha-example");return r(),c(n,{"code-js":e.codeJs,header:"protocol","is-code-visible-default":!0},null,8,["code-js"])}const X=s(D,[["render",V]]);function q(){return{codeJs:`filterLink("example.com", { target: "_blank" });
