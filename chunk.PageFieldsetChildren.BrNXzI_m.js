import{A as E}from"./chunk.AlohaFormTypes.bqJPLOhS.js";import{A as f,a as R}from"./chunk.AlohaExample.DwwyPnI9.js";import{A as k}from"./chunk.AlohaTableProps.B-OtB9it.js";import{A as D}from"./chunk.AlohaTableTranslate.rmComZ4R.js";import{R as y,_ as u,g as v,A as O}from"./bundle.index.CBN060hU.js";import{r as m,U as h,aS as p,e as t,V as _,Z as d,Y as b,aT as x,d as C}from"./chunk.vendor.DOoIAE1K.js";import"./chunk.vendor-lodash.BAE3VvPy.js";import"./chunk.AList.Oij0pmUM.js";import"./chunk.APageTabTitle.B7cA4VS4.js";import"./chunk.AlohaHighlightjs.BbO2lEkw.js";import"./chunk.ATable.C-Nc9qOh.js";import"./chunk.translations-ar.B3XbQD-F.js";import"./chunk.translations-de.BU3I7i25.js";import"./chunk.translations-en.Dz5VXJqd.js";import"./chunk.translations-es.BKlBZ5Wd.js";import"./chunk.translations-fr.CMF_fLGD.js";import"./chunk.translations-hr.C5ZK4YvJ.js";import"./chunk.translations-it.CAxOY8kK.js";import"./chunk.translations-ru.C-L7Lrhy.js";function S(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  label="Fieldset"
></a-fieldset>
...
};`}}const Q={name:"PageFieldsetChildrenErrorsAll",components:{AFieldset:y,AlohaExample:f},setup(){const e=[{type:"text",label:"Text",id:"aloha3.text",classColumn:"a_column a_column_12"},{type:"oneCheckbox",label:"Checkbox",id:"aloha3.checkbox"},{type:"currency",label:"Currency",id:"aloha3.currency"},{type:"date",label:"Date",id:"aloha3.date"}],l={aloha3:{text:"error",checkbox:"error",currency:"error",date:"error"}},o=m(void 0),{codeHtml:a}=z(),{codeJs:s}=K();return{children:e,errorsAll:l,codeHtml:a,codeJs:s,model:o}}};function W(e,l,o,a,s,i){const n=t("a-fieldset"),c=t("aloha-example");return _(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_ALL_HEADER_",description:"_A_UI_GROUP_ERRORS_ALL_DESCRIPTION_",props:["errors-all"]},{default:p(()=>[d(n,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=r=>e.model=r),children:e.children,"errors-all":e.errorsAll,label:"Fieldset"},null,8,["modelValue","children","errors-all"]),b("div",null,"model: "+x(e.model),1)]),_:1},8,["code-html","code-js"])}const X=u(Q,[["render",W]]);function ee(){return{codeHtml:`<a-fieldset
  :model-value="model1"
  :children="children1"
  :readonly="true"
  label="Fieldset 1"
