...
};`}}const Y={name:"PageProgressBasic",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=z(),{codeJs:a}=Z();return{codeHtml:s,codeJs:a}}};function K(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return g(),u(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_BASIC_USAGE_",props:"value"},{default:c(()=>[e(r,{value:50})]),_:1},8,["code-html","code-js"])}const Q=p(Y,[["render",K]]);function ss(){return{codeHtml:`<a-progress
  class="a_bg_primary"
  :value="30"
...
};`}}const le={name:"PageProgressValue",components:{AInputNumber:h,AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=_e(),{codeJs:a}=ne(),_=$(20);return{codeHtml:s,codeJs:a,model:_}}};function ce(s,a,_,n,l,m){const r=o("a-input-number"),t=o("a-progress"),P=o("aloha-example");return g(),u(P,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_VALUE_HEADER_",description:"_A_PROGRESS_GROUP_VALUE_DESCRIPTION_",props:"value"},{default:c(()=>[e(r,{class:"a_mb_4",modelValue:s.model,"onUpdate:modelValue":a[0]||(a[0]=b=>s.model=b),min:0,max:100,step:5,type:"integerNonNegative"},null,8,["modelValue"]),e(t,{value:s.model},null,8,["value"])]),_:1},8,["code-html","code-js"])}const pe=p(le,[["render",ce]]);function ge(){return{codeHtml:`<a-progress
  :value="20"
