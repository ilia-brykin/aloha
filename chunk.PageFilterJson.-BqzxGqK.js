import{A as m,a as S}from"./chunk.AlohaExample.BZeZthkV.js";import{P as O,a as T,b as N}from"./chunk.PageFilterTest.Bpf7Y5fP.js";import{P as j}from"./chunk.PageFilterImportCompositionApi.D4OfgmVj.js";import{aW as n,_ as i,A as E}from"./bundle.index.BhEeXSAb.js";import{Z as p,Y as u,f as t,aV as F,a0 as a}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import"./chunk.APageTabTitle.C6WQ6Ehw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function H(){return{codeJs:`filterJson({ x: 5, y: 6 }, { isHtml: true, class: "aloha" });
...
// ${n(s,{replacer:["week","month","model"]})}`}}const z={name:"PageFilterJsonReplacer",components:{AlohaExample:m},setup(){const{codeJs:e}=V();return{codeJs:e}}};function D(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"replacer","is-code-visible-default":!0},null,8,["code-js"])}const W=i(z,[["render",D]]);function Y(){return{codeJs:`filterJson({ x: 5, y: 6 }, { space: 0 });
// ${n({x:5,y:6},{space:0})}
...
// ${n({x:5,y:6},{space:"	"})}`}}const Z={name:"PageFilterJsonSpace",components:{AlohaExample:m},setup(){const{codeJs:e}=Y();return{codeJs:e}}};function q(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"space","is-code-visible-default":!0},null,8,["code-js"])}const K=i(Z,[["render",q]]);function Q(){return{codeJs:`filterJson({ x: 5, y: 6 }, { isHtml: true, tag: "pre" });
// ${n({x:5,y:6},{isHtml:!0,tag:"pre"})}

filterJson({ x: 5, y: 6 }, { isHtml: true, tag: "div" });
// ${n({x:5,y:6},{isHtml:!0,tag:"div"})}`}}const X={name:"PageFilterJsonTag",components:{AlohaExample:m},setup(){const{codeJs:e}=Q();return{codeJs:e}}};function ee(e,s,l,c,r,_){const o=t("aloha-example");return p(),u(o,{"code-js":e.codeJs,header:"tag","is-code-visible-default":!0},null,8,["code-js"])}const te=i(X,[["render",ee]]);function ne(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_JSON_ARGUMENTS_VALUE_"},{value:"[replacer]",types:["Function","Array"],text:"_PAGE_FILTER_JSON_ARGUMENTS_REPLACER_"},{value:"[space=2]",types:["Number","String"],text:"_PAGE_FILTER_JSON_ARGUMENTS_SPACE_"},{value:"[isHtml=false]",types:["Boolean"],text:"_PAGE_FILTER_JSON_ARGUMENTS_IS_HTML_"},{value:"[jsonClass=a_code_content]",types:["String"],text:"_PAGE_FILTER_JSON_ARGUMENTS_JSON_CLASS_"},{value:"[tag=pre]",types:["String"],text:"_PAGE_FILTER_JSON_ARGUMENTS_TAG_"}]}}function oe(){return{pageTitle:"filterJson"}}const se=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
