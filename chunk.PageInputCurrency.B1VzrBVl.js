...
};`}}const W={name:"PageInputCurrencyChange",components:{AInputCurrency:C,AlohaExample:f},setup(){const e=p(10.02),n=({model:c,id:m,props:l})=>{e.value=c,console.log(m,l)},{codeHtml:r}=k(),{codeJs:d}=w();return{changeModel:n,codeHtml:r,codeJs:d,model:e}}};function K(e,n,r,d,c,m){const l=t("a-input-currency"),u=t("aloha-example");return P(),I(u,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:y(()=>[a(l,{change:e.changeModel,"model-value":e.model,label:"Input"},null,8,["change","model-value"]),s("div",null,"model: "+i(e.model),1)]),_:1},8,["code-html","code-js"])}const Q=_(W,[["render",K]]);function z(){return{codeHtml:`<a-input-currency
  v-model="model"
  controls-type="none"
  label="Input"
></a-input-currency>
...
};`}}const Ke={name:"PageInputCurrencySymbol",components:{AInputCurrency:C,AlohaExample:f},setup(){const e=p(10.02),{codeHtml:n}=we(),{codeJs:r}=We();return{codeHtml:n,codeJs:r,model:e}}};function Qe(e,n,r,d,c,m){const l=t("a-input-currency"),u=t("aloha-example");return P(),I(u,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_SYMBOL_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_SYMBOL_DESCRIPTION_",props:["currency-symbol","currency-symbol-position"]},{default:y(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"currency-symbol-position":"right","currency-symbol":"%",label:"Input"},null,8,["modelValue"]),a(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),"currency-symbol-position":"left","currency-symbol":"$",label:"Input"},null,8,["modelValue"]),s("div",null,"model: "+i(e.model),1)]),_:1},8,["code-html","code-js"])}const ze=_(Ke,[["render",Qe]]);function Ze(){return{codeHtml:`<a-input-currency
  v-model="model"
  thousand-divider=","
  decimal-divider="."
