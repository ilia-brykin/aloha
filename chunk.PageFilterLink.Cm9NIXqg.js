...
// ${o("example.com",{protocol:"http://"})}`}}const V={name:"PageFilterLinkProtocol",components:{AlohaExample:f},setup(){const{codeJs:e}=O();return{codeJs:e}}};function D(e,l,i,c,m,_){const n=t("aloha-example");return s(),p(n,{"code-js":e.codeJs,header:"protocol","is-code-visible-default":!0},null,8,["code-js"])}const X=r(V,[["render",D]]);function Y(){return{codeJs:`filterLink("example.com", { target: "_blank" });
...
// ${o("example.com",{target:"_top"})}`}}const Z={name:"PageFilterLinkTarget",components:{AlohaExample:f},setup(){const{codeJs:e}=Y();return{codeJs:e}}};function q(e,l,i,c,m,_){const n=t("aloha-example");return s(),p(n,{"code-js":e.codeJs,header:"target","is-code-visible-default":!0},null,8,["code-js"])}const z=r(Z,[["render",q]]);function H(){return{argumentsText:[{value:"url",types:["String"],text:"_PAGE_FILTER_LINK_ARGUMENTS_URL_"},{value:'[linkText=""]',types:["String"],text:"_PAGE_FILTER_LINK_ARGUMENTS_LINK_TEXT_"},{value:'[protocol="https://"]',types:["String"],text:"_PAGE_FILTER_LINK_ARGUMENTS_PROTOCOL_"},{value:'[target=""]',types:["String"],text:"_PAGE_FILTER_LINK_ARGUMENTS_TARGET_"},{value:'[linkClass=""]',types:["String"],text:"_PAGE_FILTER_LINK_ARGUMENTS_LINK_CLASS_"}]}}function Q(){return{pageTitle:"filterLink"}}const W=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
