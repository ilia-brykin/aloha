import{A as h,a as M}from"./chunk.AlohaExample.CMUUEVcN.js";import{A as X}from"./chunk.AlohaTableProps.DwOUDlIA.js";import{a0 as d,_ as c,b as q,g as w,A as F}from"./bundle.index.DOWaPX07.js";import{B as r,C as m,L as l,G as e,m as a,F as b,r as z,a as k}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.ATable.BiLWW37G.js";import"./chunk.utilsMath.D900FRx8.js";import"./chunk.AForm.BMBXIC54.js";import"./chunk.ADatepicker.DXR-Bzfp.js";import"./chunk.UiMixinProps.3z5E7Tu9.js";import"./chunk.AInputNumber.CmREK6bZ.js";import"./chunk.ATinymce.BcMFUTFk.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function V(){return{codeHtml:`<a-Link
...
};`}}const Z={name:"PageLinkBasic",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=V(),{codeJs:_}=W();return{codeHtml:t,codeJs:_}}};function Y(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_BASIC_USAGE_",props:["text","href","to"]},{default:l(()=>[e(n,{text:"https://github.com/",href:"https://github.com/"}),e(n,{class:"a_ml_2",text:"Aloha",to:{name:"PageButton"}}),e(n,{class:"a_ml_2",text:"Aloha",to:"/button"})]),_:1},8,["code-html","code-js"])}const Q=c(Z,[["render",Y]]);function tt(){return{codeHtml:`<a-link
...
};`}}const nt={name:"PageLinkClass",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=tt(),{codeJs:_}=et();return{codeHtml:t,codeJs:_}}};function at(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_CLASS_HEADER_",description:"_A_LINK_GROUP_CLASS_DESCRIPTION_",props:"class"},{default:l(()=>[e(n,{class:"a_btn a_btn_link",text:"link",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_primary a_ml_2",text:"primary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_secondary a_ml_2",text:"secondary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_tertiary a_ml_2",text:"tertiary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_success a_ml_2",text:"success",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_info a_ml_2",text:"info",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_warning a_ml_2",text:"warning",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_danger a_ml_2",text:"danger",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_dark a_ml_2",text:"dark",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_light a_ml_2",text:"light",href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const _t=c(nt,[["render",at]]);function st(){return{codeHtml:`<a-link
...
};`}}const lt={name:"PageLinkComplex",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=st(),{codeJs:_}=ot();return{codeHtml:t,codeJs:_}}};function it(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_COMPLEX_HEADER_",description:"_A_LINK_GROUP_COMPLEX_DESCRIPTION_"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:{desktop:"Aloha"},"text-before":{desktop:"$ "},"icon-left":{desktop:"Dnd",mobile:"Cog"},"icon-right":{mobile:"Cog"},title:{desktop:"Aloha"},"text-aria-hidden":!0,"text-screen-reader":{desktop:"Aloha",mobile:"Aloha-mobile"},href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const ct=c(lt,[["render",it]]);function rt(){return{codeHtml:`<a-link
  class="a_btn a_btn_link"
  text="primary"
  :disabled="true"
  href="https://github.com/"
...
};`}}const ft={name:"PageLinkGroup",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=dt(),{codeJs:_}=bt();return{codeHtml:t,codeJs:_}}},gt={class:"a_btn_group"},kt={class:"a_btn_group a_ml_3"};function At(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_GROUP_HEADER_",description:"_A_LINK_GROUP_GROUP_DESCRIPTION_"},{default:l(()=>[b("div",gt,[e(n,{class:"a_btn a_btn_primary",text:"primary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_secondary",text:"secondary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_success",text:"success",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_info",text:"info",href:"https://github.com/"})]),b("div",kt,[e(n,{class:"a_btn a_btn_outline_primary",text:"outline-primary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_outline_secondary",text:"outline-secondary",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_outline_success",text:"outline-success",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_outline_info",text:"outline-info",href:"https://github.com/"})])]),_:1},8,["code-html","code-js"])}const Lt=c(ft,[["render",At]]);function It(){return{codeHtml:`<div
...
};`}}const ae={name:"PageLinkLoading",components:{AButton:q,ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=ee(),{codeJs:_}=ne(),o=z(!0);return{codeHtml:t,codeJs:_,loading:o,toggleLoading:()=>{o.value=!o.value}}}};function _e(t,_,o,i,p,u){const n=a("a-link"),s=a("a-button"),f=a("aloha-example");return r(),m(f,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_LOADING_HEADER_",description:"_A_LINK_GROUP_LOADING_DESCRIPTION_",props:["loading","loading-align"]},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",loading:t.loading,"loading-align":"left",text:'loading-align="left"',href:"https://github.com/"},null,8,["loading"]),e(n,{class:"a_btn a_btn_primary a_ml_2",loading:t.loading,"loading-align":"right",text:'loading-align="right"',href:"https://github.com/"},null,8,["loading"]),e(s,{class:"a_btn a_btn_secondary a_ml_5",text:"a-button toggle",onClick:t.toggleLoading},null,8,["onClick"])]),_:1},8,["code-html","code-js"])}const se=c(ae,[["render",_e]]);function oe(){return{codeHtml:`<a-link
  class="a_btn a_btn_outline_primary"
  text="outline-primary"
  href="https://github.com/"
>
...
};`}}const ge={name:"PageLinkSizes",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=be(),{codeJs:_}=fe();return{codeHtml:t,codeJs:_}}};function ke(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_SIZES_HEADER_",description:"_A_LINK_GROUP_SIZES_DESCRIPTION_",props:"class"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary a_btn_large",text:"large",href:"https://github.com/"}),e(n,{class:"a_btn a_btn_primary a_btn_small a_ml_2",text:"small",href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const Ae=c(ge,[["render",ke]]);function Le(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  text="Aloha"
  href="https://github.com/"
>
...
};`}}const Pe={name:"PageLinkSlotAppend",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=Le(),{codeJs:_}=Ie();return{codeHtml:t,codeJs:_}}},xe=b("span",null,"(***)",-1);function Ee(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_SLOT_APPEND_HEADER_",description:"_A_LINK_GROUP_SLOT_APPEND_DESCRIPTION_",slots:"linkAppend"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:"Aloha",href:"https://github.com/"},{linkAppend:l(()=>[xe]),_:1})]),_:1},8,["code-html","code-js"])}const Te=c(Pe,[["render",Ee]]);function Ne(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  href="https://github.com/"
>
  <span>(Aloha)</span>
...
};`}}const ye={name:"PageLinkSlotDefault",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=Ne(),{codeJs:_}=Oe();return{codeHtml:t,codeJs:_}}},Se=b("span",null,"(Aloha)",-1);function Re(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_SLOT_DEFAULT_HEADER_",description:"_A_LINK_GROUP_SLOT_DEFAULT_DESCRIPTION_",slots:"default"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",href:"https://github.com/"},{default:l(()=>[Se]),_:1})]),_:1},8,["code-html","code-js"])}const $e=c(ye,[["render",Re]]);function He(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  text="Aloha"
  href="https://github.com/"
>
...
};`}}const Ke={name:"PageLinkSlotPrepend",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=He(),{codeJs:_}=De();return{codeHtml:t,codeJs:_}}},Je=b("span",null,"(***)",-1);function Ce(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_SLOT_PREPEND_HEADER_",description:"_A_LINK_GROUP_SLOT_PREPEND_DESCRIPTION_",slots:"linkPrepend"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:"Aloha",href:"https://github.com/"},{linkPrepend:l(()=>[Je]),_:1})]),_:1},8,["code-html","code-js"])}const Ge=c(Ke,[["render",Ce]]);function je(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  text="Aloha"
  :is-title-html="true"
  href="https://github.com/"
...
};`}}const Fe={name:"PageLinkTextAfterBefore",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=qe(),{codeJs:_}=we();return{codeHtml:t,codeJs:_}}};function ze(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_TEXT_AFTER_BEFORE_HEADER_",description:"_A_LINK_GROUP_TEXT_AFTER_BEFORE_DESCRIPTION_",props:["text-before","text-after"]},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:"_SHOW_MORE_","text-after":" €","text-before":"$ ",href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const Ve=c(Fe,[["render",ze]]);function We(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
...
};`}}const Ye={name:"PageLinkTextObject",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=We(),{codeJs:_}=Ze();return{codeHtml:t,codeJs:_}}};function Qe(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_TEXT_OBJECT_HEADER_",description:"_A_LINK_GROUP_TEXT_OBJECT_DESCRIPTION_",props:"text (as object)"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:{mobile:"Aloha",desktop:"Aloha-desktop"},href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const tn=c(Ye,[["render",Qe]]);function en(){return{codeHtml:`<a-link
  class="a_btn a_btn_secondary"
  text="Aloha"
  text-tag="strong"
  href="https://github.com/"
...
};`}}const an={name:"PageLinkTextTag",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=en(),{codeJs:_}=nn();return{codeHtml:t,codeJs:_}}};function _n(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_TEXT_TAG_HEADER_",description:"_A_LINK_GROUP_TEXT_TAG_DESCRIPTION_",props:"text-tag"},{default:l(()=>[e(n,{class:"a_btn a_btn_secondary",text:"Aloha","text-tag":"strong",href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const sn=c(an,[["render",_n]]);function on(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  :title="['Aloha', '$(Aloha)']"
  text="Aloha"
  href="https://github.com/"
...
};`}}const cn={name:"PageLinkTitleArray",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=on(),{codeJs:_}=ln();return{codeHtml:t,codeJs:_}}};function rn(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return r(),m(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_TITLE_ARRAY_HEADER_",description:"_A_LINK_GROUP_TITLE_ARRAY_DESCRIPTION_",props:"title (as array)"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",title:["Aloha","$(Aloha)"],text:"Aloha",href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const mn=c(cn,[["render",rn]]);function pn(){return{codeHtml:`<a-link
