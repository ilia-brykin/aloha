import{A as S,a as h}from"./chunk.AlohaExample.DwwyPnI9.js";import{A as b}from"./chunk.AlohaTableProps.B-OtB9it.js";import{A as N}from"./chunk.AlohaTableTranslate.rmComZ4R.js";import{a3 as I,_ as c,g as y,A as U}from"./bundle.index.CBN060hU.js";import{r as u,U as E,aS as m,e as l,V as p,Z as o,Y as P,aT as A,d as R}from"./chunk.vendor.DOoIAE1K.js";import"./chunk.vendor-lodash.BAE3VvPy.js";import"./chunk.APageTabTitle.B7cA4VS4.js";import"./chunk.AlohaHighlightjs.BbO2lEkw.js";import"./chunk.ATable.C-Nc9qOh.js";import"./chunk.translations-ar.B3XbQD-F.js";import"./chunk.translations-de.BU3I7i25.js";import"./chunk.translations-en.Dz5VXJqd.js";import"./chunk.translations-es.BKlBZ5Wd.js";import"./chunk.translations-fr.CMF_fLGD.js";import"./chunk.translations-hr.C5ZK4YvJ.js";import"./chunk.translations-it.CAxOY8kK.js";import"./chunk.translations-ru.C-L7Lrhy.js";function g(){return{codeHtml:`<a-multiselect-ordered
  v-model="model1"
  :data="data"
  key-id="value"
  key-label="label"
...
};`}}const W={name:"PageMultiselectOrderedHelpText",components:{AlohaExample:S,AMultiselectOrdered:I},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),{codeHtml:t}=X(),{codeJs:_}=w();return{codeHtml:t,codeJs:_,data:e,model:a}}};function x(e,a,t,_,i,s){const d=l("a-multiselect-ordered"),n=l("aloha-example");return p(),E(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:m(()=>[o(d,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),data:e.data,"help-text":"Aloha","key-id":"value","key-label":"label",label:"Select"},null,8,["modelValue","data"])]),_:1},8,["code-html","code-js"])}const Q=c(W,[["render",x]]);function Z(){return{codeHtml:`<a-multiselect-ordered
  v-model="model1"
  :data="data"
  :readonly="true"
  key-id="value"
