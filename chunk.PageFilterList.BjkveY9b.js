import{A as L,a as P}from"./chunk.AlohaExample.CMUUEVcN.js";import{aq as s,_ as o,A as M}from"./bundle.index.DOWaPX07.js";import{P as k,a as J,b as H}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as C}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as c,C as p,m as l,L as F,G as i}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function R(){return{codeJs:`const ITEMS = ["label 1", "label 2", "label 3"];

filterList(ITEMS, {
  isHtml: false,
  isSimpleArray: true,
});
// ${s(["label 1","label 2","label 3"],{isHtml:!1,isSimpleArray:!0})}`}}const B={name:"PageFilterListIsHtml",components:{AlohaExample:L},setup(){const{codeJs:e}=R();return{codeJs:e}}};function G(e,t,r,n,_,u){const a=l("aloha-example");return c(),p(a,{"code-js":e.codeJs,header:"isHtml=false","is-code-visible-default":!0},null,8,["code-js"])}const j=o(B,[["render",G]]);function w(){return{codeJs:`const ITEMS = ["label 1", "label 2", "label 3"];

filterList(ITEMS, {
  isSimpleArray: true,
});
// ${s(["label 1","label 2","label 3"],{isSimpleArray:!0})}`}}const N={name:"PageFilterListIsSimpleArray",components:{AlohaExample:L},setup(){const{codeJs:e}=w();return{codeJs:e}}};function U(e,t,r,n,_,u){const a=l("aloha-example");return c(),p(a,{"code-js":e.codeJs,header:"isSimpleArray=true","is-code-visible-default":!0},null,8,["code-js"])}const K=o(N,[["render",U]]);function Y(){return{codeJs:`const ITEMS = [
  "Level 1",
    [
      "Level 2",
      [
...
// ${s(["x0",["x1",["x1.1","x1.2"]],"x3"],{isSimpleArray:!0})}`}}const z={name:"PageFilterListIsSimpleArrayTree",components:{AlohaExample:L},setup(){const{codeJs:e}=Y();return{codeJs:e}}};function D(e,t,r,n,_,u){const a=l("aloha-example");return c(),p(a,{"code-js":e.codeJs,header:"_PAGE_FILTER_LIST_IS_SIMPLE_ARRAY_TREE_HEADER_","is-code-visible-default":!0},null,8,["code-js"])}const O=o(z,[["render",D]]);function V(){return{codeJs:`const ITEMS = [
  {
    label: "Level 1",
    children: [
      {
...
// ${s([{label:"label 1"},{label:"label 2"},{label:"label 3"},{label:"label 4"}],{keyLabel:"label"})}`}}const Z={name:"PageFilterListKeyLabel",components:{AlohaExample:L},setup(){const{codeJs:e}=X();return{codeJs:e}}};function ee(e,t,r,n,_,u){const a=l("aloha-example");return c(),p(a,{"code-js":e.codeJs,header:"keyLabel","is-code-visible-default":!0},null,8,["code-js"])}const le=o(Z,[["render",ee]]);function te(){return{codeJs:`const ITEMS = [
  {
    label: "label 1",
  },
  {
...
// ${s(e,{isHtml:!0,isSimpleArray:!0,separator:";"})}`}}const _e={name:"PageFilterListSeparator",components:{AlohaExample:L},setup(){const{codeJs:e}=pe();return{codeJs:e}}};function ue(e,t,r,n,_,u){const a=l("aloha-example");return c(),p(a,{"code-js":e.codeJs,header:"separator / lastSeparator","is-code-visible-default":!0},null,8,["code-js"])}const Le=o(_e,[["render",ue]]);function be(){const e=["label 1","label 2","label 3"];return{codeJs:`const ITEMS = ["label 1", "label 2", "label 3"];
...
`,xe={name:"PageFilterList",components:{AlohaPage:P,ATranslation:M,PageFilterArguments:H,PageFilterImportCompositionApi:C,PageFilterImportFunction:J,PageFilterListIsHtml:j,PageFilterListIsSimpleArray:K,PageFilterListIsSimpleArrayTree:O,PageFilterListKeyChildren:W,PageFilterListKeyLabel:le,PageFilterListKeyLabelCallback:se,PageFilterListListClass:ce,PageFilterListSeparator:Le,PageFilterListSeparatorHtml:fe,PageFilterListTag:Te,PageFilterTest:k},setup(){const{pageTitle:e}=Ie(),{argumentsText:t}=Ae();return{argumentsText:t,pageTitle:e,test:he}}};function Ee(e,t,r,n,_,u){const a=l("a-translation"),b=l("page-filter-import-function"),m=l("page-filter-import-composition-api"),d=l("page-filter-arguments"),f=l("page-filter-list-is-simple-array"),S=l("page-filter-list-key-label"),v=l("page-filter-list-key-label-callback"),y=l("page-filter-list-is-html"),T=l("page-filter-list-separator"),A=l("page-filter-list-separator-html"),I=l("page-filter-list-tag"),h=l("page-filter-list-list-class"),x=l("page-filter-list-key-children"),E=l("page-filter-list-is-simple-array-tree"),g=l("page-filter-test"),$=l("aloha-page");return c(),p($,{"page-title":e.pageTitle},{body:F(()=>[i(a,{tag:"p",html:"_PAGE_FILTER_LIST_DESCRIPTION_"}),i(b,{"function-name":"filterList","type-import":"filters"}),i(m,{"function-name":"filterList"}),i(d,{"arguments-text":e.argumentsText,"function-description":'filterList(array, { [defaultValue=""], [isHtml=true], [isSimpleArray=false], [keyChildren=""], [keyLabel=""], [keyLabelCallback], [lastSeparator], [listClass=""], [separator], [separatorHtml=", "], [tag="ul"] })'},null,8,["arguments-text"]),i(f),i(S),i(v),i(y),i(T),i(A),i(I),i(h),i(x),i(E),i(g,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const Ce=o(xe,[["render",Ee]]);export{Ce as default};
