import{$ as l,_ as p,g as h,ap as y,A as C}from"./bundle.index.TDRGJtdO.js";import{A as m,a as x}from"./chunk.AlohaExample.COwLWL3e.js";import{A as B}from"./chunk.AlohaTableProps.BwzBMLpS.js";import{k as a,J as u,aJ as r,H as A,O as t,a as D,N as O}from"./chunk.vendor.Ca3-nzbX.js";import"./chunk.vendor-lodash.-viuv_rg.js";import"./chunk.translations-ar.CGH9gktb.js";import"./chunk.translations-de.S4PF1KYg.js";import"./chunk.translations-en.Ck05aPwN.js";import"./chunk.translations-es.CN4IYWAw.js";import"./chunk.translations-fr.CCwWtZH3.js";import"./chunk.translations-hr.C7fo1LlO.js";import"./chunk.translations-it.BFH_rAJL.js";import"./chunk.translations-ru.C3zXigta.js";import"./chunk.ATable.BV3GJRlA.js";import"./chunk.utilsMath.DoITS5e9.js";import"./chunk.AForm.DP_AeeTu.js";import"./chunk.ADatepicker.BtlALN0M.js";import"./chunk.UiMixinProps.SXpQQH-L.js";import"./chunk.AInputNumber.CppxR36z.js";function W(){return{codeHtml:`<a-dropdown
...
};`}}const J={name:"PageDropdownButtonClass",components:{ADropdown:l,AlohaExample:m},setup(){const{codeHtml:o}=L(),{codeJs:e}=q();return{codeHtml:o,codeJs:e,dropdownActions:[{text:"Actions 0",type:"button",callback:()=>{}},{text:"Actions 1",type:"button",callback:()=>{}}]}}};function G(o,e,d,c,_,i){const n=a("a-dropdown"),s=a("aloha-example");return A(),u(s,{"code-html":o.codeHtml,"code-js":o.codeJs,header:"_A_DROPDOWN_GROUP_BUTTON_CLASS_HEADER_",description:"_A_DROPDOWN_GROUP_BUTTON_CLASS_DESCRIPTION_",props:"button-text"},{default:r(()=>[t(n,{actions:o.dropdownActions,"button-class":"a_btn a_btn_primary"},null,8,["actions"]),t(n,{class:"a_ml_2",actions:o.dropdownActions,"button-class":"a_btn a_btn_success"},null,8,["actions"]),t(n,{class:"a_ml_2",actions:o.dropdownActions,"button-class":"a_btn a_btn_info"},null,8,["actions"])]),_:1},8,["code-html","code-js"])}const j=p(J,[["render",G]]);function v(){return{codeHtml:`<a-dropdown
  :actions="dropdownActions"
...
};`}}const z={name:"PageDropdownButtonLoading",components:{ADropdown:l,AlohaExample:m},setup(){const{codeHtml:o}=Y(),{codeJs:e}=K();return{codeHtml:o,codeJs:e,dropdownActions:[{text:"Actions 0",type:"button",callback:()=>{}},{text:"Actions 1",type:"button",callback:()=>{}}]}}};function Q(o,e,d,c,_,i){const n=a("a-dropdown"),s=a("aloha-example");return A(),u(s,{"code-html":o.codeHtml,"code-js":o.codeJs,header:"_A_DROPDOWN_GROUP_BUTTON_LOADING_HEADER_",description:"_A_DROPDOWN_GROUP_BUTTON_LOADING_DESCRIPTION_",props:["button-loading","button-loading-align"]},{default:r(()=>[t(n,{actions:o.dropdownActions,"button-text":"aloha","button-loading":!0},null,8,["actions"]),t(n,{class:"a_ml_2",actions:o.dropdownActions,"button-text":"aloha","button-loading":!0,"button-loading-align":"left"},null,8,["actions"]),t(n,{class:"a_ml_2",actions:o.dropdownActions,"button-text":"aloha","button-loading":!0,"button-loading-align":"right"},null,8,["actions"])]),_:1},8,["code-html","code-js"])}const Z=p(z,[["render",Q]]);function oo(){return{codeHtml:`<a-dropdown
  :actions="dropdownActions"
  button-text="Aloha"
></a-dropdown>
<a-dropdown
...
<a-dropdown
  ...
  :actions="dropdownActions"
  caret-icon="Gear"
></a-dropdown>`}}function ro(){return{codeJs:`import ADropdown from "aloha-vue/src/ADropdown/ADropdown";
