import{A as N,a as T}from"./chunk.AlohaExample.DRx6PH98.js";import{A as G}from"./chunk.AlohaTableProps.lPA1_h9w.js";import{A as S}from"./chunk.AlohaTableTranslate.CwwNCmDb.js";import{A as I}from"./chunk.AlohaPaginationItems.B3SNUxlq.js";import{_ as f,a as L,E as D,g as C,A as M}from"./bundle.index.Cpia4xHG.js";import{r as m,d,Y as g,W as A,aU as P,f as o,$ as s,_ as b}from"./chunk.vendor.BEEJbev-.js";import"./chunk.vendor-lodash.CwOx-Q_g.js";import{b as O}from"./chunk.ATable.CeLfvA3h.js";import{A as $}from"./chunk.ASlider.CP9PKIxo.js";import"./chunk.APageTabTitle.yxiJ4GqD.js";import"./chunk.AlohaHighlightjs.De6fh8wy.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function R(){return{codeHtml:`<div 
...
};`}}const w={name:"PagePaginationPagesBasic",components:{AlohaExample:N,AlohaPaginationItems:I,APaginationPages:O},setup(){const e=m(87),a=m(10),r=m(5),n=m(0),p=d(()=>{const t=e.value-n.value;return t<=0?0:Math.min(t,a.value)}),c=t=>{n.value=t},{codeHtml:i}=R(),{codeJs:l}=k();return{codeHtml:i,codeJs:l,limit:a,maxPages:r,offset:n,rowsLength:p,totalCount:e,updateOffset:c}}};function x(e,a,r,n,p,c){const i=o("aloha-pagination-items"),l=o("a-pagination-pages"),t=o("aloha-example");return g(),A(t,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_"},{default:P(()=>[s(i,{length:e.rowsLength,offset:e.offset},null,8,["length","offset"]),s(l,{limit:e.limit,"max-pages":e.maxPages,offset:e.offset,"total-count":e.totalCount,"onUpdate:offset":e.updateOffset},null,8,["limit","max-pages","offset","total-count","onUpdate:offset"])]),_:1},8,["code-html","code-js"])}const H=f(w,[["render",x]]);function y(){return{codeHtml:`<a-switch
  v-model="isDisabled"
  class="a_mb_4"
...
<a-pagination-pages
  ...
  :total-count="totalCount"
  @update:offset="updateOffset"
></a-pagination-pages>`}}function U(){return{codeJs:`import {
  computed,
  ref,
} from "vue";
import {
...
};`}}const B={name:"PagePaginationPagesDisabled",components:{AlohaExample:N,AlohaPaginationItems:I,APaginationPages:O,ASwitch:L},setup(){const e=m(87),a=m(10),r=m(5),n=m(0),p=m(!0),c=d(()=>{const _=e.value-n.value;return _<=0?0:Math.min(_,a.value)}),i=_=>{n.value=_},{codeHtml:l}=y(),{codeJs:t}=U();return{codeHtml:l,codeJs:t,isDisabled:p,limit:a,maxPages:r,offset:n,rowsLength:c,totalCount:e,updateOffset:i}}};function J(e,a,r,n,p,c){const i=o("a-switch"),l=o("aloha-pagination-items"),t=o("a-pagination-pages"),_=o("aloha-example");return g(),A(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_PAGINATION_PAGES_GROUP_DISABLED_HEADER_",description:"_A_PAGINATION_PAGES_GROUP_DISABLED_DESCRIPTION_",props:["disabled"]},{default:P(()=>[s(i,{class:"a_mb_4",modelValue:e.isDisabled,"onUpdate:modelValue":a[0]||(a[0]=u=>e.isDisabled=u),label:"_LBL_DISABLED_"},null,8,["modelValue"]),s(l,{length:e.rowsLength,offset:e.offset},null,8,["length","offset"]),s(t,{disabled:e.isDisabled,limit:e.limit,"max-pages":e.maxPages,offset:e.offset,"total-count":e.totalCount,"onUpdate:offset":e.updateOffset},null,8,["disabled","limit","max-pages","offset","total-count","onUpdate:offset"])]),_:1},8,["code-html","code-js"])}const V=f(B,[["render",J]]);function j(){return{codeHtml:`<a-slider
  v-model="maxPages"
  :max="10"
  :min="1"
  :step="1"
