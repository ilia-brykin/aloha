...
};`}}const Xs={name:"PageProgressSlotText",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Fs(),{codeJs:a}=ks();return{codeHtml:s,codeJs:a}}};function Ws(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_HEADER_",description:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_DESCRIPTION_",slots:"progressText"},{default:c(()=>[e(r,{value:20},{progressText:c(({valuePercent:P})=>[R("span",null,"Aloha "+S(P),1)]),_:1}),e(r,{class:"a_mt_4",value:40},{progressText:c(({valuePercent:P})=>[R("span",null,"$$$ "+S(P),1)]),_:1})]),_:1},8,["code-html","code-js"])}const zs=p(Xs,[["render",Ws]]);function Zs(){return{codeHtml:`<a-progress
  :value="50"
  class-progress-bar="a_bg_primary"
  :striped="true"
></a-progress>
...
};`}}const le={name:"PageProgressValue",components:{AInputNumber:$,AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=_e(),{codeJs:a}=ne(),_=E(20);return{codeHtml:s,codeJs:a,model:_}}};function ce(s,a,_,n,l,m){const r=o("a-input-number"),t=o("a-progress"),P=o("aloha-example");return u(),g(P,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_VALUE_HEADER_",description:"_A_PROGRESS_GROUP_VALUE_DESCRIPTION_",props:"value"},{default:c(()=>[e(r,{class:"a_mb_4",modelValue:s.model,"onUpdate:modelValue":a[0]||(a[0]=b=>s.model=b),min:0,max:100,step:5,type:"integerNonNegative"},null,8,["modelValue"]),e(t,{value:s.model},null,8,["value"])]),_:1},8,["code-html","code-js"])}const pe=p(le,[["render",ce]]);function ge(){return{codeHtml:`<a-progress
  :value="20"
