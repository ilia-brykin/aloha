import{A as H,a as h}from"./chunk.AlohaExample.BRf15a9v.js";import{P as T,a as A,b as P}from"./chunk.PageFilterTest.CRZDfwg3.js";import{aL as a,_ as i,A as S}from"./bundle.index.DaWeoMpR.js";import{W as r,V as l,e,aT as F,_ as n}from"./chunk.vendor.7qYoMuVo.js";import"./chunk.vendor-lodash.H1qWA996.js";import{P as L}from"./chunk.PageFilterImportCompositionApi.DhmqSZuJ.js";import"./chunk.APageTabTitle.DJ6kSNp2.js";import"./chunk.AlohaHighlightjs.CqftpDCI.js";import"./chunk.translations-ar.BVGXYuic.js";import"./chunk.translations-de.BTTkg7IT.js";import"./chunk.translations-en.B1a-0dJo.js";import"./chunk.translations-es.9uV8L16o.js";import"./chunk.translations-fr.b_PTR2hx.js";import"./chunk.translations-hr.BZQfnGWK.js";import"./chunk.translations-it.CbF6AZKa.js";import"./chunk.translations-ru.DaNQBvrb.js";function O(){return{codeJs:`filterEscapeHtml("<script>alert('XSS Attack')<\/script>");
// ${a('<script>alert("XSS Attack")<\/script>')}

filterEscapeHtml("Hello, World!");
// ${a("Hello, World!")}`}}const $={name:"PageFilterEscapeHTMLExample",components:{AlohaExample:H},setup(){const{codeJs:t}=O();return{codeJs:t}}};function I(t,o,s,c,u,m){const p=e("aloha-example");return r(),l(p,{"code-js":t.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const M=i($,[["render",I]]);function B(){return{argumentsText:[{value:"value",types:["String"],text:"_PAGE_FILTER_ESCAPE_HTML_ARGUMENTS_VALUE_"}]}}function C(){return{pageTitle:"filterEscapeHtml"}}const k=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
