...
};`}}const X={name:"PageFieldsetCollapse",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha1.text"}],l=[{type:"text",label:"Text",id:"aloha2.text"}],t=m(void 0),d=m(void 0),{codeHtml:c}=G(),{codeJs:_}=M();return{children1:e,children2:l,codeHtml:c,codeJs:_,model1:t,model2:d,toggleCollapse:({isCollapsed:r,id:a,props:A})=>{console.log(r,a,A)}}}},Y={class:"a_columns a_columns_count_12"},w={class:"a_column a_column_6 a_columns_count_12_touch"};function K(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return P(),f(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_COLLAPSE_HEADER_",description:"_A_UI_GROUP_COLLAPSE_DESCRIPTION_",props:["collapsible","is-collapsed"],emits:["toggle-collapse"]},{default:h(()=>[i("div",Y,[i("div",w,[s(n,{modelValue:e.model1,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model1=a),children:e.children1,collapsible:!0,label:"Aloha",onToggleCollapse:e.toggleCollapse},null,8,["modelValue","children","onToggleCollapse"]),i("div",null,"model1: "+p(e.model1),1),s(n,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":l[1]||(l[1]=a=>e.model2=a),children:e.children2,collapsible:!0,"is-collapsed":!0,label:"Aloha",onToggleCollapse:e.toggleCollapse},null,8,["modelValue","children","onToggleCollapse"]),i("div",null,"model2: "+p(e.model2),1)])])]),_:1},8,["code-html","code-js"])}const W=u(X,[["render",K]]);function Q(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  errors="Aloha"
  label="Fieldset"
