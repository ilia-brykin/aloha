...
};`}}const Wt={name:"PageTableFormSticky",components:{AlohaExample:Z,AOneCheckbox:Ae,ATableForm:Q},setup(){const{codeHtml:e}=Ut(),{codeJs:t}=$t(),o=C(!0),l=Array.from({length:20},(i,a)=>{const n=a+1;return{id:`c${n}`,label:`${n}`,maxWidth:120,minWidth:120,width:120,formElement:{controlsType:"none",type:"integer"}}}),r=C(Array.from({length:6},(i,a)=>{const n={id:a+1};return l.forEach((c,d)=>{n[c.id]=(a+1)*100+d+1}),n}));return{codeHtml:e,codeJs:t,columns:l,isActionsSticky:o,rows:r}}};function jt(e,t,o,l,r,i){const a=g("a-one-checkbox"),n=g("a-table-form"),c=g("aloha-example");return G(),J(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TABLE_FORM_STICKY_HEADER_",description:"_A_TABLE_FORM_STICKY_DESCRIPTION_",props:["is-actions-sticky","is-deletable-confirm","is-editable"]},{default:V(()=>[F(a,{class:"a_mb_4",modelValue:e.isActionsSticky,"onUpdate:modelValue":t[0]||(t[0]=d=>e.isActionsSticky=d),label:"isActionsSticky"},null,8,["modelValue"]),F(n,{columns:e.columns,"is-actions-sticky":e.isActionsSticky,"is-deletable-confirm":!0,"is-editable":!0,rows:e.rows,"key-id":"id",label:"20 columns"},null,8,["columns","is-actions-sticky","rows"])]),_:1},8,["code-html","code-js"])}const Gt=j(Wt,[["render",jt]]);function Jt(){return{pageTitle:u(()=>Ee({placeholder:"_A_TABLE_FORM_PAGE_TITLE_"}))}}const Vt={name:"PageTableForm",components:{AlohaPage:ue,PageTableFormBasic:Ct,PageTableFormDND:Lt,PageTableFormEdit:It,PageTableFormGrow:Ht,PageTableFormSticky:Gt},setup(){const{pageTitle:e}=Jt();return{pageTitle:e}}};function Kt(e,t,o,l,r,i){const a=g("page-table-form-basic"),n=g("page-table-form-d-n-d"),c=g("page-table-form-edit"),d=g("page-table-form-sticky"),v=g("page-table-form-grow"),b=g("aloha-page");return G(),J(b,{"page-title":e.pageTitle},{body:V(()=>[F(a),F(n),F(c),F(d),F(v)]),_:1},8,["page-title"])}const uo=j(Vt,[["render",Kt]]);export{uo as default};
