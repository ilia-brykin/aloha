...
};`}}const Re={name:"PageInputReadonly",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha1"),o=_("Aloha2"),a=_(void 0),{codeHtml:s}=fe(),{codeJs:p}=Ae();return{codeHtml:s,codeJs:p,model1:e,model2:o,model3:a}}};function Ee(e,o,a,s,p,u){const l=t("a-input"),d=t("aloha-example");return I(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_GROUP_READONLY_HEADER_",description:"_A_INPUT_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:c(()=>[n(l,{"model-value":e.model1,readonly:!0,label:"Input1",type:"text"},null,8,["model-value"]),n(l,{class:"a_mt_3","model-value":e.model2,readonly:!0,label:"Input2",type:"text"},null,8,["model-value"]),n(l,{class:"a_mt_3","model-value":e.model3,readonly:!0,label:"Input3","readonly-default":"-",type:"text"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const Se=m(Re,[["render",Ee]]);function Oe(){return{codeHtml:`<a-input
  :model-value="model"
  :readonly="true"
  :show-password="false"
  label="Input1"
