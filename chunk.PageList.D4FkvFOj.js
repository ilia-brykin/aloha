...
};`}}const Q={name:"PageListIsDataSimpleArray",components:{AList:c,AlohaExample:L},setup(){const{codeHtml:e}=F(),{codeJs:l}=z();return{codeHtml:e,codeJs:l,items1:["label 1","label 2","label 3","label 4"],items2:["Level 1",["Level 2",["Level 2.1","Level 2.2"]],["Level 3",["Level 3.1",["Level 3.2",["Level 3.2.1","Level 3.2.2"]]]]]}}},X={class:"a_columns a_columns_count_12"},Z={class:"a_column a_column_4 a_column_12_tablet"};function x(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return b(),u(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_LIST_GROUP_IS_DATA_SIMPLE_ARRAY_HEADER_",description:"_A_LIST_GROUP_IS_DATA_SIMPLE_ARRAY_DESCRIPTION_",props:["is-data-simple-array"]},{default:d(()=>[r("div",X,[r("div",Z,[t(s,{data:e.items1,"is-data-simple-array":!0},null,8,["data"]),t(s,{class:"a_mt_4",data:e.items2,"is-data-simple-array":!0},null,8,["data"])])])]),_:1},8,["code-html","code-js"])}const ee=p(Q,[["render",x]]);function le(){return{codeHtml:`<a-switch
  v-model="modelIsHtml"
