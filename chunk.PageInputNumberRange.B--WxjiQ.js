...
};`}}const C={name:"PageInputNumberRangeBasic",components:{AlohaExample:g,AInputNumberRange:h},setup(){const{codeHtml:e}=$(),{codeJs:o}=y(),n=R(void 0);return{codeHtml:e,codeJs:o,model:n}}},L={class:"a_columns a_columns_count_12"},H={class:"a_column a_column_6 a_columns_count_12_touch"},U={class:"a_mt_3"};function D(e,o,n,d,u,A){const l=a("a-input-number-range"),_=a("aloha-example");return c(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["v-model","label"]},{default:i(()=>[t("div",L,[t("div",H,[s(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),label:"Aloha"},null,8,["modelValue"]),t("div",U,"model: "+E(e.model),1)])])]),_:1},8,["code-html","code-js"])}const G=m(C,[["render",D]]);function B(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
  placeholder-max="Max"
  placeholder-min="Min"
...
};`}}const X={name:"PageInputNumberRangeTypeInteger",components:{AlohaExample:g,AInputNumberRange:h},setup(){const{codeHtml:e}=k(),{codeJs:o}=F(),n=R(void 0);return{codeHtml:e,codeJs:o,model:n}}},w={class:"a_columns a_columns_count_12"},z={class:"a_column a_column_6 a_columns_count_12_touch"},K={class:"a_mt_3"};function Q(e,o,n,d,u,A){const l=a("a-input-number-range"),_=a("aloha-example");return c(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_DESCRIPTION_",props:"type='integerRange'"},{default:i(()=>[t("div",w,[t("div",z,[s(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),label:"Aloha",type:"integerRange"},null,8,["modelValue"]),t("div",K,"model: "+E(e.model),1)])])]),_:1},8,["code-html","code-js"])}const W=m(X,[["render",Q]]);function Z(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
