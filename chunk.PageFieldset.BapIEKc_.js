import{A,a as F}from"./chunk.AlohaExample.DKBt6BF9.js";import{A as N}from"./chunk.AlohaTableProps.DkJtq6j7.js";import{A as x}from"./chunk.AlohaTableTranslate.BVuHx40h.js";import{s as E,_ as u,g as v,A as U}from"./bundle.index.hzSDncRt.js";import{r as m,k as o,J as f,aO as h,H as P,O as s,N as i,aP as p,a as S}from"./chunk.vendor.CwuJ9Ljq.js";import"./chunk.vendor-lodash.BBRAkY5X.js";import"./chunk.ATable.Cuiv0i4K.js";import"./chunk.translations-ar.CGH9gktb.js";import"./chunk.translations-de.S4PF1KYg.js";import"./chunk.translations-en.Ck05aPwN.js";import"./chunk.translations-es.CN4IYWAw.js";import"./chunk.translations-fr.CCwWtZH3.js";import"./chunk.translations-hr.C7fo1LlO.js";import"./chunk.translations-it.BFH_rAJL.js";import"./chunk.translations-ru.C3zXigta.js";function L(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  label="Fieldset"
></a-fieldset>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      })`,required:!1}]}}function Oe(){return{dataEvents:[{name:"update-data",description:"_A_UI_EVENTS_UPDATE_DATA_DESCRIPTION_",type:"Function"},{name:"toggle-collapse",description:"_A_UI_EVENTS_TOGGLE_COLLAPSE_DESCRIPTION_",type:"Function"},{name:"update:model-value",description:"_A_UI_EVENTS_UPDATE_MODEL_VALUE_DESCRIPTION_",type:"Function"}]}}function Re(){return{dataTranslate:["_A_FIELDSET_COLLAPSE_OPEN_","_A_FIELDSET_COLLAPSE_CLOSE_"]}}const Ce={name:"PageFieldset",components:{AlohaPage:F,AlohaTableProps:N,AlohaTableTranslate:x,ATranslation:U,PageFieldsetBasic:k,PageFieldsetChange:j,PageFieldsetCollapse:W,PageFieldsetError:le,PageFieldsetHasBorder:re,PageFieldsetHelpText:pe,PageFieldsetLabelScreenReader:Ie},setup(){const{pageTitle:e}=be(),{dataProps:l}=Se(),{dataEvents:t}=Oe(),{dataTranslate:d}=Re();return{dataEvents:t,dataProps:l,dataTranslate:d,pageTitle:e}}};function Te(e,l,t,d,c,_){const n=o("a-translation"),r=o("page-fieldset-basic"),a=o("page-fieldset-change"),I=o("page-fieldset-help-text"),O=o("page-fieldset-error"),R=o("page-fieldset-label-screen-reader"),C=o("page-fieldset-collapse"),T=o("page-fieldset-has-border"),b=o("aloha-table-props"),g=o("aloha-table-translate"),D=o("aloha-page");return P(),f(D,{"page-title":e.pageTitle},{body:h(()=>[s(n,{tag:"p",html:"_A_FIELDSET_COMPONENT_DESCRIPTION_"}),s(r),s(a),s(I),s(O),s(R),s(C),s(T),s(b,{data:e.dataProps},null,8,["data"]),s(b,{"table-label":"Events",data:e.dataEvents,columns:["name","type","description"]},null,8,["data"]),s(g,{data:e.dataTranslate},null,8,["data"])]),_:1},8,["page-title"])}const qe=u(Ce,[["render",Te]]);export{qe as default};
