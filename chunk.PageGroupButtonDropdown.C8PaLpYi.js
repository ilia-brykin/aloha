...
};`}}const h={name:"PageGroupButtonDropdownBasic",components:{AGroupButtonDropdown:O,AlohaExample:b},setup(){const{codeHtml:t}=U(),{codeJs:e}=C();return{actions:[{text:"Action 1",type:"button",callback:()=>{}},{text:"Action 2",type:"button",callback:()=>{}},{text:"Action 3",type:"button",callback:()=>{}}],codeHtml:t,codeJs:e}}};function H(t,e,c,s,i,d){const o=a("a-group-button-dropdown"),r=a("aloha-example");return l(),p(r,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_BASIC_USAGE_",description:"_A_GROUP_BUTTON_DROPDOWN_GROUP_BASIC_DESCRIPTION_",props:"actions"},{default:u(()=>[n(o,{actions:t.actions},null,8,["actions"])]),_:1},8,["code-html","code-js"])}const $=_(h,[["render",H]]);function J(){return{codeHtml:`<a-group-button-dropdown
  :actions="actions"
