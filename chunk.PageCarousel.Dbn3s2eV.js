import{A as N,a as x}from"./chunk.AlohaExample.CduO3eaH.js";import{A as B}from"./chunk.AlohaTableProps.BrqA5CPO.js";import{A as q}from"./chunk.AlohaTableTranslate.CeSdGbCt.js";import{f as v,h,i as p,j as f,A as y,g as R,_ as T}from"./bundle.index.Ck-7K_-E.js";import{t as n,d as i,h as S,r as D,A as k,O as M,a$ as $,U as b,aS as E,e as O,V as I,Y as A,Z as u}from"./chunk.vendor.bx9jdKRu.js";import{h as V,N as g,Y as U,f as C,c as G,g as W,u as j,a as H,e as Y}from"./chunk.vendor-lodash.DXsmYJeZ.js";import"./chunk.APageTabTitle.C_nh3cuM.js";import"./chunk.AlohaHighlightjs.ZYRFUDZw.js";import"./chunk.ATable.oWy5dBn5.js";import"./chunk.translations-ar.D2gF-ODY.js";import"./chunk.translations-de.Bu-UVWhZ.js";import"./chunk.translations-en.C5s5k3m-.js";import"./chunk.translations-es.DdYbVNuW.js";import"./chunk.translations-fr.CNQfX44G.js";import"./chunk.translations-hr.DLfY43V5.js";import"./chunk.translations-it.BZHHVHJh.js";import"./chunk.translations-ru.DpY40Ywz.js";function J(e){const t=n(e,"type");return{btnClass:i(()=>`a_carousel__arrow_${t.value}`)}}function X(e){const t=n(e,"texts"),a=n(e,"type");return{btnTitle:i(()=>{if(a.value==="previous")return t.value.previousSlide;if(a.value==="next")return t.value.nextSlide})}}const P={name:"ACarouselBtn",props:{ariaDisabled:{type:Boolean,required:!1},btnAttributes:{type:Object,required:!1,default:()=>({})},disabled:{type:Boolean,required:!1},icon:{type:String,required:!1,default:void 0},texts:{type:Object,required:!0},type:{type:String,required:!0,validator:e=>["previous","next"].includes(e)}},emits:["toSlide"],setup(e){const{btnClass:t}=J(e),{btnTitle:a}=X(e);return{btnClass:t,btnTitle:a}},render(){return S(v,{class:["a_carousel__arrow",this.btnClass],ariaDisabled:this.ariaDisabled,disabled:this.disabled,iconLeft:this.icon,title:this.btnTitle,textScreenReader:this.btnTitle,type:"button",onClick:()=>this.$emit("toSlide"),...this.btnAttributes})}};function K(){return{ariaLabelTabsAttributes:i(()=>h({attr:"aria-label",placeholder:"_A_CAROUSEL_CONTROLS_SLIDES_"}))}}function F({emit:e}){return{changeActiveId:({item:r})=>{e("changeActiveId",{id:r[p]})},onPressBtn:r=>{r.keyCode===f.arrowLeft?(r.preventDefault(),e("toPreviousSlide")):r.keyCode===f.arrowRight&&(r.preventDefault(),e("toNextSlide"))}}}const Z={icons:{dots:`<svg width="34" height="34" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
};`}}const ne={name:"PageCarouselArrowsTrigger",components:{ACarousel:w,AlohaExample:N,ATranslation:y},setup(){const e=i(()=>[{id:1,src:"./assets/Basketball_ball_red_background.png",alt:R({placeholder:"_A_CAROUSEL_COMPONENT_ALT_BASKETBALL_BALL_"})},{id:2,src:"./assets/Soccer_ball_red_background.png",alt:R({placeholder:"_A_CAROUSEL_COMPONENT_ALT_SOCCER_BALL_"})},{id:3,src:"./assets/Tennis_ball_purple_background.png",alt:R({placeholder:"_A_CAROUSEL_COMPONENT_ALT_TENNIS_BALL_"})},{id:4,src:"./assets/Volleyball_ball_red_background.png",alt:R({placeholder:"_A_CAROUSEL_COMPONENT_ALT_VOLLEY_BALL_"})}]),{codeHtml:t}=oe(),{codeJs:a}=ie();return{codeHtml:t,codeJs:a,data:e}}},de={class:"a_columns a_columns_count_12"},ce={class:"a_column a_column_12_touch a_column_4"},ue=["src","alt"],Ae={class:"a_column a_column_12_touch a_column_4"},Se=["src","alt"],Oe={class:"a_column a_column_12_touch a_column_4"},pe=["src","alt"],me={class:"a_column a_column_12_touch a_column_4"},Le=["src","alt"];function Re(e,t,a,r,d,o){const l=O("a-translation"),c=O("a-carousel"),_=O("aloha-example");return I(),b(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_CAROUSEL_GROUP_ARROWS_TRIGGER_HEADER_",description:"_A_CAROUSEL_GROUP_ARROWS_TRIGGER_DESCRIPTION_",props:"arrows-trigger"},{default:E(()=>[A("div",de,[A("div",ce,[u(l,{tag:"h3",html:"_A_CAROUSEL_COMPONENT_ARROWS_TRIGGER_HOVER_"}),u(c,{data:e.data,"aria-label":"_A_CAROUSEL_COMPONENT_BALLS_ARIA_LABEL_","arrows-trigger":"hover","key-id":"id"},{item:E(({item:s})=>[A("img",{class:"a_height_auto a_width_100",src:s.src,alt:s.alt},null,8,ue)]),_:1},8,["data"])]),A("div",Ae,[u(l,{tag:"h3",html:"_A_CAROUSEL_COMPONENT_ARROWS_TRIGGER_FOCUS_"}),u(c,{data:e.data,"aria-label":"_A_CAROUSEL_COMPONENT_BALLS_ARIA_LABEL_","arrows-trigger":"focus","key-id":"id"},{item:E(({item:s})=>[A("img",{class:"a_height_auto a_width_100",src:s.src,alt:s.alt},null,8,Se)]),_:1},8,["data"])]),A("div",Oe,[u(l,{tag:"h3",html:"_A_CAROUSEL_COMPONENT_ARROWS_TRIGGER_HOVER_FOCUS_"}),u(c,{"arrows-trigger":["hover","focus"],data:e.data,"aria-label":"_A_CAROUSEL_COMPONENT_BALLS_ARIA_LABEL_","key-id":"id"},{item:E(({item:s})=>[A("img",{class:"a_height_auto a_width_100",src:s.src,alt:s.alt},null,8,pe)]),_:1},8,["data"])]),A("div",me,[u(l,{tag:"h3",html:"_A_CAROUSEL_COMPONENT_ARROWS_TRIGGER_ALWAYS_"}),u(c,{data:e.data,"aria-label":"_A_CAROUSEL_COMPONENT_BALLS_ARIA_LABEL_","arrows-trigger":"always","key-id":"id"},{item:E(({item:s})=>[A("img",{class:"a_height_auto a_width_100",src:s.src,alt:s.alt},null,8,Le)]),_:1},8,["data"])])])]),_:1},8,["code-html","code-js"])}const Ee=T(ne,[["render",Re]]);function Ce(){return{codeHtml:`<div class="a_columns a_columns_count_12">
  <div class="a_column a_column_12_touch a_column_4">
    <a-carousel
      :data="data"
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      }`,required:!1}]}}function ye(){return{dataTranslate:["_A_CAROUSEL_NEXT_SLIDE_","_A_CAROUSEL_PREVIOUS_SLIDE_","_A_CAROUSEL_CONTROLS_SLIDE_{{number}}_","_A_CAROUSEL_CONTROLS_SLIDES_","_A_CAROUSEL_CONTROLS_START_","_A_CAROUSEL_CONTROLS_STOP_","_A_CAROUSEL_ITEM_ARIA_LABEL_{{number}}_{{count}}_"]}}const Ue={name:"PageCarousel",components:{AlohaPage:x,AlohaTableProps:B,AlohaTableTranslate:q,ATranslation:y,PageCarouselArrowsTrigger:Ee,PageCarouselBasic:Pe},setup(){const{pageTitle:e}=Ne(),{dataProps:t}=ve(),{dataTranslate:a}=ye();return{dataProps:t,dataTranslate:a,pageTitle:e}}};function we(e,t,a,r,d,o){const l=O("a-translation"),c=O("page-carousel-basic"),_=O("page-carousel-arrows-trigger"),s=O("aloha-table-props"),m=O("aloha-table-translate"),L=O("aloha-page");return I(),b(L,{"page-title":e.pageTitle},{body:E(()=>[u(l,{tag:"p",html:"_A_CAROUSEL_COMPONENT_DESCRIPTION_"}),u(c),u(_),u(s,{data:e.dataProps},null,8,["data"]),u(m,{data:e.dataTranslate},null,8,["data"])]),_:1},8,["page-title"])}const Ze=T(Ue,[["render",we]]);export{Ze as default};
