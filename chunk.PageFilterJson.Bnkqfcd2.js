...
// ${n(o,{replacer:["week","month","model"]})}`}}const O={name:"PageFilterJsonReplacer",components:{AlohaExample:m},setup(){const{codeJs:e}=b();return{codeJs:e}}};function k(e,o,i,l,s,f){const a=t("aloha-example");return u(),p(a,{"code-js":e.codeJs,header:"replacer","is-code-visible-default":!0},null,8,["code-js"])}const w=c(O,[["render",k]]);function G(){return{codeJs:`filterJson({ x: 5, y: 6 }, { space: 0 });
// ${n({x:5,y:6},{space:0})}
