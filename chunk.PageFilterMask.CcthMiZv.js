import{A as d,a as x}from"./chunk.AlohaExample.CMUUEVcN.js";import{aK as t,_ as l,A}from"./bundle.index.DOWaPX07.js";import{P,a as T,b as $}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as y}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as i,C as c,m as s,L as B,G as n}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function E(){return{codeJs:`filterMask("1234567812345678");
// ${t("1234567812345678")}
...
// ${t("12345678",{chars:10})}`}}const b={name:"PageFilterMaskExample",components:{AlohaExample:d},setup(){const{codeJs:e}=E();return{codeJs:e}}};function v(e,a,o,u,p,m){const r=s("aloha-example");return i(),c(r,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const F=l(b,[["render",v]]);function S(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_MASK_ARGUMENTS_VALUE_"},{value:"[chars=4]",types:["Number"],text:"_PAGE_FILTER_MASK_ARGUMENTS_CHARS_"},{value:'[mask="*"]',types:["String"],text:"_PAGE_FILTER_MASK_ARGUMENTS_MASK_"}]}}function I(){return{pageTitle:"filterMask"}}const G=`import filterMask from "../filterMask";
...
`,R={name:"PageFilterMask",components:{AlohaPage:x,ATranslation:A,PageFilterArguments:$,PageFilterImportCompositionApi:y,PageFilterImportFunction:T,PageFilterMaskExample:F,PageFilterTest:P},setup(){const{pageTitle:e}=I(),{argumentsText:a}=S();return{argumentsText:a,pageTitle:e,test:G}}};function C(e,a,o,u,p,m){const r=s("a-translation"),f=s("page-filter-import-function"),_=s("page-filter-import-composition-api"),g=s("page-filter-arguments"),h=s("page-filter-mask-example"),k=s("page-filter-test"),M=s("aloha-page");return i(),c(M,{"page-title":e.pageTitle},{body:B(()=>[n(r,{tag:"p",html:"_PAGE_FILTER_MASK_DESCRIPTION_"}),n(f,{"function-name":"filterMask","type-import":"filters"}),n(_,{"function-name":"filterMask"}),n(g,{"arguments-text":e.argumentsText,"function-description":'filterMask(value, { [chars=4], [mask="*"] })'},null,8,["arguments-text"]),n(h),n(k,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const V=l(R,[["render",C]]);export{V as default};
