...
};`}}const Z={name:"PageTooltipHideArrow",components:{AlohaExample:f,ATooltip:T},setup(){const{codeHtml:e}=V(),{codeJs:t}=K();return{codeHtml:e,codeJs:t}}};function Y(e,t,r,p,_,d){const s=n("a-tooltip"),l=n("aloha-example");return m(),c(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TOOLTIP_GROUP_HIDE_ARROW_HEADER_",description:"_A_TOOLTIP_GROUP_HIDE_ARROW_DESCRIPTION_",props:"show-arrow"},{default:o(()=>[i(s,{class:"a_btn a_btn_primary",tag:"button","show-arrow":!1},{title:o(()=>t[0]||(t[0]=[a("div",null,"Aloha",-1)])),default:o(()=>[t[1]||(t[1]=a("span",null,"Aloha",-1))]),_:1})]),_:1},8,["code-html","code-js"])}const z=u(Z,[["render",Y]]);function tt(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :max-width="300"
>
