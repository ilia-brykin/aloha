...
};`}}const Aa={name:"PageCarouselBasic",components:{ACarousel:f,AlohaExample:v},setup(){const e=i(()=>[{id:1,src:"./assets/Basketball_ball_red_background.png",alt:_({placeholder:"_A_CAROUSEL_COMPONENT_ALT_BASKETBALL_BALL_"})},{id:2,src:"./assets/Soccer_ball_red_background.png",alt:_({placeholder:"_A_CAROUSEL_COMPONENT_ALT_SOCCER_BALL_"})},{id:3,src:"./assets/Tennis_ball_purple_background.png",alt:_({placeholder:"_A_CAROUSEL_COMPONENT_ALT_TENNIS_BALL_"})},{id:4,src:"./assets/Volleyball_ball_red_background.png",alt:_({placeholder:"_A_CAROUSEL_COMPONENT_ALT_VOLLEY_BALL_"})}]),a=i(()=>[{id:4,src:"./assets/Volleyball_ball_red_background.png",alt:_({placeholder:"_A_CAROUSEL_COMPONENT_ALT_VOLLEY_BALL_"})}]),{codeHtml:t}=ca(),{codeJs:l}=ua();return{codeHtml:t,codeJs:l,data:e,dataOne:a}}},La={class:"a_columns a_columns_count_12"},Oa={class:"a_column a_column_12_touch a_column_4"},pa=["src","alt"],Ta={class:"a_column a_column_12_touch a_column_4"},ma=["src","alt"];function Ea(e,a,t,l,c,o){const s=u("a-carousel"),d=u("aloha-example");return N(),P(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_"},{default:p(()=>[n("div",La,[n("div",Oa,[O(s,{data:e.data,"aria-label":"_A_CAROUSEL_COMPONENT_BALLS_ARIA_LABEL_","key-id":"id"},{item:p(({item:r})=>[n("img",{class:"a_height_auto a_width_100",src:r.src,alt:r.alt},null,8,pa)]),_:1},8,["data"])]),n("div",Ta,[O(s,{data:e.dataOne,"aria-label":"_A_CAROUSEL_COMPONENT_BALLS_ARIA_LABEL_","key-id":"id"},{item:p(({item:r})=>[n("img",{class:"a_height_auto a_width_100",src:r.src,alt:r.alt},null,8,ma)]),_:1},8,["data"])])])]),_:1},8,["code-html","code-js"])}const Sa=R(Aa,[["render",Ea]]);function ga(){return{codeHtml:`<div class="a_columns a_columns_count_12">
  <div class="a_column a_column_12_touch a_column_6">
    <a-carousel
      :data="data"
      aria-label="Carousel with balls"
