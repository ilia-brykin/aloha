...
};`}}const V={name:"PageTranslationBasic",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=k(),{codeJs:e}=w();return{codeHtml:t,codeJs:e}}};function Y(t,e,r,d,m,T){const n=o("a-translation"),_=o("aloha-example");return A(),i(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_BASIC_USAGE_",props:"text"},{default:s(()=>[a(n,{text:"_A_TRANSLATION_SHOW_MORE_"})]),_:1},8,["code-html","code-js"])}const K=c(V,[["render",Y]]);function z(){return{codeHtml:`<a-translation
...
};`}}const Vt={name:"PageTranslationTextObject",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=kt(),{codeJs:e}=wt();return{codeHtml:t,codeJs:e}}};function Yt(t,e,r,d,m,T){const n=o("a-translation"),_=o("aloha-example");return A(),i(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_TEXT_OBJECT_HEADER_",description:"_A_TRANSLATION_GROUP_TEXT_OBJECT_DESCRIPTION_",props:"text (as object)"},{default:s(()=>[a(n,{text:{mobile:"_A_TRANSLATION_SHOW_MORE_",desktop:"_A_TRANSLATION_SHOW_LESS_"}})]),_:1},8,["code-html","code-js"])}const Kt=c(Vt,[["render",Yt]]);function zt(){return{codeHtml:`<a-translation
  title="_SHOW_MORE_"
