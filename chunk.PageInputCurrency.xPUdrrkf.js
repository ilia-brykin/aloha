import{A as f,a as J}from"./chunk.AlohaExample.B95p2ibG.js";import{A as Y}from"./chunk.AlohaTableProps.BDwC0GEx.js";import{A as q}from"./chunk.AlohaTableTranslate.ClAHSQpR.js";import{a9 as R,_ as s,g as G,A as M}from"./bundle.index.7Gm8ngMZ.js";import{r as m,V as _,aT as i,e as r,W as I,_ as l,Z as P,aU as y,d as E}from"./chunk.vendor.D2EiI1BL.js";import"./chunk.vendor-lodash.Wop2AkRA.js";import"./chunk.APageTabTitle.DRSOBdvA.js";import"./chunk.AlohaHighlightjs.B_1iuPG1.js";import"./chunk.ATable.q3RyArlj.js";import"./chunk.translations-ar.DEWt73y8.js";import"./chunk.translations-de.CN5eAU-4.js";import"./chunk.translations-en.CPCEcTAP.js";import"./chunk.translations-es.BKTK5PUv.js";import"./chunk.translations-fr.CslimZmU.js";import"./chunk.translations-hr.CiJ7_Y2m.js";import"./chunk.translations-it.H45F8miC.js";import"./chunk.translations-ru.o-dOzdYz.js";function j(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="Input"
></a-input-currency>
...
};`}}const F={name:"PageInputCurrencyBasic",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=j(),{codeJs:a}=B();return{codeHtml:n,codeJs:a,model:e}}};function X(e,n,a,u,c,p){const t=r("a-input-currency"),d=r("aloha-example");return I(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:i(()=>[l(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const w=s(F,[["render",X]]);function W(){return{codeHtml:`<a-input-currency
  :change="changeModel"
  :model-value="model"
  label="Input"
></a-input-currency>
...
};`}}const Ce={name:"PageInputCurrencyHelpText",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=fe(),{codeJs:a}=Re();return{codeHtml:n,codeJs:a,model:e}}};function Ee(e,n,a,u,c,p){const t=r("a-input-currency"),d=r("aloha-example");return I(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[l(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"help-text":"Aloha",label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const Ae=s(Ce,[["render",Ee]]);function Ne(){return{codeHtml:`<a-input-currency
  v-model="model"
...
};`}}const Ue={name:"PageInputCurrencyLabelFloat",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=Ne(),{codeJs:a}=Oe();return{codeHtml:n,codeJs:a,model:e}}};function Te(e,n,a,u,c,p){const t=r("a-input-currency"),d=r("aloha-example");return I(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_IS_LABEL_FLOAT_HEADER_",description:"_A_UI_GROUP_IS_LABEL_FLOAT_DESCRIPTION_",props:["is-label-float"]},{default:i(()=>[l(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"is-label-float":!1,label:"Input"},null,8,["modelValue"]),l(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),"is-label-float":!0,label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const ge=s(Ue,[["render",Te]]);function ve(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="Input"
></a-input-currency>
<a-input-currency
...
};`}}const Ge={name:"PageInputCurrencyModelType",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=Ye(),{codeJs:a}=qe();return{codeHtml:n,codeJs:a,model:e}}};function Me(e,n,a,u,c,p){const t=r("a-input-currency"),d=r("aloha-example");return I(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_MODEL_TYPE_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_MODEL_TYPE_DESCRIPTION_",props:["model-type"]},{default:i(()=>[l(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),label:"number","model-type":"number"},null,8,["modelValue"]),l(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),label:"string","model-type":"string"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const je=s(Ge,[["render",Me]]);function Be(){return{codeHtml:`<a-input-currency
  v-model="model"
  help-text="Aloha"
  label="Input"
></a-input-currency>
