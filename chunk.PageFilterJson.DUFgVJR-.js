...
// ${n([NaN,null,1/0,void 0])}`}}const w={name:"PageFilterJsonExample",components:{AlohaExample:m},setup(){const{codeJs:e}=L();return{codeJs:e}}};function C(e,s,l,c,r,_){const o=t("aloha-example");return u(),p(o,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const G=i(w,[["render",C]]);function b(){return{codeJs:`filterJson({ x: 5, y: 6 }, { isHtml: true });
// ${n({x:5,y:6},{isHtml:!0})}
