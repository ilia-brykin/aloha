import{A as _,a as P}from"./chunk.AlohaExample.A9Ef-QbL.js";import{aQ as n,_ as c,A}from"./bundle.index.Dn7qpWjQ.js";import{P as E,a as T,b as v}from"./chunk.PageFilterTest.Dwl2cJEE.js";import{P as F}from"./chunk.PageFilterImportCompositionApi.dDZ0bVyw.js";import{m as t,K as p,J as u,aK as N,P as r}from"./chunk.vendor.DQz1Isc4.js";import"./chunk.vendor-lodash.Cgq9oNCy.js";import"./chunk.vendor-tinymce.cPIiul0H.js";function S(){return{codeJs:`filterJson({ x: 5, y: 6 });
// ${n({x:5,y:6})}
...
`,K={name:"PageFilterJson",components:{AlohaPage:P,ATranslation:A,PageFilterArguments:E,PageFilterImportCompositionApi:F,PageFilterImportFunction:T,PageFilterJsonExample:j,PageFilterJsonReplacer:w,PageFilterJsonSpace:L,PageFilterTest:v},setup(){const{pageTitle:e}=U(),{argumentsText:o}=M();return{argumentsText:o,pageTitle:e,test:z}}};function V(e,o,i,l,s,f){const a=t("a-translation"),m=t("page-filter-import-function"),d=t("page-filter-import-composition-api"),g=t("page-filter-arguments"),J=t("page-filter-json-example"),x=t("page-filter-json-space"),h=t("page-filter-json-replacer"),$=t("page-filter-test"),y=t("aloha-page");return u(),p(y,{"page-title":e.pageTitle},{body:N(()=>[r(a,{tag:"p",html:"_PAGE_FILTER_JSON_DESCRIPTION_"}),r(m,{"function-name":"filterJson","type-import":"filters"}),r(d,{"function-name":"filterJson"}),r(g,{"arguments-text":e.argumentsText,"function-description":"filterJson(value, { [replacer], [space=2] })"},null,8,["arguments-text"]),r(J),r(x),r(h),r($,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const Z=c(K,[["render",V]]);export{Z as default};
