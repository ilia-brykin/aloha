import{A as d,a as x}from"./chunk.AlohaExample.CMUUEVcN.js";import{aP as V,_ as r,A as K}from"./bundle.index.DOWaPX07.js";import{P as A,a as P,b}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as v}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as i,C as s,m as t,L as E,G as a}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function T(){return{codeJs:`filterKeyValue({ x: "aloha", y: 2 });
// ${V({x:"aloha",y:2})}`}}const B={name:"PageFilterKeyValueExample",components:{AlohaExample:d},setup(){const{codeJs:e}=T();return{codeJs:e}}};function j(e,n,o,p,u,c){const l=t("aloha-example");return i(),s(l,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const F=r(B,[["render",j]]);function $(){return{argumentsText:[{value:"value",types:["Object"],text:"_PAGE_FILTER_KEY_VALUE_ARGUMENTS_VALUE_"}]}}function I(){return{pageTitle:"filterKeyValue"}}const C=`import filterKeyValue from "../filterKeyValue";
