...
};`}}const k={name:"PageSwitchErrors",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=Y(),{codeJs:a}=x();return{codeHtml:t,codeJs:a,model:e}}};function Q(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=m(k,[["render",Q]]);function z(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
