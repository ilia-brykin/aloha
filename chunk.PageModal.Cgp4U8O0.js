import{A as M,a as y}from"./chunk.AlohaExample.D19CN2wh.js";import{A as v}from"./chunk.AlohaTableProps.SdA0hIGF.js";import{A as g}from"./chunk.AlohaTableTranslate.C-J83jrW.js";import{b as O,i as E,_ as m,g as H,A as V}from"./bundle.index.Cv6dkyGa.js";import{r as A,m as l,K as r,aK as u,J as c,P as a,aR as b,O as P,a as D}from"./chunk.vendor.DQz1Isc4.js";import"./chunk.vendor-lodash.Cgq9oNCy.js";import"./chunk.ATable.CgCSCDr2.js";import"./chunk.utilsMath.1mfWsA3R.js";import"./chunk.AForm.Bvve0IYh.js";import"./chunk.ADatepicker.D3pbJRZb.js";import"./chunk.UiMixinProps.BvCyZ1Ij.js";import"./chunk.AInputNumber.D7-F2j3f.js";import"./chunk.ATinymce.BUC7EngB.js";import"./chunk.vendor-tinymce.cPIiul0H.js";function $(){return{codeHtml:`<a-button
...
};`}}const k={name:"PageModalBasic",components:{AButton:O,AlohaExample:M,AModal:E},setup(){const{codeHtml:e}=$(),{codeJs:t}=x(),o=A(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function G(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["close","header-text"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha",close:e.closeModal},null,8,["close"])):b("",!0)]),_:1},8,["code-html","code-js"])}const q=m(k,[["render",G]]);function J(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      <li>Aliquam tincidunt mauris eu risus.</li>
      <li>Vestibulum auctor dapibus neque.</li>
    </ul>`,closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function F(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_BODY_HTML_HEADER_",description:"_A_MODAL_GROUP_BODY_HTML_DESCRIPTION_",props:["body-html"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha","body-html":e.bodyHtml,close:e.closeModal},null,8,["body-html","close"])):b("",!0)]),_:1},8,["code-html","code-js"])}const z=m(j,[["render",F]]);function X(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
};`}}const W={name:"PageModalCloseButton",components:{AButton:O,AlohaExample:M,AModal:E},setup(){const{codeHtml:e}=X(),{codeJs:t}=Y(),o=A(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function K(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_CLOSE_BUTTON_HEADER_",description:"_A_MODAL_GROUP_CLOSE_BUTTON_DESCRIPTION_",props:["close-button-attributes","close-button-class","close-button-id","close-button-text"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha",close:e.closeModal,"close-button-attributes":{textTag:"strong"},"close-button-class":"a_btn a_btn_danger","close-button-id":"btn_close","close-button-text":"_A_MODAL_PAGE_BTN_CLOSE_"},null,8,["close"])):b("",!0)]),_:1},8,["code-html","code-js"])}const Z=m(W,[["render",K]]);function w(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      <li>39</li>
      <li>40</li>
    </ul>`,closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function oe(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_FOOTER_STICKY_HEADER_",description:"_A_MODAL_GROUP_FOOTER_STICKY_DESCRIPTION_",props:["is-footer-sticky"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"body-html":e.bodyHtml,close:e.closeModal,"is-footer-sticky":!0,"header-text":"Aloha"},null,8,["body-html","close"])):b("",!0)]),_:1},8,["code-html","code-js"])}const te=m(ee,[["render",oe]]);function le(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
};`}}const ne={name:"PageModalSaveButton",components:{AButton:O,AlohaExample:M,AModal:E},setup(){const{codeHtml:e}=le(),{codeJs:t}=ae(),o=A(void 0),_=()=>{o.value=!0},s=()=>{o.value=!1};return{closeModal:s,codeHtml:e,codeJs:t,isModalVisible:o,openModal:_,saveModal:()=>{console.log("saveModal"),s()}}}};function _e(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_SAVE_BUTTON_HEADER_",description:"_A_MODAL_GROUP_SAVE_BUTTON_DESCRIPTION_",props:["save","save-button-attributes","save-button-class","save-button-id","save-button-text"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha",close:e.closeModal,save:e.saveModal,"save-button-attributes":{textTag:"strong"},"save-button-class":"a_btn a_btn_success","save-button-id":"btn_save"},null,8,["close","save"])):b("",!0)]),_:1},8,["code-html","code-js"])}const se=m(ne,[["render",_e]]);function ie(){return{codeHtml:`<a-button
  id="btn_open_modal"
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
...
};`}}const re={name:"PageModalSelectorClose",components:{AButton:O,AlohaExample:M,AModal:E},setup(){const{codeHtml:e}=ie(),{codeJs:t}=de(),o=A(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function ce(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_SELECTOR_CLOSE_HEADER_",description:"_A_MODAL_GROUP_SELECTOR_CLOSE_DESCRIPTION_",props:["selector-close"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",id:"btn_open_modal",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha",close:e.closeModal,"selector-close":["#btn_aloha","#btn_open_modal"]},null,8,["close"])):b("",!0)]),_:1},8,["code-html","code-js"])}const ue=m(re,[["render",ce]]);function pe(){return{codeHtml:`<a-button
...
};`}}const me={name:"PageModalSelectorCloseIds",components:{AButton:O,AlohaExample:M,AModal:E},setup(){const{codeHtml:e}=pe(),{codeJs:t}=Ae(),o=A(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function Me(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_SELECTOR_CLOSE_IDS_HEADER_",description:"_A_MODAL_GROUP_SELECTOR_CLOSE_IDS_DESCRIPTION_",props:["selector-close-ids"]},{default:u(()=>[a(n,{class:"a_btn a_btn_primary",id:"btn_open_modal_id",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha",close:e.closeModal,"selector-close-ids":["btn_aloha","btn_open_modal_id"]},null,8,["close"])):b("",!0)]),_:1},8,["code-html","code-js"])}const Oe=m(me,[["render",Me]]);function Ee(){return{codeHtml:`<div 
  class="a_btn_group"
  role="group"
>
  <a-button
...
};`}}const fe={name:"PageModalSize",components:{AButton:O,AlohaExample:M,AModal:E},setup(){const{codeHtml:e}=Ee(),{codeJs:t}=be(),o=A(void 0),_=A(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:n=>{_.value=n,o.value=!0},sizeModal:_}}},Pe={class:"a_btn_group",role:"group"};function Se(e,t,o,_,s,p){const n=l("a-button"),i=l("a-modal"),d=l("aloha-example");return c(),r(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_SIZE_HEADER_",description:"_A_MODAL_GROUP_SIZE_DESCRIPTION_",props:["size"]},{default:u(()=>[P("div",Pe,[a(n,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (small)",onClick:t[0]||(t[0]=f=>e.openModal("small"))}),a(n,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (large)",onClick:t[1]||(t[1]=f=>e.openModal("large"))}),a(n,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (xl)",onClick:t[2]||(t[2]=f=>e.openModal("xl"))}),a(n,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (xxl)",onClick:t[3]||(t[3]=f=>e.openModal("xxl"))}),a(n,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (fullscreen)",onClick:t[4]||(t[4]=f=>e.openModal("fullscreen"))})]),e.isModalVisible?(c(),r(i,{key:0,"header-text":"Aloha",close:e.closeModal,size:e.sizeModal},null,8,["close","size"])):b("",!0)]),_:1},8,["code-html","code-js"])}const De=m(fe,[["render",Se]]);function Te(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
