...
};`}}const F={name:"PageOneCheckboxErrors",components:{AlohaExample:E,AOneCheckbox:h},setup(){const e=u(void 0),{codeHtml:o}=K(),{codeJs:t}=w();return{codeHtml:o,codeJs:t,model:e}}};function W(e,o,t,r,s,_){const l=n("a-one-checkbox"),c=n("aloha-example");return f(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:m(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),errors:"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Q=i(F,[["render",W]]);function z(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
...
};`}}const pe={name:"PageOneCheckboxSlotName",components:{AElement:g,AlohaExample:E,AOneCheckbox:h},setup(){const e=u(void 0),{codeHtml:o}=ue(),{codeJs:t}=ie();return{codeHtml:o,codeJs:t,model:e}}};function fe(e,o,t,r,s,_){const l=n("a-element"),c=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_SLOT_NAME_HEADER_",description:"_A_UI_GROUP_SLOT_NAME_DESCRIPTION_",props:["slot-name"]},{default:m(()=>[a(c,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=P=>e.model=P),label:"Aloha","slot-name":"aloha"},{aloha:m(({id:P,labelClass:I,label:b,labelScreenReader:C,required:R,props:S})=>[O("span",{class:v(I)},[O("span",null,A(b),1),a(l,{class:"a_ml_2","is-title-html":!0,"icon-left":"Window",tabindex:"0","text-screen-reader":"Aloha",title:"Aloha",type:"text"})],2)]),_:1},8,["modelValue"])]),_:1},8,["code-html","code-js"])}const he=i(pe,[["render",fe]]);function Ee(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :true-value="1"
  class="a_mt_3"
  label="Aloha"
