import{A,a as D}from"./chunk.AlohaExample.DKBt6BF9.js";import{A as h}from"./chunk.AlohaTableProps.DkJtq6j7.js";import{A as U}from"./chunk.AlohaTableTranslate.BVuHx40h.js";import{h as S,_ as p,g as C,A as b}from"./bundle.index.hzSDncRt.js";import{r as P,k as n,J as c,aO as u,H as i,O as t,N as I,aP as O,a as E}from"./chunk.vendor.CwuJ9Ljq.js";import"./chunk.vendor-lodash.BBRAkY5X.js";import"./chunk.ATable.Cuiv0i4K.js";import"./chunk.translations-ar.CGH9gktb.js";import"./chunk.translations-de.S4PF1KYg.js";import"./chunk.translations-en.Ck05aPwN.js";import"./chunk.translations-es.CN4IYWAw.js";import"./chunk.translations-fr.CCwWtZH3.js";import"./chunk.translations-hr.C7fo1LlO.js";import"./chunk.translations-it.BFH_rAJL.js";import"./chunk.translations-ru.C3zXigta.js";function j(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<div>model:</div>
...
};`}}const x={name:"PageJsonErrors",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=V(),{codeJs:a}=k();return{codeHtml:o,codeJs:a,model:e}}};function F(e,o,a,d,_,m){const s=n("a-json"),r=n("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),errors:"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const X=p(x,[["render",F]]);function w(){return{codeHtml:`<a-json
  v-model="model"
  help-text="Aloha"
  label="JSON"
...
};`}}const Q={name:"PageJsonHelpText",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=w(),{codeJs:a}=z();return{codeHtml:o,codeJs:a,model:e}}};function W(e,o,a,d,_,m){const s=n("a-json"),r=n("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),"help-text":"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=p(Q,[["render",W]]);function K(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<a-json
