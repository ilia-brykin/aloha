import{A as b,a as N}from"./chunk.AlohaExample.DS-HNpL6.js";import{A as R}from"./chunk.AlohaTableProps.CKhZbova.js";import{_ as d,g as B,A as I}from"./bundle.index.CFFwUiWS.js";import{a as O}from"./chunk.ATable.CF9ZcVcl.js";import{k as a,J as p,aO as u,H as l,O as n,a as m}from"./chunk.vendor.QyCKSPD8.js";import"./chunk.vendor-lodash.GuFqEw-8.js";import"./chunk.translations-ar.CGH9gktb.js";import"./chunk.translations-de.S4PF1KYg.js";import"./chunk.translations-en.Ck05aPwN.js";import"./chunk.translations-es.CN4IYWAw.js";import"./chunk.translations-fr.CCwWtZH3.js";import"./chunk.translations-hr.C7fo1LlO.js";import"./chunk.translations-it.BFH_rAJL.js";import"./chunk.translations-ru.C3zXigta.js";function E(){return{codeHtml:`<a-group-button-dropdown
  :actions="actions"
...
};`}}const g={name:"PageGroupButtonDropdownActionsClasses",components:{AGroupButtonDropdown:O,AlohaExample:b},setup(){const{codeHtml:t}=E(),{codeJs:e}=S();return{actions:[{text:"Action 1",type:"button",callback:()=>{}},{text:"Action 2",type:"button",callback:()=>{}},{text:"Action 3",type:"button",callback:()=>{}},{text:"Action 4",type:"button",callback:()=>{}},{text:"Action 5",type:"button",callback:()=>{}},{text:"Action 6",type:"button",callback:()=>{}}],codeHtml:t,codeJs:e}}};function k(t,e,c,s,i,_){const o=a("a-group-button-dropdown"),r=a("aloha-example");return l(),p(r,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_GROUP_BUTTON_DROPDOWN_GROUP_ACTIONS_CLASSES_HEADER_",description:"_A_GROUP_BUTTON_DROPDOWN_GROUP_ACTIONS_CLASSES_DESCRIPTION_",props:["actions-classes"]},{default:u(()=>[n(o,{actions:t.actions,"index-first-dropdown-action":6,"index-first-dropdown-action-mobile":6,"actions-classes":["a_btn a_btn_primary","a_btn a_btn_secondary","a_btn a_btn_info","a_btn a_btn_info","a_btn a_btn_info","a_btn a_btn_info"]},null,8,["actions"]),n(o,{class:"a_mt_3",actions:t.actions,"index-first-dropdown-action":3,"index-first-dropdown-action-mobile":3,"actions-classes":["a_btn a_btn_primary","a_btn a_btn_secondary","a_btn a_btn_secondary","a_btn a_btn_primary"]},null,8,["actions"])]),_:1},8,["code-html","code-js"])}const U=d(g,[["render",k]]);function C(){return{codeHtml:`<a-group-button-dropdown
  :actions="actions"
...
};`}}const z={name:"PageGroupButtonDropdownExtraClasses",components:{AGroupButtonDropdown:O,AlohaExample:b},setup(){const{codeHtml:t}=K(),{codeJs:e}=Y();return{actions:[{text:"Action 1",type:"button",callback:()=>{},classExtra:"test_action1"},{text:"Action 2",type:"button",callback:()=>{},classExtra:"test_action2"},{text:"Action 3",type:"button",callback:()=>{},classExtra:"test_action3"},{text:"Action 4",type:"button",callback:()=>{},classExtra:"test_action4"},{text:"Action 5",type:"button",callback:()=>{},classExtra:"test_action5"},{text:"Action 6",type:"button",callback:()=>{},classExtra:"test_action6"}],codeHtml:t,codeJs:e}}};function Q(t,e,c,s,i,_){const o=a("a-group-button-dropdown"),r=a("aloha-example");return l(),p(r,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_GROUP_BUTTON_DROPDOWN_GROUP_EXTRA_CLASSES_HEADER_",description:"_A_GROUP_BUTTON_DROPDOWN_GROUP_EXTRA_CLASSES_DESCRIPTION_",props:["actions.classExtra"]},{default:u(()=>[n(o,{actions:t.actions,"index-first-dropdown-action":2,"index-first-dropdown-action-mobile":2},null,8,["actions"])]),_:1},8,["code-html","code-js"])}const Z=d(z,[["render",Q]]);function tt(){return{codeHtml:`<a-group-button-dropdown
  :actions="actions"
  :index-first-dropdown-action="1"
  :index-first-dropdown-action-mobile="1"
