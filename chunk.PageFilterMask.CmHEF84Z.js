import{A as d,a as x}from"./chunk.AlohaExample.BLz9gN2Z.js";import{aI as t,_ as l,A}from"./bundle.index.DdISXs5g.js";import{P,a as T,b as $}from"./chunk.PageFilterTest.BPGpw9zC.js";import{P as y}from"./chunk.PageFilterImportCompositionApi.ILIcSKMH.js";import{k as s,J as i,H as c,aJ as B,O as n}from"./chunk.vendor.Ca3-nzbX.js";import"./chunk.vendor-lodash.-viuv_rg.js";function E(){return{codeJs:`filterMask("1234567812345678");
// ${t("1234567812345678")}
...
// ${t("12345678",{chars:10})}`}}const b={name:"PageFilterMaskExample",components:{AlohaExample:d},setup(){const{codeJs:e}=E();return{codeJs:e}}};function v(e,a,o,u,p,m){const r=s("aloha-example");return c(),i(r,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const F=l(b,[["render",v]]);function I(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_MASK_ARGUMENTS_VALUE_"},{value:"[chars=4]",types:["Number"],text:"_PAGE_FILTER_MASK_ARGUMENTS_CHARS_"},{value:'[mask="*"]',types:["String"],text:"_PAGE_FILTER_MASK_ARGUMENTS_MASK_"}]}}function S(){return{pageTitle:"filterMask"}}const R=`import filterMask from "../filterMask";
