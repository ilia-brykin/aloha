import{A as R,a as S}from"./chunk.AlohaExample.BRf15a9v.js";import{A as k}from"./chunk.AlohaTableProps.Bhug38uR.js";import{A as y}from"./chunk.AlohaTableTranslate.DuIANfok.js";import{v as A,_ as c,g as b,A as G}from"./bundle.index.DaWeoMpR.js";import{r as _,W as m,V as u,aT as E,e as t,_ as n,Z as h,aU as K,d as P}from"./chunk.vendor.7qYoMuVo.js";import{u as $}from"./chunk.vendor-lodash.H1qWA996.js";import"./chunk.APageTabTitle.DJ6kSNp2.js";import"./chunk.AlohaHighlightjs.CqftpDCI.js";import"./chunk.ATable.Tz_WJjjm.js";import"./chunk.translations-ar.BVGXYuic.js";import"./chunk.translations-de.BTTkg7IT.js";import"./chunk.translations-en.B1a-0dJo.js";import"./chunk.translations-es.9uV8L16o.js";import"./chunk.translations-fr.b_PTR2hx.js";import"./chunk.translations-hr.BZQfnGWK.js";import"./chunk.translations-it.CbF6AZKa.js";import"./chunk.translations-ru.DaNQBvrb.js";function H(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
</a-datepicker-range>
...
};`}}const v={name:"PageDatepickerRangeBasic",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=H(),{codeJs:a}=L(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}},U={class:"a_mt_3"};function q(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_BASIC_HEADER_",description:"_PAGE_DATEPICKER_RANGE_BASIC_DESCRIPTION_",props:["v-model","label"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),label:"Aloha"},null,8,["modelValue"]),h("div",U,"model: "+K(e.model),1)]),_:1},8,["code-html","code-js"])}const B=c(v,[["render",q]]);function M(){return{codeHtml:`<a-datepicker-range
  v-model="model"
...
};`}}const V={name:"PageDatepickerRangeCustomFirstDay",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=M(),{codeJs:a}=J(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}};function F(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_HEADER_",description:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_DESCRIPTION_",props:["v-model","label","firstDayOfWeek"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),label:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_EXAMPLE_","first-day-of-week":4},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=c(V,[["render",F]]);function j(){return{codeHtml:`<a-datepicker-range
 v-model="model"
  :disabled="true">
</a-datepicker-range>
<a-datepicker-range
...
};`}}const Q={name:"PageDatepickerRangeFormatCustomization",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=w(),{codeJs:a}=Z(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}};function ee(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_HEADER_",description:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_DESCRIPTION_",props:["v-model","format","formatSave"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),format:"DD.MM.YY","format-save":"YY-MM-DD"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ae=c(Q,[["render",ee]]);function te(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
