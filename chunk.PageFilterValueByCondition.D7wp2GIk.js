import{A as T,a as C}from"./chunk.AlohaExample.Di1hQFwd.js";import{P as V,a as $,b as N}from"./chunk.PageFilterTest.Mq29Z2Zn.js";import{P}from"./chunk.PageFilterImportCompositionApi.Csk5TLpT.js";import{aP as t,_ as u,A as x}from"./bundle.index.mluylX0A.js";import{Y as r,W as c,f as n,aU as O,$ as o}from"./chunk.vendor.BEEJbev-.js";import"./chunk.vendor-lodash.CwOx-Q_g.js";import"./chunk.APageTabTitle.BbbhJnhY.js";import"./chunk.AlohaHighlightjs.De6fh8wy.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";const f={conditions:[{if:e=>e>3,then:e=>`(${e*3} Aloha)`},{if:e=>e<2,then:"aloha"}],defaultValue:e=>e/2};function F(){return{codeJs:`const options = {
  conditions: [
    {
      if: value => value > 3,
...
`,X={name:"PageFilterValueByCondition",components:{AlohaPage:C,ATranslation:x,PageFilterArguments:N,PageFilterImportCompositionApi:P,PageFilterImportFunction:$,PageFilterTest:V,PageFilterValueByConditionFunction:S,PageFilterValueByConditionMixed:b,PageFilterValueByConditionStringExpression:j},setup(){const{pageTitle:e}=z(),{argumentsText:a}=k();return{argumentsText:a,pageTitle:e,test:H}}};function w(e,a,l,_,p,d){const i=n("a-translation"),h=n("page-filter-import-function"),v=n("page-filter-import-composition-api"),A=n("page-filter-arguments"),E=n("page-filter-value-by-condition-function"),g=n("page-filter-value-by-condition-string-expression"),I=n("page-filter-value-by-condition-mixed"),y=n("page-filter-test"),B=n("aloha-page");return r(),c(B,{"page-title":e.pageTitle},{body:O(()=>[o(i,{tag:"p",html:"_PAGE_FILTER_VALUE_BY_CONDITION_DESCRIPTION_"}),o(i,{tag:"p",html:"_PAGE_FILTER_VALUE_BY_CONDITION_SECURITY_"}),o(h,{"function-name":"filterValueByCondition","type-import":"filters"}),o(v,{"function-name":"filterValueByCondition"}),o(A,{"arguments-text":e.argumentsText,"function-description":'filterValueByCondition(value, { [conditions=[]], [defaultValue=""], [defaultTemplate] })'},null,8,["arguments-text"]),o(E),o(g),o(I),o(y,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const _e=u(X,[["render",w]]);export{_e as default};
