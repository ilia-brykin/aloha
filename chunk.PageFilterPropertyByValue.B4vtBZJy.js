import{A as m,a as A}from"./chunk.AlohaExample.CjncY9yb.js";import{aF as r,_ as p,A as B}from"./bundle.index.D9gcatRx.js";import{P as E,a as T,b as x}from"./chunk.PageFilterTest.XRvw5J-J.js";import{P as $}from"./chunk.PageFilterImportCompositionApi.Bxn2dkOk.js";import{k as t,J as i,H as s,aJ as R,O as a}from"./chunk.vendor.Ca3-nzbX.js";import"./chunk.vendor-lodash.-viuv_rg.js";function v(){return{codeJs:`filterPropertyByValue("111", { mapping: { aloha: "1", holla: "2" }, defaultValue: "not found" });
// ${r("111",{mapping:{aloha:"1",holla:"2"},defaultValue:"not found"})}
filterPropertyByValue("222", { mapping: { aloha: "1", holla: "2" }, defaultValue: "0" });
// ${r("222",{mapping:{aloha:"1",holla:"2"},defaultValue:"0"})}`}}const F={name:"PageFilterPropertyByValueDefaultValue",components:{AlohaExample:m},setup(){const{codeJs:e}=v();return{codeJs:e}}};function I(e,o,l,u,c,_){const n=t("aloha-example");return s(),i(n,{"code-js":e.codeJs,header:"defaultValue","is-code-visible-default":!0},null,8,["code-js"])}const J=p(F,[["render",I]]);function b(){return{codeJs:`filterPropertyByValue("111", { mapping: { aloha: "1", holla: "2" } });
// ${r("111",{mapping:{aloha:"1",holla:"2"}})}
filterPropertyByValue("aloha", { mapping: { aloha: "1", holla: "2" } });
// ${r("aloha",{mapping:{aloha:"1",holla:"2"}})}`}}const L={name:"PageFilterPropertyByValueMapping",components:{AlohaExample:m},setup(){const{codeJs:e}=b();return{codeJs:e}}};function U(e,o,l,u,c,_){const n=t("aloha-example");return s(),i(n,{"code-js":e.codeJs,header:"mapping","is-code-visible-default":!0},null,8,["code-js"])}const G=p(L,[["render",U]]);function Y(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_PROPERTY_BY_VALUE_ARGUMENTS_VALUE_"},{value:"[mapping={}]",types:["Object"],text:"_PAGE_FILTER_PROPERTY_BY_VALUE_ARGUMENTS_MAPPING_"},{value:'[defaultValue=""]',types:["String"],text:"_PAGE_FILTER_PROPERTY_BY_VALUE_ARGUMENTS_DEFAULT_VALUE_"}]}}function O(){return{pageTitle:"filterPropertyByValue"}}const M=`import filterPropertyByValue from "../filterPropertyByValue";
