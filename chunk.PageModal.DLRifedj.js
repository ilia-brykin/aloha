import{A as O,a as B}from"./chunk.AlohaExample.BRf15a9v.js";import{A as g}from"./chunk.AlohaTableProps.Bhug38uR.js";import{A as H}from"./chunk.AlohaTableTranslate.DuIANfok.js";import{O as b,c as E,_ as M,g as V,A as $}from"./bundle.index.DaWeoMpR.js";import{r as m,W as i,V as c,aT as u,e as l,_ as n,a$ as A,Z as P,d as D}from"./chunk.vendor.7qYoMuVo.js";import"./chunk.vendor-lodash.H1qWA996.js";import"./chunk.APageTabTitle.DJ6kSNp2.js";import"./chunk.AlohaHighlightjs.CqftpDCI.js";import"./chunk.ATable.Tz_WJjjm.js";import"./chunk.translations-ar.BVGXYuic.js";import"./chunk.translations-de.BTTkg7IT.js";import"./chunk.translations-en.B1a-0dJo.js";import"./chunk.translations-es.9uV8L16o.js";import"./chunk.translations-fr.b_PTR2hx.js";import"./chunk.translations-hr.BZQfnGWK.js";import"./chunk.translations-it.CbF6AZKa.js";import"./chunk.translations-ru.DaNQBvrb.js";function x(){return{codeHtml:`<a-button
...
};`}}const G={name:"PageModalBasic",components:{AButton:E,AlohaExample:O,AModal:b},setup(){const{codeHtml:e}=x(),{codeJs:t}=k(),o=m(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function J(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["close","header-text"]},{default:u(()=>[n(a,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(i(),c(d,{key:0,"header-text":"Aloha",close:e.closeModal},null,8,["close"])):A("",!0)]),_:1},8,["code-html","code-js"])}const q=M(G,[["render",J]]);function U(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      <li>Aliquam tincidunt mauris eu risus.</li>
      <li>Vestibulum auctor dapibus neque.</li>
    </ul>`,closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function z(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_BODY_HTML_HEADER_",description:"_A_MODAL_GROUP_BODY_HTML_DESCRIPTION_",props:["body-html"]},{default:u(()=>[n(a,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(i(),c(d,{key:0,"header-text":"Aloha","body-html":e.bodyHtml,close:e.closeModal},null,8,["body-html","close"])):A("",!0)]),_:1},8,["code-html","code-js"])}const X=M(F,[["render",z]]);function Y(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
};`}}const Z={name:"PageModalCloseButton",components:{AButton:E,AlohaExample:O,AModal:b},setup(){const{codeHtml:e}=Y(),{codeJs:t}=W(),o=m(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function K(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_CLOSE_BUTTON_HEADER_",description:"_A_MODAL_GROUP_CLOSE_BUTTON_DESCRIPTION_",props:["close-button-attributes","close-button-class","close-button-id","close-button-text"]},{default:u(()=>[n(a,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(i(),c(d,{key:0,"header-text":"Aloha",close:e.closeModal,"close-button-attributes":{textTag:"strong"},"close-button-class":"a_btn a_btn_danger","close-button-id":"btn_close","close-button-text":"_A_MODAL_PAGE_BTN_CLOSE_"},null,8,["close"])):A("",!0)]),_:1},8,["code-html","code-js"])}const w=M(Z,[["render",K]]);function Q(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      <li>39</li>
      <li>40</li>
    </ul>`,closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function te(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_FOOTER_STICKY_HEADER_",description:"_A_MODAL_GROUP_FOOTER_STICKY_DESCRIPTION_",props:["is-footer-sticky"]},{default:u(()=>[n(a,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(i(),c(d,{key:0,"body-html":e.bodyHtml,close:e.closeModal,"is-footer-sticky":!0,"header-text":"Aloha"},null,8,["body-html","close"])):A("",!0)]),_:1},8,["code-html","code-js"])}const le=M(oe,[["render",te]]);function ae(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
};`}}const se={name:"PageModalInModal",components:{AButton:E,AlohaExample:O,AModal:b},setup(){const{codeHtml:e}=ae(),{codeJs:t}=ne(),o=m(void 0),s=m(void 0);return{closeModal:()=>{o.value=!1},closeModal2:()=>{s.value=!1},codeHtml:e,codeJs:t,isModal2Visible:s,isModalVisible:o,openModal:()=>{o.value=!0},openModal2:()=>{s.value=!0}}}};function _e(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_IN_MODAL_HEADER_",description:"_A_MODAL_GROUP_IN_MODAL_DESCRIPTION_"},{default:u(()=>[n(a,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(i(),c(d,{key:0,close:e.closeModal,"header-text":"Modal 1",size:"xl"},{modalBody:u(()=>[n(a,{class:"a_btn a_btn_primary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal2},null,8,["onClick"])]),_:1},8,["close"])):A("",!0),e.isModal2Visible?(i(),c(d,{key:1,close:e.closeModal2,"header-text":"Modal 2"},null,8,["close"])):A("",!0)]),_:1},8,["code-html","code-js"])}const de=M(se,[["render",_e]]);function ie(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
...
};`}}const Me={name:"PageModalSelectorClose",components:{AButton:E,AlohaExample:O,AModal:b},setup(){const{codeHtml:e}=me(),{codeJs:t}=Ae(),o=m(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:()=>{o.value=!0}}}};function Oe(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_SELECTOR_CLOSE_HEADER_",description:"_A_MODAL_GROUP_SELECTOR_CLOSE_DESCRIPTION_",props:["selector-close"]},{default:u(()=>[n(a,{class:"a_btn a_btn_primary",id:"btn_open_modal",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_",onClick:e.openModal},null,8,["onClick"]),e.isModalVisible?(i(),c(d,{key:0,"header-text":"Aloha",close:e.closeModal,"selector-close":["#btn_aloha","#btn_open_modal"]},null,8,["close"])):A("",!0)]),_:1},8,["code-html","code-js"])}const be=M(Me,[["render",Oe]]);function Ee(){return{codeHtml:`<a-button
...
};`}}const Re={name:"PageModalSize",components:{AButton:E,AlohaExample:O,AModal:b},setup(){const{codeHtml:e}=Te(),{codeJs:t}=Le(),o=m(void 0),s=m(void 0);return{closeModal:()=>{o.value=!1},codeHtml:e,codeJs:t,isModalVisible:o,openModal:a=>{s.value=a,o.value=!0},sizeModal:s}}},Ie={class:"a_btn_group",role:"group"};function Ne(e,t,o,s,_,p){const a=l("a-button"),d=l("a-modal"),r=l("aloha-example");return i(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_MODAL_GROUP_SIZE_HEADER_",description:"_A_MODAL_GROUP_SIZE_DESCRIPTION_",props:["size"]},{default:u(()=>[P("div",Ie,[n(a,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (small)",onClick:t[0]||(t[0]=f=>e.openModal("small"))}),n(a,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (large)",onClick:t[1]||(t[1]=f=>e.openModal("large"))}),n(a,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (xl)",onClick:t[2]||(t[2]=f=>e.openModal("xl"))}),n(a,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (xxl)",onClick:t[3]||(t[3]=f=>e.openModal("xxl"))}),n(a,{class:"a_btn a_btn_outline_secondary",text:"_A_MODAL_PAGE_BTN_OPEN_MODAL_","text-after":" (fullscreen)",onClick:t[4]||(t[4]=f=>e.openModal("fullscreen"))})]),e.isModalVisible?(i(),c(d,{key:0,"header-text":"Aloha",close:e.closeModal,size:e.sizeModal},null,8,["close","size"])):A("",!0)]),_:1},8,["code-html","code-js"])}const Ce=M(Re,[["render",Ne]]);function ye(){return{codeHtml:`<a-button
  class="a_btn a_btn_primary"
  text="_A_MODAL_PAGE_BTN_OPEN_MODAL_"
  @click="openModal"
></a-button>
