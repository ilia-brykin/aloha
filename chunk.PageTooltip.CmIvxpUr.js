...
};`}}const gt={name:"PageTooltipHideArrow",components:{AlohaExample:f,ATooltip:T},setup(){const{codeHtml:t}=Ot(),{codeJs:a}=St();return{codeHtml:t,codeJs:a}}},It=o("span",null,"Aloha",-1),At=o("div",null,"Aloha",-1);function ht(t,a,_,c,r,p){const i=n("a-tooltip"),l=n("aloha-example");return m(),u(l,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TOOLTIP_GROUP_HIDE_ARROW_HEADER_",description:"_A_TOOLTIP_GROUP_HIDE_ARROW_DESCRIPTION_",props:"show-arrow"},{default:e(()=>[s(i,{class:"a_btn a_btn_primary",tag:"button","show-arrow":!1},{title:e(()=>[At]),default:e(()=>[It]),_:1})]),_:1},8,["code-html","code-js"])}const Et=d(gt,[["render",ht]]);function Rt(){return{codeHtml:`<a-tooltip
  class="a_btn a_btn_primary"
  tag="button"
  :offset-skidding="30"
>
