...
};`}}const pe={name:"PageOneCheckboxSlotName",components:{AElement:U,AlohaExample:h,AOneCheckbox:E},setup(){const e=u(void 0),{codeHtml:o}=ue(),{codeJs:t}=ie();return{codeHtml:o,codeJs:t,model:e}}};function fe(e,o,t,r,s,_){const l=n("a-element"),c=n("a-one-checkbox"),d=n("aloha-example");return f(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_SLOT_NAME_HEADER_",description:"_A_UI_GROUP_SLOT_NAME_DESCRIPTION_",props:["slot-name"]},{default:m(()=>[a(c,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=P=>e.model=P),label:"Aloha","slot-name":"aloha"},{aloha:m(({id:P,labelClass:I,label:b,labelScreenReader:C,required:R,props:S})=>[O("span",{class:$(I)},[O("span",null,A(b),1),a(l,{class:"a_ml_2","is-title-html":!0,"icon-left":"Window",tabindex:"0","text-screen-reader":"Aloha",title:"Aloha",type:"string"})],2)]),_:1},8,["modelValue"])]),_:1},8,["code-html","code-js"])}const he=i(pe,[["render",fe]]);function Ee(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :true-value="1"
  class="a_mt_3"
  label="Aloha"
