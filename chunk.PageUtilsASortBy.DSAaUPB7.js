import{A as B,a as h}from"./chunk.AlohaExample.DrXl1UQv.js";import{P as b,a as A,b as v}from"./chunk.PageFilterTest.B_brwOwC.js";import{G as t,_ as m,A as x}from"./bundle.index.BbTO4tZu.js";import{Y as p,W as d,f as s,aU as E,$ as r}from"./chunk.vendor.BEEJbev-.js";import"./chunk.vendor-lodash.CwOx-Q_g.js";import"./chunk.APageTabTitle.CFnrzrto.js";import"./chunk.AlohaHighlightjs.De6fh8wy.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";const N=[{name:"beta"},{name:"Alpha"},{name:"gamma"}],U=[{name:"alex",score:5},{name:"Alex",score:3},{name:"alex",score:2},{name:"alex",score:7}],q=[{profile:{lastName:"Davis"},status:"active"},{profile:{lastName:"anders"},status:"inactive"},{profile:{lastName:"Anders"},status:"active"}],l=[{code:"abC"},{code:"abc"},{code:"Abd"}];function T(){const n=t(N,"name").map(e=>e.name),a=t(U,["name",e=>e.score]).map(e=>`${e.name}:${e.score}`),o=t(q,["profile.lastName",{status:"active"}]).map(e=>`${e.profile.lastName}:${e.status}`),i=t(l,"code").map(e=>e.code),u=t(l,"code",{caseSensitive:!0}).map(e=>e.code);return{codeJs:`const users = [
  { name: "beta" },
  { name: "Alpha" },
  { name: "gamma" },
];
