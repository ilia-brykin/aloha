import{A as P,a as C}from"./chunk.AlohaExample.BZeZthkV.js";import{A as H}from"./chunk.AlohaTableProps.BP-QrYCJ.js";import{A as w}from"./chunk.AlohaTableTranslate.CSBHe8xv.js";import{K as f,_ as m,g as L,A as J}from"./bundle.index.BhEeXSAb.js";import{r as _,Z as c,Y as i,aV as I,f as t,a0 as a,$ as E,aW as S,d as R}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import"./chunk.APageTabTitle.C6WQ6Ehw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.ATable.TDP6pXBu.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function V(){return{codeHtml:`<a-input
  v-model="model"
  label="Input"
></a-input>
...
};`}}const K={name:"PageInputErrorIcon",components:{AInput:f,AlohaExample:P},setup(){const e=_("Aloha"),o='<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.93 6.588 8.758 10.042a.5.5 0 0 1-.998 0L7.588 6.588a.5.5 0 1 1 .998 0M8 5.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5m0 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/></svg>',{codeHtml:n}=X(),{codeJs:s}=k();return{codeHtml:n,codeJs:s,errorIcon:o,model:e}}};function Q(e,o,n,s,p,u){const l=t("a-input"),r=t("aloha-example");return c(),i(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERROR_ICON_HEADER_",description:"_A_UI_GROUP_ERROR_ICON_DESCRIPTION_",props:["errors","error-icon"]},{default:I(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),"error-icon":e.errorIcon,errors:"Aloha",label:"Input"},null,8,["modelValue","error-icon"])]),_:1},8,["code-html","code-js"])}const Z=m(K,[["render",Q]]);function z(){return{codeHtml:`<a-input
  v-model="model"
  errors="Aloha"
  label="Input"
