import{_ as p,X as h,g as B,A as V}from"./bundle.index.DCnxV7cB.js";import{t as E,a as f,h as v,O as g,aR as c,b as o,Q as u,V as e,r as $,U as S,aS as A}from"./chunk.vendor.CjhiT8UL.js";import{m as j,c as L}from"./chunk.vendor-lodash.DyQEPI1B.js";import{A as d,a as q}from"./chunk.AlohaExample.BvKd8PsJ.js";import{A as M}from"./chunk.AlohaTableProps.DnUdqH3Y.js";import{W as F,V as X}from"./chunk.WidthAPI.BmZryvkE.js";import"./chunk.translations-ar.CL71O9SG.js";import"./chunk.translations-de.DIN2Jpxb.js";import"./chunk.translations-en.CI9kEZeh.js";import"./chunk.translations-es.BBJvdG2l.js";import"./chunk.translations-fr.C2AjtHKq.js";import"./chunk.translations-hr.CkUFQqdC.js";import"./chunk.translations-it.CvHGMPAq.js";import"./chunk.translations-ru.B99zmNGE.js";import"./chunk.APageTabTitle.C3nV7Rnf.js";import"./chunk.AlohaHighlightjs.rF1jvLhM.js";import"./chunk.ATable.BFN21kL2.js";function k(s,{widthPercent:a=f(()=>0)}){const _=E(s,"classProgressBar");return{classProgressBarLocal:f(()=>j(_.value)?_.value(a.value):_.value)}}function W(s){const a=E(s,"duration");return{durationLocal:f(()=>{if(!L(a.value))return`${a.value}s`})}}const i={name:"AProgress",props:{classProgressBar:{type:[String,Object,Function],required:!1,default:void 0},duration:{type:Number,required:!1,default:void 0},indeterminate:{type:Boolean,required:!1,default:!1},max:{type:Number,required:!1,default:100},min:{type:Number,required:!1,default:0},reverse:{type:Boolean,required:!1,default:!1},showValue:{type:Boolean,required:!1,default:!0},striped:{type:Boolean,required:!1,default:!1},stripedFlow:{type:Boolean,required:!1,default:!1},value:{type:Number,required:!1,default:0},valueTextInteger:{type:Boolean,required:!1,default:!1}},setup(s){const{widthPercent:a}=F(s),{valuePercent:_}=X(s,{widthPercent:a}),{classProgressBarLocal:n}=k(s,{widthPercent:a}),{durationLocal:l}=W(s);return{classProgressBarLocal:n,durationLocal:l,valuePercent:_,widthPercent:a}},render(){let s;return this.$slots.progressText?s=v("span",{class:"a_progress__text"},[this.$slots.progressText&&this.$slots.progressText({valuePercent:this.valuePercent})]):this.showValue&&(s=v("span",{class:"a_progress__text"},this.valuePercent)),v("div",{class:["a_progress",{a_progress_reverse:this.reverse}]},[v("div",{class:["a_progress__bar",{a_progress__bar_striped:this.striped,a_progress__bar_striped_flow:this.stripedFlow,a_progress__bar_indeterminate:this.indeterminate},this.classProgressBarLocal],role:"progressbar","aria-valuenow":this.value,"aria-valuemin":this.min,"aria-valuemax":this.max,style:{width:`${this.widthPercent}%`,"animation-duration":this.durationLocal}},[s])])}};function z(){return{codeHtml:`<a-progress
  :value="50"
></a-progress>`}}function Z(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const Q={name:"PageProgressBasic",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=z(),{codeJs:a}=Z();return{codeHtml:s,codeJs:a}}};function K(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_BASIC_USAGE_",props:"value"},{default:c(()=>[e(r,{value:50})]),_:1},8,["code-html","code-js"])}const Y=p(Q,[["render",K]]);function ss(){return{codeHtml:`<a-progress
  class="a_bg_primary"
  :value="30"
...
></a-progress>`}}function es(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
<a-progress
  ...
  :value="50"
  class-progress-bar="a_bg_black"
></a-progress>`}}function _s(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
<a-progress
  ...
  :duration="8"
  :show-value="false"
></a-progress>`}}function Ps(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
<a-progress
  ...
  :indeterminate="true"
  :show-value="false"
></a-progress>`}}function Ss(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const As={name:"PageProgressIndeterminate",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Rs(),{codeJs:a}=Ss();return{codeHtml:s,codeJs:a}}};function hs(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_INDETERMINATE_HEADER_",description:"_A_PROGRESS_GROUP_INDETERMINATE_DESCRIPTION_",props:"indeterminate"},{default:c(()=>[e(r,{value:20,"class-progress-bar":"a_bg_primary",indeterminate:!0,"show-value":!1}),e(r,{class:"a_mt_4",value:30,"class-progress-bar":"a_bg_secondary",indeterminate:!0,"show-value":!1}),e(r,{class:"a_mt_4",value:40,"class-progress-bar":"a_bg_tertiary",indeterminate:!0,"show-value":!1}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_success",indeterminate:!0,"show-value":!1}),e(r,{class:"a_mt_4",value:60,"class-progress-bar":"a_bg_warning",indeterminate:!0,"show-value":!1}),e(r,{class:"a_mt_4",value:70,"class-progress-bar":"a_bg_info",indeterminate:!0,"show-value":!1}),e(r,{class:"a_mt_4",value:80,"class-progress-bar":"a_bg_danger",indeterminate:!0,"show-value":!1})]),_:1},8,["code-html","code-js"])}const Es=p(As,[["render",hs]]);function $s(){return{codeHtml:`<a-progress
  :value="-20"
  :min="-100"
  :max="0"
></a-progress>
...
<a-progress
  ...
  :max="-100"
  :value="-130"
></a-progress>`}}function Os(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
<a-progress
  ...
  :value="40"
  :reverse="true"
></a-progress>`}}function Ts(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const ws={name:"PageProgressReverse",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Gs(),{codeJs:a}=Ts();return{codeHtml:s,codeJs:a}}};function xs(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_REVERSE_HEADER_",description:"_A_PROGRESS_GROUP_REVERSE_DESCRIPTION_",props:"reverse"},{default:c(()=>[e(r,{value:20,reverse:!0}),e(r,{class:"a_mt_4",value:40,reverse:!0})]),_:1},8,["code-html","code-js"])}const Js=p(ws,[["render",xs]]);function Ns(){return{codeHtml:`<a-progress
...
<a-progress
  ...
  :value="20"
></a-progress>`}}function Cs(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const Ds={name:"PageProgressShowValue",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Ns(),{codeJs:a}=Cs();return{codeHtml:s,codeJs:a}}};function Us(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SHOW_VALUE_HEADER_",description:"_A_PROGRESS_GROUP_SHOW_VALUE_DESCRIPTION_",props:"show-value"},{default:c(()=>[e(r,{value:20,"show-value":!1}),e(r,{class:"a_mt_4",value:40,"show-value":!0})]),_:1},8,["code-html","code-js"])}const Bs=p(Ds,[["render",Us]]);function Vs(){return{codeHtml:`<a-progress
  class="a_progress_small"
  :value="20"
></a-progress>
<a-progress
...
<a-progress
  class="a_mt_4 a_progress_large"
  :value="20"
></a-progress>`}}function js(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const Ls={name:"PageProgressSizes",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Vs(),{codeJs:a}=js();return{codeHtml:s,codeJs:a}}};function qs(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SIZES_HEADER_",description:"_A_PROGRESS_GROUP_SIZES_DESCRIPTION_",props:"class"},{default:c(()=>[e(r,{class:"a_progress_small",value:20}),e(r,{class:"a_mt_4 a_progress_medium",value:20}),e(r,{class:"a_mt_4 a_progress_large",value:20})]),_:1},8,["code-html","code-js"])}const Ms=p(Ls,[["render",qs]]);function Fs(){return{codeHtml:`<a-progress
  :value="20"
>
  <template
...
</a-progress>`}}function Xs(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const ks={name:"PageProgressSlotText",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Fs(),{codeJs:a}=Xs();return{codeHtml:s,codeJs:a}}};function Ws(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_HEADER_",description:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_DESCRIPTION_",slots:"progressText"},{default:c(()=>[e(r,{value:20},{progressText:c(({valuePercent:P})=>[S("span",null,"Aloha "+A(P),1)]),_:1}),e(r,{class:"a_mt_4",value:40},{progressText:c(({valuePercent:P})=>[S("span",null,"$$$ "+A(P),1)]),_:1})]),_:1},8,["code-html","code-js"])}const zs=p(ks,[["render",Ws]]);function Zs(){return{codeHtml:`<a-progress
  :value="50"
  class-progress-bar="a_bg_primary"
  :striped="true"
></a-progress>
...
<a-progress
  ...
  class-progress-bar="a_bg_danger"
  :striped="true"
></a-progress>`}}function Qs(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const Ks={name:"PageProgressStriped",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Zs(),{codeJs:a}=Qs();return{codeHtml:s,codeJs:a}}};function Ys(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_STRIPED_HEADER_",description:"_A_PROGRESS_GROUP_STRIPED_DESCRIPTION_",props:"striped"},{default:c(()=>[e(r,{value:50,"class-progress-bar":"a_bg_primary",striped:!0}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_secondary",striped:!0}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_tertiary",striped:!0}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_success",striped:!0}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_warning",striped:!0}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_info",striped:!0}),e(r,{class:"a_mt_4",value:50,"class-progress-bar":"a_bg_danger",striped:!0})]),_:1},8,["code-html","code-js"])}const se=p(Ks,[["render",Ys]]);function ee(){return{codeHtml:`<a-progress
  :value="20"
  class-progress-bar="a_bg_primary"
  :striped="true"
  :striped-flow="true"
...
<a-progress
  ...
  :striped="true"
  :striped-flow="true"
></a-progress>`}}function re(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
...
};`}}const le={name:"PageProgressValue",components:{AInputNumber:h,AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=_e(),{codeJs:a}=ne(),_=$(20);return{codeHtml:s,codeJs:a,model:_}}};function ce(s,a,_,n,l,m){const r=o("a-input-number"),t=o("a-progress"),P=o("aloha-example");return u(),g(P,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_VALUE_HEADER_",description:"_A_PROGRESS_GROUP_VALUE_DESCRIPTION_",props:"value"},{default:c(()=>[e(r,{class:"a_mb_4",modelValue:s.model,"onUpdate:modelValue":a[0]||(a[0]=b=>s.model=b),min:0,max:100,step:5,type:"integerNonNegative"},null,8,["modelValue"]),e(t,{value:s.model},null,8,["value"])]),_:1},8,["code-html","code-js"])}const pe=p(le,[["render",ce]]);function ge(){return{codeHtml:`<a-progress
  :value="20"
...
<a-progress
  ...
  :value="40"
  :value-text-integer="true"
></a-progress>`}}function ue(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
