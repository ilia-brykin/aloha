...
></a-disclosure>`}}function ae(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
></a-disclosure>`}}function _e(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
></a-disclosure>`}}function De(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
};`}}const Ie={name:"PageDisclosureBtnTexts",components:{AlohaExample:f,ADisclosure:v},setup(){const{codeHtml:e}=Se(),{codeJs:t}=De();return{codeHtml:e,codeJs:t,textLess:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus.",textMore:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},Re={class:"a_columns a_columns_count_12"},Ae={class:"a_column a_column_4 a_column_12_tablet"};function Me(e,t,n,o,r,c){const u=s("a-disclosure"),l=s("aloha-example");return g(),b(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_BTN_TITLE_HEADER_",description:"_A_DISCLOSURE_GROUP_BTN_TITLE_DESCRIPTION_",props:["btn-title-less","btn-title-more"]},{default:m(()=>[i("div",Re,[i("div",Ae,[a(u,{"text-less":e.textLess,"text-more":e.textMore,"btn-title-less":"_A_DISCLOSURE_GROUP_TITLE_LESS_","btn-title-more":"_A_DISCLOSURE_GROUP_TITLE_MORE_"},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const Ce=_(Te,[["render",Me]]);function Ne(){return{codeHtml:`<a-disclosure
  :text-less="textLess"
  :text-more="textMore"
  btn-title-less="_A_DISCLOSURE_GROUP_TITLE_LESS_"
  btn-title-more="_A_DISCLOSURE_GROUP_TITLE_MORE_"
...
<a-disclosure
  ...
  :is-btn-title-html="true"
></a-disclosure>`}}function $e(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},Ue={class:"a_columns a_columns_count_12"},Be={class:"a_column a_column_4 a_column_12_tablet"};function je(e,t,n,o,r,c){const u=s("a-disclosure"),l=s("aloha-example");return g(),b(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_BTN_TITLE_HTML_HEADER_",description:"_A_DISCLOSURE_GROUP_BTN_TITLE_HTML_DESCRIPTION_",props:["btn-title-less","btn-title-more","is-btn-title-html"]},{default:m(()=>[i("div",Ue,[i("div",Be,[a(u,{"text-less":e.textLess,"text-more":e.textMore,"btn-title-less":"_A_DISCLOSURE_GROUP_TITLE_LESS_","btn-title-more":"_A_DISCLOSURE_GROUP_TITLE_MORE_","is-btn-title-html":!0},null,8,["text-less","text-more"]),a(u,{class:"a_mt_2","text-less":e.textLess,"text-more":e.textMore,"btn-title-less":"<strong>Aloha</strong>","btn-title-more":"<strong>Aloha</strong>","is-btn-title-html":!0},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const ye=_(He,[["render",je]]);function Je(){return{codeHtml:`<a-disclosure
  ...
  :text-more="textMore"
  :disabled="true"
></a-disclosure>`}}function Qe(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.</p>`}}},dt={class:"a_columns a_columns_count_12"},pt={class:"a_column a_column_4 a_column_12_tablet"};function _t(e,t,n,o,r,c){const u=s("a-disclosure"),l=s("aloha-example");return g(),b(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_HTML_HEADER_",description:"_A_DISCLOSURE_GROUP_HTML_DESCRIPTION_",props:["html-less","html-more"]},{default:m(()=>[i("div",dt,[i("div",pt,[a(u,{"html-less":e.htmlLess,"html-more":e.htmlMore},null,8,["html-less","html-more"])])])]),_:1},8,["code-html","code-js"])}const bt=_(mt,[["render",_t]]);function gt(){return{codeHtml:`<a-disclosure
  ...
  :text-more="textMore"
  :show-less="false"
></a-disclosure>`}}function ht(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},vt={class:"a_columns a_columns_count_12"},St={class:"a_column a_column_4 a_column_12_tablet"};function Dt(e,t,n,o,r,c){const u=s("a-disclosure"),l=s("aloha-example");return g(),b(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_NOT_LESS_HEADER_",description:"_A_DISCLOSURE_GROUP_NOT_LESS_DESCRIPTION_",props:"show-less"},{default:m(()=>[i("div",vt,[i("div",St,[a(u,{"text-less":e.textLess,"text-more":e.textMore,"show-less":!1},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const It=_(ft,[["render",Dt]]);function Lt(){return{codeHtml:`<a-disclosure
  :text-less="textLess"
  :text-more="textMore"
  :is-open-default="true"
></a-disclosure>`}}function xt(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
};`}}const qt={name:"PageDisclosureOpenDefault",components:{AlohaExample:f,ADisclosure:v},setup(){const{codeHtml:e}=Lt(),{codeJs:t}=xt();return{codeHtml:e,codeJs:t,textLess:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus.",textMore:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
></a-disclosure>`}}function At(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
...
};`}}const Mt={name:"PageDisclosureSafeHtml",components:{AlohaExample:f,ADisclosure:v},setup(){const{codeHtml:e}=Rt(),{codeJs:t}=At();return{codeHtml:e,codeJs:t,htmlLess:`<p onclick="alert('Aloha')">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna.</p>`,htmlMore:`<p onclick="alert('Aloha')">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
...
</a-disclosure>`}}function Bt(){return{codeJs:`import ADisclosure from "aloha-vue/src/ADisclosure/ADisclosure";
