...
};`}}const W={name:"PageRateModelValue",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=U(),{codeJs:t}=G(),n=x(3);return{codeHtml:e,codeJs:t,handleModelValueChange:d=>{n.value=d},modelValue:n}}};function Y(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"ModelValue",description:"_A_RATE_DESCRIPTION_MODEL_VALUE_",props:"model-value"},{default:R(()=>[r(a,{text:"ARate","model-value":e.modelValue,onUpdate:e.handleModelValueChange},null,8,["model-value","onUpdate"])]),_:1},8,["code-html","code-js"])}const Z=p(W,[["render",Y]]);function K(){return{codeHtml:`<a-rate 
  :model-value="2.4"
  :readonly="true"
  text="2.4 readonly">
...
};`}}const ee={name:"PageRateReadonly",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=K(),{codeJs:t}=Q();return{codeHtml:e,codeJs:t}}};function te(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Readonly",description:"_A_RATE_DESCRIPTION_READONLY_",props:"readonly"},{default:R(()=>[r(a,{"model-value":2.4,readonly:!0,text:"2.4 readonly"})]),_:1},8,["code-html","code-js"])}const oe=p(ee,[["render",te]]);function ae(){return{codeHtml:`<a-rate 
  :half-icon="true">
...
};`}}const re={name:"PageRateHalfIcon",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=ae(),{codeJs:t}=ne();return{codeHtml:e,codeJs:t}}};function ce(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Select half Icon",description:"_A_RATE_DESCRIPTION_HALF_ICON_",props:"half-icon"},{default:R(()=>[r(a,{"half-icon":!0})]),_:1},8,["code-html","code-js"])}const le=p(re,[["render",ce]]);function se(){return{codeHtml:`<a-rate 
  size="small"
  text="small">
</a-rate>
<a-rate 
...
};`}}const ie={name:"PageRateSize",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=se(),{codeJs:t}=de();return{codeHtml:e,codeJs:t}}},ue=L("br",null,null,-1),_e=L("br",null,null,-1);function me(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Sizes",description:"_A_RATE_DESCRIPTION_SIZE_",props:"size"},{default:R(()=>[r(a,{size:"small",text:"small"}),ue,r(a,{size:"medium",text:"medium"}),_e,r(a,{size:"big",text:"big"})]),_:1},8,["code-html","code-js"])}const pe=p(ie,[["render",me]]);function fe(){return{codeHtml:`<a-rate 
  color="gray"
  text="gray">
...
};`}}const Re={name:"PageRateColor",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=fe(),{codeJs:t}=he();return{codeHtml:e,codeJs:t}}};function Ae(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Color",description:"_A_RATE_DESCRIPTION_COLOR_",props:"color"},{default:R(()=>[r(a,{color:"gray",text:"gray"})]),_:1},8,["code-html","code-js"])}const ge=p(Re,[["render",Ae]]);function Ie(){return{codeHtml:`<a-rate 
  hovered-color="red"
  text="red">
...
};`}}const $e={name:"PageRateHoveredColor",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=Ie(),{codeJs:t}=ve();return{codeHtml:e,codeJs:t}}};function Pe(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"HoveredColor",description:"_A_RATE_DESCRIPTION_HOVERED_COLOR_",props:"hovered-color"},{default:R(()=>[r(a,{"hovered-color":"red",text:"red"})]),_:1},8,["code-html","code-js"])}const Ee=p($e,[["render",Pe]]);function Se(){return{codeHtml:`<a-rate 
  :rating="7">
</a-rate>`}}function He(){return{codeJs:`import ARate from "aloha-vue/src/ARate/ARate";
...
};`}}const Ce={name:"PageRateRating",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=Se(),{codeJs:t}=He();return{codeHtml:e,codeJs:t}}};function ye(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Rating",description:"_A_RATE_DESCRIPTION_RATING_",props:"rating"},{default:R(()=>[r(a,{rating:7})]),_:1},8,["code-html","code-js"])}const Te=p(Ce,[["render",ye]]);function xe(){return{codeHtml:`<a-rate
 icon="ChatSquareText">
</a-rate>
<br />
<a-rate
...
};`}}const Le={name:"PageRateIconFill",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=Me(),{codeJs:t}=Ve();return{codeHtml:e,codeJs:t}}};function we(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"IconFill",description:"_A_RATE_DESCRIPTION_ICON_FILL_",props:"icon-fill"},{default:R(()=>[r(a,{"icon-fill":"Star"})]),_:1},8,["code-html","code-js"])}const je=p(Le,[["render",we]]);function ze(){return{codeHtml:`<a-rate
 :show-score="true">
...
};`}}const ke={name:"PageRateShowScore",components:{ARate:g,AlohaExample:A},setup(){const{codeHtml:e}=ze(),{codeJs:t}=Fe();return{codeHtml:e,codeJs:t}}};function qe(e,t,n,s,d,i){const a=o("a-rate"),c=o("aloha-example");return f(),h(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"ShowScore",description:"_A_RATE_DESCRIPTION_SHOW_SCORE_",props:"show-score"},{default:R(()=>[r(a,{"show-score":!0})]),_:1},8,["code-html","code-js"])}const Be=p(ke,[["render",qe]]);function Xe(){return{codeHtml:`<a-rate 
  text="text and extra">
