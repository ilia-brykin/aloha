...
};`}}const J={name:"PageSwitchBasic",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=y(),{codeJs:a}=B();return{codeHtml:t,codeJs:a,model:e}}};function V(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return m(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s)},null,8,["modelValue"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(J,[["render",V]]);function F(){return{codeHtml:`<a-switch
  :change="changeModel"
  :model-value="model"
></a-switch>
...
};`}}const k={name:"PageSwitchErrors",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=x(),{codeJs:a}=X();return{codeHtml:t,codeJs:a,model:e}}};function Q(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return m(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=i(k,[["render",Q]]);function z(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
...
};`}}const Z={name:"PageSwitchHelpText",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=z(),{codeJs:a}=K();return{codeHtml:t,codeJs:a,model:e}}};function ee(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return m(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"help-text":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=i(Z,[["render",ee]]);function oe(){return{codeHtml:`<a-switch
  v-model="model"
  label="ASwitch"
></a-switch>
<a-switch
...
};`}}const le={name:"PageSwitchLabelScreenReader",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=oe(),{codeJs:a}=ae();return{codeHtml:t,codeJs:a,model:e}}};function ne(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return m(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_SCREEN_READER_HEADER_",description:"_A_UI_GROUP_LABEL_SCREEN_READER_DESCRIPTION_",props:["label-screen-reader"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),label:"ASwitch"},null,8,["modelValue"]),l(n,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":t[1]||(t[1]=s=>e.model=s),"label-screen-reader":"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const se=i(le,[["render",ne]]);function re(){return{codeHtml:`<a-switch
  v-model="model"
  :default-value="null"
  :is-three-state="true"
...
};`}}const pe={name:"PageSwitchTitle",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(0),{codeHtml:t}=me(),{codeJs:a}=ue();return{codeHtml:t,codeJs:a,model:e}}};function Se(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return m(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_SWITCH_GROUP_TITLE_HEADER_",description:"_A_SWITCH_GROUP_TITLE_DESCRIPTION_",props:["title","is-title-html"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"is-title-html":!0,title:"Aloha"},null,8,["modelValue"]),l(n,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":t[1]||(t[1]=s=>e.model=s),"is-title-html":!1,title:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const he=i(pe,[["render",Se]]);function fe(){return{codeHtml:`<a-switch
  v-model="model"
  false-label="0"
  true-label="1"
></a-switch>`}}function Ae(){return{codeJs:`import {
...
};`}}const Pe={name:"PageSwitchTrueFalseLabel",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=fe(),{codeJs:a}=Ae();return{codeHtml:t,codeJs:a,model:e}}};function Ee(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return m(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_SWITCH_GROUP_TRUE_FALSE_LABEL_HEADER_",description:"_A_SWITCH_GROUP_TRUE_FALSE_LABEL_DESCRIPTION_",props:["false-label","true-label"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"false-label":"0","true-label":"1"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Ie=i(Pe,[["render",Ee]]);function Te(){return{codeHtml:`<a-switch
  v-model="model"
  :false-value="0"
  :true-value="1"
></a-switch>
