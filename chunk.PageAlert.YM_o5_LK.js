import{A as d,a as D}from"./chunk.AlohaExample.CKKfR-ns.js";import{A as x}from"./chunk.AlohaTableProps.VNeTpe-0.js";import{u as A,_,c as v,g as J,A as w}from"./bundle.index.YfyqosMS.js";import{V as c,aT as u,e as o,W as m,_ as t,r as P,Z as h,a_ as q,d as E}from"./chunk.vendor.DOXCeh_m.js";import"./chunk.vendor-lodash.xKfd5mqF.js";import"./chunk.APageTabTitle.BNJ4kiO5.js";import"./chunk.AlohaHighlightjs.DItoDPrl.js";import"./chunk.ATable.CiRu0ByV.js";import"./chunk.translations-ar.BojwqMl_.js";import"./chunk.translations-de.Cs8AX5zd.js";import"./chunk.translations-en.B6SbFZD7.js";import"./chunk.translations-es.Bq5-ThmB.js";import"./chunk.translations-fr.CNUiPhMd.js";import"./chunk.translations-hr.BHL5VI6-.js";import"./chunk.translations-it.CT6ME8Ab.js";import"./chunk.translations-ru.-V16kngL.js";function B(){return{codeHtml:`<a-alert>
  html="AAlert"
  :is-visible="true"
...
};`}}const ne={name:"PageAlertExposes",components:{AAlert:A,AButton:v,AlohaExample:d},setup(){const{codeHtml:e}=ae(),{codeJs:l}=re(),a=P(void 0);return{alertRef:a,closeAlert:()=>{a.value.close()},codeHtml:e,codeJs:l,showAlert:()=>{a.value.isHidden=!1}}}},ie={class:"a_btn_group"};function ce(e,l,a,n,i,p){const s=o("a-button"),r=o("a-alert"),b=o("aloha-example");return m(),c(b,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_EXPOSES_HEADER_",exposes:["close","isHidden"]},{default:u(()=>[h("div",ie,[t(s,{class:"a_btn a_btn_outline_primary",text:"_A_ALERT_GROUP_EXPOSES_BTN_CLOSE_",onClick:e.closeAlert},null,8,["onClick"]),t(s,{class:"a_btn a_btn_outline_primary",text:"_A_ALERT_GROUP_EXPOSES_BTN_SHOW_",onClick:e.showAlert},null,8,["onClick"])]),t(r,{ref:"alertRef","alert-class":"a_mt_3",html:"Alert success","is-visible":!0,type:"success",closable:!0,"remove-alert-on-close":!0},null,512)]),_:1},8,["code-html","code-js"])}const ue=_(ne,[["render",ce]]);function me(){return{codeHtml:`<a-alert 
  :html="html"
  :is-visible="true"
  type="primary"
>
...
};`}}const fe={name:"PageAlertIconsCustom",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=he(),{codeJs:l}=be();return{codeHtml:e,codeJs:l}}};function Ee(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return m(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_ICONS_CUSTOM_HEADER_",description:"_A_ALERT_GROUP_ICONS_CUSTOM_DESCRIPTION_",props:["icon","show-icon"]},{default:u(()=>[t(s,{html:"Alert success","is-visible":!0,type:"success","show-icon":!0,icon:"Boxes"}),t(s,{html:"Alert info","is-visible":!0,type:"info","show-icon":!0,icon:"EyeFill"}),t(s,{html:"Alert warning","is-visible":!0,type:"warning","show-icon":!0,icon:"EyeSlash"}),t(s,{html:"Alert danger","is-visible":!0,type:"danger","show-icon":!0,icon:"House"}),t(s,{html:"Alert primary","is-visible":!0,type:"primary","show-icon":!0,icon:"Bell"})]),_:1},8,["code-html","code-js"])}const ve=_(fe,[["render",Ee]]);function Pe(){return{codeHtml:`<a-alert 
  html="Alert success" 
  :is-visible="true" 
  type="success"
  :show-icon="true"
