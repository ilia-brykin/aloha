...
};`}}const V={name:"PageSwitchBasic",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=J(),{codeJs:a}=B();return{codeHtml:t,codeJs:a,model:e}}};function q(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s)},null,8,["modelValue"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const j=m(V,[["render",q]]);function W(){return{codeHtml:`<a-switch
  :change="changeModel"
  :model-value="model"
></a-switch>
...
};`}}const G={name:"PageSwitchChange",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),t=({model:_,id:c,props:n})=>{e.value=_,console.log(c,n)},{codeHtml:a}=W(),{codeJs:r}=F();return{changeModel:t,codeHtml:a,codeJs:r,model:e}}};function M(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:p(()=>[l(n,{change:e.changeModel,"model-value":e.model},null,8,["change","model-value"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const X=m(G,[["render",M]]);function Y(){return{codeHtml:`<a-switch
  v-model="model"
  errors="Aloha"
  label="ASwitch"
...
};`}}const k={name:"PageSwitchErrors",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=Y(),{codeJs:a}=x();return{codeHtml:t,codeJs:a,model:e}}};function Q(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const z=m(k,[["render",Q]]);function K(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
...
};`}}const ee={name:"PageSwitchHelpText",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),{codeHtml:t}=K(),{codeJs:a}=Z();return{codeHtml:t,codeJs:a,model:e}}};function te(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:p(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"help-text":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const oe=m(ee,[["render",te]]);function ae(){return{codeHtml:`<a-switch
  v-model="model"
  label="ASwitch"
></a-switch>
<a-switch
...
};`}}const ce={name:"PageSwitchReadonly",components:{AlohaExample:h,ASwitch:S},setup(){const e=i(!1),t=i(!0),a=i(void 0),{codeHtml:r}=re(),{codeJs:_}=_e();return{codeHtml:r,codeJs:_,model1:e,model2:t,model3:a}}};function ie(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return f(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","default-label"]},{default:p(()=>[l(n,{"model-value":e.model1,readonly:!0,label:"Switch 1"},null,8,["model-value"]),l(n,{class:"a_mt_3","model-value":e.model2,readonly:!0,label:"Switch 2"},null,8,["model-value"]),l(n,{class:"a_mt_3","model-value":e.model3,readonly:!0,label:"Switch 3"},null,8,["model-value"]),l(n,{class:"a_mt_3","model-value":e.model3,readonly:!0,"default-label":"default",label:"Switch 4"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const me=m(ce,[["render",ie]]);function ue(){return{codeHtml:`<a-switch
  v-model="model"
  :default-value="null"
  :is-three-state="true"
  default-label="Default"
