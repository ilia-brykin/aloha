import{A as d,a as B}from"./chunk.AlohaExample.D0ymkjgW.js";import{A as V}from"./chunk.AlohaTableProps.DWn8jOwu.js";import{_ as p,X as h,g as j,A as L}from"./bundle.index.CPxkKzC9.js";import{t as E,d as f,h as v,R as g,aR as c,e as o,U as u,Y as e,r as $,W as S,aS as A}from"./chunk.vendor.CDkHfsNc.js";import{m as q,h as M}from"./chunk.vendor-lodash.OlSEBnWT.js";import{W as F,V as X}from"./chunk.WidthAPI.RdjZLDk5.js";import"./chunk.APageTabTitle.BDXgwlHH.js";import"./chunk.AlohaHighlightjs.DI9-5vSP.js";import"./chunk.ATable.DuduJ03h.js";import"./chunk.translations-ar.DqQSf4Wb.js";import"./chunk.translations-de.CcH3uB05.js";import"./chunk.translations-en.yTECDdGB.js";import"./chunk.translations-es.CYtDSsXm.js";import"./chunk.translations-fr.BAhEupf5.js";import"./chunk.translations-hr.Dvyl72TP.js";import"./chunk.translations-it.D2YwB_KV.js";import"./chunk.translations-ru.CCP2K-G_.js";function W(s,{widthPercent:a=f(()=>0)}){const _=E(s,"classProgressBar");return{classProgressBarLocal:f(()=>q(_.value)?_.value(a.value):_.value)}}function k(s){const a=E(s,"duration");return{durationLocal:f(()=>{if(!M(a.value))return`${a.value}s`})}}const i={name:"AProgress",props:{classProgressBar:{type:[String,Object,Function],required:!1,default:void 0},duration:{type:Number,required:!1,default:void 0},indeterminate:{type:Boolean,required:!1,default:!1},max:{type:Number,required:!1,default:100},min:{type:Number,required:!1,default:0},reverse:{type:Boolean,required:!1,default:!1},showValue:{type:Boolean,required:!1,default:!0},striped:{type:Boolean,required:!1,default:!1},stripedFlow:{type:Boolean,required:!1,default:!1},value:{type:Number,required:!1,default:0},valueTextInteger:{type:Boolean,required:!1,default:!1}},setup(s){const{widthPercent:a}=F(s),{valuePercent:_}=X(s,{widthPercent:a}),{classProgressBarLocal:n}=W(s,{widthPercent:a}),{durationLocal:l}=k(s);return{classProgressBarLocal:n,durationLocal:l,valuePercent:_,widthPercent:a}},render(){let s;return this.$slots.progressText?s=v("span",{class:"a_progress__text"},[this.$slots.progressText&&this.$slots.progressText({valuePercent:this.valuePercent})]):this.showValue&&(s=v("span",{class:"a_progress__text"},this.valuePercent)),v("div",{class:["a_progress",{a_progress_reverse:this.reverse}]},[v("div",{class:["a_progress__bar",{a_progress__bar_striped:this.striped,a_progress__bar_striped_flow:this.stripedFlow,a_progress__bar_indeterminate:this.indeterminate},this.classProgressBarLocal],role:"progressbar","aria-valuenow":this.value,"aria-valuemin":this.min,"aria-valuemax":this.max,style:{width:`${this.widthPercent}%`,"animation-duration":this.durationLocal}},[s])])}};function z(){return{codeHtml:`<a-progress
  :value="50"
...
};`}}const Ws={name:"PageProgressSlotText",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Fs(),{codeJs:a}=Xs();return{codeHtml:s,codeJs:a}}};function ks(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_HEADER_",description:"_A_PROGRESS_GROUP_SLOT_PROGRESS_TEXT_DESCRIPTION_",slots:"progressText"},{default:c(()=>[e(r,{value:20},{progressText:c(({valuePercent:P})=>[S("span",null,"Aloha "+A(P),1)]),_:1}),e(r,{class:"a_mt_4",value:40},{progressText:c(({valuePercent:P})=>[S("span",null,"$$$ "+A(P),1)]),_:1})]),_:1},8,["code-html","code-js"])}const zs=p(Ws,[["render",ks]]);function Zs(){return{codeHtml:`<a-progress
  :value="50"
  class-progress-bar="a_bg_primary"
  :striped="true"
></a-progress>
...
<a-progress
  ...
  class-progress-bar="a_bg_danger"
  :striped="true"
></a-progress>`}}function Ys(){return{codeJs:`import { 
  AProgress,
} from "aloha-vue";
