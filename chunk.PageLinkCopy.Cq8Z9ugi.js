...
};`}}const z={name:"PageLinkCopyButtonPosition",components:{ALinkCopy:h,AlohaExample:m},setup(){const{codeHtml:t}=X(),{codeJs:o}=V();return{codeHtml:t,codeJs:o}}};function Q(t,o,c,i,l,_){const e=n("a-link-copy"),a=n("aloha-example");return u(),d(a,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_COPY_GROUP_BUTTON_POSITION_HEADER_",description:"_A_LINK_COPY_GROUP_BUTTON_POSITION_DESCRIPTION_",props:"button-position"},{default:p(()=>[s(e,{"button-position":"left","link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"}}),s(e,{class:"a_ml_2","button-position":"right","link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"}})]),_:1},8,["code-html","code-js"])}const W=r(z,[["render",Q]]);function Z(){return{codeHtml:`<a-link-copy
...
};`}}const yt={name:"PageLinkCopyLinkOptions",components:{ALinkCopy:h,AlohaExample:m},setup(){const{codeHtml:t}=mt(),{codeJs:o}=ht();return{codeHtml:t,codeJs:o}}};function bt(t,o,c,i,l,_){const e=n("a-link-copy"),a=n("aloha-example");return u(),d(a,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_COPY_GROUP_LINK_OPTIONS_HEADER_",description:"_A_LINK_COPY_GROUP_LINK_OPTIONS_DESCRIPTION_",props:"link-options"},{default:p(()=>[s(e,{"link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"}})]),_:1},8,["code-html","code-js"])}const kt=r(yt,[["render",bt]]);function ft(){return{codeHtml:`<a-link-copy
...
};`}}const xt={name:"PageLinkCopyTextCopy",components:{ALinkCopy:h,AlohaExample:m},setup(){const{codeHtml:t}=$t(),{codeJs:o}=St();return{codeHtml:t,codeJs:o}}};function Rt(t,o,c,i,l,_){const e=n("a-link-copy"),a=n("aloha-example");return u(),d(a,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_COPY_GROUP_TEXT_COPY_HEADER_",description:"_A_LINK_COPY_GROUP_TEXT_COPY_DESCRIPTION_",props:"text-copy"},{default:p(()=>[s(e,{"link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"},"text-copy":"github"}),s(e,{class:"a_ml_2","link-options":{class:"a_btn a_btn_secondary",text:"https://github.com/",href:"https://github.com/"},"text-copy":"Aloha"})]),_:1},8,["code-html","code-js"])}const Et=r(xt,[["render",Rt]]);function Ht(){const t=k(()=>J({placeholder:"_A_LINK_COPY_COMPONENT_NAME_"}));return{pageTitle:k(()=>`ALinkCopy${t.value?` (${t.value})`:""}`)}}function Dt(){return{dataProps:[{name:"button-options",description:"_A_LINK_COPY_PROPS_BUTTON_OPTIONS_",type:"Object",default:"() => ({})",required:!1},{name:"button-position",description:"_A_LINK_COPY_PROPS_BUTTON_POSITION_DESCRIPTION_",type:"String",default:"right",required:!1},{name:"class",description:"_A_LINK_COPY_PROPS_CLASS_DESCRIPTION_",type:"String / Object",default:void 0,required:!1},{name:"class-default",description:"_A_LINK_COPY_PROPS_CLASS_DEFAULT_DESCRIPTION_",type:"String",default:"a_btn_group",required:!1},{name:"disabled",description:"_A_LINK_COPY_PROPS_DISABLED_DESCRIPTION_",type:"Boolean",default:void 0,required:!1},{name:"link-options",description:"_A_LINK_COPY_PROPS_LINK_OPTIONS_DESCRIPTION_",type:"Object",default:"() => ({})",required:!1},{name:"textCopy",description:"_A_LINK_COPY_PROPS_TEXT_COPY_DESCRIPTION_",type:"String",default:void 0,required:!1}]}}function Jt(){return{dataSlots:[{name:"button",description:"_A_LINK_COPY_SLOT_BUTTON_DESCRIPTION_"},{name:"link",description:"_A_LINK_COPY_SLOT_LINK_DESCRIPTION_"}]}}function Kt(){return{dataTranslate:["_A_LINK_COPY_BTN_TITLE_","_A_LINK_COPY_COPIED_TO_CLIPBOARD_"]}}const Yt={name:"PageLinkCopy",components:{AlohaPage:S,AlohaTableProps:x,AlohaTableTranslate:R,ATranslation:K,PageLinkCopyButtonOptions:M,PageLinkCopyButtonPosition:W,PageLinkCopyClass:et,PageLinkCopyClassDefault:it,PageLinkCopyDisabled:ut,PageLinkCopyLinkOptions:kt,PageLinkCopySlotButton:Lt,PageLinkCopySlotLink:Nt,PageLinkCopyTextCopy:Et},setup(){const{pageTitle:t}=Ht(),{dataProps:o}=Dt(),{dataSlots:c}=Jt(),{dataTranslate:i}=Kt();return{dataProps:o,dataSlots:c,dataTranslate:i,pageTitle:t}}};function Bt(t,o,c,i,l,_){const e=n("a-translation"),a=n("page-link-copy-link-options"),P=n("page-link-copy-class"),C=n("page-link-copy-class-default"),g=n("page-link-copy-disabled"),L=n("page-link-copy-text-copy"),O=n("page-link-copy-button-options"),A=n("page-link-copy-button-position"),I=n("page-link-copy-slot-link"),T=n("page-link-copy-slot-button"),b=n("aloha-table-props"),N=n("aloha-table-translate"),$=n("aloha-page");return u(),d($,{"page-title":t.pageTitle},{body:p(()=>[s(e,{tag:"p",html:"_A_LINK_COPY_COMPONENT_DESCRIPTION_"}),s(a),s(P),s(C),s(g),s(L),s(O),s(A),s(I),s(T),s(b,{data:t.dataProps},null,8,["data"]),s(b,{"table-label":"Slots",data:t.dataSlots,columns:["name","description"]},null,8,["data"]),s(N,{data:t.dataTranslate},null,8,["data"])]),_:1},8,["page-title"])}const to=r(Yt,[["render",Bt]]);export{to as default};
