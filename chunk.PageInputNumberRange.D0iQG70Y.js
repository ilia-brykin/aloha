import{A as h,a as S}from"./chunk.AlohaExample.euE9897d.js";import{A as O}from"./chunk.AlohaTableProps.CsXDiqMM.js";import{A as y}from"./chunk.AlohaTableTranslate.CxdCOql4.js";import{ak as R,_ as c,g as $,A as L}from"./bundle.index.BPv8TCIb.js";import{r as p,U as i,aS as A,e as o,V as g,Y as r,Z as t,aT as I,d as E}from"./chunk.vendor.B8i9Zb03.js";import"./chunk.vendor-lodash.QssoVJm1.js";import"./chunk.APageTabTitle.Oi5nFreQ.js";import"./chunk.AlohaHighlightjs.DOgKZA3M.js";import"./chunk.ATable.x4flbXwq.js";import"./chunk.translations-ar.DEWt73y8.js";import"./chunk.translations-de.F_OeclwJ.js";import"./chunk.translations-en.CPCEcTAP.js";import"./chunk.translations-es.BKTK5PUv.js";import"./chunk.translations-fr.CslimZmU.js";import"./chunk.translations-hr.CiJ7_Y2m.js";import"./chunk.translations-it.H45F8miC.js";import"./chunk.translations-ru.o-dOzdYz.js";function C(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
...
};`}}const x={name:"PageInputNumberRangePlaceholder",components:{AlohaExample:h,AInputNumberRange:R},setup(){const{codeHtml:e}=M(),{codeJs:n}=j(),a=p(void 0);return{codeHtml:e,codeJs:n,model:a}}},q={class:"a_columns a_columns_count_12"},Y={class:"a_column a_column_6 a_columns_count_12_touch"},X={class:"a_mt_3"};function k(e,n,a,u,m,s){const l=o("a-input-number-range"),_=o("aloha-example");return g(),i(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_PLACEHOLDER_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_PLACEHOLDER_DESCRIPTION_",props:["placeholder-max","placeholder-min"]},{default:A(()=>[r("div",q,[r("div",Y,[t(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=d=>e.model=d),label:"Aloha","placeholder-max":"Max","placeholder-min":"Min",type:"integerRange"},null,8,["modelValue"]),r("div",X,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const F=c(x,[["render",k]]);function w(){return{codeHtml:`<a-input-number-range
  :model-value="model1"
  :readonly="true"
  label="Input 1"
></a-input-number-range>
