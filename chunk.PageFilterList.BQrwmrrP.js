import{A as L,a as P}from"./chunk.AlohaExample.BT0L4sPf.js";import{aq as s,_ as o,A as M}from"./bundle.index.CgpAdSdY.js";import{P as k,a as J,b as H}from"./chunk.PageFilterTest.DueiWPai.js";import{P as C}from"./chunk.PageFilterImportCompositionApi.5-X5CRoG.js";import{m as l,C as c,B as p,L as F,G as i}from"./chunk.vendor.D-Y3mz6a.js";import"./chunk.vendor-lodash.ClBXVCWL.js";import"./chunk.vendor-tinymce.2RT9eEW9.js";function R(){return{codeJs:`const ITEMS = ["label 1", "label 2", "label 3"];
...
`,xe={name:"PageFilterList",components:{AlohaPage:P,ATranslation:M,PageFilterArguments:k,PageFilterImportCompositionApi:C,PageFilterImportFunction:J,PageFilterListIsHtml:j,PageFilterListIsSimpleArray:K,PageFilterListIsSimpleArrayTree:O,PageFilterListKeyChildren:W,PageFilterListKeyLabel:le,PageFilterListKeyLabelCallback:se,PageFilterListListClass:ce,PageFilterListSeparator:Le,PageFilterListSeparatorHtml:fe,PageFilterListTag:Te,PageFilterTest:H},setup(){const{pageTitle:e}=Ie(),{argumentsText:t}=Ae();return{argumentsText:t,pageTitle:e,test:he}}};function Ee(e,t,r,n,_,u){const a=l("a-translation"),b=l("page-filter-import-function"),m=l("page-filter-import-composition-api"),d=l("page-filter-arguments"),f=l("page-filter-list-is-simple-array"),S=l("page-filter-list-key-label"),v=l("page-filter-list-key-label-callback"),y=l("page-filter-list-is-html"),T=l("page-filter-list-separator"),A=l("page-filter-list-separator-html"),I=l("page-filter-list-tag"),h=l("page-filter-list-list-class"),x=l("page-filter-list-key-children"),E=l("page-filter-list-is-simple-array-tree"),g=l("page-filter-test"),$=l("aloha-page");return p(),c($,{"page-title":e.pageTitle},{body:F(()=>[i(a,{tag:"p",html:"_PAGE_FILTER_LIST_DESCRIPTION_"}),i(b,{"function-name":"filterList","type-import":"filters"}),i(m,{"function-name":"filterList"}),i(d,{"arguments-text":e.argumentsText,"function-description":'filterList(array, { [defaultValue=""], [isHtml=true], [isSimpleArray=false], [keyChildren=""], [keyLabel=""], [keyLabelCallback], [lastSeparator], [listClass=""], [separator], [separatorHtml=", "], [tag="ul"] })'},null,8,["arguments-text"]),i(f),i(S),i(v),i(y),i(T),i(A),i(I),i(h),i(x),i(E),i(g,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const Ce=o(xe,[["render",Ee]]);export{Ce as default};
