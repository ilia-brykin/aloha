import{A as f,a as y}from"./chunk.AlohaExample.C5zbBUyN.js";import{A as J}from"./chunk.AlohaTableProps.atc6uoyO.js";import{A as Q}from"./chunk.AlohaTableTranslate.CV1jYay2.js";import{s as G,A as C,C as w,_ as p,c as V,g as k}from"./bundle.index.2fjrVuJ_.js";import{t as d,r as x,d as S,M as N,h as O,Y as _,W as b,aU as m,f as s,_ as i,$ as a,z as W,aV as A}from"./chunk.vendor.CWr53wb5.js";import{u as X}from"./chunk.vendor-lodash.CWoM99Se.js";import"./chunk.APageTabTitle.ByCz-RvO.js";import"./chunk.AlohaHighlightjs.Cyb5M4zM.js";import"./chunk.ATable.DXx5WSOV.js";import"./chunk.translations-ar.CG00cKrz.js";import"./chunk.translations-de.jRMdBWJu.js";import"./chunk.translations-en.Ccpp2c3W.js";import"./chunk.translations-es.Bh9mDab1.js";import"./chunk.translations-fr.B3yhrsaC.js";import"./chunk.translations-hr.B5_cxohh.js";import"./chunk.translations-it.DDcVOPnN.js";import"./chunk.translations-ru.BxzwpxMH.js";function F(e,{isOpen:t=x(!1)}){const o=d(e,"btnIconLeftLess"),n=d(e,"btnIconLeftMore"),l=d(e,"btnIconRightLess"),c=d(e,"btnIconRightMore"),u=d(e,"btnTextLess"),r=d(e,"btnTextMore"),g=d(e,"btnTitleLess"),h=d(e,"btnTitleMore"),I=d(e,"showLess"),L=d(e,"showMore"),q=x(void 0),E=S(()=>t.value?u.value:r.value),P=S(()=>t.value?g.value:h.value),D=S(()=>t.value?o.value:n.value),T=S(()=>t.value?l.value:c.value),M=S(()=>t.value?I.value:L.value);return{btnIconLeft:D,btnIconRight:T,btnText:E,btnTitle:P,buttonRef:q,isButtonVisible:M}}function Y(e){const t=d(e,"isOpenDefault"),o=x(void 0);return{initIsOpen:()=>{o.value=t.value},isOpen:o}}function z(e,{isOpen:t=x(!1)}){const o=d(e,"htmlLess"),n=d(e,"htmlMore"),l=d(e,"safeHtmlLess"),c=d(e,"safeHtmlMore"),u=d(e,"textLess"),r=d(e,"textMore"),g=S(()=>t.value?n.value:o.value),h=S(()=>t.value?c.value:l.value),I=S(()=>t.value?r.value:u.value),L=S(()=>!!(I.value||h.value||g.value));return{htmlLocal:g,isTextOrHtmlVisible:L,safeHtmlLocal:h,textLocal:I}}function K(e,{emit:t},{isOpen:o=x(!1)}){const n=x(void 0);return{containerRef:n,toggleButton:()=>{o.value=!o.value,t("toggle",{isOpen:o.value}),o.value&&!window.isScrollDisabled&&N().then(()=>G({element:n.value}))}}}const v={name:"ADisclosure",inheritAttrs:!0,props:{alwaysTranslate:{type:Boolean,required:!1},btnAttributes:{type:Object,required:!1,default:()=>({})},btnClass:{type:[String,Object],required:!1,default:"a_btn a_btn_link a_p_0"},btnIconLeftLess:{type:String,required:!1,default:void 0},btnIconLeftMore:{type:String,required:!1,default:void 0},btnIconRightLess:{type:String,required:!1,default:void 0},btnIconRightMore:{type:String,required:!1,default:void 0},btnId:{type:String,required:!1,default:void 0},btnParentClass:{type:String,required:!1,default:"a_text_center"},btnTextLess:{type:String,required:!1,default:"_A_DISCLOSURE_LESS_"},btnTextMore:{type:String,required:!1,default:"_A_DISCLOSURE_MORE_"},btnTitleLess:{type:String,required:!1,default:void 0},btnTitleMore:{type:String,required:!1,default:void 0},btnTitlePlacement:{type:String,required:!1,default:void 0},disabled:{type:Boolean,required:!1,default:!1},htmlLess:{type:String,required:!1,default:void 0},htmlMore:{type:String,required:!1,default:void 0},id:{type:String,required:!1,default:()=>X("a_disclosure_")},isBtnTitleHtml:{type:Boolean,required:!1},isOpenDefault:{type:Boolean,required:!1,default:!1},safeHtmlLess:{type:String,required:!1,default:void 0},safeHtmlMore:{type:String,required:!1,default:void 0},showLess:{type:Boolean,required:!1,default:!0},showMore:{type:Boolean,required:!1,default:!0},textLess:{type:String,required:!1,default:void 0},textMore:{type:String,required:!1,default:void 0}},emits:["toggle"],setup(e,t){const{expose:o}=t,{initIsOpen:n,isOpen:l}=Y(e),{htmlLocal:c,isTextOrHtmlVisible:u,safeHtmlLocal:r,textLocal:g}=z(e,{isOpen:l}),{containerRef:h,toggleButton:I}=K(e,t,{isOpen:l}),{btnIconLeft:L,btnIconRight:q,btnText:E,btnTitle:P,buttonRef:D,isButtonVisible:T}=F(e,{isOpen:l});return n(),o({buttonRef:D,containerRef:h,isOpen:l,toggleButton:I}),{btnIconLeft:L,btnIconRight:q,btnText:E,btnTitle:P,buttonRef:D,containerRef:h,htmlLocal:c,isButtonVisible:T,isOpen:l,isTextOrHtmlVisible:u,safeHtmlLocal:r,textLocal:g,toggleButton:I}},render(){return O("div",{class:["a_show_more",{a_show_more_open:this.isOpen}]},[O("div",{class:"a_show_more__wrapper"},[O("div",{ref:"containerRef",id:this.id,ariaExpanded:this.isOpen,...this.$attrs},[this.isTextOrHtmlVisible&&O(C,{alwaysTranslate:this.alwaysTranslate,html:this.htmlLocal,safeHtml:this.safeHtmlLocal,tag:"div",text:this.textLocal}),this.isOpen?this.$slots.more&&this.$slots.more({isButtonVisible:this.isButtonVisible,isOpen:this.isOpen}):this.$slots.less&&this.$slots.less({isButtonVisible:this.isButtonVisible,isOpen:this.isOpen})])]),this.isButtonVisible&&O("div",{class:this.btnParentClass},[O(w,{ref:"buttonRef",id:this.btnId,alwaysTranslate:this.alwaysTranslate,"aria-controls":this.id,class:["a_show_more__button",this.btnClass],disabled:this.disabled,iconLeft:this.btnIconLeft,iconRight:this.btnIconRight,isTitleHtml:this.isBtnTitleHtml,text:this.btnText,title:this.btnTitle,titlePlacement:this.btnTitlePlacement,type:"button",...this.btnAttributes,onClick:this.toggleButton},()=>this.$slots.button&&this.$slots.button({isButtonVisible:this.isButtonVisible,isOpen:this.isOpen}))])])}};function Z(){return{codeHtml:`<a-disclosure
  :text-less="textLess"
  :text-more="textMore"
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},re={class:"a_columns a_columns_count_12"},ce={class:"a_column a_column_4 a_column_12_tablet"};function me(e,t,o,n,l,c){const u=s("a-disclosure"),r=s("aloha-example");return _(),b(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_BTN_CLASS_HEADER_",description:"_A_DISCLOSURE_GROUP_BTN_CLASS_DESCRIPTION_",props:["btn-class","btn-parent-class"]},{default:m(()=>[i("div",re,[i("div",ce,[a(u,{"text-less":e.textLess,"text-more":e.textMore,"btn-class":"a_btn a_btn_primary","btn-parent-class":"a_text_left"},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const de=p(le,[["render",me]]);function pe(){return{codeHtml:`<a-disclosure
  :text-less="textLess"
  :text-more="textMore"
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},xe={class:"a_columns a_columns_count_12"},De={class:"a_column a_column_4 a_column_12_tablet"};function Oe(e,t,o,n,l,c){const u=s("a-disclosure"),r=s("aloha-example");return _(),b(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_BTN_TEXTS_HEADER_",description:"_A_DISCLOSURE_GROUP_BTN_TEXTS_DESCRIPTION_",props:["btn-text-less","btn-text-more"]},{default:m(()=>[i("div",xe,[i("div",De,[a(u,{"text-less":e.textLess,"text-more":e.textMore,"btn-text-less":"Show less aloha","btn-text-more":"Show more aloha"},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const qe=p(Le,[["render",Oe]]);function Ee(){return{codeHtml:`<a-disclosure
  :text-less="textLess"
  :text-more="textMore"
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},we={class:"a_columns a_columns_count_12"},Ve={class:"a_column a_column_4 a_column_12_tablet"};function ke(e,t,o,n,l,c){const u=s("a-disclosure"),r=s("aloha-example");return _(),b(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_DISABLED_HEADER_",description:"_A_DISCLOSURE_GROUP_DISABLED_DESCRIPTION_",props:"disabled"},{default:m(()=>[i("div",we,[i("div",Ve,[a(u,{"text-less":e.textLess,"text-more":e.textMore,disabled:!0},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const We=p(Ge,[["render",ke]]);function Xe(){return{codeHtml:`<a-disclosure
  :text-less="textLess"
  :text-more="textMore"
  @toggle="onToggle"
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},ze={class:"a_columns a_columns_count_12"},Ke={class:"a_column a_column_4 a_column_12_tablet"};function Ze(e,t,o,n,l,c){const u=s("a-disclosure"),r=s("aloha-example");return _(),b(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_EVENTS_HEADER_",description:"_A_DISCLOSURE_GROUP_EVENTS_DESCRIPTION_",emits:"toggle"},{default:m(()=>[i("div",ze,[i("div",Ke,[a(u,{"text-less":e.textLess,"text-more":e.textMore,onToggle:e.onToggle},null,8,["text-less","text-more","onToggle"])])])]),_:1},8,["code-html","code-js"])}const et=p(Ye,[["render",Ze]]);function tt(){return{codeHtml:`<div
  class="a_btn_group"
>
  <a-button
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`,l=x(void 0),c=()=>{l.value.isOpen=!l.value.isOpen},u=()=>{l.value.toggleButton()};return W(()=>{l.value.containerRef.setAttribute("class","a_bg_gray_200"),N().then(()=>{l.value.buttonRef.$el.setAttribute("class","a_btn a_btn_primary")})}),{codeHtml:e,codeJs:t,disclosureRef:l,textLess:o,textMore:n,toggleShowWithIsOpen:c,toggleShowWithToggleButton:u}}},ot={class:"a_columns a_columns_count_12"},nt={class:"a_column a_column_4 a_column_12_tablet"},ut={class:"a_btn_group"};function at(e,t,o,n,l,c){const u=s("a-button"),r=s("a-disclosure"),g=s("aloha-example");return _(),b(g,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_EXPOSES_HEADER_",exposes:["buttonRef","containerRef","isOpen","toggleButton"]},{default:m(()=>[i("div",ot,[i("div",nt,[i("div",ut,[a(u,{class:"a_btn a_btn_outline_primary",text:"_A_DISCLOSURE_TEXT_TOGGLE_WITH_IS_OPEN_",onClick:e.toggleShowWithIsOpen},null,8,["onClick"]),a(u,{class:"a_btn a_btn_outline_primary",text:"_A_DISCLOSURE_TEXT_TOGGLE_WITH_TOGGLE_BUTTON_",onClick:e.toggleShowWithToggleButton},null,8,["onClick"])]),a(r,{ref:"disclosureRef","text-less":e.textLess,"text-more":e.textMore},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const lt=p(it,[["render",at]]);function rt(){return{codeHtml:`<a-disclosure
  :html-less="htmlLess"
  :html-more="htmlMore"
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.`}}},qt={class:"a_columns a_columns_count_12"},Et={class:"a_column a_column_4 a_column_12_tablet"};function Pt(e,t,o,n,l,c){const u=s("a-disclosure"),r=s("aloha-example");return _(),b(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_DISCLOSURE_GROUP_OPEN_DEFAULT_HEADER_",description:"_A_DISCLOSURE_GROUP_OPEN_DEFAULT_DESCRIPTION_",props:"is-open-default"},{default:m(()=>[i("div",qt,[i("div",Et,[a(u,{"text-less":e.textLess,"text-more":e.textMore,"is-open-default":!0},null,8,["text-less","text-more"])])])]),_:1},8,["code-html","code-js"])}const Tt=p(Ot,[["render",Pt]]);function Rt(){return{codeHtml:`<a-disclosure
