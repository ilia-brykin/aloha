import{A as R,a as S}from"./chunk.AlohaExample.DQald-L_.js";import{A as k}from"./chunk.AlohaTableProps.nxAQILM8.js";import{A as y}from"./chunk.AlohaTableTranslate.CSmDkKaH.js";import{g as A,ah as c,aM as b,a3 as G}from"./bundle.index.D1OA29U_.js";import{bf as _,bc as m,aQ as u,br as E,bi as t,aV as n,aP as h,bn as K,aN as P}from"./chunk.vendor.B7xidcyX.js";import{a5 as $}from"./chunk.vendor-lodash.DHCI5OYQ.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function H(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
</a-datepicker-range>
...
};`}}const v={name:"PageDatepickerRangeBasic",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=H(),{codeJs:a}=L(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}},U={class:"a_mt_3"};function q(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_BASIC_HEADER_",description:"_PAGE_DATEPICKER_RANGE_BASIC_DESCRIPTION_",props:["v-model","label"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),label:"Aloha"},null,8,["modelValue"]),h("div",U,"model: "+K(e.model),1)]),_:1},8,["code-html","code-js"])}const M=c(v,[["render",q]]);function B(){return{codeHtml:`<a-datepicker-range
  v-model="model"
...
};`}}const V={name:"PageDatepickerRangeCustomFirstDay",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=B(),{codeJs:a}=J(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}};function F(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_HEADER_",description:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_DESCRIPTION_",props:["v-model","label","firstDayOfWeek"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),label:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_EXAMPLE_","first-day-of-week":4},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=c(V,[["render",F]]);function j(){return{codeHtml:`<a-datepicker-range
 v-model="model"
  :disabled="true">
</a-datepicker-range>
<a-datepicker-range
...
};`}}const X={name:"PageDatepickerRangeDisabledVariants",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=j(),{codeJs:a}=x(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}};function W(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_DISABLED_VARIANTS_HEADER_",description:"_PAGE_DATEPICKER_RANGE_DISABLED_VARIANTS_DESCRIPTION_",props:["v-model","disabled","disabledFrom","disabledUntil"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),disabled:!0},null,8,["modelValue"]),n(r,{modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=d=>e.model=d),"disabled-from":!0},null,8,["modelValue"]),n(r,{modelValue:e.model,"onUpdate:modelValue":a[2]||(a[2]=d=>e.model=d),"disabled-until":!0},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const z=c(X,[["render",W]]);function w(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  format="DD.MM.YY"
  format-save="YY-MM-DD"
</a-datepicker-range>`}}function Q(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const Z={name:"PageDatepickerRangeFormatCustomization",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=w(),{codeJs:a}=Q(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}};function ee(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_HEADER_",description:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_DESCRIPTION_",props:["v-model","format","formatSave"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),format:"DD.MM.YY","format-save":"YY-MM-DD"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ae=c(Z,[["render",ee]]);function te(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
...
};`}}const ne={name:"PageDatepickerRangeHelpText",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=te(),{codeJs:a}=oe(),o=_(void 0);return{codeHtml:e,codeJs:a,model:o}}};function re(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_HELP_TEXT_HEADER_",description:"_PAGE_DATEPICKER_RANGE_HELP_TEXT_DESCRIPTION_",props:["v-model","label","helpText"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),label:"Aloha","help-text":"Aloha helpText"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const de=c(ne,[["render",re]]);function le(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Date"
...
};`}}const ie={name:"PageDatepickerRangeLabelDescription",components:{ADatepickerRange:A,AlohaExample:R},setup(){const e=_(void 0),{codeHtml:a}=le(),{codeJs:o}=_e();return{codeHtml:a,codeJs:o,model:e}}};function se(e,a,o,i,s,p){const r=t("a-datepicker-range"),l=t("aloha-example");return m(),u(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:E(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=d=>e.model=d),label:"Date","label-description":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const pe=c(ie,[["render",se]]);function ce(){return{codeHtml:`<a-datepicker-range
  :model-value="model1"
  :readonly="true"
  label="Input 1"
</a-datepicker-range>
