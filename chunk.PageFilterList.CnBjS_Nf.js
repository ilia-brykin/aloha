...
// ${s([{label:"Level 1",children:[{label:"Level 1.1",children:[{label:"Level 1.1.1"},{label:"Level 1.1.2"}]},{label:"Level 1.2"}]},{label:"Level 2",children:[{label:"Level 2.1"},{label:"Level 2.2"}]}],{keyLabel:"label",keyChildren:"children"})}`}}const Z={name:"PageFilterListKeyChildren",components:{AlohaExample:b},setup(){const{codeJs:e}=O();return{codeJs:e}}};function q(e,t,r,n,_,u){const i=l("aloha-example");return c(),p(i,{"code-js":e.codeJs,header:"keyChildren","is-code-visible-default":!0},null,8,["code-js"])}const Q=o(Z,[["render",q]]);function W(){return{codeJs:`const ITEMS = [
  {
    label: "label 1",
  },
  {
...
// ${s([{label:"label 1"},{label:"label 2"},{label:"label 3"},{label:"label 4"}],{keyLabel:"label"})}`}}const X={name:"PageFilterListKeyLabel",components:{AlohaExample:b},setup(){const{codeJs:e}=W();return{codeJs:e}}};function ee(e,t,r,n,_,u){const i=l("aloha-example");return c(),p(i,{"code-js":e.codeJs,header:"keyLabel","is-code-visible-default":!0},null,8,["code-js"])}const le=o(X,[["render",ee]]);function te(){return{codeJs:`const ITEMS = [
  {
    label: "label 1",
  },
  {
