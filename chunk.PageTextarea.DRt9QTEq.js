...
};`}}const V={name:"PageTextareaBasic",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=H(),{codeJs:o}=L();return{codeHtml:a,codeJs:o,model:e}}};function y(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),label:"Textarea"},null,8,["modelValue"]),a[1]||(a[1]=A("div",null,"model:",-1)),A("pre",null,E(e.model),1)]),_:1},8,["code-html","code-js"])}const J=p(V,[["render",y]]);function B(){return{codeHtml:`<a-textarea
  :change="changeModel"
  :model-value="model"
  label="Textarea"
></a-textarea>
...
};`}}const F={name:"PageTextareaErrors",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=X(),{codeJs:o}=M();return{codeHtml:a,codeJs:o,model:e}}};function k(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=p(F,[["render",k]]);function Z(){return{codeHtml:`<a-textarea
  v-model="model"
  help-text="Aloha"
  label="Textarea"
...
};`}}const K={name:"PageTextareaHelpText",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=Z(),{codeJs:o}=W();return{codeHtml:a,codeJs:o,model:e}}};function Q(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"help-text":"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=p(K,[["render",Q]]);function ee(){return{codeHtml:`<a-textarea
  v-model="model"
  :is-scalable="true"
  label="Textarea"
></a-textarea>
...
};`}}const te={name:"PageTextareaIsScalable",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=ee(),{codeJs:o}=ae();return{codeHtml:a,codeJs:o,model:e}}};function oe(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TEXTAREA_GROUP_IS_SCALABLE_HEADER_",description:"_A_TEXTAREA_GROUP_IS_SCALABLE_DESCRIPTION_",props:["is-scalable"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"is-scalable":!0,label:"Textarea"},null,8,["modelValue"]),a[1]||(a[1]=A("div",null,"model:",-1)),A("pre",null,E(e.model),1)]),_:1},8,["code-html","code-js"])}const re=p(te,[["render",oe]]);function le(){return{codeHtml:`<a-textarea
  v-model="model"
...
};`}}const de={name:"PageTextareaLabelFloat",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=le(),{codeJs:o}=ne();return{codeHtml:a,codeJs:o,model:e}}};function se(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_IS_LABEL_FLOAT_HEADER_",description:"_A_UI_GROUP_IS_LABEL_FLOAT_DESCRIPTION_",props:["is-label-float"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"is-label-float":!1,label:"Textarea"},null,8,["modelValue"]),n(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=r=>e.model=r),"is-label-float":!0,label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const _e=p(de,[["render",se]]);function me(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<a-textarea
