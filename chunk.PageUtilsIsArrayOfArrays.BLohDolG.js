import{aF as t,_ as i,A as g}from"./bundle.index.Dgzc7bjQ.js";import{O as l,b as a,Q as p,aR as O,V as e}from"./chunk.vendor.CjhiT8UL.js";import"./chunk.vendor-lodash.DyQEPI1B.js";import{A as h,a as x}from"./chunk.AlohaExample.CIkLb_bK.js";import{P as $,a as T,b as P}from"./chunk.PageFilterTest.CJGsC8UY.js";import"./chunk.translations-ar.C11Uen7Y.js";import"./chunk.translations-de.BBAHPZjP.js";import"./chunk.translations-en.CqBU0PE_.js";import"./chunk.translations-es.DvkoYeON.js";import"./chunk.translations-fr.C7hT-abA.js";import"./chunk.translations-hr.D7VNFl8O.js";import"./chunk.translations-it.3UCFXD55.js";import"./chunk.translations-ru.DEOz_l29.js";import"./chunk.APageTabTitle.DXIasEKs.js";import"./chunk.AlohaHighlightjs.rF1jvLhM.js";function I(){return{codeJs:`isArrayOfArrays([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
// ${t([[1,2,3],[4,5,6],[7,8,9]])}
isArrayOfArrays([[], [], []]);
// ${t([[],[],[]])}
...
// ${t([[1,2,3],"This is not an array",[7,8,9]])}`}}const B={name:"PageUtilsIsArrayOfArraysExample",components:{AlohaExample:h},setup(){const{codeJs:r}=I();return{codeJs:r}}};function R(r,s,o,A,f,y){const n=a("aloha-example");return p(),l(n,{"code-js":r.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const v=i(B,[["render",R]]);function S(){return{argumentsText:[{value:"value",types:["Array"],text:"_PAGE_UTILS_IS_ARRAY_OF_ARRAYS_ARGUMENTS_VALUE_"}]}}function E(){return{pageTitle:"isArrayOfArrays"}}const U=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
...
`,F={name:"PageUtilsIsArrayOfArrays",components:{AlohaPage:x,ATranslation:g,PageFilterArguments:P,PageFilterImportFunction:T,PageFilterTest:$,PageUtilsIsArrayOfArraysExample:v},setup(){const{pageTitle:r}=E(),{argumentsText:s}=S();return{argumentsText:s,pageTitle:r,test:U}}};function b(r,s,o,A,f,y){const n=a("a-translation"),c=a("page-filter-import-function"),u=a("page-filter-arguments"),m=a("page-utils-is-array-of-arrays-example"),_=a("page-filter-test"),d=a("aloha-page");return p(),l(d,{"page-title":r.pageTitle},{body:O(()=>[e(n,{tag:"p",html:"_PAGE_UTILS_IS_ARRAY_OF_ARRAYS_DESCRIPTION_"}),e(c,{"function-name":"isArrayOfArrays","type-import":"utils"}),e(u,{"arguments-text":r.argumentsText,"function-description":"isArrayOfArrays(value)"},null,8,["arguments-text"]),e(m),e(_,{test:r.test},null,8,["test"])]),_:1},8,["page-title"])}const H=i(F,[["render",b]]);export{H as default};
