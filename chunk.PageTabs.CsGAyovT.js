...
export default {
  ...
  :data="data"
  key-active="active"
></a-tabs>`}}function We(){return{codeJs:`import ATabs from "aloha-vue/src/ATabs/ATabs";
...
};`}}const ze={name:"PageTabsKeyActive",components:{AlohaExample:p,ATabs:B},setup(){const e=[{label:"_A_TABS_TAB_1_",content:"_A_TABS_CONTENT_1_"},{label:"_A_TABS_TAB_2_",content:"_A_TABS_CONTENT_2_"},{label:"_A_TABS_TAB_3_",content:"_A_TABS_CONTENT_3_",active:!0},{label:"_A_TABS_TAB_4_",content:"_A_TABS_CONTENT_4_"}],{codeHtml:t}=Xe(),{codeJs:a}=We();return{codeHtml:t,codeJs:a,data:e}}};function Qe(e,t,a,l,c,d){const _=o("a-tabs"),n=o("aloha-example");return m(),u(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TABS_GROUP_KEY_ACTIVE_HEADER_",description:"_A_TABS_GROUP_KEY_ACTIVE_DESCRIPTION_",props:["key-active"]},{default:T(()=>[s(_,{data:e.data,"key-active":"active"},null,8,["data"])]),_:1},8,["code-html","code-js"])}const Ze=b(ze,[["render",Qe]]);function et(){return{codeHtml:`<a-tabs
  :data="data"
  key-content="aloha"
