import{A as p,a as D}from"./chunk.AlohaExample.CMUUEVcN.js";import{A as C}from"./chunk.AlohaTableProps.DwOUDlIA.js";import{A as U}from"./chunk.AShowMore.BzItDg96.js";import{A as l,_ as c,g as v}from"./bundle.index.DOWaPX07.js";import{B as i,C as A,L as s,F as u,G as o,N as f,m as a,a as R}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.ATable.BiLWW37G.js";import"./chunk.utilsMath.D900FRx8.js";import"./chunk.AForm.BMBXIC54.js";import"./chunk.ADatepicker.DXR-Bzfp.js";import"./chunk.UiMixinProps.3z5E7Tu9.js";import"./chunk.AInputNumber.CmREK6bZ.js";import"./chunk.ATinymce.BcMFUTFk.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function B(){return{codeHtml:`<a-translation
  tag="button"
...
};`}}const V={name:"PageTranslationBasic",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=k(),{codeJs:e}=w();return{codeHtml:t,codeJs:e}}};function Y(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_BASIC_USAGE_",props:"text"},{default:s(()=>[o(n,{text:"_A_TRANSLATION_SHOW_MORE_"})]),_:1},8,["code-html","code-js"])}const z=c(V,[["render",Y]]);function K(){return{codeHtml:`<a-translation
...
};`}}const st={name:"PageTranslationHtml",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=nt(),{codeJs:e}=_t();return{codeHtml:t,codeJs:e}}};function rt(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_HTML_HEADER_",description:"_A_TRANSLATION_GROUP_HTML_DESCRIPTION_",props:"html"},{default:s(()=>[o(n,{html:"_A_TRANSLATION_EXAMPLE_HTML_"})]),_:1},8,["code-html","code-js"])}const lt=c(st,[["render",rt]]);function ct(){return{codeHtml:`<a-translation
  html="_A_TRANSLATION_EXAMPLE_HTML_"
  text-before="$ "
  text-after=" €"
...
};`}}const ut={name:"PageTranslationPlaceholder",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=Tt(),{codeJs:e}=pt();return{codeHtml:t,codeJs:e}}};function ft(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_PLACEHOLDER_HEADER_",description:"_A_TRANSLATION_GROUP_PLACEHOLDER_DESCRIPTION_",props:["tag","placeholder"]},{default:s(()=>[o(n,{tag:"input",placeholder:"_A_TRANSLATION_SHOW_MORE_"})]),_:1},8,["code-html","code-js"])}const Ot=c(ut,[["render",ft]]);function Rt(){return{codeHtml:`<a-translation
...
export default {
  ...
  // "_A_TRANSLATION_EXAMPLE_HTML_": "<button class='a_btn a_btn_primary' onclick='alert("Aloha")'>Aloha</button>",
};`}}const ht={name:"PageTranslationSafeHtml",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=Rt(),{codeJs:e}=Nt();return{codeHtml:t,codeJs:e}}};function Pt(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_SAFE_HTML_HEADER_",description:"_A_TRANSLATION_GROUP_SAFE_HTML_DESCRIPTION_",props:"safe-html"},{default:s(()=>[o(n,{"safe-html":"_A_TRANSLATION_EXAMPLE_HTML_"})]),_:1},8,["code-html","code-js"])}const Et=c(ht,[["render",Pt]]);function It(){return{codeHtml:`<a-translation
  text-before="+ "
  text-after=" -"
...
};`}}const Mt={name:"PageTranslationTextAfter",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=bt(),{codeJs:e}=Jt();return{codeHtml:t,codeJs:e}}};function jt(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_TEXT_AFTER_HEADER_",description:"_A_TRANSLATION_GROUP_TEXT_AFTER_DESCRIPTION_",props:"text-after"},{default:s(()=>[o(n,{text:"_A_TRANSLATION_SHOW_MORE_","text-after":" *(Aloha)"})]),_:1},8,["code-html","code-js"])}const Dt=c(Mt,[["render",jt]]);function Ct(){return{codeHtml:`<a-translation
...
};`}}const Wt={name:"PageTranslationTextBefore",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=Xt(),{codeJs:e}=yt();return{codeHtml:t,codeJs:e}}};function Ft(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_TEXT_BEFORE_HEADER_",description:"_A_TRANSLATION_GROUP_TEXT_BEFORE_DESCRIPTION_",props:"text-before"},{default:s(()=>[o(n,{text:"_A_TRANSLATION_SHOW_MORE_","text-before":"$Aloha$ "})]),_:1},8,["code-html","code-js"])}const qt=c(Wt,[["render",Ft]]);function kt(){return{codeHtml:`<a-translation
...
};`}}const Zt={name:"PageTranslationTitle",components:{AlohaExample:p,ATranslation:l},setup(){const{codeHtml:t}=Kt(),{codeJs:e}=Qt();return{codeHtml:t,codeJs:e}}},te={class:"a_columns a_columns_count_12"},ee={class:"a_column a_column_4 a_column_12_tablet"};function ae(t,e,r,d,m,T){const n=a("a-translation"),_=a("aloha-example");return i(),A(_,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_TRANSLATION_GROUP_TITLE_HEADER_",description:"_A_TRANSLATION_GROUP_TITLE_DESCRIPTION_"},{default:s(()=>[u("div",te,[u("div",ee,[o(n,{title:"_A_TRANSLATION_SHOW_MORE_"},{default:s(()=>[f("Aloha")]),_:1})])])]),_:1},8,["code-html","code-js"])}const oe=c(Zt,[["render",ae]]);function ne(){return{codeHtml:`<a-translation
