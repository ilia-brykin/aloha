import{A,a as b}from"./chunk.AlohaExample.CfAOzOZB.js";import{A as j}from"./chunk.AlohaTableProps.dLIzUMiQ.js";import{A as L}from"./chunk.AlohaTableTranslate.B3UQt050.js";import{q as P,_ as p,g as O,A as C}from"./bundle.index.DSsXBbUX.js";import{r as c,V as u,aT as i,e as a,W as f,_ as t,Z as S,aU as R,d as I}from"./chunk.vendor.tcMGz7j_.js";import"./chunk.vendor-lodash.rFt76tyK.js";import"./chunk.APageTabTitle.ChtIk8T5.js";import"./chunk.AlohaHighlightjs.BwPt1uu6.js";import"./chunk.ATable.CGGVFAzp.js";import"./chunk.translations-ar.CwyMQWPR.js";import"./chunk.translations-de.DuV3v3Cz.js";import"./chunk.translations-en.BAVPZb8D.js";import"./chunk.translations-es.CScVS5gr.js";import"./chunk.translations-fr.DnbqWcMA.js";import"./chunk.translations-hr.BvJBUX6u.js";import"./chunk.translations-it.DGOUtzh8.js";import"./chunk.translations-ru.DKR_u9IZ.js";function y(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<div>model:</div>
...
};`}}const M={name:"PageJsonChange",components:{AJson:P,AlohaExample:A},setup(){const e=c({glossary:{title:"example glossary",GlossDiv:{title:"S",GlossList:{GlossEntry:{ID:"SGML",SortAs:"SGML",GlossTerm:"Standard Generalized Markup Language",Acronym:"SGML",Abbrev:"ISO 8879:1986",GlossDef:{para:"A meta-markup language, used to create markup languages such as DocBook.",GlossSeeAlso:["GML","XML"]},GlossSee:"markup"}}}}}),o=({model:d,id:m,props:l})=>{e.value=d,console.log(m,l)},{codeHtml:n}=B(),{codeJs:s}=q();return{changeModel:o,codeHtml:n,codeJs:s,model:e}}};function V(e,o,n,s,d,m){const l=a("a-json"),r=a("aloha-example");return f(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:i(()=>[t(l,{change:e.changeModel,"model-value":e.model,label:"JSON"},null,8,["change","model-value"]),o[0]||(o[0]=S("div",null,"model:",-1)),S("pre",null,R(e.model),1)]),_:1},8,["code-html","code-js"])}const x=p(M,[["render",V]]);function k(){return{codeHtml:`<a-json
  v-model="model"
  errors="Aloha"
  label="JSON"
