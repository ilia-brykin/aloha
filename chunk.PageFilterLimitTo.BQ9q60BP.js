import{A as _,a as E}from"./chunk.AlohaExample.CjncY9yb.js";import{aA as i,_ as n,A as $}from"./bundle.index.D9gcatRx.js";import{P as A,a as P,b as D}from"./chunk.PageFilterTest.XRvw5J-J.js";import{P as I}from"./chunk.PageFilterImportCompositionApi.Bxn2dkOk.js";import{k as e,J as a,H as l,aJ as F,O as o}from"./chunk.vendor.Ca3-nzbX.js";import"./chunk.vendor-lodash.-viuv_rg.js";function X(){const t="Lorem ipsum dolor sit amet consectetur adipisicing elit";return{codeJs:`const TEXT = "Lorem ipsum dolor sit amet consectetur adipisicing elit";
...
// ${i(t,{limit:5,maxThreeDots:!1})}`}}const v={name:"PageFilterLimitToMaxThreeDots",components:{AlohaExample:_},setup(){const{codeJs:t}=R();return{codeJs:t}}};function G(t,s,m,c,p,T){const r=e("aloha-example");return l(),a(r,{"code-js":t.codeJs,header:"maxThreeDots","is-code-visible-default":!0},null,8,["code-js"])}const O=n(v,[["render",G]]);function b(){return{argumentsText:[{value:"text",types:["String"],text:"_PAGE_FILTER_LIMIT_TO_ARGUMENTS_TEXT_"},{value:"[limit=30]",types:["Number"],text:"_PAGE_FILTER_LIMIT_TO_ARGUMENTS_LIMIT_"},{value:"[maxThreeDots=true]",types:["Boolean"],text:"_PAGE_FILTER_LIMIT_TO_ARGUMENTS_MAX_THREE_DOTS_"}]}}function y(){return{pageTitle:"filterLimitTo"}}const N=`import filterLimitTo from "../filterLimitTo";
