...
};`}}const H={name:"PageJsonBasic",components:{AJson:P,AlohaExample:S},setup(){const e=I({}),{codeHtml:o}=j(),{codeJs:a}=L();return{codeHtml:o,codeJs:a,model:e}}};function $(e,o,a,d,_,m){const s=n("a-json"),l=n("aloha-example");return i(),c(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),label:"JSON"},null,8,["modelValue"]),o[1]||(o[1]=A("div",null,"model:",-1)),A("pre",null,R(e.model),1)]),_:1},8,["code-html","code-js"])}const v=p(H,[["render",$]]);function y(){return{codeHtml:`<a-json
  :change="changeModel"
  :model-value="model"
  label="JSON"
></a-json>
...
};`}}const W={name:"PageJsonHelpText",components:{AJson:P,AlohaExample:S},setup(){const e=I({}),{codeHtml:o}=w(),{codeJs:a}=z();return{codeHtml:o,codeJs:a,model:e}}};function Y(e,o,a,d,_,m){const s=n("a-json"),l=n("aloha-example");return i(),c(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),"help-text":"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Q=p(W,[["render",Y]]);function K(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<a-json
