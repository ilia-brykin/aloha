import{A,a as h}from"./chunk.AlohaExample.BT0L4sPf.js";import{A as D}from"./chunk.AlohaTableProps.AKmRY_Bl.js";import{A as U}from"./chunk.AlohaTableTranslate.DWhPyfrI.js";import{_ as m,g as C,A as b}from"./bundle.index.CgpAdSdY.js";import{a as S}from"./chunk.AForm.CpIOokJc.js";import{r as P,m as n,C as p,L as u,B as i,G as t,F as I,M as O,a as E}from"./chunk.vendor.D-Y3mz6a.js";import"./chunk.vendor-lodash.ClBXVCWL.js";import"./chunk.ATable.DALhqzqJ.js";import"./chunk.utilsMath.7PmiGUbm.js";import"./chunk.vendor-tinymce.2RT9eEW9.js";import"./chunk.ADatepicker.BS_Ghotq.js";import"./chunk.UiMixinProps.BVfs3aDc.js";import"./chunk.AInputNumber.C93fy0SX.js";import"./chunk.ATinymce.1a39zYU1.js";function L(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<div>model:</div>
...
};`}}const X={name:"PageJsonErrors",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=k(),{codeJs:a}=F();return{codeHtml:o,codeJs:a,model:e}}};function w(e,o,a,d,_,c){const s=n("a-json"),r=n("aloha-example");return i(),p(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),errors:"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const z=m(X,[["render",w]]);function Q(){return{codeHtml:`<a-json
  v-model="model"
  help-text="Aloha"
  label="JSON"
...
};`}}const Y={name:"PageJsonHelpText",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=Q(),{codeJs:a}=W();return{codeHtml:o,codeJs:a,model:e}}};function K(e,o,a,d,_,c){const s=n("a-json"),r=n("aloha-example");return i(),p(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),"help-text":"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=m(Y,[["render",K]]);function ee(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<a-json
