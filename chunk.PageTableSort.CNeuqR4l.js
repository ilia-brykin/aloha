import{A as O,a as P}from"./chunk.AlohaExample.yE023I1X.js";import{A as h}from"./chunk.ATable.D1MQeD59.js";import{U as E,f as I,S as M,Q as R}from"./chunk.vendor-lodash.GuFqEw-8.js";import{r as u,k as _,J as r,aO as m,H as i,N as p,O as c,a as N}from"./chunk.vendor.QyCKSPD8.js";import{_ as A,g as y}from"./bundle.index.C9lpaoUP.js";import"./chunk.APageTabTitle.BP4gNxYd.js";import"./chunk.translations-ar.D84EYJUC.js";import"./chunk.translations-de.B3_DNkZv.js";import"./chunk.translations-en.DZoFKckB.js";import"./chunk.translations-es.92fkcSMr.js";import"./chunk.translations-fr.DBliKyyP.js";import"./chunk.translations-hr.KiqIBbb_.js";import"./chunk.translations-it.BBYgaTTr.js";import"./chunk.translations-ru.CgZqQiYL.js";function k(){return{codeHtml:`<a-table
  :columns="columns"
  :data="data"
...
};`}}const ue={name:"PageTableSortSequenceNumberClass",components:{AlohaExample:O,ATable:h},setup(){const{codeHtml:e}=ce(),{codeJs:t}=de(),n=[{id:"column1",keyLabel:"id",label:"_A_TABLE_COLUMN_1_",sortId:"id"},{id:"column2",keyLabel:"aloha",label:"_A_TABLE_COLUMN_2_",sortId:"aloha"},{id:"column3",keyLabel:"number",label:"_A_TABLE_COLUMN_3_",sortId:"number"},{id:"column4",keyLabel:"alohaPlus",label:"_A_TABLE_COLUMN_4_",sortId:"alohaPlus"},{id:"column5",keyLabel:"aloha",label:"_A_TABLE_COLUMN_5_"}],l=u([]);return(()=>{const o=[];E(5,a=>{o.push({id:a+1,aloha:`aloha ${a}`,alohaPlus:`aloha ${a%2}${a%2}`,number:5-a})}),l.value=o})(),{codeHtml:e,codeJs:t,columns:n,data:l}}};function re(e,t,n,l,s,d){const o=_("a-table"),a=_("aloha-example");return i(),r(a,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TABLE_GROUP_SORT_SEQUENCE_NUMBER_CLASS_HEADER_",description:"_A_TABLE_GROUP_SORT_SEQUENCE_NUMBER_CLASS_DESCRIPTION_"},{default:m(()=>[p("div",null,[c(o,{columns:e.columns,data:e.data,label:"_A_TABLE_GROUP_SORT_SEQUENCE_NUMBER_CLASS_LABEL_","key-id":"id","is-sorting-multi-column":!0,"model-sort":["-alohaPlus","aloha"],"sorting-sequence-number-class":"a_badge a_pill_rounded"},null,8,["columns","data"])])]),_:1},8,["code-html","code-js"])}const me=A(ue,[["render",re]]);function ie(){return{codeHtml:`<a-table
  :columns="columns"
  :data="data"
