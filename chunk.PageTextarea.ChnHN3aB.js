import{A,a as D}from"./chunk.AlohaExample.D3tDTkvW.js";import{A as $}from"./chunk.AlohaTableProps.B6tyFcJK.js";import{A as v}from"./chunk.AlohaTableTranslate.CvuwDOFX.js";import{n as P,_ as p,g as C,A as H}from"./bundle.index.DVkenmS7.js";import{r as u,U as c,aS as i,e as t,V as f,Z as r,Y as T,aT as I,d as R}from"./chunk.vendor.COYgx38y.js";import"./chunk.vendor-lodash.DB6s1oac.js";import"./chunk.APageTabTitle.BFATH397.js";import"./chunk.AlohaHighlightjs.CW1W2LCP.js";import"./chunk.ATable.BqQ_I3cA.js";import"./chunk.translations-ar.BHcacQS4.js";import"./chunk.translations-de.BrqZ4DnZ.js";import"./chunk.translations-en.BxW0tsA8.js";import"./chunk.translations-es.BFGc66dt.js";import"./chunk.translations-fr.Brd-erqy.js";import"./chunk.translations-hr.CzLDvybY.js";import"./chunk.translations-it.DFHL-15C.js";import"./chunk.translations-ru.CvsrSaN8.js";function L(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<div>model:</div>
...
};`}}const Y={name:"PageTextareaErrors",components:{AlohaExample:A,ATextarea:P},setup(){const e=u("Aloha"),{codeHtml:a}=M(),{codeJs:o}=F();return{codeHtml:a,codeJs:o,model:e}}};function Z(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return f(),c(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[r(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=p(Y,[["render",Z]]);function k(){return{codeHtml:`<a-textarea
  v-model="model"
  help-text="Aloha"
  label="Textarea"
