...
};`}}const Q={name:"PageRateColor",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Z(),{codeJs:t}=K();return{codeHtml:e,codeJs:t}}};function ee(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Color",description:"_A_RATE_DESCRIPTION_COLOR_",props:"color"},{default:R(()=>[r(a,{color:"gray",text:"gray"})]),_:1},8,["code-html","code-js"])}const te=p(Q,[["render",ee]]);function oe(){return{codeHtml:`<a-rate 
  :half-icon="true">
...
};`}}const be={name:"PageRateReadonly",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Oe(),{codeJs:t}=Ne();return{codeHtml:e,codeJs:t}}};function De(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Readonly",description:"_A_RATE_DESCRIPTION_READONLY_",props:"readonly"},{default:R(()=>[r(a,{"model-value":2.4,readonly:!0,text:"2.4 readonly"})]),_:1},8,["code-html","code-js"])}const Ve=p(be,[["render",De]]);function Me(){return{codeHtml:`<a-rate
 :show-score="true">
