import{A,a as U}from"./chunk.AlohaExample.BZeZthkV.js";import{A as j}from"./chunk.AlohaTableProps.BP-QrYCJ.js";import{A as L}from"./chunk.AlohaTableTranslate.CSBHe8xv.js";import{ab as P,_ as p,g as O,A as C}from"./bundle.index.BhEeXSAb.js";import{r as c,Z as u,Y as i,aV as f,f as a,a0 as t,$ as S,aW as R,d as I}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import"./chunk.APageTabTitle.C6WQ6Ehw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.ATable.TDP6pXBu.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function $(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<div>model:</div>
...
};`}}const X={name:"PageJsonErrors",components:{AJson:P,AlohaExample:A},setup(){const e=c({}),{codeHtml:o}=k(),{codeJs:n}=F();return{codeHtml:o,codeJs:n,model:e}}};function Y(e,o,n,s,d,m){const l=a("a-json"),r=a("aloha-example");return u(),i(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:f(()=>[t(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=_=>e.model=_),errors:"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=p(X,[["render",Y]]);function z(){return{codeHtml:`<a-json
  v-model="model"
  help-text="Aloha"
  label="JSON"
...
};`}}const Q={name:"PageJsonHelpText",components:{AJson:P,AlohaExample:A},setup(){const e=c({}),{codeHtml:o}=z(),{codeJs:n}=W();return{codeHtml:o,codeJs:n,model:e}}};function Z(e,o,n,s,d,m){const l=a("a-json"),r=a("aloha-example");return u(),i(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:f(()=>[t(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=_=>e.model=_),"help-text":"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const K=p(Q,[["render",Z]]);function ee(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
