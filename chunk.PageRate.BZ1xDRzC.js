...
};`}}const Q={name:"PageRateColor",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Y(),{codeJs:t}=K();return{codeHtml:e,codeJs:t}}};function ee(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Color",description:"_A_RATE_DESCRIPTION_COLOR_",props:"color"},{default:R(()=>[r(a,{color:"gray",text:"gray"})]),_:1},8,["code-html","code-js"])}const te=p(Q,[["render",ee]]);function oe(){return{codeHtml:`<a-rate 
  :half-icon="true">
...
};`}}const ne={name:"PageRateHalfIcon",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=oe(),{codeJs:t}=ae();return{codeHtml:e,codeJs:t}}};function re(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Select half Icon",description:"_A_RATE_DESCRIPTION_HALF_ICON_",props:"half-icon"},{default:R(()=>[r(a,{"half-icon":!0})]),_:1},8,["code-html","code-js"])}const le=p(ne,[["render",re]]);function ce(){return{codeHtml:`<a-rate 
  hovered-color="red"
  text="red">
...
};`}}const pe={name:"PageRateIcon",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=me(),{codeJs:t}=_e();return{codeHtml:e,codeJs:t}}};function fe(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Icon",description:"_A_RATE_DESCRIPTION_ICON_",props:"icon"},{default:R(()=>[r(a,{icon:"ChatSquareText"}),t[0]||(t[0]=L("br",null,null,-1)),r(a,{icon:"ArrowRightCircle"})]),_:1},8,["code-html","code-js"])}const he=p(pe,[["render",fe]]);function Re(){return{codeHtml:`<a-rate
 icon-fill="Star">
...
};`}}const ye={name:"PageRateRating",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Ce(),{codeJs:t}=Te();return{codeHtml:e,codeJs:t}}};function xe(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Rating",description:"_A_RATE_DESCRIPTION_RATING_",props:"rating"},{default:R(()=>[r(a,{rating:7})]),_:1},8,["code-html","code-js"])}const Je=p(ye,[["render",xe]]);function Oe(){return{codeHtml:`<a-rate 
  :model-value="2.4"
  :readonly="true"
  text="2.4 readonly">
...
};`}}const De={name:"PageRateReadonly",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Oe(),{codeJs:t}=Ne();return{codeHtml:e,codeJs:t}}};function be(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Readonly",description:"_A_RATE_DESCRIPTION_READONLY_",props:"readonly"},{default:R(()=>[r(a,{"model-value":2.4,readonly:!0,text:"2.4 readonly"})]),_:1},8,["code-html","code-js"])}const Ve=p(De,[["render",be]]);function Me(){return{codeHtml:`<a-rate
 :show-score="true">
...
};`}}const qe={name:"PageRateSize",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Fe(),{codeJs:t}=ke();return{codeHtml:e,codeJs:t}}};function Be(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return f(),h(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"Sizes",description:"_A_RATE_DESCRIPTION_SIZE_",props:"size"},{default:R(()=>[r(a,{size:"small",text:"small"}),t[0]||(t[0]=L("br",null,null,-1)),r(a,{size:"medium",text:"medium"}),t[1]||(t[1]=L("br",null,null,-1)),r(a,{size:"big",text:"big"})]),_:1},8,["code-html","code-js"])}const Xe=p(qe,[["render",Be]]);function Ue(){return{codeHtml:`<a-rate 
  text="text and extra">
