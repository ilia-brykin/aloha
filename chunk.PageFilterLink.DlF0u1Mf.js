import{A as x,a as A}from"./chunk.AlohaExample.yE023I1X.js";import{at as o,_ as r,A as E}from"./bundle.index.C9lpaoUP.js";import{P as I,a as J,b as F}from"./chunk.PageFilterTest.HHPB_jIn.js";import{P as b}from"./chunk.PageFilterImportCompositionApi.DVluyLc8.js";import{k as t,J as s,H as p,aO as C,O as a}from"./chunk.vendor.QyCKSPD8.js";import"./chunk.vendor-lodash.GuFqEw-8.js";import"./chunk.APageTabTitle.BP4gNxYd.js";import"./chunk.translations-ar.D84EYJUC.js";import"./chunk.translations-de.B3_DNkZv.js";import"./chunk.translations-en.DZoFKckB.js";import"./chunk.translations-es.92fkcSMr.js";import"./chunk.translations-fr.DBliKyyP.js";import"./chunk.translations-hr.KiqIBbb_.js";import"./chunk.translations-it.BBYgaTTr.js";import"./chunk.translations-ru.CgZqQiYL.js";function R(){return{codeJs:`filterLink("example.com");
// ${o("example.com")}
...
// ${o("https://example.com",{linkText:"Aloha"})}`}}const y={name:"PageFilterLinkLinkText",components:{AlohaExample:x},setup(){const{codeJs:e}=U();return{codeJs:e}}};function O(e,l,i,c,m,_){const n=t("aloha-example");return p(),s(n,{"code-js":e.codeJs,header:"linkText","is-code-visible-default":!0},null,8,["code-js"])}const w=r(y,[["render",O]]);function M(){return{codeJs:`filterLink("example.com", { protocol: "" });
// ${o("example.com",{protocol:""})}

filterLink("https://example.com", { protocol: "http://" });
// ${o("example.com",{protocol:"http://"})}`}}const D={name:"PageFilterLinkProtocol",components:{AlohaExample:x},setup(){const{codeJs:e}=M();return{codeJs:e}}};function H(e,l,i,c,m,_){const n=t("aloha-example");return p(),s(n,{"code-js":e.codeJs,header:"protocol","is-code-visible-default":!0},null,8,["code-js"])}const V=r(D,[["render",H]]);function X(){return{codeJs:`filterLink("example.com", { target: "_blank" });
