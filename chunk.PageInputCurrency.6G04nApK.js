...
};`}}const k={name:"PageInputCurrencyChange",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=p(10.02),n=({model:c,id:m,props:r})=>{e.value=c,console.log(m,r)},{codeHtml:l}=w(),{codeJs:u}=W();return{changeModel:n,codeHtml:l,codeJs:u,model:e}}};function Q(e,n,l,u,c,m){const r=t("a-input-currency"),d=t("aloha-example");return y(),I(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:P(()=>[a(r,{change:e.changeModel,"model-value":e.model,label:"Input"},null,8,["change","model-value"]),s("div",null,"model: "+i(e.model),1)]),_:1},8,["code-html","code-js"])}const z=_(k,[["render",Q]]);function K(){return{codeHtml:`<a-input-currency
  v-model="model"
  controls-type="none"
  label="Input"
></a-input-currency>
