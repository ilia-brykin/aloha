import{A as _,a as E}from"./chunk.AlohaExample.CMUUEVcN.js";import{aC as i,_ as n,A as $}from"./bundle.index.DOWaPX07.js";import{P,a as A,b as D}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as I}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as a,C as l,m as e,L as F,G as o}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function X(){const t="Lorem ipsum dolor sit amet consectetur adipisicing elit";return{codeJs:`const TEXT = "Lorem ipsum dolor sit amet consectetur adipisicing elit";
...
// ${i(t,{limit:100})}`}}const B={name:"PageFilterLimitToLimit",components:{AlohaExample:_},setup(){const{codeJs:t}=X();return{codeJs:t}}};function M(t,s,m,c,p,T){const r=e("aloha-example");return a(),l(r,{"code-js":t.codeJs,header:"limit","is-code-visible-default":!0},null,8,["code-js"])}const J=n(B,[["render",M]]);function R(){const t="Aloha...";return{codeJs:`const TEXT = "Aloha...";
...
// ${i(t,{limit:5,maxThreeDots:!1})}`}}const v={name:"PageFilterLimitToMaxThreeDots",components:{AlohaExample:_},setup(){const{codeJs:t}=R();return{codeJs:t}}};function G(t,s,m,c,p,T){const r=e("aloha-example");return a(),l(r,{"code-js":t.codeJs,header:"maxThreeDots","is-code-visible-default":!0},null,8,["code-js"])}const b=n(v,[["render",G]]);function y(){return{argumentsText:[{value:"text",types:["String"],text:"_PAGE_FILTER_LIMIT_TO_ARGUMENTS_TEXT_"},{value:"[limit=30]",types:["Number"],text:"_PAGE_FILTER_LIMIT_TO_ARGUMENTS_LIMIT_"},{value:"[maxThreeDots=true]",types:["Boolean"],text:"_PAGE_FILTER_LIMIT_TO_ARGUMENTS_MAX_THREE_DOTS_"}]}}function C(){return{pageTitle:"filterLimitTo"}}const N=`import filterLimitTo from "../filterLimitTo";
...
`,O={name:"PageFilterLimitTo",components:{AlohaPage:E,ATranslation:$,PageFilterArguments:D,PageFilterImportCompositionApi:I,PageFilterImportFunction:A,PageFilterLimitToLimit:J,PageFilterLimitToMaxThreeDots:b,PageFilterTest:P},setup(){const{pageTitle:t}=C(),{argumentsText:s}=y();return{argumentsText:s,pageTitle:t,test:N}}};function S(t,s,m,c,p,T){const r=e("a-translation"),u=e("page-filter-import-function"),f=e("page-filter-import-composition-api"),L=e("page-filter-arguments"),d=e("page-filter-limit-to-limit"),x=e("page-filter-limit-to-max-three-dots"),g=e("page-filter-test"),h=e("aloha-page");return a(),l(h,{"page-title":t.pageTitle},{body:F(()=>[o(r,{tag:"p",html:"_PAGE_FILTER_LIMIT_TO_DESCRIPTION_"}),o(u,{"function-name":"filterLimitTo","type-import":"filters"}),o(f,{"function-name":"filterLimitTo"}),o(L,{"arguments-text":t.argumentsText,"function-description":"filterLimitTo(text, { [limit=30], [maxThreeDots=true] })"},null,8,["arguments-text"]),o(d),o(x),o(g,{test:t.test},null,8,["test"])]),_:1},8,["page-title"])}const z=n(O,[["render",S]]);export{z as default};
