import{A as S,a as D}from"./chunk.AlohaExample.CyDUW8HH.js";import{A as T}from"./chunk.AlohaTableProps.DXT0f_CK.js";import{A as N}from"./chunk.AlohaTableTranslate.DfW_sW3S.js";import{Z as E,_ as u,g as y,A as U}from"./bundle.index.CTNpzYUa.js";import{r as i,U as c,aS as P,e as r,V as I,Z as d,Y as p,aT as s,d as A}from"./chunk.vendor.w-kCrpQl.js";import"./chunk.vendor-lodash.GmlDDh1v.js";import"./chunk.APageTabTitle.L6_rZJza.js";import"./chunk.AlohaHighlightjs.Cjego80K.js";import"./chunk.ATable.BpXP_u2H.js";import"./chunk.translations-ar.7kyFlj_7.js";import"./chunk.translations-de.BMzqk4tK.js";import"./chunk.translations-en.CYLIQ7pD.js";import"./chunk.translations-es.D962VZ2D.js";import"./chunk.translations-fr.CcjuPFMN.js";import"./chunk.translations-hr.D1P_Fjd9.js";import"./chunk.translations-it.BsI54FWd.js";import"./chunk.translations-ru.hctQRJz1.js";function C(){return{codeHtml:`<a-datepicker
  v-model="model1"
  label="Input 1"
></a-datepicker>
...
};`}}const b={name:"PageDatepickerBasic",components:{ADatepicker:E,AlohaExample:S},setup(){const e=i("2022-10-18"),t=i("2023-12-12"),l=i(void 0),{codeHtml:n}=C(),{codeJs:_}=v();return{codeHtml:n,codeJs:_,model1:e,model2:t,model3:l}}};function g(e,t,l,n,_,f){const a=r("a-datepicker"),m=r("aloha-example");return I(),c(m,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:P(()=>[d(a,{modelValue:e.model1,"onUpdate:modelValue":t[0]||(t[0]=o=>e.model1=o),label:"Input 1"},null,8,["modelValue"]),p("div",null,"model1: "+s(e.model1),1),d(a,{modelValue:e.model2,"onUpdate:modelValue":t[1]||(t[1]=o=>e.model2=o),label:"Input 2"},null,8,["modelValue"]),p("div",null,"model2: "+s(e.model2),1),d(a,{modelValue:e.model3,"onUpdate:modelValue":t[2]||(t[2]=o=>e.model3=o),label:"Input 3"},null,8,["modelValue"]),p("div",null,"model3: "+s(e.model3),1)]),_:1},8,["code-html","code-js"])}const k=u(b,[["render",g]]);function H(){return{codeHtml:`<a-datepicker
  :model-value="model1"
  :readonly="true"
  label="Input 1"
></a-datepicker>
...
<a-datepicker
  ...
  readonly-default="-"
  help-text="Aloha"
></a-datepicker>`}}function L(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const q={name:"PageDatepickerReadonly",components:{ADatepicker:E,AlohaExample:S},setup(){const e=i("2022-10-18"),t=i("2023-12-12"),l=i(void 0),{codeHtml:n}=H(),{codeJs:_}=L();return{codeHtml:n,codeJs:_,model1:e,model2:t,model3:l}}};function Y(e,t,l,n,_,f){const a=r("a-datepicker"),m=r("aloha-example");return I(),c(m,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:P(()=>[d(a,{"model-value":e.model1,readonly:!0,label:"Input 1"},null,8,["model-value"]),d(a,{class:"a_mt_3","model-value":e.model2,readonly:!0,label:"Input 2"},null,8,["model-value"]),d(a,{class:"a_mt_3","model-value":e.model3,readonly:!0,label:"Input 3"},null,8,["model-value"]),d(a,{class:"a_mt_3","model-value":e.model3,readonly:!0,label:"Input 4","readonly-default":"-","help-text":"Aloha"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const h=u(q,[["render",Y]]);function B(){return{codeHtml:`<a-datepicker
  v-model="model1"
  label="Date"
  type="date"
></a-datepicker>
...
<a-datepicker
  ...
  type="datetime"
></a-datepicker>
<div>model3: {{ model3 }}</div>`}}function $(){return{codeJs:`import {
  ref,
} from "vue";
