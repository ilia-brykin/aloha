import{A as f,a as D}from"./chunk.AlohaExample.BcPB8Qry.js";import{A as N}from"./chunk.AlohaTableProps.B6_mPHyq.js";import{A as $}from"./chunk.AlohaTableTranslate.D5UoyO8w.js";import{b as S,_ as i,g as v,A as b}from"./bundle.index.q0oygsl8.js";import{r as h,k as o,Q as m,aQ as u,O as p,V as l,U as A,aR as P,a as I}from"./chunk.vendor.C_nZR3i9.js";import"./chunk.APageTabTitle.YhYn5T6u.js";import"./chunk.AlohaHighlightjs.zzXDUp_j.js";import"./chunk.vendor-lodash.BzDRedSD.js";import"./chunk.ATable.Dm0jLwEE.js";import"./chunk.translations-ar.CGL8aVo9.js";import"./chunk.translations-de.RdwLQ5AB.js";import"./chunk.translations-en.DDBINhYl.js";import"./chunk.translations-es.Db8DPcgi.js";import"./chunk.translations-fr.Bj0H1VLd.js";import"./chunk.translations-hr.D6Hyl4N8.js";import"./chunk.translations-it.BR5rbHtH.js";import"./chunk.translations-ru.BkDZ_0rg.js";function V(){return{codeHtml:`<a-switch
  v-model="model"
></a-switch>
...
};`}}const J={name:"PageSwitchBasic",components:{AlohaExample:f,ASwitch:S},setup(){const e=h(!1),{codeHtml:t}=V(),{codeJs:a}=y();return{codeHtml:t,codeJs:a,model:e}}};function B(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return p(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s)},null,8,["modelValue"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(J,[["render",B]]);function j(){return{codeHtml:`<a-switch
  :change="changeModel"
  :model-value="model"
></a-switch>
...
};`}}const k={name:"PageSwitchErrors",components:{AlohaExample:f,ASwitch:S},setup(){const e=h(!1),{codeHtml:t}=x(),{codeJs:a}=X();return{codeHtml:t,codeJs:a,model:e}}};function Q(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return p(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=i(k,[["render",Q]]);function z(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
...
};`}}const Z={name:"PageSwitchHelpText",components:{AlohaExample:f,ASwitch:S},setup(){const e=h(!1),{codeHtml:t}=z(),{codeJs:a}=K();return{codeHtml:t,codeJs:a,model:e}}};function ee(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return p(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"help-text":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=i(Z,[["render",ee]]);function oe(){return{codeHtml:`<a-switch
  v-model="model"
  label="ASwitch"
></a-switch>
<a-switch
