...
};`}}const lt={name:"PageLinkComplex",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=st(),{codeJs:_}=ot();return{codeHtml:t,codeJs:_}}};function it(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return m(),r(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_COMPLEX_HEADER_",description:"_A_LINK_GROUP_COMPLEX_DESCRIPTION_"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:{desktop:"Aloha"},"text-before":{desktop:"$ "},"icon-left":{desktop:"Gear",mobile:"Code"},"icon-right":{mobile:"Code"},title:{desktop:"Aloha"},"text-aria-hidden":!0,"text-screen-reader":{desktop:"Aloha",mobile:"Aloha-mobile"},href:"https://github.com/"})]),_:1},8,["code-html","code-js"])}const ct=c(lt,[["render",it]]);function rt(){return{codeHtml:`<a-link
  class="a_btn a_btn_link"
  text="primary"
  :disabled="true"
  href="https://github.com/"
...
};`}}const Ge={name:"PageLinkSlotPrepend",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=He(),{codeJs:_}=De();return{codeHtml:t,codeJs:_}}},Ke=b("span",null,"(***)",-1);function Je(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return m(),r(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_SLOT_PREPEND_HEADER_",description:"_A_LINK_GROUP_SLOT_PREPEND_DESCRIPTION_",slots:"linkPrepend"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:"Aloha",href:"https://github.com/"},{linkPrepend:l(()=>[Ke]),_:1})]),_:1},8,["code-html","code-js"])}const Ce=c(Ge,[["render",Je]]);function je(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  text="Aloha"
  :is-title-html="true"
  href="https://github.com/"
...
</a-link>`}}function ve(){return{codeJs:`import ALink from "aloha-vue/src/ALink/ALink";
...
};`}}const Be={name:"PageLinkSlotTitle",components:{ALink:d,AlohaExample:h},setup(){const{codeHtml:t}=je(),{codeJs:_}=ve();return{codeHtml:t,codeJs:_}}},Ue=b("strong",null,"(***Aloha***)",-1);function Me(t,_,o,i,p,u){const n=a("a-link"),s=a("aloha-example");return m(),r(s,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_SLOT_TITLE_HEADER_",description:"_A_LINK_GROUP_SLOT_TITLE_DESCRIPTION_",slots:"linkTitle"},{default:l(()=>[e(n,{class:"a_btn a_btn_primary",text:"Aloha","is-title-html":!0,href:"https://github.com/"},{linkTitle:l(()=>[Ue]),_:1})]),_:1},8,["code-html","code-js"])}const Xe=c(Be,[["render",Me]]);function qe(){return{codeHtml:`<a-link
  class="a_btn a_btn_primary"
  text="_SHOW_MORE_"
  text-after=" €"
  text-before="$ "
