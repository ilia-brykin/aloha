...
};`}}const C={name:"PageTemplateHtml",components:{AlohaExample:A,ATemplate:h},setup(){const e="<ul><li>Aloha 1</li><li>Aloha 2</li></ul>",{codeHtml:t}=J(),{codeJs:l}=v();return{codeHtml:t,codeJs:l,html:e}}};function F(e,t,l,r,u,T){const n=o("a-template"),s=o("aloha-example");return i(),c(s,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TEMPLATE_GROUP_HTML_HEADER_",description:"_A_TEMPLATE_GROUP_HTML_DESCRIPTION_",props:["html"]},{default:m(()=>[a(n,{html:e.html},null,8,["html"])]),_:1},8,["code-html","code-js"])}const U=_(C,[["render",F]]);function j(){return{codeHtml:`<a-template
