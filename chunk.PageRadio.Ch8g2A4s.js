import{A as b,a as W}from"./chunk.AlohaExample.DVnVMcKR.js";import{A as Q}from"./chunk.AlohaTableProps.CSVVAKjg.js";import{A as z}from"./chunk.AlohaTableTranslate.BCm6jUcD.js";import{Q as R,_ as m,g as Z,A as x}from"./bundle.index.z5gwPU4G.js";import{r as u,Y as c,W as p,aU as A,f as d,$ as r,_ as s,aV as f,d as E}from"./chunk.vendor.CWr53wb5.js";import"./chunk.vendor-lodash.CWoM99Se.js";import"./chunk.APageTabTitle.CEPAqBab.js";import"./chunk.AlohaHighlightjs.Cyb5M4zM.js";import"./chunk.ATable.DDMzSsN7.js";import"./chunk.translations-ar.CG00cKrz.js";import"./chunk.translations-de.jRMdBWJu.js";import"./chunk.translations-en.Ccpp2c3W.js";import"./chunk.translations-es.Bh9mDab1.js";import"./chunk.translations-fr.B3yhrsaC.js";import"./chunk.translations-hr.B5_cxohh.js";import"./chunk.translations-it.DDcVOPnN.js";import"./chunk.translations-ru.BxzwpxMH.js";function aa(){return{codeHtml:`<a-radio
  v-model="model"
  :data="data"
  label="Aloha"
></a-radio>
...
};`}}const fa={name:"PageRadioDataExtra",components:{AlohaExample:b,ARadio:R},setup(){const{codeHtml:a}=ba(),{codeJs:l}=Ra(),t=[{label:"Aloha 0",id:"aloha_0",aloha:"",alohaBR:"Köln"},{label:"Aloha 1",id:"aloha_1",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 2",id:"aloha_2",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 3",id:"aloha_3",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 4",id:"aloha_4",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 5",id:"aloha_5",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 6",id:"aloha_6",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 7",id:"aloha_7",aloha:"Alex",alohaBR:"Düsseldorf"},{label:"Aloha 8",id:"aloha_8",aloha:"Alex",alohaBR:"Düsseldorf"}],n=[["extra_id_1","Extra 1"],["extra_id_2","Extra 2"]],h=[{label:"Extra 1",id:"extra_id_1",group:"Recommended"},{label:"Extra 2",id:"extra_id_2",group:"Other"},{label:"Extra 3",id:"extra_id_3",group:"Other"}],i=u(void 0),e=u(void 0);return{codeHtml:a,codeJs:l,data:t,dataExtraArrayOfArrays:n,dataExtraArrayOfObjects:h,model1:i,model2:e}}},Ia={class:"a_columns a_columns_count_12"},Pa={class:"a_column a_column_6 a_columns_count_12_touch"};function Ea(a,l,t,n,h,i){const e=d("a-radio"),_=d("aloha-example");return c(),p(_,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_DATA_EXTRA_HEADER_",description:"_A_UI_GROUP_DATA_EXTRA_DESCRIPTION_",props:["data-extra","key-group"]},{default:A(()=>[s("div",Ia,[s("div",Pa,[r(e,{modelValue:a.model1,"onUpdate:modelValue":l[0]||(l[0]=o=>a.model1=o),"data-extra":a.dataExtraArrayOfArrays,data:a.data,search:!0,"key-id":"id","key-label":"label",label:"Data extra (Array of Arrays)"},null,8,["modelValue","data-extra","data"]),s("div",null,"model1: "+f(a.model1),1),r(e,{class:"a_mt_3",modelValue:a.model2,"onUpdate:modelValue":l[1]||(l[1]=o=>a.model2=o),"data-extra":a.dataExtraArrayOfObjects,data:a.data,search:!0,"key-id":"id","key-label":"label","key-group":"group",label:"Grouped data extra (Array of Objects)"},null,8,["modelValue","data-extra","data"]),s("div",null,"model2: "+f(a.model2),1)])])]),_:1},8,["code-html","code-js"])}const ga=m(fa,[["render",Ea]]);function ya(){return{codeHtml:`<a-radio
  v-model="model"
  :data="data"
  errors="Aloha"
  label="Radio"
...
};`}}const Ua={name:"PageRadioFocusBlur",components:{AlohaExample:b,ARadio:R},setup(){const a=[{label:"Aloha 0",id:"aloha_0",aloha:"",alohaBR:"Köln"},{label:"Aloha 1",id:"aloha_1",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 2",id:"aloha_2",aloha:"Buba",alohaBR:"Köln"},{label:"Aloha 3",id:"aloha_3",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 4",id:"aloha_4",aloha:"Sandra",alohaBR:"Köln"},{label:"Aloha 5",id:"aloha_5",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 6",id:"aloha_6",aloha:"Coco",alohaBR:"Düsseldorf"},{label:"Aloha 7",id:"aloha_7",aloha:"Alex",alohaBR:"Düsseldorf"},{label:"Aloha 8",id:"aloha_8",aloha:"Alex",alohaBR:"Düsseldorf"}],l=u(void 0),t=({event:o,props:I})=>{console.log("focusin1",o,I)},n=({event:o,props:I})=>{console.log("focusin2",o,I)},h=({event:o,props:I})=>{console.log("focusout1",o,I)},i=({event:o,props:I})=>{console.log("focusout2",o,I)},{codeHtml:e}=Da(),{codeJs:_}=ka();return{codeHtml:e,codeJs:_,data:a,focusin1:t,focusin2:n,focusout1:h,focusout2:i,model:l}}};function Ta(a,l,t,n,h,i){const e=d("a-radio"),_=d("aloha-example");return c(),p(_,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_FOCUS_BLUR_HEADER_",description:"_A_UI_GROUP_FOCUS_BLUR_DESCRIPTION_",emits:["focusin","focusout"]},{default:A(()=>[r(e,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=o=>a.model=o),data:a.data,"key-group":["alohaBR","aloha"],search:!0,"key-id":"id","key-label":"label",label:"Radio1",onFocusin:a.focusin1,onFocusout:a.focusout1},null,8,["modelValue","data","onFocusin","onFocusout"]),r(e,{class:"a_mt_5",modelValue:a.model,"onUpdate:modelValue":l[1]||(l[1]=o=>a.model=o),data:a.data,"key-group":["alohaBR","aloha"],"is-button-group":!0,search:!0,"key-id":"id","key-label":"label",label:"Radio2","class-button-group-default":"a_btn a_btn_outline_secondary a_text_nowrap",onFocusin:a.focusin2,onFocusout:a.focusout2},null,8,["modelValue","data","onFocusin","onFocusout"])]),_:1},8,["code-html","code-js"])}const $a=m(Ua,[["render",Ta]]);function Ca(){return{codeHtml:`<a-radio
  v-model="model"
  :data="data"
  :key-group="['alohaBR', 'aloha']"
  key-id="id"
...
};`}}const Uo={name:"PageRadioSearchTextInHtml",components:{AlohaExample:b,ARadio:R},setup(){const{codeHtml:a}=Do(),{codeJs:l}=ko(),t=[{label:"<span>Aloha</span> <strong>1</strong>",id:"aloha_0",aloha:"",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>2</strong>",id:"aloha_1",aloha:"Buba",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>3</strong>",id:"aloha_2",aloha:"Buba",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>4</strong>",id:"aloha_3",aloha:"Sandra",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>5</strong>",id:"aloha_4",aloha:"Sandra",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>6</strong>",id:"aloha_5",aloha:"Coco",alohaBR:"<strong>Düsseldorf</strong>"},{label:"<span>Aloha</span> <strong>7</strong>",id:"aloha_6",aloha:"Coco",alohaBR:"<strong>Düsseldorf</strong>"},{label:"<span>Aloha</span> <strong>8</strong>",id:"aloha_7",aloha:"Alex",alohaBR:"<strong>Düsseldorf</strong>"},{label:"<span>Aloha</span> <strong>9</strong>",id:"aloha_8",aloha:"Alex",alohaBR:"<strong>Düsseldorf</strong>"}],n=u("aloha_7");return{codeHtml:a,codeJs:l,data:t,model:n}}},To={class:"a_columns a_columns_count_12"},$o={class:"a_column a_column_6 a_columns_count_12_touch"};function Co(a,l,t,n,h,i){const e=d("a-radio"),_=d("aloha-example");return c(),p(_,{"code-html":a.codeHtml,"code-js":a.codeJs,header:"_A_UI_GROUP_SEARCH_TEXT_IN_HTML_HEADER_",description:"_A_UI_GROUP_SEARCH_TEXT_IN_HTML_DESCRIPTION_",props:["search","search-text-in-html"]},{default:A(()=>[s("div",To,[s("div",$o,[r(e,{modelValue:a.model,"onUpdate:modelValue":l[0]||(l[0]=o=>a.model=o),data:a.data,"key-group":["alohaBR","aloha"],"search-in-group":!0,"search-text-in-html":!0,search:!0,"key-id":"id","key-label":"label",label:"Aloha group"},null,8,["modelValue","data"]),r(e,{class:"a_mt_3",modelValue:a.model,"onUpdate:modelValue":l[1]||(l[1]=o=>a.model=o),data:a.data,"search-text-in-html":!0,search:!0,"key-id":"id","key-label":"label",label:"Aloha"},null,8,["modelValue","data"]),s("div",null,"model: "+f(a.model),1)])])]),_:1},8,["code-html","code-js"])}const Ho=m(Uo,[["render",Co]]);function No(){return{codeHtml:`<a-radio
  v-model="model"
  :data="data"
