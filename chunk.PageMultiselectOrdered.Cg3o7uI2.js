import{A,a as v}from"./chunk.AlohaExample.BtGipkxf.js";import{A as N}from"./chunk.AlohaTableProps.BAyfHDfG.js";import{A as U}from"./chunk.AlohaTableTranslate.CcPltOW0.js";import{n as S,_ as c,g as M,A as B}from"./bundle.index.CwqHJ84O.js";import{r as u,Y as m,W as p,aU as E,f as a,$ as _,_ as R,aV as I,d as P}from"./chunk.vendor.CWr53wb5.js";import"./chunk.vendor-lodash.CWoM99Se.js";import"./chunk.APageTabTitle.Baaj9M4x.js";import"./chunk.AlohaHighlightjs.Cyb5M4zM.js";import"./chunk.ATable.BBE5pLFK.js";import"./chunk.translations-ar.DRto1jDw.js";import"./chunk.translations-de.CEjcANRo.js";import"./chunk.translations-en.BjlQK_tj.js";import"./chunk.translations-es.BcLAUo0L.js";import"./chunk.translations-fr.DINmPQrz.js";import"./chunk.translations-hr.BU9Fw-5f.js";import"./chunk.translations-it.Cu9SxZzh.js";import"./chunk.translations-ru.Cs_zBe4-.js";function q(){return{codeHtml:`<a-multiselect-ordered
  v-model="model1"
  :data="data"
  key-id="value"
  key-label="label"
...
};`}}const $={name:"PageMultiselectOrderedBasic",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],l=u(["aloha_4","aloha_2"]),t=u(void 0),{codeHtml:d}=q(),{codeJs:s}=H();return{codeHtml:d,codeJs:s,data:e,model1:l,model2:t}}};function k(e,l,t,d,s,i){const r=a("a-multiselect-ordered"),n=a("aloha-example");return m(),p(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["data","model-value","label"]},{default:E(()=>[_(r,{modelValue:e.model1,"onUpdate:modelValue":l[0]||(l[0]=o=>e.model1=o),data:e.data,"key-id":"value","key-label":"label",label:"Select 1"},null,8,["modelValue","data"]),R("div",null,"model1: "+I(e.model1),1),_(r,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":l[1]||(l[1]=o=>e.model2=o),data:e.data,"key-id":"value","key-label":"label",label:"Select 2"},null,8,["modelValue","data"]),R("div",null,"model2: "+I(e.model2),1)]),_:1},8,["code-html","code-js"])}const V=c($,[["render",k]]);function J(){return{codeHtml:`<a-multiselect-ordered
  :change="changeModel"
  :model-value="model"
  :data="data"
  key-id="value"
