import{A as m,a as A}from"./chunk.AlohaExample.CMUUEVcN.js";import{aH as r,_ as p,A as B}from"./bundle.index.DOWaPX07.js";import{P as E,a as T,b as x}from"./chunk.PageFilterTest.CqA3wSrh.js";import{P as $}from"./chunk.PageFilterImportCompositionApi.DTdLG250.js";import{B as i,C as s,m as t,L as R,G as a}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function v(){return{codeJs:`filterPropertyByValue("111", { mapping: { aloha: "1", holla: "2" }, defaultValue: "not found" });
// ${r("111",{mapping:{aloha:"1",holla:"2"},defaultValue:"not found"})}
filterPropertyByValue("222", { mapping: { aloha: "1", holla: "2" }, defaultValue: "0" });
// ${r("222",{mapping:{aloha:"1",holla:"2"},defaultValue:"0"})}`}}const F={name:"PageFilterPropertyByValueDefaultValue",components:{AlohaExample:m},setup(){const{codeJs:e}=v();return{codeJs:e}}};function I(e,n,l,u,c,_){const o=t("aloha-example");return i(),s(o,{"code-js":e.codeJs,header:"defaultValue","is-code-visible-default":!0},null,8,["code-js"])}const L=p(F,[["render",I]]);function b(){return{codeJs:`filterPropertyByValue("111", { mapping: { aloha: "1", holla: "2" } });
// ${r("111",{mapping:{aloha:"1",holla:"2"}})}
filterPropertyByValue("aloha", { mapping: { aloha: "1", holla: "2" } });
// ${r("aloha",{mapping:{aloha:"1",holla:"2"}})}`}}const J={name:"PageFilterPropertyByValueMapping",components:{AlohaExample:m},setup(){const{codeJs:e}=b();return{codeJs:e}}};function U(e,n,l,u,c,_){const o=t("aloha-example");return i(),s(o,{"code-js":e.codeJs,header:"mapping","is-code-visible-default":!0},null,8,["code-js"])}const G=p(J,[["render",U]]);function Y(){return{argumentsText:[{value:"value",types:["Any"],text:"_PAGE_FILTER_PROPERTY_BY_VALUE_ARGUMENTS_VALUE_"},{value:"[mapping={}]",types:["Object"],text:"_PAGE_FILTER_PROPERTY_BY_VALUE_ARGUMENTS_MAPPING_"},{value:'[defaultValue=""]',types:["String"],text:"_PAGE_FILTER_PROPERTY_BY_VALUE_ARGUMENTS_DEFAULT_VALUE_"}]}}function M(){return{pageTitle:"filterPropertyByValue"}}const N=`import filterPropertyByValue from "../filterPropertyByValue";
