import{A as x,a as A}from"./chunk.AlohaExample.CjncY9yb.js";import{aK as o,_ as s,A as E}from"./bundle.index.D9gcatRx.js";import{P as J,a as I,b as F}from"./chunk.PageFilterTest.XRvw5J-J.js";import{P as b}from"./chunk.PageFilterImportCompositionApi.Bxn2dkOk.js";import{k as t,J as r,H as c,aJ as C,O as a}from"./chunk.vendor.Ca3-nzbX.js";import"./chunk.vendor-lodash.-viuv_rg.js";function R(){return{codeJs:`filterLink("example.com");
// ${o("example.com")}
...
// ${o("example.com",{protocol:"http://"})}`}}const D={name:"PageFilterLinkProtocol",components:{AlohaExample:x},setup(){const{codeJs:e}=O();return{codeJs:e}}};function H(e,l,i,p,m,_){const n=t("aloha-example");return c(),r(n,{"code-js":e.codeJs,header:"protocol","is-code-visible-default":!0},null,8,["code-js"])}const V=s(D,[["render",H]]);function X(){return{codeJs:`filterLink("example.com", { target: "_blank" });
