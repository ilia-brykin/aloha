...
};`}}const Ae={name:"PageShowMoreBtnTitle",components:{AlohaExample:g,AShowMore:v},setup(){const{codeHtml:e}=xe(),{codeJs:t}=we();return{codeHtml:e,codeJs:t,html:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
Phasellus bibendum turpis ut ipsum egestas, sed sollicitudin elit convallis. 
Cras pharetra mi tristique sapien vestibulum lobortis. Nam eget bibendum metus, 
non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.</p>`}}},Dt={class:"a_columns a_columns_count_12"},xt={class:"a_column a_column_4 a_column_12_tablet"};function wt(e,t,u,s,n,c){const o=a("a-show-more"),l=a("aloha-example");return _(),b(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_SHOW_MORE_GROUP_NOT_LESS_HEADER_",description:"_A_SHOW_MORE_GROUP_NOT_LESS_DESCRIPTION_",props:"show-less"},{default:p(()=>[i("div",Dt,[i("div",xt,[r(o,{html:e.html,"show-less":!1},null,8,["html"])])])]),_:1},8,["code-html","code-js"])}const At=d(Rt,[["render",wt]]);function Ht(){return{codeHtml:`<a-show-more 
  :html="html"
