...
};`}}const Q={name:"PageTextareaHelpText",components:{AlohaExample:f,ATextarea:P},setup(){const e=E("Aloha"),{codeHtml:a}=Z(),{codeJs:o}=W();return{codeHtml:a,codeJs:o,model:e}}};function Y(e,a,o,s,_,m){const r=t("a-textarea"),d=t("aloha-example");return c(),u(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[n(r,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=l=>e.model=l),"help-text":"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const K=p(Q,[["render",Y]]);function ee(){return{codeHtml:`<a-textarea
  v-model="model"
  :is-scalable="true"
  label="Textarea"
></a-textarea>
