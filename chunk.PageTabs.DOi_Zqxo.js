...
};`}}const Ke={name:"PageTabsIsChangeOutside",components:{AlohaExample:p,ATabs:B},setup(){const e=L("1"),t=[{label:"_A_TABS_TAB_1_",content:"_A_TABS_CONTENT_1_",id:"1"},{label:"_A_TABS_TAB_2_",content:"_A_TABS_CONTENT_2_",id:"2"},{label:"_A_TABS_TAB_3_",content:"_A_TABS_CONTENT_3_",id:"3"},{label:"_A_TABS_TAB_4_",content:"_A_TABS_CONTENT_4_",id:"4"}],a=({$event:d,tab:_,tabId:n,index:i})=>{console.log("$event, tab, tabId, index",d,_,n,i),e.value=n},{codeHtml:s}=qe(),{codeJs:c}=Ge();return{activeTabId:e,changeTab:a,codeHtml:s,codeJs:c,data:t}}};function je(e,t,a,s,c,d){const _=o("a-tabs"),n=o("aloha-example");return m(),u(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TABS_GROUP_IS_CHANGE_OUTSIDE_HEADER_",description:"_A_TABS_GROUP_IS_CHANGE_OUTSIDE_DESCRIPTION_",props:["is-change-outside","active-tab-id"],emits:["change"]},{default:T(()=>[l(_,{data:e.data,"active-tab-id":e.activeTabId,"is-change-outside":!0,"key-id":"id",onChange:e.changeTab},null,8,["data","active-tab-id","onChange"])]),_:1},8,["code-html","code-js"])}const Ue=b(Ke,[["render",je]]);function Fe(){return{codeHtml:`<a-tabs
  :data="data"
  :is-vertical="true"
></a-tabs>
<a-tabs
