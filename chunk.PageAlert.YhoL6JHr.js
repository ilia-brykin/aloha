...
export default {
  ...
  components: {
    AAlert,
...
};`}}const j={name:"PageAlertBasic",components:{AAlert:d,AlohaExample:A},setup(){const{codeHtml:e}=B(),{codeJs:s}=U();return{codeHtml:e,codeJs:s,html:`<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
      ...
      non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.</p>`}}};function G(e,s,l,n,i,p){const o=a("a-alert"),r=a("aloha-example");return _(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:"is-visible"},{default:u(()=>[t(o,{html:"AAlert","is-visible":!0})]),_:1},8,["code-html","code-js"])}const M=m(j,[["render",G]]);function k(){return{codeHtml:`<a-alert 
  text="Aloha"
  :is-visible="true"
  type="success"
...
};`}}const z={name:"PageAlertClosable",components:{AAlert:d,AButton:P,AlohaExample:A},setup(){const{codeHtml:e}=W(),{codeJs:s}=Y(),l=g(!0);return{codeHtml:e,codeJs:s,hideAlert:()=>{l.value=!1},isAlertVisible:l,showAlert:()=>{l.value=!0}}}};function K(e,s,l,n,i,p){const o=a("a-button"),r=a("a-alert"),b=a("aloha-example");return _(),c(b,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_CLOSABLE_HEADER_",description:"_A_ALERT_GROUP_CLOSABLE_DESCRIPTION_",props:"closable",emits:"close"},{default:u(()=>[h("div",null,[e.isAlertVisible?J("",!0):(_(),c(o,{key:0,class:"a_btn a_btn_primary",text:"_A_ALERT_GROUP_CLOSABLE_FROM_OUTSIDE_SHOW_ALERT_",onClick:e.showAlert},null,8,["onClick"]))]),t(r,{html:"Alert success","is-visible":e.isAlertVisible,type:"success",closable:!0,onClose:e.hideAlert},null,8,["is-visible","onClose"])]),_:1},8,["code-html","code-js"])}const Z=m(z,[["render",K]]);function ee(){return{codeHtml:`<a-alert 
  html="Alert success"
  :is-visible="true"
  type="success"
  :show-icon="true"
...
};`}}const pe={name:"PageAlertHtml",components:{AAlert:d,AlohaExample:A},setup(){const{codeHtml:e}=_e(),{codeJs:s}=me();return{codeHtml:e,codeJs:s,html:`<p onclick="alert('Aloha')">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
      pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
      Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
      in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
      per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
<a-alert 
  ...
  :show-icon="true"
>
</a-alert>`}}function ve(){return{codeJs:`import { 
  AAlert,
} from "aloha-vue";
...
};`}}const Re={name:"PageAlertIconsDefault",components:{AAlert:d,AlohaExample:A},setup(){const{codeHtml:e}=ge(),{codeJs:s}=ve();return{codeHtml:e,codeJs:s}}};function Te(e,s,l,n,i,p){const o=a("a-alert"),r=a("aloha-example");return _(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_ICONS_DEFAULT_HEADER_",description:"_A_ALERT_GROUP_ICONS_DEFAULT_DESCRIPTION_",props:"show-icon"},{default:u(()=>[t(o,{html:"Alert success","is-visible":!0,type:"success","show-icon":!0}),t(o,{html:"Alert info","is-visible":!0,type:"info","show-icon":!0}),t(o,{html:"Alert warning","is-visible":!0,type:"warning","show-icon":!0}),t(o,{html:"Alert danger","is-visible":!0,type:"danger","show-icon":!0})]),_:1},8,["code-html","code-js"])}const Se=m(Re,[["render",Te]]);function Oe(){return{codeHtml:`<a-alert 
  html="Alert success"
  :is-visible="true"
  type="success"
  :closable="true"
...
};`}}const Ne={name:"PageAlertSafeHtml",components:{AAlert:d,AlohaExample:A},setup(){const{codeHtml:e}=Ce(),{codeJs:s}=He();return{codeHtml:e,codeJs:s,html:`<p onclick="alert('Aloha')">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
      pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
      Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
      in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
      per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
...
};`}}const Me={name:"PageAlertText",components:{AAlert:d,AlohaExample:A},setup(){const{codeHtml:e}=je(),{codeJs:s}=Ge();return{codeHtml:e,codeJs:s,text:"Lorem ipsum dolor sit amet"}}};function ke(e,s,l,n,i,p){const o=a("a-alert"),r=a("aloha-example");return _(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_TEXT_HEADER_",description:"_A_ALERT_GROUP_TEXT_DESCRIPTION_",props:"text"},{default:u(()=>[t(o,{text:e.text,"is-visible":!0,type:"primary"},null,8,["text"])]),_:1},8,["code-html","code-js"])}const Ve=m(Me,[["render",ke]]);function Fe(){return{codeHtml:`<a-alert 
  html="Alert success" 
  :is-visible="true" 
  type="success"
>
