import{A as S,a as D}from"./chunk.AlohaExample.BcPB8Qry.js";import{A as h}from"./chunk.AlohaTableProps.B6_mPHyq.js";import{A as U}from"./chunk.AlohaTableTranslate.D5UoyO8w.js";import{h as P,_ as p,g as C,A as b}from"./bundle.index.q0oygsl8.js";import{r as I,k as n,Q as c,aQ as u,O as i,V as t,U as A,aR as O,a as E}from"./chunk.vendor.C_nZR3i9.js";import"./chunk.APageTabTitle.YhYn5T6u.js";import"./chunk.AlohaHighlightjs.zzXDUp_j.js";import"./chunk.vendor-lodash.BzDRedSD.js";import"./chunk.ATable.Dm0jLwEE.js";import"./chunk.translations-ar.CGL8aVo9.js";import"./chunk.translations-de.RdwLQ5AB.js";import"./chunk.translations-en.DDBINhYl.js";import"./chunk.translations-es.Db8DPcgi.js";import"./chunk.translations-fr.Bj0H1VLd.js";import"./chunk.translations-hr.D6Hyl4N8.js";import"./chunk.translations-it.BR5rbHtH.js";import"./chunk.translations-ru.BkDZ_0rg.js";function j(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<div>model:</div>
...
};`}}const x={name:"PageJsonErrors",components:{AJson:P,AlohaExample:S},setup(){const e=I({}),{codeHtml:o}=V(),{codeJs:a}=k();return{codeHtml:o,codeJs:a,model:e}}};function F(e,o,a,d,_,m){const s=n("a-json"),l=n("aloha-example");return i(),c(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),errors:"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const X=p(x,[["render",F]]);function Q(){return{codeHtml:`<a-json
  v-model="model"
  help-text="Aloha"
  label="JSON"
...
};`}}const z={name:"PageJsonHelpText",components:{AJson:P,AlohaExample:S},setup(){const e=I({}),{codeHtml:o}=Q(),{codeJs:a}=w();return{codeHtml:o,codeJs:a,model:e}}};function W(e,o,a,d,_,m){const s=n("a-json"),l=n("aloha-example");return i(),c(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:u(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),"help-text":"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=p(z,[["render",W]]);function K(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<a-json
