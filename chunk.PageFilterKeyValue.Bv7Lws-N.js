import{A as d,a as x}from"./chunk.AlohaExample.wWuHaNWc.js";import{P as V,a as K,b as A}from"./chunk.PageFilterTest.X7PevsJq.js";import{P as b}from"./chunk.PageFilterImportCompositionApi.BmIds8XV.js";import{aE as E,_ as i,A as P}from"./bundle.index.B35c-w_J.js";import{U as r,e as t,V as s,aS as v,Z as n}from"./chunk.vendor.COYgx38y.js";import"./chunk.vendor-lodash.xyEKcfD7.js";import"./chunk.APageTabTitle.HIlrONDf.js";import"./chunk.AlohaHighlightjs.CW1W2LCP.js";import"./chunk.translations-ar.DdW6Pri2.js";import"./chunk.translations-de.C0Pg9Cu0.js";import"./chunk.translations-en.BVWaiPVb.js";import"./chunk.translations-es.BPcLnyv8.js";import"./chunk.translations-fr.PZcafYmn.js";import"./chunk.translations-hr.DnDbRE79.js";import"./chunk.translations-it.DhOsfBNE.js";import"./chunk.translations-ru.DF-Kmeqf.js";function T(){return{codeJs:`filterKeyValue({ x: "aloha", y: 2 });
// ${E({x:"aloha",y:2})}`}}const j={name:"PageFilterKeyValueExample",components:{AlohaExample:d},setup(){const{codeJs:e}=T();return{codeJs:e}}};function B(e,a,l,p,u,c){const o=t("aloha-example");return s(),r(o,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const F=i(j,[["render",B]]);function $(){return{argumentsText:[{value:"value",types:["Object"],text:"_PAGE_FILTER_KEY_VALUE_ARGUMENTS_VALUE_"}]}}function I(){return{pageTitle:"filterKeyValue"}}const k=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
...
`,C={name:"PageFilterKeyValue",components:{AlohaPage:x,ATranslation:P,PageFilterArguments:A,PageFilterImportCompositionApi:b,PageFilterImportFunction:K,PageFilterKeyValueExample:F,PageFilterTest:V},setup(){const{pageTitle:e}=I(),{argumentsText:a}=$();return{argumentsText:a,pageTitle:e,test:k}}};function U(e,a,l,p,u,c){const o=t("a-translation"),m=t("page-filter-import-function"),_=t("page-filter-import-composition-api"),g=t("page-filter-arguments"),f=t("page-filter-key-value-example"),y=t("page-filter-test"),h=t("aloha-page");return s(),r(h,{"page-title":e.pageTitle},{body:v(()=>[n(o,{tag:"p",html:"_PAGE_FILTER_KEY_VALUE_DESCRIPTION_"}),n(m,{"function-name":"filterKeyValue","type-import":"filters"}),n(_,{"function-name":"filterKeyValue"}),n(g,{"arguments-text":e.argumentsText,"function-description":"filterKeyValue(value)"},null,8,["arguments-text"]),n(f),n(y,{test:e.test},null,8,["test"])]),_:1},8,["page-title"])}const W=i(C,[["render",U]]);export{W as default};
