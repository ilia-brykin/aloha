import{A as g,a as b}from"./chunk.AlohaExample.FXulhKLv.js";import{A as S}from"./chunk.AlohaTableProps.DTQQdQbF.js";import{a5 as h,_ as m,g as O,A as v}from"./bundle.index.Dg3km1_u.js";import{r as R,R as p,aR as i,e as a,U as c,W as t,Y as s,aS as E,d as P}from"./chunk.vendor.CDkHfsNc.js";import"./chunk.vendor-lodash.OlSEBnWT.js";import"./chunk.APageTabTitle.Cyh8N43-.js";import"./chunk.AlohaHighlightjs.DI9-5vSP.js";import"./chunk.ATable.D_dOG0Fc.js";import"./chunk.translations-ar.kBCJx-bM.js";import"./chunk.translations-de.CcH3uB05.js";import"./chunk.translations-en.CkfjxDk2.js";import"./chunk.translations-es.CpXwTaxM.js";import"./chunk.translations-fr.Dpmk0n6x.js";import"./chunk.translations-hr.U-WzYQZM.js";import"./chunk.translations-it.Omt4gBfb.js";import"./chunk.translations-ru.crR4rwWj.js";function $(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
...
};`}}const k={name:"PageInputNumberRangeTypeInteger",components:{AlohaExample:g,AInputNumberRange:h},setup(){const{codeHtml:e}=F(),{codeJs:o}=X(),n=R(void 0);return{codeHtml:e,codeJs:o,model:n}}},w={class:"a_columns a_columns_count_12"},W={class:"a_column a_column_6 a_columns_count_12_touch"},z={class:"a_mt_3"};function K(e,o,n,d,u,A){const l=a("a-input-number-range"),_=a("aloha-example");return c(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_DESCRIPTION_",props:"type='integerRange'"},{default:i(()=>[t("div",w,[t("div",W,[s(l,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=r=>e.model=r),label:"Aloha",type:"integerRange"},null,8,["modelValue"]),t("div",z,"model: "+E(e.model),1)])])]),_:1},8,["code-html","code-js"])}const Q=m(k,[["render",K]]);function Z(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
