...
// ${s(["label 1","label 2","label 3"],{isSimpleArray:!0})}`}}const N={name:"PageFilterListIsSimpleArray",components:{AlohaExample:b},setup(){const{codeJs:e}=w();return{codeJs:e}}};function U(e,t,r,n,_,u){const a=l("aloha-example");return p(),c(a,{"code-js":e.codeJs,header:"isSimpleArray=true","is-code-visible-default":!0},null,8,["code-js"])}const K=o(N,[["render",U]]);function O(){return{codeJs:`const ITEMS = [
  "Level 1",
    [
      "Level 2",
      [
...
// ${s(["x0",["x1",["x1.1","x1.2"]],"x3"],{isSimpleArray:!0})}`}}const Y={name:"PageFilterListIsSimpleArrayTree",components:{AlohaExample:b},setup(){const{codeJs:e}=O();return{codeJs:e}}};function z(e,t,r,n,_,u){const a=l("aloha-example");return p(),c(a,{"code-js":e.codeJs,header:"_PAGE_FILTER_LIST_IS_SIMPLE_ARRAY_TREE_HEADER_","is-code-visible-default":!0},null,8,["code-js"])}const D=o(Y,[["render",z]]);function V(){return{codeJs:`const ITEMS = [
  {
    label: "Level 1",
    children: [
      {
