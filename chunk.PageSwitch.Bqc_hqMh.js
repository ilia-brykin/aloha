...
};`}}const J={name:"PageSwitchBasic",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=y(),{codeJs:a}=B();return{codeHtml:t,codeJs:a,model:e}}};function V(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return p(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s)},null,8,["modelValue"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(J,[["render",V]]);function F(){return{codeHtml:`<a-switch
  :change="changeModel"
  :model-value="model"
></a-switch>
...
};`}}const k={name:"PageSwitchErrors",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=x(),{codeJs:a}=X();return{codeHtml:t,codeJs:a,model:e}}};function Q(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return p(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=i(k,[["render",Q]]);function z(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
...
};`}}const Z={name:"PageSwitchHelpText",components:{AlohaExample:S,ASwitch:h},setup(){const e=f(!1),{codeHtml:t}=z(),{codeJs:a}=K();return{codeHtml:t,codeJs:a,model:e}}};function ee(e,t,a,d,_,c){const n=o("a-switch"),r=o("aloha-example");return p(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),"help-text":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=i(Z,[["render",ee]]);function oe(){return{codeHtml:`<a-switch
  v-model="model"
  label="ASwitch"
></a-switch>
<a-switch
