import{A as f,a as Y}from"./chunk.AlohaExample.DQald-L_.js";import{A as q}from"./chunk.AlohaTableProps.nxAQILM8.js";import{A as G}from"./chunk.AlohaTableTranslate.CSmDkKaH.js";import{w as R,ah as s,aM as M,a3 as j}from"./bundle.index.D1OA29U_.js";import{bf as m,bc as _,aQ as i,br as I,bi as l,aV as r,aP as P,bn as y,aN as A}from"./chunk.vendor.B7xidcyX.js";import"./chunk.vendor-lodash.DHCI5OYQ.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function B(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="Input"
></a-input-currency>
...
};`}}const X={name:"PageInputCurrencyBasic",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=B(),{codeJs:a}=F();return{codeHtml:n,codeJs:a,model:e}}};function w(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const k=s(X,[["render",w]]);function Q(){return{codeHtml:`<a-input-currency
  :change="changeModel"
  :model-value="model"
  label="Input"
></a-input-currency>
...
};`}}const z={name:"PageInputCurrencyChange",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),n=({model:c,id:p,props:t})=>{e.value=c,console.log(p,t)},{codeHtml:a}=Q(),{codeJs:u}=W();return{changeModel:n,codeHtml:a,codeJs:u,model:e}}};function K(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:I(()=>[r(t,{change:e.changeModel,"model-value":e.model,label:"Input"},null,8,["change","model-value"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const Z=s(z,[["render",K]]);function x(){return{codeHtml:`<a-input-currency
  v-model="model"
  controls-type="none"
  label="Input"
></a-input-currency>
...
};`}}const pe={name:"PageInputCurrencyDecimalPartLength",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=ce(),{codeJs:a}=me();return{codeHtml:n,codeJs:a,model:e}}};function se(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_DECIMAL_PART_LENGTH_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_DECIMAL_PART_LENGTH_DESCRIPTION_",props:["decimal-part-length"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"decimal-part-length":0,label:"decimal-part-length 0"},null,8,["modelValue"]),r(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),"decimal-part-length":1,label:"decimal-part-length 1"},null,8,["modelValue"]),r(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[2]||(n[2]=o=>e.model=o),"decimal-part-length":2,label:"decimal-part-length 2"},null,8,["modelValue"]),r(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[3]||(n[3]=o=>e.model=o),"decimal-part-length":4,label:"decimal-part-length 4"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const _e=s(pe,[["render",se]]);function ie(){return{codeHtml:`<a-input-currency
  v-model="model"
  errors="Aloha"
  label="Input"
></a-input-currency>
...
};`}}const Pe={name:"PageInputCurrencyErrors",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=ie(),{codeJs:a}=Ie();return{codeHtml:n,codeJs:a,model:e}}};function ye(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),errors:"Aloha",label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const fe=s(Pe,[["render",ye]]);function Re(){return{codeHtml:`<a-input-currency
  v-model="model"
  help-text="Aloha"
  label="Input"
></a-input-currency>
...
};`}}const Ae={name:"PageInputCurrencyHelpText",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=Re(),{codeJs:a}=Ce();return{codeHtml:n,codeJs:a,model:e}}};function Ee(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"help-text":"Aloha",label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const Ne=s(Ae,[["render",Ee]]);function Oe(){return{codeHtml:`<a-input-currency
  v-model="model"
...
};`}}const ge={name:"PageInputCurrencyLabelDescription",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=Oe(),{codeJs:a}=Ue();return{codeHtml:n,codeJs:a,model:e}}};function ve(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"is-label-float":!1,label:"Input","label-description":"Aloha"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const Se=s(ge,[["render",ve]]);function Te(){return{codeHtml:`<a-input-currency
  v-model="model"
  :is-label-float="false"
  label="Input"
></a-input-currency>
...
};`}}const be={name:"PageInputCurrencyLabelFloat",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=Te(),{codeJs:a}=he();return{codeHtml:n,codeJs:a,model:e}}};function De(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_IS_LABEL_FLOAT_HEADER_",description:"_A_UI_GROUP_IS_LABEL_FLOAT_DESCRIPTION_",props:["is-label-float"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),"is-label-float":!1,label:"Input"},null,8,["modelValue"]),r(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),"is-label-float":!0,label:"Input"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const $e=s(be,[["render",De]]);function He(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="Input"
></a-input-currency>
<a-input-currency
...
};`}}const Me={name:"PageInputCurrencyMaxMin",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),n=m(10.02),{codeHtml:a}=qe(),{codeJs:u}=Ge();return{codeHtml:a,codeJs:u,model1:e,model2:n}}};function je(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_MAX_MIN_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_MAX_MIN_DESCRIPTION_",props:["max","min"]},{default:I(()=>[r(t,{modelValue:e.model1,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model1=o),max:20,min:1,label:"1 - 20"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model1),1),r(t,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model2=o),max:19.05,min:-10.05,label:"-10.05 - 19.05"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model2),1)]),_:1},8,["code-html","code-js"])}const Be=s(Me,[["render",je]]);function Fe(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="number"
  model-type="number"
></a-input-currency>
...
};`}}const we={name:"PageInputCurrencyModelType",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=Fe(),{codeJs:a}=Xe();return{codeHtml:n,codeJs:a,model:e}}};function ke(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_MODEL_TYPE_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_MODEL_TYPE_DESCRIPTION_",props:["model-type"]},{default:I(()=>[r(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),label:"number","model-type":"number"},null,8,["modelValue"]),r(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),label:"string","model-type":"string"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const Qe=s(we,[["render",ke]]);function We(){return{codeHtml:`<a-input-currency
  v-model="model"
  help-text="Aloha"
  label="Input"
></a-input-currency>
...
};`}}const Ke={name:"PageInputCurrencyReadonly",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),n=m(1e4),a=m(void 0),{codeHtml:u}=We(),{codeJs:c}=ze();return{codeHtml:u,codeJs:c,model1:e,model2:n,model3:a}}};function Ze(e,n,a,u,c,p){const t=l("a-input-currency"),d=l("aloha-example");return _(),i(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:I(()=>[r(t,{"model-value":e.model1,readonly:!0,label:"Input 1"},null,8,["model-value"]),r(t,{class:"a_mt_3","model-value":e.model2,readonly:!0,label:"Input 2"},null,8,["model-value"]),r(t,{class:"a_mt_3","model-value":e.model3,readonly:!0,label:"Input 3"},null,8,["model-value"]),r(t,{class:"a_mt_3","model-value":e.model3,readonly:!0,"help-text":"Aloha",label:"Input 4","readonly-default":"-"},null,8,["model-value"])]),_:1},8,["code-html","code-js"])}const xe=s(Ke,[["render",Ze]]);function en(){return{codeHtml:`<a-input-currency
  v-model="model"
  :step="2"
  controls-type="plus-minus"
  label="step 2"
