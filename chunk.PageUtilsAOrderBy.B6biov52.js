...
// ${JSON.stringify(m)}`}}const R={name:"PageUtilsAOrderByExample",components:{AlohaExample:O},setup(){const{codeJs:n}=P();return{codeJs:n}}};function I(n,r,o,i,l,m){const c=a("aloha-example");return g(),_(c,{"code-js":n.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const $=d(R,[["render",I]]);function U(){return{argumentsText:[{value:"collection",types:["Array","Object"],text:"_PAGE_UTILS_A_ORDER_BY_ARGUMENTS_COLLECTION_"},{value:"iteratees",types:["String","Function","Array","Object","Null"],text:"_PAGE_UTILS_A_ORDER_BY_ARGUMENTS_ITERATEES_"},{value:"orders",types:["String","Array","Null"],text:"_PAGE_UTILS_A_ORDER_BY_ARGUMENTS_ORDERS_"},{value:"options",types:["Object"],text:"_PAGE_UTILS_A_ORDER_BY_ARGUMENTS_OPTIONS_"}]}}function C(){return{pageTitle:"aOrderBy"}}const q=`import {
  describe,
  expect,
  it,
} from "@jest/globals";
