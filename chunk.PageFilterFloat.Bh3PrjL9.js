import{A as g,a as G}from"./chunk.AlohaExample.ChWGlwlc.js";import{aS as o,_ as r,A as P}from"./bundle.index.DLk96wXl.js";import{P as T,a as I,b as E}from"./chunk.PageFilterTest.DsME3NfJ.js";import{m as e,C as s,B as f,L as J,G as n}from"./chunk.vendor.D-Y3mz6a.js";import{P as S}from"./chunk.PageFilterImportCompositionApi.BK_YDq1S.js";import"./chunk.vendor-lodash.ClBXVCWL.js";import"./chunk.vendor-tinymce.2RT9eEW9.js";function v(){return{codeJs:`filterFloat(1000222.55, { digitGrouping: false });
// ${o(100022255e-2,{digitGrouping:!1})}

filterFloat(1000222.55, { digitGrouping: true });
// ${o(100022255e-2,{digitGrouping:!0})}`}}const L={name:"PageFilterFloatDigitGrouping",components:{AlohaExample:g},setup(){const{codeJs:t}=v();return{codeJs:t}}};function R(t,l,a,p,c,u){const i=e("aloha-example");return f(),s(i,{"code-js":t.codeJs,header:"digitGrouping","is-code-visible-default":!0},null,8,["code-js"])}const b=r(L,[["render",R]]);function N(){return{codeJs:`filterFloat(2000, { digits: 0 });
// ${o(2e3,{digits:0})}

filterFloat("25.53451", { digits: 4 });
// ${o("25.53451",{digits:4})}`}}const j={name:"PageFilterFloatDigits",components:{AlohaExample:g},setup(){const{codeJs:t}=N();return{codeJs:t}}};function U(t,l,a,p,c,u){const i=e("aloha-example");return f(),s(i,{"code-js":t.codeJs,header:"digits","is-code-visible-default":!0},null,8,["code-js"])}const D=r(j,[["render",U]]);function O(){return{codeJs:`filterFloat(123456);
// ${o(123456)}
...
// ${o("25.5",{suffix:"%"})}`}}const w={name:"PageFilterFloatSuffix",components:{AlohaExample:g},setup(){const{codeJs:t}=k();return{codeJs:t}}};function V(t,l,a,p,c,u){const i=e("aloha-example");return f(),s(i,{"code-js":t.codeJs,header:"suffix","is-code-visible-default":!0},null,8,["code-js"])}const X=r(w,[["render",V]]);function q(){return{argumentsText:[{value:"value",types:["Number","String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_VALUE_"},{value:'[suffix=""]',types:["String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_SUFFIX_"},{value:"[digits=2]",types:["Number"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGITS_"},{value:"[digitGrouping=true]",types:["Boolean"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGIT_GROUPING_"}]}}function z(){return{pageTitle:"filterFloat"}}const H=`import filterFloat from "../filterFloat";
