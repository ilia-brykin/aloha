import{A as c,a as P}from"./chunk.AlohaExample.c0lK4xeX.js";import{al as t,_ as s,A as T}from"./bundle.index.Bnk4n8mj.js";import{P as x,a as h,b as F}from"./chunk.PageFilterTest.BU4-rZGz.js";import{a as m,k as o,Q as u,O as i,aR as I,V as l}from"./chunk.vendor.CKp6uFg6.js";import"./chunk.vendor-lodash.PFnXOCw6.js";import{P as J}from"./chunk.PageFilterImportCompositionApi.6G2xNIHc.js";import{f as L}from"./chunk.filterBoolean.test.DygJ_39J.js";import"./chunk.APageTabTitle.CSMpk_jC.js";import"./chunk.AlohaHighlightjs.BV1_SJG8.js";import"./chunk.translations-ar.BDutgt0v.js";import"./chunk.translations-de.1a3sgRj7.js";import"./chunk.translations-en.BBi3Bg6e.js";import"./chunk.translations-es.BtBPtY4X.js";import"./chunk.translations-fr.Bg3PfzNk.js";import"./chunk.translations-hr.CIMS9XA_.js";import"./chunk.translations-it.DIzh0LMI.js";import"./chunk.translations-ru.COuwmRYJ.js";function O(){return{codeJs:m(()=>`filterBoolean(true);
// ${t(!0)}
filterBoolean(false);
// ${t(!1)}
...
// ${t("aloha")}
filterBoolean("");
// ${t("")}`)}}const S={name:"PageFilterBooleanExample",components:{AlohaExample:c},setup(){const{codeJs:e}=O();return{codeJs:e}}};function v(e,n,r,p,_,f){const a=o("aloha-example");return i(),u(a,{"code-js":e.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const R=s(S,[["render",v]]);function U(){return{codeJs:m(()=>`filterBoolean(true, { trueValue: "1", falseValue: "0" });
...
// ${t(0,{trueValue:"true",falseValue:"false"})}`)}}const b={name:"PageFilterBooleanTrueFalseValues",components:{AlohaExample:c},setup(){const{codeJs:e}=U();return{codeJs:e}}};function G(e,n,r,p,_,f){const a=o("aloha-example");return i(),u(a,{"code-js":e.codeJs,header:"trueValue, falseValue","is-code-visible-default":!0},null,8,["code-js"])}const y=s(b,[["render",G]]);function j(){return{codeJs:m(()=>`filterBoolean(null, { useNil: true });
// ${t(null,{useNil:!0})}
