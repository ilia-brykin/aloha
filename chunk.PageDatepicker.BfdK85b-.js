...
};`}}const h={name:"PageDatepickerLabelDescription",components:{ADatepicker:f,AlohaExample:E},setup(){const e=i(void 0),{codeHtml:t}=V(),{codeJs:n}=B();return{codeHtml:t,codeJs:n,model:e}}};function q(e,t,n,_,m,u){const a=r("a-datepicker"),l=r("aloha-example");return I(),P(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:A(()=>[o(a,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),label:"Date","label-description":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const M=c(h,[["render",q]]);function J(){return{codeHtml:`<a-datepicker
  v-model="model1"
...
};`}}const w={name:"PageDatepickerMaxMinDate",components:{ADatepicker:f,AlohaExample:E},setup(){const e=i(void 0),t=i(void 0),n=i(void 0),_=D(()=>{const l=new Date;return l.setDate(l.getDate()-1),l.toISOString()}),m=D(()=>{const l=new Date;return l.setDate(l.getDate()+1),l.toISOString()}),{codeHtml:u}=J(),{codeJs:a}=Y();return{codeHtml:u,codeJs:a,dateTomorrow:m,dateYesterday:_,model1:e,model2:t,model3:n}}};function G(e,t,n,_,m,u){const a=r("a-datepicker"),l=r("aloha-example");return I(),P(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_MAX_MIN_DATE_HEADER_",description:"_PAGE_DATEPICKER_MAX_MIN_DATE_DESCRIPTION_",props:["max-date","min-date"]},{default:A(()=>[o(a,{modelValue:e.model1,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model1=d),"min-date":e.dateYesterday,label:"_PAGE_DATEPICKER_LBL_WITH_MIN_DATE_",type:"date"},null,8,["modelValue","min-date"]),s("div",null,"model1: "+p(e.model1),1),o(a,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":t[1]||(t[1]=d=>e.model2=d),"max-date":e.dateTomorrow,label:"_PAGE_DATEPICKER_LBL_WITH_MAX_DATE_",type:"date"},null,8,["modelValue","max-date"]),s("div",null,"model2: "+p(e.model2),1),o(a,{class:"a_mt_3",modelValue:e.model3,"onUpdate:modelValue":t[2]||(t[2]=d=>e.model3=d),"max-date":e.dateTomorrow,"min-date":e.dateTomorrow,label:"_PAGE_DATEPICKER_LBL_WITH_MIN_AND_MAX_DATE_",type:"date"},null,8,["modelValue","max-date","min-date"]),s("div",null,"model3: "+p(e.model3),1)]),_:1},8,["code-html","code-js"])}const j=c(w,[["render",G]]);function K(){return{codeHtml:`<a-datepicker
  :model-value="model1"
  :readonly="true"
  label="Input 1"
></a-datepicker>
