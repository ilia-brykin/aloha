import{A as I,a as b}from"./chunk.AlohaExample.D4SaE4p9.js";import{A as C}from"./chunk.AlohaTableProps.Ufe0zjLW.js";import{A as $}from"./chunk.AlohaTableTranslate.Bh5isJ5K.js";import{f as P,_ as u,g as H,A as L}from"./bundle.index.BIdvGbaF.js";import{r as f,R as m,aR as i,e as o,U as c,Y as a,W as S,aS as R,d as E}from"./chunk.vendor.BBAqWnj3.js";import"./chunk.vendor-lodash.DcJeCbOg.js";import"./chunk.APageTabTitle.D2d__OPV.js";import"./chunk.AlohaHighlightjs.CLW-CbN5.js";import"./chunk.ATable.Ccz-NYvK.js";import"./chunk.translations-ar.DEUMydUO.js";import"./chunk.translations-de.Cu1ohgZi.js";import"./chunk.translations-en.C0yymw0D.js";import"./chunk.translations-es.BOdupE53.js";import"./chunk.translations-fr.DA6ZjNfb.js";import"./chunk.translations-hr.9tXo0j2W.js";import"./chunk.translations-it.ChqBTVFj.js";import"./chunk.translations-ru.9b8s4Lgz.js";function y(){return{codeHtml:`<a-input
  v-model="model"
  label="Input"
></a-input>
...
export default {
  ...
  errors="Aloha"
  label="Input"
></a-input>`}}function W(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const x={name:"PageInputErrors",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=F(),{codeJs:n}=W();return{codeHtml:t,codeJs:n,model:e}}};function X(e,t,n,s,p,_){const l=o("a-input"),r=o("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),errors:"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=u(x,[["render",X]]);function k(){return{codeHtml:`<a-input
  v-model="model"
  help-text="Aloha"
  label="Input"
...
};`}}const z={name:"PageInputHelpText",components:{AInput:P,AlohaExample:I},setup(){const e=f("Aloha"),{codeHtml:t}=k(),{codeJs:n}=Q();return{codeHtml:t,codeJs:n,model:e}}};function K(e,t,n,s,p,_){const l=o("a-input"),r=o("aloha-example");return c(),m(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),"help-text":"Aloha",label:"Input"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=u(z,[["render",K]]);function ee(){return{codeHtml:`<a-input
  v-model="model"
