...
};`}}const ne={name:"PageLinkLoading",components:{AButton:M,ALink:h,AlohaExample:d},setup(){const{codeHtml:t}=ee(),{codeJs:n}=ae(),o=w(!0);return{codeHtml:t,codeJs:n,loading:o,toggleLoading:()=>{o.value=!o.value}}}};function _e(t,n,o,i,p,u){const a=_("a-link"),s=_("a-button"),f=_("aloha-example");return m(),r(f,{"code-html":t.codeHtml,"code-js":t.codeJs,header:"_A_LINK_GROUP_LOADING_HEADER_",description:"_A_LINK_GROUP_LOADING_DESCRIPTION_",props:["loading","loading-align"]},{default:l(()=>[e(a,{class:"a_btn a_btn_primary",loading:t.loading,"loading-align":"left",text:'loading-align="left"',href:"https://github.com/"},null,8,["loading"]),e(a,{class:"a_btn a_btn_primary a_ml_2",loading:t.loading,"loading-align":"right",text:'loading-align="right"',href:"https://github.com/"},null,8,["loading"]),e(s,{class:"a_btn a_btn_secondary a_ml_5",text:"a-button toggle",onClick:t.toggleLoading},null,8,["onClick"])]),_:1},8,["code-html","code-js"])}const se=c(ne,[["render",_e]]);function oe(){return{codeHtml:`<a-link
  class="a_btn a_btn_outline_primary"
  text="outline-primary"
  href="https://github.com/"
>
