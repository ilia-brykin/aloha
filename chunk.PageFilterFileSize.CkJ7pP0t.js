import{A as m,a as T}from"./chunk.AlohaExample.BT0L4sPf.js";import{A as h}from"./chunk.AlohaTableTranslate.DWhPyfrI.js";import{aQ as t,_ as l,A as U}from"./bundle.index.CgpAdSdY.js";import{P as x,a as J,b as L}from"./chunk.PageFilterTest.DueiWPai.js";import{a as f,m as i,C as _,B as c,L as Z,G as s}from"./chunk.vendor.D-Y3mz6a.js";import{P as B}from"./chunk.PageFilterImportCompositionApi.5-X5CRoG.js";import{f as G}from"./chunk.filterBoolean.test.DygJ_39J.js";import"./chunk.vendor-lodash.ClBXVCWL.js";import"./chunk.ATable.DALhqzqJ.js";import"./chunk.utilsMath.7PmiGUbm.js";import"./chunk.AForm.CpIOokJc.js";import"./chunk.ADatepicker.BS_Ghotq.js";import"./chunk.UiMixinProps.BVfs3aDc.js";import"./chunk.AInputNumber.C93fy0SX.js";import"./chunk.ATinymce.1a39zYU1.js";import"./chunk.vendor-tinymce.2RT9eEW9.js";function v(){return{codeJs:f(()=>`filterFileSize(1024, { digits: 0 });
// ${t(1024,{digits:0})}

filterFileSize(10241, { digits: 2 });
// ${t(10241,{digits:2})}`)}}const R={name:"PageFilterFileSizeDigits",components:{AlohaExample:m},setup(){const{codeJs:e}=v();return{codeJs:e}}};function j(e,o,r,a,u,p){const n=i("aloha-example");return c(),_(n,{"code-js":e.codeJs,header:"digits","is-code-visible-default":!0},null,8,["code-js"])}const y=l(R,[["render",j]]);function N(){return{codeJs:f(()=>`filterFileSize(2000);
// ${t(2e3)}
...
// ${t(1e-4,{sourceUnits:"tb"})}`)}}const O={name:"PageFilterFileSizeSourceUnits",components:{AlohaExample:m},setup(){const{codeJs:e}=D();return{codeJs:e}}};function V(e,o,r,a,u,p){const n=i("aloha-example");return c(),_(n,{"code-js":e.codeJs,header:"sourceUnits","is-code-visible-default":!0},null,8,["code-js"])}const w=l(O,[["render",V]]);function K(){return{codeJs:f(()=>`filterFileSize(1024, { units: "b" });
// ${t(1024,{units:"b"})}
