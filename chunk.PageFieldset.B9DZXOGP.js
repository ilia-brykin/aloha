import{A as E,a as N}from"./chunk.AlohaExample.BRf15a9v.js";import{A as U}from"./chunk.AlohaTableProps.Bhug38uR.js";import{A as x}from"./chunk.AlohaTableTranslate.DuIANfok.js";import{a9 as I,_ as u,g as y,A as F}from"./bundle.index.DaWeoMpR.js";import{r as m,W as f,V as h,aT as P,e as o,_ as s,Z as i,aU as p,d as b}from"./chunk.vendor.7qYoMuVo.js";import"./chunk.vendor-lodash.H1qWA996.js";import"./chunk.APageTabTitle.DJ6kSNp2.js";import"./chunk.AlohaHighlightjs.CqftpDCI.js";import"./chunk.ATable.Tz_WJjjm.js";import"./chunk.translations-ar.BVGXYuic.js";import"./chunk.translations-de.BTTkg7IT.js";import"./chunk.translations-en.B1a-0dJo.js";import"./chunk.translations-es.9uV8L16o.js";import"./chunk.translations-fr.b_PTR2hx.js";import"./chunk.translations-hr.BZQfnGWK.js";import"./chunk.translations-it.CbF6AZKa.js";import"./chunk.translations-ru.DaNQBvrb.js";function v(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  label="Fieldset"
></a-fieldset>
...
};`}}const H={name:"PageFieldsetBasic",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha.text"},{type:"oneCheckbox",label:"Checkbox",id:"aloha.checkbox"}],l=m(void 0),{codeHtml:t}=v(),{codeJs:d}=$();return{children:e,codeHtml:t,codeJs:d,model:l}}};function k(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label","children"]},{default:P(()=>[s(n,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model=a),children:e.children,label:"Fieldset"},null,8,["modelValue","children"]),i("div",null,"model: "+p(e.model),1)]),_:1},8,["code-html","code-js"])}const B=u(H,[["render",k]]);function J(){return{codeHtml:`<a-fieldset
  :change="changeModel"
  :children="children"
  :model-value="model"
  label="Fieldset"
...
};`}}const V={name:"PageFieldsetChange",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha.text1"},{type:"oneCheckbox",label:"Checkbox",id:"aloha.checkbox1"}],l=m(void 0),t=({model:_,id:n,props:r})=>{l.value=_,console.log(n,r)},{codeHtml:d}=J(),{codeJs:c}=q();return{changeModel:t,children:e,codeHtml:d,codeJs:c,model:l}}};function j(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:P(()=>[s(n,{change:e.changeModel,children:e.children,"model-value":e.model,label:"Fieldset"},null,8,["change","children","model-value"]),i("div",null,"model: "+p(e.model),1)]),_:1},8,["code-html","code-js"])}const G=u(V,[["render",j]]);function M(){return{codeHtml:`<a-fieldset
  v-model="model1"
  :children="children1"
  :collapsible="true"
  label="Aloha"
...
};`}}const Y={name:"PageFieldsetCollapse",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha1.text"}],l=[{type:"text",label:"Text",id:"aloha2.text"}],t=m(void 0),d=m(void 0),{codeHtml:c}=M(),{codeJs:_}=X();return{children1:e,children2:l,codeHtml:c,codeJs:_,model1:t,model2:d,toggleCollapse:({isCollapsed:r,id:a,props:A})=>{console.log(r,a,A)}}}},K={class:"a_columns a_columns_count_12"},w={class:"a_column a_column_6 a_columns_count_12_touch"};function W(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_COLLAPSE_HEADER_",description:"_A_UI_GROUP_COLLAPSE_DESCRIPTION_",props:["collapsible","is-collapsed"],emits:["toggle-collapse"]},{default:P(()=>[i("div",K,[i("div",w,[s(n,{modelValue:e.model1,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model1=a),children:e.children1,collapsible:!0,label:"Aloha",onToggleCollapse:e.toggleCollapse},null,8,["modelValue","children","onToggleCollapse"]),i("div",null,"model1: "+p(e.model1),1),s(n,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":l[1]||(l[1]=a=>e.model2=a),children:e.children2,collapsible:!0,"is-collapsed":!0,label:"Aloha",onToggleCollapse:e.toggleCollapse},null,8,["modelValue","children","onToggleCollapse"]),i("div",null,"model2: "+p(e.model2),1)])])]),_:1},8,["code-html","code-js"])}const Q=u(Y,[["render",W]]);function Z(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  errors="Aloha"
  label="Fieldset"
...
};`}}const ee={name:"PageFieldsetError",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha.text"},{type:"oneCheckbox",label:"Checkbox",id:"aloha.checkbox"}],l=m(void 0),{codeHtml:t}=Z(),{codeJs:d}=z();return{children:e,codeHtml:t,codeJs:d,model:l}}};function le(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:P(()=>[s(n,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model=a),children:e.children,errors:"Aloha",label:"Fieldset"},null,8,["modelValue","children"]),i("div",null,"model: "+p(e.model),1)]),_:1},8,["code-html","code-js"])}const oe=u(ee,[["render",le]]);function te(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  :has-border="true"
  label="Fieldset"
...
};`}}const ne={name:"PageFieldsetHasBorder",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"border.text"},{type:"oneCheckbox",label:"Checkbox",id:"border.checkbox"}],l=m(void 0),{codeHtml:t}=te(),{codeJs:d}=de();return{children:e,codeHtml:t,codeJs:d,model:l}}},ae={class:"a_columns a_columns_count_12"},se={class:"a_column a_column_6 a_columns_count_12_touch"};function re(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HAS_BORDER_HEADER_",description:"_A_UI_GROUP_HAS_BORDER_DESCRIPTION_",props:"has-border"},{default:P(()=>[i("div",ae,[i("div",se,[s(n,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model=a),children:e.children,"has-border":!0,label:"Fieldset"},null,8,["modelValue","children"]),s(n,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":l[1]||(l[1]=a=>e.model=a),children:e.children,"has-border":!1,label:"Fieldset"},null,8,["modelValue","children"]),i("div",null,"model: "+p(e.model),1)])])]),_:1},8,["code-html","code-js"])}const ie=u(ne,[["render",re]]);function ce(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  help-text="Aloha"
  label="Fieldset"
...
};`}}const me={name:"PageFieldsetHelpText",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha.text2"},{type:"oneCheckbox",label:"Checkbox",id:"aloha.checkbox2"}],l=m(void 0),{codeHtml:t}=ce(),{codeJs:d}=_e();return{children:e,codeHtml:t,codeJs:d,model:l}}};function pe(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:P(()=>[s(n,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model=a),children:e.children,"help-text":"Aloha",label:"Fieldset"},null,8,["modelValue","children"]),i("div",null,"model: "+p(e.model),1)]),_:1},8,["code-html","code-js"])}const ue=u(me,[["render",pe]]);function fe(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  label="Fieldset"
...
};`}}const Pe={name:"PageFieldsetLabelDescription",components:{AFieldset:I,AlohaExample:E},setup(){const e=[{type:"text",label:"Text",id:"aloha.text2"},{type:"oneCheckbox",label:"Checkbox",id:"aloha.checkbox2"}],l=m(void 0),{codeHtml:t}=fe(),{codeJs:d}=he();return{children:e,codeHtml:t,codeJs:d,model:l}}};function Ee(e,l,t,d,c,_){const n=o("a-fieldset"),r=o("aloha-example");return f(),h(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:P(()=>[s(n,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=a=>e.model=a),children:e.children,label:"Fieldset","label-description":"Aloha"},null,8,["modelValue","children"]),i("div",null,"model: "+p(e.model),1)]),_:1},8,["code-html","code-js"])}const Ie=u(Pe,[["render",Ee]]);function Ae(){return{codeHtml:`<a-fieldset
  v-model="model"
  :children="children"
  label="Fieldset"
></a-fieldset>
