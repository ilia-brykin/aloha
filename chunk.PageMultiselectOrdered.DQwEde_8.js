...
};`}}const H={name:"PageMultiselectOrderedBasic",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),o=u(void 0),{codeHtml:d}=M(),{codeJs:s}=q();return{codeHtml:d,codeJs:s,data:e,model1:a,model2:o}}};function k(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["data","model-value","label"]},{default:p(()=>[r(_,{modelValue:e.model1,"onUpdate:modelValue":a[0]||(a[0]=t=>e.model1=t),data:e.data,"key-id":"value","key-label":"label",label:"Select 1"},null,8,["modelValue","data"]),I("div",null,"model1: "+P(e.model1),1),r(_,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":a[1]||(a[1]=t=>e.model2=t),data:e.data,"key-id":"value","key-label":"label",label:"Select 2"},null,8,["modelValue","data"]),I("div",null,"model2: "+P(e.model2),1)]),_:1},8,["code-html","code-js"])}const $=c(H,[["render",k]]);function V(){return{codeHtml:`<a-multiselect-ordered
  :change="changeModel"
  :model-value="model"
  :data="data"
  key-id="value"
...
export default {
...
};`}}const j={name:"PageMultiselectOrderedChange",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),o=({model:i,id:_,props:n})=>{a.value=i,console.log(_,n)},{codeHtml:d}=V(),{codeJs:s}=J();return{changeModel:o,codeHtml:d,codeJs:s,data:e,model:a}}};function G(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:p(()=>[r(_,{change:e.changeModel,"model-value":e.model,data:e.data,"key-id":"value","key-label":"label",label:"Select"},null,8,["change","model-value","data"]),I("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const K=c(j,[["render",G]]);function Y(){return{codeHtml:`<a-multiselect-ordered
  v-model="model"
  :data="data"
  errors="Aloha"
  key-id="value"
  key-label="label"
  label="Select"
></a-multiselect-ordered>`}}function F(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const X={name:"PageMultiselectOrderedErrors",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),{codeHtml:o}=Y(),{codeJs:d}=F();return{codeHtml:o,codeJs:d,data:e,model:a}}};function w(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=t=>e.model=t),data:e.data,errors:"Aloha","key-id":"value","key-label":"label",label:"Select"},null,8,["modelValue","data"])]),_:1},8,["code-html","code-js"])}const W=c(X,[["render",w]]);function x(){return{codeHtml:`<a-multiselect-ordered
  v-model="model"
  :data="data"
  help-text="Aloha"
  key-id="value"
...
};`}}const Z={name:"PageMultiselectOrderedHelpText",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),{codeHtml:o}=x(),{codeJs:d}=Q();return{codeHtml:o,codeJs:d,data:e,model:a}}};function z(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=t=>e.model=t),data:e.data,"help-text":"Aloha","key-id":"value","key-label":"label",label:"Select"},null,8,["modelValue","data"])]),_:1},8,["code-html","code-js"])}const ee=c(Z,[["render",z]]);function ae(){return{codeHtml:`<a-multiselect-ordered
  v-model="model"
  :data="data"
  key-id="value"
  key-label="label"
...
></a-multiselect-ordered>`}}function le(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const te={name:"PageMultiselectOrderedLabelDescription",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),{codeHtml:o}=ae(),{codeJs:d}=le();return{codeHtml:o,codeJs:d,data:e,model:a}}};function oe(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=t=>e.model=t),data:e.data,"key-id":"value","key-label":"label",label:"Select","label-description":"Aloha"},null,8,["modelValue","data"])]),_:1},8,["code-html","code-js"])}const de=c(te,[["render",oe]]);function _e(){return{codeHtml:`<a-multiselect-ordered
  v-model="model1"
  :data="data"
  :readonly="true"
  key-id="value"
...
<a-multiselect-ordered
  ...
  label="Select 3"
  readonly-default="-"
></a-multiselect-ordered>`}}function re(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const ne={name:"PageMultiselectOrderedReadonly",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const e=[{value:"aloha_1",label:"Aloha 1"},{value:"aloha_2",label:"Aloha 2"},{value:"aloha_3",label:"Aloha 3"},{value:"aloha_4",label:"Aloha 4"}],a=u(["aloha_4","aloha_2"]),o=u(void 0),{codeHtml:d}=_e(),{codeJs:s}=re();return{codeHtml:d,codeJs:s,data:e,model1:a,model2:o}}};function se(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_READONLY_HEADER_",description:"_A_UI_GROUP_READONLY_DESCRIPTION_",props:["readonly","readonly-default"]},{default:p(()=>[r(_,{modelValue:e.model1,"onUpdate:modelValue":a[0]||(a[0]=t=>e.model1=t),data:e.data,readonly:!0,"key-id":"value","key-label":"label",label:"Select 1"},null,8,["modelValue","data"]),r(_,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":a[1]||(a[1]=t=>e.model2=t),data:e.data,readonly:!0,"key-id":"value","key-label":"label",label:"Select 2"},null,8,["modelValue","data"]),r(_,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":a[2]||(a[2]=t=>e.model2=t),data:e.data,readonly:!0,"key-id":"value","key-label":"label",label:"Select 3","readonly-default":"-"},null,8,["modelValue","data"])]),_:1},8,["code-html","code-js"])}const ie=c(ne,[["render",se]]);function ue(){return{codeHtml:`<a-multiselect-ordered
  v-model="model"
  :data="data"
...
};`}}const me={name:"PageMultiselectOrderedSearchTextInHtml",components:{AlohaExample:A,AMultiselectOrdered:S},setup(){const{codeHtml:e}=ue(),{codeJs:a}=ce(),o=[{label:"<span>Aloha</span> <strong>1</strong>",id:"aloha_0",aloha:"",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>2</strong>",id:"aloha_1",aloha:"Buba",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>3</strong>",id:"aloha_2",aloha:"Buba",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>4</strong>",id:"aloha_3",aloha:"Sandra",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>5</strong>",id:"aloha_4",aloha:"Sandra",alohaBR:"<strong>Köln</strong>"},{label:"<span>Aloha</span> <strong>6</strong>",id:"aloha_5",aloha:"Coco",alohaBR:"<strong>Düsseldorf</strong>"},{label:"<span>Aloha</span> <strong>7</strong>",id:"aloha_6",aloha:"Coco",alohaBR:"<strong>Düsseldorf</strong>"},{label:"<span>Aloha</span> <strong>8</strong>",id:"aloha_7",aloha:"Alex",alohaBR:"<strong>Düsseldorf</strong>"},{label:"<span>Aloha</span> <strong>9</strong>",id:"aloha_8",aloha:"Alex",alohaBR:"<strong>Düsseldorf</strong>"}],d=u(["aloha_7"]);return{codeHtml:e,codeJs:a,data:o,model:d}}},pe={class:"a_columns a_columns_count_12"},Ee={class:"a_column a_column_6 a_columns_count_12_touch"};function Ae(e,a,o,d,s,i){const _=l("a-multiselect-ordered"),n=l("aloha-example");return E(),m(n,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_SEARCH_TEXT_IN_HTML_HEADER_",description:"_A_UI_GROUP_SEARCH_TEXT_IN_HTML_DESCRIPTION_",props:["search","search-text-in-html"]},{default:p(()=>[I("div",pe,[I("div",Ee,[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=t=>e.model=t),data:e.data,"key-group":["alohaBR","aloha"],"search-in-group":!0,"search-text-in-html":!0,search:!0,"key-id":"id","key-label":"label",label:"Aloha group"},null,8,["modelValue","data"]),r(_,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=t=>e.model=t),data:e.data,"search-text-in-html":!0,search:!0,"key-id":"id","key-label":"label",label:"Aloha"},null,8,["modelValue","data"]),I("div",null,"model: "+P(e.model),1)])])]),_:1},8,["code-html","code-js"])}const Se=c(me,[["render",Ae]]);function Ie(){return{codeHtml:`<a-multiselect-ordered
  v-model="model1"
  :data="data"
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      }`,required:!1},{name:"translate-data",description:"_A_UI_PROPS_TRANSLATE_DATA_DESCRIPTION_",type:"Boolean",default:!1,required:!1},{name:"url",description:"_A_UI_PROPS_URL_DESCRIPTION_",type:"String",default:void 0,required:!1},{name:"url-params",description:"_A_UI_PROPS_URL_PARAMS_DESCRIPTION_",type:"Object",default:void 0,required:!1}]}}function De(){return{dataTranslate:["_A_MULTISELECT_ORDERED_BTN_DELETE_","_A_MULTISELECT_ORDERED_BTN_DOWN_","_A_MULTISELECT_ORDERED_BTN_GROUP_ARIA_LABEL_","_A_MULTISELECT_ORDERED_BTN_UP_","_A_MULTISELECT_ORDERED_DESELECT_ALL_","_A_MULTISELECT_ORDERED_GROUP_ALL_","_A_MULTISELECT_ORDERED_LABEL_SELECT_","_A_MULTISELECT_ORDERED_MODEL_EMPTY_","_A_MULTISELECT_ORDERED_SELECT_ALL_"]}}const Le={name:"PageMultiselectOrdered",components:{AlohaPage:y,AlohaTableProps:N,AlohaTableTranslate:U,ATranslation:B,PageMultiselectOrderedBasic:$,PageMultiselectOrderedChange:K,PageMultiselectOrderedErrors:W,PageMultiselectOrderedHelpText:ee,PageMultiselectOrderedLabelDescription:de,PageMultiselectOrderedReadonly:ie,PageMultiselectOrderedSearchTextInHtml:Se,PageMultiselectOrderedSelectDeselectAll:he},setup(){const{pageTitle:e}=Te(),{dataProps:a}=be(),{dataTranslate:o}=De(),{dataEvents:d}=fe();return{dataEvents:d,dataProps:a,dataTranslate:o,pageTitle:e}}};function Ce(e,a,o,d,s,i){const _=l("a-translation"),n=l("page-multiselect-ordered-basic"),t=l("page-multiselect-ordered-change"),O=l("page-multiselect-ordered-help-text"),h=l("page-multiselect-ordered-errors"),f=l("page-multiselect-ordered-label-description"),T=l("page-multiselect-ordered-select-deselect-all"),b=l("page-multiselect-ordered-search-text-in-html"),D=l("page-multiselect-ordered-readonly"),L=l("aloha-table-props"),C=l("aloha-table-translate"),g=l("aloha-page");return E(),m(g,{"page-title":e.pageTitle},{body:p(()=>[r(_,{tag:"p",html:"_A_MULTISELECT_ORDERED_DESCRIPTION_"}),r(n),r(t),r(O),r(h),r(f),r(T),r(b),r(D),r(L,{data:e.dataProps},null,8,["data"]),r(C,{data:e.dataTranslate},null,8,["data"])]),_:1},8,["page-title"])}const Fe=c(Le,[["render",Ce]]);export{Fe as default};
