import{A as g,a as G}from"./chunk.AlohaExample.CjncY9yb.js";import{aQ as o,_ as r,A as P}from"./bundle.index.D9gcatRx.js";import{P as T,a as I,b as J}from"./chunk.PageFilterTest.XRvw5J-J.js";import{k as e,J as s,H as f,aJ as E,O as n}from"./chunk.vendor.Ca3-nzbX.js";import{P as v}from"./chunk.PageFilterImportCompositionApi.Bxn2dkOk.js";import"./chunk.vendor-lodash.-viuv_rg.js";function S(){return{codeJs:`filterFloat(1000222.55, { digitGrouping: false });
...
// ${o("25.53451",{digits:4})}`}}const j={name:"PageFilterFloatDigits",components:{AlohaExample:g},setup(){const{codeJs:t}=N();return{codeJs:t}}};function O(t,l,a,p,c,u){const i=e("aloha-example");return f(),s(i,{"code-js":t.codeJs,header:"digits","is-code-visible-default":!0},null,8,["code-js"])}const U=r(j,[["render",O]]);function D(){return{codeJs:`filterFloat(123456);
// ${o(123456)}
...
// ${o(void 0)}`}}const y={name:"PageFilterFloatExample",components:{AlohaExample:g},setup(){const{codeJs:t}=D();return{codeJs:t}}};function C(t,l,a,p,c,u){const i=e("aloha-example");return f(),s(i,{"code-js":t.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const M=r(y,[["render",C]]);function k(){return{codeJs:`filterFloat(2000, { suffix: "€" });
// ${o(2e3,{suffix:"€"})}

filterFloat("25.5", { suffix: "%" });
// ${o("25.5",{suffix:"%"})}`}}const w={name:"PageFilterFloatSuffix",components:{AlohaExample:g},setup(){const{codeJs:t}=k();return{codeJs:t}}};function V(t,l,a,p,c,u){const i=e("aloha-example");return f(),s(i,{"code-js":t.codeJs,header:"suffix","is-code-visible-default":!0},null,8,["code-js"])}const H=r(w,[["render",V]]);function Q(){return{argumentsText:[{value:"value",types:["Number","String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_VALUE_"},{value:'[suffix=""]',types:["String"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_SUFFIX_"},{value:"[digits=2]",types:["Number"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGITS_"},{value:"[digitGrouping=true]",types:["Boolean"],text:"_PAGE_FILTER_FLOAT_ARGUMENTS_DIGIT_GROUPING_"}]}}function X(){return{pageTitle:"filterFloat"}}const q=`import filterFloat from "../filterFloat";
...
`,z={name:"PageFilterFloat",components:{AlohaPage:G,ATranslation:P,PageFilterArguments:T,PageFilterFloatDigitGrouping:b,PageFilterFloatDigits:U,PageFilterFloatExample:M,PageFilterFloatSuffix:H,PageFilterImportCompositionApi:v,PageFilterImportFunction:I,PageFilterTest:J},setup(){const{pageTitle:t}=X(),{argumentsText:l}=Q();return{argumentsText:l,pageTitle:t,test:q}}};function K(t,l,a,p,c,u){const i=e("a-translation"),_=e("page-filter-import-function"),d=e("page-filter-import-composition-api"),F=e("page-filter-arguments"),x=e("page-filter-float-example"),m=e("page-filter-float-suffix"),B=e("page-filter-float-digits"),$=e("page-filter-float-digit-grouping"),A=e("page-filter-test"),h=e("aloha-page");return f(),s(h,{"page-title":t.pageTitle},{body:E(()=>[n(i,{tag:"p",html:"_PAGE_FILTER_FLOAT_DESCRIPTION_"}),n(_,{"function-name":"filterFloat","type-import":"filters"}),n(d,{"function-name":"filterFloat"}),n(F,{"arguments-text":t.argumentsText,"function-description":'filterFloat(value, { [suffix=""], [digits=2], [digitGrouping=true] })'},null,8,["arguments-text"]),n(x),n(m),n(B),n($),n(A,{test:t.test},null,8,["test"])]),_:1},8,["page-title"])}const it=r(z,[["render",K]]);export{it as default};
