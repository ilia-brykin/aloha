...
};`}}const ee={name:"PageModalFooterSticky",components:{AButton:M,AlohaExample:b,AModal:O},setup(){const{codeHtml:e}=w(),{codeJs:t}=Q(),o=m(void 0);return{bodyHtml:`<ul>
      <li>1</li>
      <li>2</li>
      <li>3</li>
      <li>4</li>
