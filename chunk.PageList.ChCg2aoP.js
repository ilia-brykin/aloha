import{A as d}from"./chunk.AList.BQo7zPGE.js";import{A as L,a as C}from"./chunk.AlohaExample.CMUUEVcN.js";import{A as O}from"./chunk.AlohaTableProps.DwOUDlIA.js";import{_ as p,g as k,A as J}from"./bundle.index.DOWaPX07.js";import{B as u,C as b,L as c,G as t,m as a,F as r,r as f,M as D,a as P}from"./chunk.vendor.9_E-x6sT.js";import{A as N,f as G}from"./chunk.AForm.BMBXIC54.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.ATable.BiLWW37G.js";import"./chunk.utilsMath.D900FRx8.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";import"./chunk.ADatepicker.DXR-Bzfp.js";import"./chunk.UiMixinProps.3z5E7Tu9.js";import"./chunk.AInputNumber.CmREK6bZ.js";import"./chunk.ATinymce.BcMFUTFk.js";function j(){return{codeHtml:`<a-list
  :data="items"
  key-label="label"
...
};`}}const B={name:"PageListClassGroup",components:{AList:d,AlohaExample:L},setup(){const{codeHtml:e}=j(),{codeJs:l}=K();return{codeHtml:e,codeJs:l,items:[{label:"label 1"},{label:"label 2"},{label:"label 3"},{label:"label 4"}]}}};function M(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return u(),b(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["data","label"]},{default:c(()=>[t(s,{data:e.items,"key-label":"label"},null,8,["data"])]),_:1},8,["code-html","code-js"])}const U=p(B,[["render",M]]);function q(){return{codeHtml:`<a-list
  :data="items"
  key-label="label"
...
};`}}const Q={name:"PageListIsDataSimpleArray",components:{AList:d,AlohaExample:L},setup(){const{codeHtml:e}=F(),{codeJs:l}=z();return{codeHtml:e,codeJs:l,items1:["label 1","label 2","label 3","label 4"],items2:["Level 1",["Level 2",["Level 2.1","Level 2.2"]],["Level 3",["Level 3.1",["Level 3.2",["Level 3.2.1","Level 3.2.2"]]]]]}}},X={class:"a_columns a_columns_count_12"},Z={class:"a_column a_column_4 a_column_12_tablet"};function x(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return u(),b(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_LIST_GROUP_IS_DATA_SIMPLE_ARRAY_HEADER_",description:"_A_LIST_GROUP_IS_DATA_SIMPLE_ARRAY_DESCRIPTION_",props:["is-data-simple-array"]},{default:c(()=>[r("div",X,[r("div",Z,[t(s,{data:e.items1,"is-data-simple-array":!0},null,8,["data"]),t(s,{class:"a_mt_4",data:e.items2,"is-data-simple-array":!0},null,8,["data"])])])]),_:1},8,["code-html","code-js"])}const ee=p(Q,[["render",x]]);function le(){return{codeHtml:`<a-switch
  v-model="modelIsHtml"
...
};`}}const de={name:"PageListKeyChildren",components:{AList:d,AlohaExample:L},setup(){const{codeHtml:e}=_e(),{codeJs:l}=ce();return{codeHtml:e,codeJs:l,items:[{label:"Parent 1",children:[{label:"Child 1"},{label:"Child 2"}]},{label:"Parent 2",children:[{label:"Child 3"},{label:"Child 4"}]}]}}};function pe(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return u(),b(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_LIST_KEY_CHILDREN_HEADER_",description:"_A_LIST_KEY_CHILDREN_DESCRIPTION_",props:["key-children"]},{default:c(()=>[t(s,{data:e.items,"key-label":"label","key-children":"children"},null,8,["data"])]),_:1},8,["code-html","code-js"])}const ue=p(de,[["render",pe]]);function be(){return{codeHtml:`<a-list
  :data="items1"
  key-label="label"
  key-id="id"
></a-list>
...
};`}}const he={name:"PageListKeyId",components:{AList:d,AlohaExample:L},setup(){const{codeHtml:e}=be(),{codeJs:l}=Le();return{codeHtml:e,codeJs:l,items1:[{label:"Lorem",id:"1"},{label:"ipsum",id:"2"},{label:"dolor",id:"3"},{label:"Lorem",id:"4"}],items2:[{label:"Item 1"},{label:"Item 2"},{label:"Item 3"},{label:"Item 4"}]}}};function Ae(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return u(),b(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_LIST_KEY_ID_HEADER_",description:"_A_LIST_KEY_ID_DESCRIPTION_",props:["key-id"]},{default:c(()=>[t(s,{data:e.items1,"key-label":"label","key-id":"id"},null,8,["data"]),t(s,{class:"a_mt_4",data:e.items2,"key-label":"label","key-id":"label"},null,8,["data"])]),_:1},8,["code-html","code-js"])}const Ie=p(he,[["render",Ae]]);function Pe(){return{codeHtml:`<a-list
  :data="items"
...
};`}}const Se={name:"PageListKeyLabelCallback",components:{AList:d,AlohaExample:L},setup(){const{codeHtml:e}=Pe(),{codeJs:l}=fe();return{codeHtml:e,codeJs:l,items:[{label:"Item 1"},{label:"Item 2"},{label:"Item 3"},{label:"Item 4"}],keyLabelCallback:({item:m,itemIndex:_})=>`${m.label} - Index: ${_}`}}};function ge(e,l,o,n,m,_){const s=a("a-list"),i=a("aloha-example");return u(),b(i,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_LIST_KEY_LABEL_CALLBACK_HEADER_",description:"_A_LIST_KEY_LABEL_CALLBACK_DESCRIPTION_",props:["key-label-callback"]},{default:c(()=>[t(s,{data:e.items,"key-label-callback":e.keyLabelCallback},null,8,["data","key-label-callback"])]),_:1},8,["code-html","code-js"])}const Te=p(Se,[["render",ge]]);function ye(){return{codeHtml:`<a-list
  :data="items"
  :is-data-simple-array="true"
  :is-html="false"
  separator=", "
