import{A as P,a as M}from"./chunk.AlohaExample.BZeZthkV.js";import{A as q}from"./chunk.AlohaTableProps.BP-QrYCJ.js";import{A as G}from"./chunk.AlohaTableTranslate.CSBHe8xv.js";import{ap as y,_ as s,g as j,A as B}from"./bundle.index.BhEeXSAb.js";import{r as m,Z as i,Y as _,aV as I,f as t,a0 as a,$ as f,aW as R,d as A}from"./chunk.vendor.hDEvjBSB.js";import"./chunk.vendor-lodash.3C581RLn.js";import"./chunk.APageTabTitle.C6WQ6Ehw.js";import"./chunk.AlohaHighlightjs.B1uKbtWp.js";import"./chunk.ATable.TDP6pXBu.js";import"./chunk.translations-ar.D5QoWFzr.js";import"./chunk.translations-de.es3zy6A0.js";import"./chunk.translations-en.CYlx3VY3.js";import"./chunk.translations-es.zp4usr_r.js";import"./chunk.translations-fr.DtjnUZtG.js";import"./chunk.translations-hr.DZGEx8XX.js";import"./chunk.translations-it.D2jWnc95.js";import"./chunk.translations-ru.CUfkkkdW.js";function w(){return{codeHtml:`<a-input-currency
  v-model="model"
  label="Input"
></a-input-currency>
...
};`}}const z={name:"PageInputCurrencyChange",components:{AInputCurrency:y,AlohaExample:P},setup(){const e=m(10.02),n=({model:c,id:p,props:l})=>{e.value=c,console.log(p,l)},{codeHtml:r}=Q(),{codeJs:u}=Z();return{changeModel:n,codeHtml:r,codeJs:u,model:e}}};function K(e,n,r,u,c,p){const l=t("a-input-currency"),d=t("aloha-example");return i(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:I(()=>[a(l,{change:e.changeModel,"model-value":e.model,label:"Input"},null,8,["change","model-value"]),f("div",null,"model: "+R(e.model),1)]),_:1},8,["code-html","code-js"])}const x=s(z,[["render",K]]);function ee(){return{codeHtml:`<a-input-currency
  v-model="model"
  controls-type="none"
  label="Input"
></a-input-currency>
...
};`}}const Ke={name:"PageInputCurrencyModelType",components:{AInputCurrency:y,AlohaExample:P},setup(){const e=m(10.02),{codeHtml:n}=Ze(),{codeJs:r}=ze();return{codeHtml:n,codeJs:r,model:e}}};function xe(e,n,r,u,c,p){const l=t("a-input-currency"),d=t("aloha-example");return i(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_MODEL_TYPE_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_MODEL_TYPE_DESCRIPTION_",props:["model-type"]},{default:I(()=>[a(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),label:"number","model-type":"number"},null,8,["modelValue"]),a(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),label:"string","model-type":"string"},null,8,["modelValue"]),f("div",null,"model: "+R(e.model),1)]),_:1},8,["code-html","code-js"])}const en=s(Ke,[["render",xe]]);function nn(){return{codeHtml:`<a-input-currency
  v-model="model"
  help-text="Aloha"
  label="Input"
></a-input-currency>
