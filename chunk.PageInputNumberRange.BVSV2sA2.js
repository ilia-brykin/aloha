...
export default {
...
};`}}const C={name:"PageInputNumberRangeBasic",components:{AlohaExample:g,AInputNumberRange:R},setup(){const{codeHtml:e}=$(),{codeJs:n}=y(),o=h(void 0);return{codeHtml:e,codeJs:n,model:o}}},L={class:"a_columns a_columns_count_12"},H={class:"a_column a_column_6 a_columns_count_12_touch"},U={class:"a_mt_3"};function D(e,n,o,u,d,A){const l=a("a-input-number-range"),r=a("aloha-example");return c(),p(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["v-model","label"]},{default:i(()=>[t("div",L,[t("div",H,[s(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=_=>e.model=_),label:"Aloha"},null,8,["modelValue"]),t("div",U,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const G=m(C,[["render",D]]);function J(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
  placeholder-max="Max"
  placeholder-min="Min"
  type="integerRange"
></a-input-number-range>
<div class="a_mt_3">model: {{ model }}</div>`}}function B(){return{codeJs:`import {
  ref,
} from "vue";
...
};`}}const V={name:"PageInputNumberRangePlaceholder",components:{AlohaExample:g,AInputNumberRange:R},setup(){const{codeHtml:e}=J(),{codeJs:n}=B(),o=h(void 0);return{codeHtml:e,codeJs:n,model:o}}},M={class:"a_columns a_columns_count_12"},q={class:"a_column a_column_6 a_columns_count_12_touch"},j={class:"a_mt_3"};function x(e,n,o,u,d,A){const l=a("a-input-number-range"),r=a("aloha-example");return c(),p(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_PLACEHOLDER_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_PLACEHOLDER_DESCRIPTION_",props:["placeholder-max","placeholder-min"]},{default:i(()=>[t("div",M,[t("div",q,[s(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=_=>e.model=_),label:"Aloha","placeholder-max":"Max","placeholder-min":"Min",type:"integerRange"},null,8,["modelValue"]),t("div",j,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const Y=m(V,[["render",x]]);function k(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
  type="integerRange"
></a-input-number-range>
...
};`}}const X={name:"PageInputNumberRangeTypeInteger",components:{AlohaExample:g,AInputNumberRange:R},setup(){const{codeHtml:e}=k(),{codeJs:n}=F(),o=h(void 0);return{codeHtml:e,codeJs:n,model:o}}},w={class:"a_columns a_columns_count_12"},K={class:"a_column a_column_6 a_columns_count_12_touch"},z={class:"a_mt_3"};function Q(e,n,o,u,d,A){const l=a("a-input-number-range"),r=a("aloha-example");return c(),p(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_DESCRIPTION_",props:"type='integerRange'"},{default:i(()=>[t("div",w,[t("div",K,[s(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=_=>e.model=_),label:"Aloha",type:"integerRange"},null,8,["modelValue"]),t("div",z,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const W=m(X,[["render",Q]]);function Z(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
...
};`}}const ne={name:"PageInputNumberRangeTypeIntegerNonNegative",components:{AlohaExample:g,AInputNumberRange:R},setup(){const{codeHtml:e}=Z(),{codeJs:n}=ee(),o=h(void 0);return{codeHtml:e,codeJs:n,model:o}}},oe={class:"a_columns a_columns_count_12"},ae={class:"a_column a_column_6 a_columns_count_12_touch"},te={class:"a_mt_3"};function le(e,n,o,u,d,A){const l=a("a-input-number-range"),r=a("aloha-example");return c(),p(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_NON_NEGATIVE_HEADER_",description:"_A_INPUT_NUMBER_RANGE_GROUP_TYPE_INTEGER_NON_NEGATIVE_DESCRIPTION_",props:"type='integerNonNegativeRange'"},{default:i(()=>[t("div",oe,[t("div",ae,[s(l,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=_=>e.model=_),label:"Aloha",type:"integerNonNegativeRange"},null,8,["modelValue"]),t("div",te,"model: "+I(e.model),1)])])]),_:1},8,["code-html","code-js"])}const re=m(ne,[["render",le]]);function _e(){return{codeHtml:`<a-input-number-range
  v-model="model"
  label="Aloha"
