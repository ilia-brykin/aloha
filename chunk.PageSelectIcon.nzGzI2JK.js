import{A as I,a as y}from"./chunk.AlohaExample.DQald-L_.js";import{A as L}from"./chunk.AlohaTableProps.nxAQILM8.js";import{Y as E,ah as u,aM as g,a3 as h}from"./bundle.index.D1OA29U_.js";import{bf as s,bc as m,aQ as p,br as S,bi as l,aV as n,aP as A,bn as O,aN as T}from"./chunk.vendor.B7xidcyX.js";import"./chunk.vendor-lodash.DHCI5OYQ.js";import"./chunk.APageTabTitle.BjEZe9gt.js";import"./chunk.AlohaHighlightjs.5M2Lhx9-.js";import"./chunk.ATable.Cjx2y3oc.js";import"./chunk.translations-ar.ChuYlDzT.js";import"./chunk.translations-de.6pPcJRrO.js";import"./chunk.translations-en.DT3q5fLP.js";import"./chunk.translations-es.B6sZfxDK.js";import"./chunk.translations-fr.ecArFLfS.js";import"./chunk.translations-hr.DhAqHXEL.js";import"./chunk.translations-it.DjP2RsZa.js";import"./chunk.translations-ru.L_V4Dr6V.js";function b(){return{codeHtml:`<a-select-icon
  v-model="model1"
  label="Select"
  type="select"
></a-select-icon>
...
};`}}const G={name:"PageSelectIconErrors",components:{AlohaExample:I,ASelectIcon:E},setup(){const e=s(void 0),{codeHtml:t}=j(),{codeJs:a}=Y();return{codeHtml:t,codeJs:a,model:e}}};function k(e,t,a,c,r,i){const o=l("a-select-icon"),_=l("aloha-example");return m(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:S(()=>[n(o,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),errors:"Aloha",label:"Select"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const x=u(G,[["render",k]]);function F(){return{codeHtml:`<a-select-icon
  v-model="model"
  help-text="Aloha"
  label="Select"
...
};`}}const X={name:"PageSelectIconHelpText",components:{AlohaExample:I,ASelectIcon:E},setup(){const e=s(void 0),{codeHtml:t}=F(),{codeJs:a}=K();return{codeHtml:t,codeJs:a,model:e}}};function w(e,t,a,c,r,i){const o=l("a-select-icon"),_=l("aloha-example");return m(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:S(()=>[n(o,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),"help-text":"Aloha",label:"Select"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Q=u(X,[["render",w]]);function W(){return{codeHtml:`<a-select-icon
  v-model="model"
...
};`}}const Z={name:"PageSelectIconLabelDescription",components:{AlohaExample:I,ASelectIcon:E},setup(){const e=s(void 0),{codeHtml:t}=W(),{codeJs:a}=z();return{codeHtml:t,codeJs:a,model:e}}};function ee(e,t,a,c,r,i){const o=l("a-select-icon"),_=l("aloha-example");return m(),p(_,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:S(()=>[n(o,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=d=>e.model=d),"is-label-float":!1,label:"Select","label-description":"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=u(Z,[["render",ee]]);function oe(){return{codeHtml:`<a-select-icon
  :model-value="model1"
  :readonly="true"
  label="Select 1"
  type="select"
