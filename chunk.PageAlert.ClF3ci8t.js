...
export default {
  ...
  components: {
    AAlert,
      ...
      non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.</p>`}}};function G(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:"is-visible"},{default:_(()=>[t(s,{html:"AAlert","is-visible":!0})]),_:1},8,["code-html","code-js"])}const M=m(j,[["render",G]]);function k(){return{codeHtml:`<a-alert 
  text="Aloha"
  :is-visible="true"
  type="success"
...
};`}}const z={name:"PageAlertClosable",components:{AAlert:A,AButton:P,AlohaExample:d},setup(){const{codeHtml:e}=W(),{codeJs:l}=Y(),a=g(!0);return{codeHtml:e,codeJs:l,hideAlert:()=>{a.value=!1},isAlertVisible:a,showAlert:()=>{a.value=!0}}}};function K(e,l,a,n,i,p){const s=o("a-button"),r=o("a-alert"),b=o("aloha-example");return c(),u(b,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_CLOSABLE_HEADER_",description:"_A_ALERT_GROUP_CLOSABLE_DESCRIPTION_",props:"closable",emits:"close"},{default:_(()=>[h("div",null,[e.isAlertVisible?q("",!0):(c(),u(s,{key:0,class:"a_btn a_btn_primary",text:"_A_ALERT_GROUP_CLOSABLE_FROM_OUTSIDE_SHOW_ALERT_",onClick:e.showAlert},null,8,["onClick"]))]),t(r,{html:"Alert success","is-visible":e.isAlertVisible,type:"success",closable:!0,onClose:e.hideAlert},null,8,["is-visible","onClose"])]),_:1},8,["code-html","code-js"])}const Z=m(z,[["render",K]]);function ee(){return{codeHtml:`<a-alert 
  html="Alert success"
  :is-visible="true"
  type="success"
  :show-icon="true"
...
};`}}const se={name:"PageAlertCss",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=ee(),{codeJs:l}=te();return{codeHtml:e,codeJs:l}}};function oe(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_CSS_HEADER_",description:"_A_ALERT_GROUP_CSS_DESCRIPTION_",props:["icon-class","alert-class","alert-content-class"]},{default:_(()=>[t(s,{html:"Alert success","is-visible":!0,type:"success","show-icon":!0,"icon-class":"a_width_6 a_height_6","alert-class":"a_p_5","alert-content-class":"a_text_center"})]),_:1},8,["code-html","code-js"])}const le=m(se,[["render",oe]]);function ae(){return{codeHtml:`<div
  class="a_btn_group"
>
  <a-button
...
};`}}const fe={name:"PageAlertIconsCustom",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=he(),{codeJs:l}=be();return{codeHtml:e,codeJs:l}}};function Ee(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_ICONS_CUSTOM_HEADER_",description:"_A_ALERT_GROUP_ICONS_CUSTOM_DESCRIPTION_",props:["icon","show-icon"]},{default:_(()=>[t(s,{html:"Alert success","is-visible":!0,type:"success","show-icon":!0,icon:"Cog"}),t(s,{html:"Alert info","is-visible":!0,type:"info","show-icon":!0,icon:"EyeOpen"}),t(s,{html:"Alert warning","is-visible":!0,type:"warning","show-icon":!0,icon:"EyeClose"}),t(s,{html:"Alert danger","is-visible":!0,type:"danger","show-icon":!0,icon:"Home"}),t(s,{html:"Alert primary","is-visible":!0,type:"primary","show-icon":!0,icon:"Lock"})]),_:1},8,["code-html","code-js"])}const Pe=m(fe,[["render",Ee]]);function ge(){return{codeHtml:`<a-alert 
  html="Alert success" 
  :is-visible="true" 
  type="success"
  :show-icon="true"
...
};`}}const Re={name:"PageAlertIconsDefault",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=ge(),{codeJs:l}=ve();return{codeHtml:e,codeJs:l}}};function Te(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_ICONS_DEFAULT_HEADER_",description:"_A_ALERT_GROUP_ICONS_DEFAULT_DESCRIPTION_",props:"show-icon"},{default:_(()=>[t(s,{html:"Alert success","is-visible":!0,type:"success","show-icon":!0}),t(s,{html:"Alert info","is-visible":!0,type:"info","show-icon":!0}),t(s,{html:"Alert warning","is-visible":!0,type:"warning","show-icon":!0}),t(s,{html:"Alert danger","is-visible":!0,type:"danger","show-icon":!0})]),_:1},8,["code-html","code-js"])}const Se=m(Re,[["render",Te]]);function Oe(){return{codeHtml:`<a-alert 
  html="Alert success"
  :is-visible="true"
  type="success"
  :closable="true"
...
};`}}const ye={name:"PageAlertRemoveOnClose",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=Oe(),{codeJs:l}=Ie();return{codeHtml:e,codeJs:l}}};function $e(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_CLOSABLE_FROM_OUTSIDE_HEADER_",description:"_A_ALERT_GROUP_CLOSABLE_FROM_OUTSIDE_DESCRIPTION_",props:["closable","remove-alert-on-close"]},{default:_(()=>[t(s,{html:"Alert success","is-visible":!0,type:"success",closable:!0}),t(s,{html:"Alert danger","is-visible":!0,type:"danger",closable:!0,"remove-alert-on-close":!0})]),_:1},8,["code-html","code-js"])}const Ce=m(ye,[["render",$e]]);function Le(){return{codeHtml:`<a-alert 
  :html="html"
  :is-visible="true"
  type="primary"
>
...
};`}}const qe={name:"PageAlertSlot",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=Je(),{codeJs:l}=we();return{codeHtml:e,codeJs:l}}},Be=h("ul",null,[h("li",null,"Aloha 1"),h("li",null,"Aloha 2"),h("li",null,"Aloha 3"),h("li",null,"Aloha 4")],-1);function Ue(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_SLOT_HEADER_",description:"_A_ALERT_GROUP_SLOT_DESCRIPTION_",slots:"default"},{default:_(()=>[t(s,{"is-visible":!0,type:"success"},{default:_(()=>[Be]),_:1})]),_:1},8,["code-html","code-js"])}const je=m(qe,[["render",Ue]]);function Ge(){return{codeHtml:`<a-alert 
  :text="text"
  :is-visible="true"
  type="primary"
>
...
};`}}const ke={name:"PageAlertText",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=Ge(),{codeJs:l}=Me();return{codeHtml:e,codeJs:l,text:"Lorem ipsum dolor sit amet"}}};function Ve(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return c(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_TEXT_HEADER_",description:"_A_ALERT_GROUP_TEXT_DESCRIPTION_",props:"text"},{default:_(()=>[t(s,{text:e.text,"is-visible":!0,type:"primary"},null,8,["text"])]),_:1},8,["code-html","code-js"])}const Fe=m(ke,[["render",Ve]]);function Xe(){return{codeHtml:`<a-alert 
  html="Alert success" 
  :is-visible="true" 
  type="success"
>
