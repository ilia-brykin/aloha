import{A as f,a as U}from"./chunk.AlohaExample.bHGij63B.js";import{A as D}from"./chunk.AlohaTableProps.Djt0Y_Qg.js";import{A as C}from"./chunk.AlohaTableTranslate.BevkBLMD.js";import{_ as u,g as $,A as v}from"./bundle.index.C_5YVLtW.js";import{c as T}from"./chunk.AForm.CSasGaDW.js";import{r as P,m as t,K as p,aK as i,J as c,P as n,O as A,aL as E,a as R}from"./chunk.vendor.D6eG-XyB.js";import"./chunk.vendor-lodash.4mRNCQpN.js";import"./chunk.ATable.DruEzHhF.js";import"./chunk.utilsMath.Dv1kx9ss.js";import"./chunk.vendor-tinymce.Dn8nHerG.js";import"./chunk.ADatepicker.DsVaojwL.js";import"./chunk.UiMixinProps.BanNRFZI.js";import"./chunk.AInputNumber.Dd9Cig3P.js";import"./chunk.ATinymce.CNhjlfBT.js";function H(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<div>model:</div>
...
};`}}const F={name:"PageTextareaErrors",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=X(),{codeJs:o}=M();return{codeHtml:a,codeJs:o,model:e}}};function w(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=u(F,[["render",w]]);function k(){return{codeHtml:`<a-textarea
  v-model="model"
  help-text="Aloha"
  label="Textarea"
...
};`}}const W={name:"PageTextareaHelpText",components:{AlohaExample:f,ATextarea:T},setup(){const e=P("Aloha"),{codeHtml:a}=k(),{codeJs:o}=K();return{codeHtml:a,codeJs:o,model:e}}};function Q(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return c(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"help-text":"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=u(W,[["render",Q]]);function ee(){return{codeHtml:`<a-textarea
  v-model="model"
  :is-scalable="true"
  label="Textarea"
></a-textarea>
