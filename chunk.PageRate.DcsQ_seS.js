...
};`}}const Pe={name:"PageRateHoveredColor",components:{ARate:A,AlohaExample:g},setup(){const{codeHtml:e}=Ie(),{codeJs:t}=ve();return{codeHtml:e,codeJs:t}}};function $e(e,t,n,s,d,i){const a=o("a-rate"),l=o("aloha-example");return R(),f(l,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"HoveredColor",description:"_A_RATE_DESCRIPTION_HOVERED_COLOR_",props:"hovered-color"},{default:h(()=>[r(a,{"hovered-color":"red",text:"red"})]),_:1},8,["code-html","code-js"])}const Ee=p(Pe,[["render",$e]]);function He(){return{codeHtml:`<a-rate 
  :rating="7">
