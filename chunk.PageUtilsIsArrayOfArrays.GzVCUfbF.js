import{A as g,a as O}from"./chunk.AlohaExample.CMUUEVcN.js";import{aV as a,_ as i,A as h}from"./bundle.index.DOWaPX07.js";import{P as x,a as $,b as T}from"./chunk.PageFilterTest.CqA3wSrh.js";import{B as l,C as A,m as t,L as P,G as e}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";function I(){return{codeJs:`isArrayOfArrays([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
// ${a([[1,2,3],[4,5,6],[7,8,9]])}
isArrayOfArrays([[], [], []]);
// ${a([[],[],[]])}
...
// ${a([[1,2,3],"This is not an array",[7,8,9]])}`}}const B={name:"PageUtilsIsArrayOfArraysExample",components:{AlohaExample:g},setup(){const{codeJs:r}=I();return{codeJs:r}}};function v(r,s,o,f,y,p){const n=t("aloha-example");return l(),A(n,{"code-js":r.codeJs,header:"_A_BASIC_USAGE_","is-code-visible-default":!0},null,8,["code-js"])}const R=i(B,[["render",v]]);function S(){return{argumentsText:[{value:"value",types:["Array"],text:"_PAGE_UTILS_IS_ARRAY_OF_ARRAYS_ARGUMENTS_VALUE_"}]}}function E(){return{pageTitle:"isArrayOfArrays"}}const U=`import {
  isArrayOfArrays,
} from "../utils";
