...
};`}}const ze={name:"PageInputCurrencyStep",components:{AInputCurrency:R,AlohaExample:f},setup(){const e=m(10.02),{codeHtml:n}=ke(),{codeJs:a}=Qe();return{codeHtml:n,codeJs:a,model:e}}};function Ke(e,n,a,u,c,p){const t=r("a-input-currency"),d=r("aloha-example");return I(),_(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_INPUT_CURRENCY_GROUP_STEP_HEADER_",description:"_A_INPUT_CURRENCY_GROUP_STEP_DESCRIPTION_",props:["step","controls-type"]},{default:i(()=>[l(t,{modelValue:e.model,"onUpdate:modelValue":n[0]||(n[0]=o=>e.model=o),step:2,"controls-type":"plus-minus",label:"step 2"},null,8,["modelValue"]),l(t,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":n[1]||(n[1]=o=>e.model=o),step:.01,"controls-type":"plus-minus",label:"step 0.01"},null,8,["modelValue"]),P("div",null,"model: "+y(e.model),1)]),_:1},8,["code-html","code-js"])}const Ze=s(ze,[["render",Ke]]);function xe(){return{codeHtml:`<a-input-currency
  v-model="model"
