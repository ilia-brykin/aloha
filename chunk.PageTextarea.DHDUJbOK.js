import{A,a as U}from"./chunk.AlohaExample.CMUUEVcN.js";import{A as D}from"./chunk.AlohaTableProps.DwOUDlIA.js";import{A as C}from"./chunk.AlohaTableTranslate.BpQfKYBR.js";import{_ as c,g as $,A as v}from"./bundle.index.DOWaPX07.js";import{c as f}from"./chunk.AForm.BMBXIC54.js";import{r as T,B as u,C as p,L as i,G as n,m as t,F as P,M as E,a as R}from"./chunk.vendor.9_E-x6sT.js";import"./chunk.vendor-lodash.Cqnw6GrA.js";import"./chunk.ATable.BiLWW37G.js";import"./chunk.utilsMath.D900FRx8.js";import"./chunk.vendor-tinymce.5PTU7oiI.js";import"./chunk.ADatepicker.DXR-Bzfp.js";import"./chunk.UiMixinProps.3z5E7Tu9.js";import"./chunk.AInputNumber.CmREK6bZ.js";import"./chunk.ATinymce.BcMFUTFk.js";function H(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<div>model:</div>
...
};`}}const V={name:"PageTextareaBasic",components:{AlohaExample:A,ATextarea:f},setup(){const e=T("Aloha"),{codeHtml:a}=H(),{codeJs:o}=L();return{codeHtml:a,codeJs:o,model:e}}},y=P("div",null,"model:",-1);function J(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),label:"Textarea"},null,8,["modelValue"]),y,P("pre",null,E(e.model),1)]),_:1},8,["code-html","code-js"])}const B=c(V,[["render",J]]);function q(){return{codeHtml:`<a-textarea
  :change="changeModel"
  :model-value="model"
  label="Textarea"
></a-textarea>
...
};`}}const Z={name:"PageTextareaErrors",components:{AlohaExample:A,ATextarea:f},setup(){const e=T("Aloha"),{codeHtml:a}=F(),{codeJs:o}=w();return{codeHtml:a,codeJs:o,model:e}}};function k(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),errors:"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const W=c(Z,[["render",k]]);function Q(){return{codeHtml:`<a-textarea
  v-model="model"
  help-text="Aloha"
  label="Textarea"
...
};`}}const K={name:"PageTextareaHelpText",components:{AlohaExample:A,ATextarea:f},setup(){const e=T("Aloha"),{codeHtml:a}=Q(),{codeJs:o}=Y();return{codeHtml:a,codeJs:o,model:e}}};function ee(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"help-text":"Aloha",label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ae=c(K,[["render",ee]]);function te(){return{codeHtml:`<a-textarea
  v-model="model"
  :is-scalable="true"
  label="Textarea"
></a-textarea>
...
};`}}const re={name:"PageTextareaIsScalable",components:{AlohaExample:A,ATextarea:f},setup(){const e=T("Aloha"),{codeHtml:a}=te(),{codeJs:o}=oe();return{codeHtml:a,codeJs:o,model:e}}},le=P("div",null,"model:",-1);function ne(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_TEXTAREA_GROUP_IS_SCALABLE_HEADER_",description:"_A_TEXTAREA_GROUP_IS_SCALABLE_DESCRIPTION_",props:["is-scalable"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"is-scalable":!0,label:"Textarea"},null,8,["modelValue"]),le,P("pre",null,E(e.model),1)]),_:1},8,["code-html","code-js"])}const de=c(re,[["render",ne]]);function se(){return{codeHtml:`<a-textarea
  v-model="model"
...
};`}}const me={name:"PageTextareaLabelFloat",components:{AlohaExample:A,ATextarea:f},setup(){const e=T("Aloha"),{codeHtml:a}=se(),{codeJs:o}=_e();return{codeHtml:a,codeJs:o,model:e}}};function ce(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_IS_LABEL_FLOAT_HEADER_",description:"_A_UI_GROUP_IS_LABEL_FLOAT_DESCRIPTION_",props:["is-label-float"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),"is-label-float":!1,label:"Textarea"},null,8,["modelValue"]),n(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=r=>e.model=r),"is-label-float":!0,label:"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const ue=c(me,[["render",ce]]);function pe(){return{codeHtml:`<a-textarea
  v-model="model"
  label="Textarea"
></a-textarea>
<a-textarea
...
};`}}const Ae={name:"PageTextareaLabelScreenReader",components:{AlohaExample:A,ATextarea:f},setup(){const e=T("Aloha"),{codeHtml:a}=pe(),{codeJs:o}=ie();return{codeHtml:a,codeJs:o,model:e}}};function fe(e,a,o,s,_,m){const l=t("a-textarea"),d=t("aloha-example");return u(),p(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_SCREEN_READER_HEADER_",description:"_A_UI_GROUP_LABEL_SCREEN_READER_DESCRIPTION_",props:["label-screen-reader"]},{default:i(()=>[n(l,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=r=>e.model=r),label:"Textarea"},null,8,["modelValue"]),n(l,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=r=>e.model=r),"label-screen-reader":"Textarea"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Te=c(Ae,[["render",fe]]);function Pe(){return{codeHtml:`<a-textarea
  v-model="model"
  label="resize='v'"
  resize="v"
></a-textarea>
