import{A as d,a as D}from"./chunk.AlohaExample.D19CN2wh.js";import{A as x}from"./chunk.AlohaTableProps.SdA0hIGF.js";import{h as A,_ as m,b as P,g as J,A as w}from"./bundle.index.Cv6dkyGa.js";import{m as o,K as c,aK as u,J as _,P as t,r as g,O as h,aR as q,a as E}from"./chunk.vendor.DQz1Isc4.js";import"./chunk.vendor-lodash.Cgq9oNCy.js";import"./chunk.ATable.CgCSCDr2.js";import"./chunk.utilsMath.1mfWsA3R.js";import"./chunk.AForm.Bvve0IYh.js";import"./chunk.ADatepicker.D3pbJRZb.js";import"./chunk.UiMixinProps.BvCyZ1Ij.js";import"./chunk.AInputNumber.D7-F2j3f.js";import"./chunk.ATinymce.BUC7EngB.js";import"./chunk.vendor-tinymce.cPIiul0H.js";function B(){return{codeHtml:`<a-alert>
  html="AAlert"
  :is-visible="true"
...
export default {
  ...
  components: {
    AAlert,
      ...
      non dictum mauris. Nulla at tellus sagittis, viverra est a, bibendum metus.</p>`}}};function M(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return _(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:"is-visible"},{default:u(()=>[t(s,{html:"AAlert","is-visible":!0})]),_:1},8,["code-html","code-js"])}const G=m(j,[["render",M]]);function k(){return{codeHtml:`<a-alert 
  text="Aloha"
  :is-visible="true"
  type="success"
...
};`}}const fe={name:"PageAlertIconsCustom",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=he(),{codeJs:l}=be();return{codeHtml:e,codeJs:l}}};function Ee(e,l,a,n,i,p){const s=o("a-alert"),r=o("aloha-example");return _(),c(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ALERT_GROUP_ICONS_CUSTOM_HEADER_",description:"_A_ALERT_GROUP_ICONS_CUSTOM_DESCRIPTION_",props:["icon","show-icon"]},{default:u(()=>[t(s,{html:"Alert success","is-visible":!0,type:"success","show-icon":!0,icon:"Boxes"}),t(s,{html:"Alert info","is-visible":!0,type:"info","show-icon":!0,icon:"EyeFill"}),t(s,{html:"Alert warning","is-visible":!0,type:"warning","show-icon":!0,icon:"EyeSlash"}),t(s,{html:"Alert danger","is-visible":!0,type:"danger","show-icon":!0,icon:"House"}),t(s,{html:"Alert primary","is-visible":!0,type:"primary","show-icon":!0,icon:"Bell"})]),_:1},8,["code-html","code-js"])}const Pe=m(fe,[["render",Ee]]);function ge(){return{codeHtml:`<a-alert 
  html="Alert success" 
  :is-visible="true" 
  type="success"
  :show-icon="true"
...
};`}}const Ne={name:"PageAlertSafeHtml",components:{AAlert:A,AlohaExample:d},setup(){const{codeHtml:e}=Ce(),{codeJs:l}=He();return{codeHtml:e,codeJs:l,html:`<p onclick="alert('Aloha')">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, 
      pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus. 
      Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt laoreet ex, 
      in pretium orci vestibulum eget. Class aptent taciti sociosqu ad litora torquent
      per conubia nostra, per inceptos himenaeos. Duis pharetra luctus lacus ut 
