...
};`}}const V={name:"PageSwitchBasic",components:{AlohaExample:f,ASwitch:S},setup(){const e=h(!1),{codeHtml:t}=J(),{codeJs:a}=y();return{codeHtml:t,codeJs:a,model:e}}};function B(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return p(),m(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s)},null,8,["modelValue"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(V,[["render",B]]);function j(){return{codeHtml:`<a-switch
  :change="changeModel"
  :model-value="model"
></a-switch>
...
};`}}const W={name:"PageSwitchChange",components:{AlohaExample:f,ASwitch:S},setup(){const e=h(!1),t=({model:_,id:c,props:n})=>{e.value=_,console.log(c,n)},{codeHtml:a}=j(),{codeJs:r}=F();return{changeModel:t,codeHtml:a,codeJs:r,model:e}}};function G(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return p(),m(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:u(()=>[l(n,{change:e.changeModel,"model-value":e.model},null,8,["change","model-value"]),A("div",null,"model: "+P(e.model),1)]),_:1},8,["code-html","code-js"])}const M=i(W,[["render",G]]);function x(){return{codeHtml:`<a-switch
  v-model="model"
  errors="Aloha"
  label="ASwitch"
...
};`}}const k={name:"PageSwitchErrors",components:{AlohaExample:f,ASwitch:S},setup(){const e=h(!1),{codeHtml:t}=x(),{codeJs:a}=X();return{codeHtml:t,codeJs:a,model:e}}};function Q(e,t,a,r,_,c){const n=o("a-switch"),d=o("aloha-example");return p(),m(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors","label"]},{default:u(()=>[l(n,{modelValue:e.model,"onUpdate:modelValue":t[0]||(t[0]=s=>e.model=s),errors:"Aloha",label:"ASwitch"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=i(k,[["render",Q]]);function z(){return{codeHtml:`<a-switch
  v-model="model"
  help-text="Aloha"
