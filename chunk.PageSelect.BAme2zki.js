import{A as f,a as J}from"./chunk.AlohaExample.-d4xrnrJ.js";import{A as K}from"./chunk.AlohaTableProps.CEeNasf0.js";import{C as A,_ as b,g as M,A as j,b as x}from"./bundle.index.BMbHS0r2.js";import{r as u,Y as m,W as E,aU as p,f as d,_ as a,$ as o,aV as h,d as v,Z as T}from"./chunk.vendor.BAXy2grE.js";import"./chunk.vendor-lodash.CCzoES9g.js";import"./chunk.APageTabTitle.DuQktD6b.js";import"./chunk.AlohaHighlightjs.BK8yZFUI.js";import"./chunk.ATable.CfA0kccH.js";import"./chunk.translations-ar.B2OoBNnE.js";import"./chunk.translations-de.UgGe9j4v.js";import"./chunk.translations-en.0stqcWf2.js";import"./chunk.translations-es.BwgNL0Sc.js";import"./chunk.translations-fr.C2YYR8Jb.js";import"./chunk.translations-hr.B965uVG9.js";import"./chunk.translations-it.qkDQbydY.js";import"./chunk.translations-ru.x6UIBrxX.js";function G(){return{codeHtml:`<a-select
  v-model="model"
  :data="data"
  key-id="id"
  key-label="label"
...
};`}}const Ce={name:"PageSelectLabelDescription",components:{AlohaExample:f,ASelect:A},setup(){const{codeHtml:e}=Be(),{codeJs:l}=Le(),s=[{label:"Aloha 1",id:"aloha_1"},{label:"Aloha 2",id:"aloha_2"},{label:"Aloha 3",id:"aloha_3"},{label:"Aloha 4",id:"aloha_4"},{label:"Aloha 5",id:"aloha_5"}],r=u(void 0);return{codeHtml:e,codeJs:l,data:s,model:r}}},$e={class:"a_columns a_columns_count_12"},De={class:"a_column a_column_6 a_columns_count_12_touch"};function Ne(e,l,s,r,_,i){const t=d("a-select"),c=d("aloha-example");return m(),E(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_LABEL_DESCRIPTION_HEADER_",description:"_A_UI_GROUP_LABEL_DESCRIPTION_DESCRIPTION_",props:["label-description"]},{default:p(()=>[a("div",$e,[a("div",De,[o(t,{modelValue:e.model,"onUpdate:modelValue":l[0]||(l[0]=n=>e.model=n),data:e.data,"is-label-float":!1,"key-id":"id","key-label":"label",label:"Select","label-description":"Aloha",type:"select"},null,8,["modelValue","data"]),a("div",null,"model: "+h(e.model),1)])])]),_:1},8,["code-html","code-js"])}const Ve=b(Ce,[["render",Ne]]);function He(){return{codeHtml:`<a-select
  v-model="model"
  :data="data"
  :key-group="['alohaBR', 'aloha']"
  :search="true"
