...
};`}}const $={name:"PageJsonBasic",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=L(),{codeJs:a}=j();return{codeHtml:o,codeJs:a,model:e}}},H=I("div",null,"model:",-1);function v(e,o,a,d,_,c){const s=n("a-json"),r=n("aloha-example");return p(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:i(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),label:"JSON"},null,8,["modelValue"]),H,I("pre",null,O(e.model),1)]),_:1},8,["code-html","code-js"])}const y=m($,[["render",v]]);function G(){return{codeHtml:`<a-json
  :change="changeModel"
  :model-value="model"
  label="JSON"
></a-json>
...
};`}}const B={name:"PageJsonChange",components:{AJson:S,AlohaExample:A},setup(){const e=P({glossary:{title:"example glossary",GlossDiv:{title:"S",GlossList:{GlossEntry:{ID:"SGML",SortAs:"SGML",GlossTerm:"Standard Generalized Markup Language",Acronym:"SGML",Abbrev:"ISO 8879:1986",GlossDef:{para:"A meta-markup language, used to create markup languages such as DocBook.",GlossSeeAlso:["GML","XML"]},GlossSee:"markup"}}}}}),o=({model:_,id:c,props:s})=>{e.value=_,console.log(c,s)},{codeHtml:a}=G(),{codeJs:d}=M();return{changeModel:o,codeHtml:a,codeJs:d,model:e}}},q=I("div",null,"model:",-1);function V(e,o,a,d,_,c){const s=n("a-json"),r=n("aloha-example");return p(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:i(()=>[t(s,{change:e.changeModel,"model-value":e.model,label:"JSON"},null,8,["change","model-value"]),q,I("pre",null,O(e.model),1)]),_:1},8,["code-html","code-js"])}const x=m(B,[["render",V]]);function k(){return{codeHtml:`<a-json
  v-model="model"
  errors="Aloha"
  label="JSON"
...
};`}}const X={name:"PageJsonErrors",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=k(),{codeJs:a}=F();return{codeHtml:o,codeJs:a,model:e}}};function w(e,o,a,d,_,c){const s=n("a-json"),r=n("aloha-example");return p(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:i(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),errors:"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const z=m(X,[["render",w]]);function Q(){return{codeHtml:`<a-json
  v-model="model"
  help-text="Aloha"
  label="JSON"
...
};`}}const Y={name:"PageJsonHelpText",components:{AJson:S,AlohaExample:A},setup(){const e=P({}),{codeHtml:o}=Q(),{codeJs:a}=W();return{codeHtml:o,codeJs:a,model:e}}};function K(e,o,a,d,_,c){const s=n("a-json"),r=n("aloha-example");return p(),u(r,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:i(()=>[t(s,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=l=>e.model=l),"help-text":"Aloha",label:"JSON"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Z=m(Y,[["render",K]]);function ee(){return{codeHtml:`<a-json
  v-model="model"
  label="JSON"
></a-json>
<a-json
