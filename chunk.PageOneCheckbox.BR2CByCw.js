...
};`}}const $={name:"PageJsonBasic",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=H(),{codeJs:t}=D();return{codeHtml:o,codeJs:t,model:e}}};function V(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_BASIC_USAGE_",props:["model-value","label"]},{default:f(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),label:"Aloha"},null,8,["modelValue"]),A("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const B=u($,[["render",V]]);function J(){return{codeHtml:`<a-one-checkbox
  :change="changeModel"
  :model-value="model"
  label="Aloha"
></a-one-checkbox>
...
};`}}const y={name:"PageOneCheckboxChange",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),o=({model:s,id:_,props:a})=>{e.value=s,console.log(_,a)},{codeHtml:t}=J(),{codeJs:r}=L();return{changeModel:o,codeHtml:t,codeJs:r,model:e}}};function q(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_CHANGE_HEADER_",description:"_A_UI_GROUP_CHANGE_DESCRIPTION_",props:["change","model-value"]},{default:f(()=>[l(a,{change:e.changeModel,"model-value":e.model,label:"Aloha"},null,8,["change","model-value"]),A("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const j=u(y,[["render",q]]);function X(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  errors="Aloha"
  label="Aloha"
...
};`}}const M={name:"PageOneCheckboxErrors",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=X(),{codeJs:t}=G();return{codeHtml:o,codeJs:t,model:e}}};function K(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_ERRORS_HEADER_",description:"_A_UI_GROUP_ERRORS_DESCRIPTION_",props:["errors"]},{default:f(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),errors:"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const w=u(M,[["render",K]]);function F(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
...
};`}}const Q={name:"PageOneCheckboxFalseValue",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(!0),o=m(!0),{codeHtml:t}=F(),{codeJs:r}=W();return{codeHtml:t,codeJs:r,model1:e,model2:o}}};function Y(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_FALSE_VALUE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_FALSE_VALUE_DESCRIPTION_",props:["false-value"]},{default:f(()=>[l(a,{modelValue:e.model1,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model1=d),"false-value":!1,label:"false-value='false'"},null,8,["modelValue"]),A("div",null,"model1: "+E(e.model1),1),l(a,{class:"a_mt_3",modelValue:e.model2,"onUpdate:modelValue":o[1]||(o[1]=d=>e.model2=d),"false-value":0,label:"false-value='0'"},null,8,["modelValue"]),A("div",null,"model2: "+E(e.model2),1)]),_:1},8,["code-html","code-js"])}const z=u(Q,[["render",Y]]);function Z(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  help-text="Aloha"
  label="Aloha"
...
};`}}const oe={name:"PageOneCheckboxHelpText",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=Z(),{codeJs:t}=ee();return{codeHtml:o,codeJs:t,model:e}}};function ne(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_UI_GROUP_HELP_TEXT_HEADER_",description:"_A_UI_GROUP_HELP_TEXT_DESCRIPTION_",props:["help-text"]},{default:f(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),"help-text":"Aloha",label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const te=u(oe,[["render",ne]]);function ae(){return{codeHtml:`<a-one-checkbox
  v-model="model1"
  :false-value="false"
  label="false-value='false'"
></a-one-checkbox>
...
};`}}const de={name:"PageOneCheckboxIndeterminate",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=ae(),{codeJs:t}=le();return{codeHtml:o,codeJs:t,model:e}}};function ce(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_INDETERMINATE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_INDETERMINATE_DESCRIPTION_",props:["indeterminate"]},{default:f(()=>[l(a,{modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),indeterminate:!0,label:"Aloha"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const re=u(de,[["render",ce]]);function se(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :true-value="1"
  class="a_mt_3"
  label="Aloha"
...
};`}}const me={name:"PageOneCheckboxTrueValue",components:{AlohaExample:h,AOneCheckbox:O},setup(){const e=m(void 0),{codeHtml:o}=se(),{codeJs:t}=_e();return{codeHtml:o,codeJs:t,model:e}}};function ue(e,o,t,r,s,_){const a=n("a-one-checkbox"),c=n("aloha-example");return i(),p(c,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_HEADER_",description:"_A_ONE_CHECKBOX_GROUP_TRUE_VALUE_DESCRIPTION_",props:["true-value"]},{default:f(()=>[l(a,{class:"a_mt_3",modelValue:e.model,"onUpdate:modelValue":o[0]||(o[0]=d=>e.model=d),"true-value":1,label:"Aloha"},null,8,["modelValue"]),A("div",null,"model: "+E(e.model),1)]),_:1},8,["code-html","code-js"])}const ie=u(me,[["render",ue]]);function pe(){return{codeHtml:`<a-one-checkbox
  v-model="model"
  :is-width-auto="true"
