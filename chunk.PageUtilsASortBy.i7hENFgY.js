import{A as B,a as h}from"./chunk.AlohaExample.B0An_qSV.js";import{P as b,a as A,b as v}from"./chunk.PageFilterTest.DSRcRkfk.js";import{J as t,_ as m,A as x}from"./bundle.index.CHj2OCoU.js";import{W as p,V as d,e as s,aT as E,_ as r}from"./chunk.vendor.7qYoMuVo.js";import"./chunk.vendor-lodash.CDw4fzB6.js";import"./chunk.APageTabTitle.DrDBA8bQ.js";import"./chunk.AlohaHighlightjs.CqftpDCI.js";import"./chunk.translations-ar.ewm0fZVJ.js";import"./chunk.translations-de.BFTItvd9.js";import"./chunk.translations-en.CxTfUgqF.js";import"./chunk.translations-es.Ujw4saS6.js";import"./chunk.translations-fr.B1NwE7Vq.js";import"./chunk.translations-hr.Bgciwlye.js";import"./chunk.translations-it.XrCRKf9v.js";import"./chunk.translations-ru.CwKesgGG.js";const N=[{name:"beta"},{name:"Alpha"},{name:"gamma"}],U=[{name:"alex",score:5},{name:"Alex",score:3},{name:"alex",score:2},{name:"alex",score:7}],q=[{profile:{lastName:"Davis"},status:"active"},{profile:{lastName:"anders"},status:"inactive"},{profile:{lastName:"Anders"},status:"active"}],l=[{code:"abC"},{code:"abc"},{code:"Abd"}];function T(){const n=t(N,"name").map(e=>e.name),a=t(U,["name",e=>e.score]).map(e=>`${e.name}:${e.score}`),o=t(q,["profile.lastName",{status:"active"}]).map(e=>`${e.profile.lastName}:${e.status}`),i=t(l,"code").map(e=>e.code),u=t(l,"code",{caseSensitive:!0}).map(e=>e.code);return{codeJs:`const users = [
  { name: "beta" },
  { name: "Alpha" },
  { name: "gamma" },
];
