...
};`}}const Ds={name:"PageProgressShowValue",components:{AlohaExample:d,AProgress:i},setup(){const{codeHtml:s}=Ns(),{codeJs:a}=Cs();return{codeHtml:s,codeJs:a}}};function Bs(s,a,_,n,l,m){const r=o("a-progress"),t=o("aloha-example");return u(),g(t,{"code-html":s.codeHtml,"code-js":s.codeJs,header:"_A_PROGRESS_GROUP_SHOW_VALUE_HEADER_",description:"_A_PROGRESS_GROUP_SHOW_VALUE_DESCRIPTION_",props:"show-value"},{default:c(()=>[e(r,{value:20,"show-value":!1}),e(r,{class:"a_mt_4",value:40,"show-value":!0})]),_:1},8,["code-html","code-js"])}const Us=p(Ds,[["render",Bs]]);function Vs(){return{codeHtml:`<a-progress
  class="a_progress_small"
  :value="20"
></a-progress>
<a-progress
