...
};`}}const K={name:"PageDatepickerRangeBasic",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=G(),{codeJs:a}=y(),o=u(void 0);return{codeHtml:e,codeJs:a,model:o}}},b={class:"a_mt_3"};function h(e,a,o,m,E,c){const _=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_BASIC_HEADER_",description:"_PAGE_DATEPICKER_RANGE_BASIC_DESCRIPTION_",props:["v-model","label"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),label:"Aloha"},null,8,["modelValue"]),g("div",b,"model: "+S(e.model),1)]),_:1},8,["code-html","code-js"])}const q=i(K,[["render",h]]);function H(){return{codeHtml:`<a-datepicker-range
  v-model="model"
...
};`}}const $={name:"PageDatepickerRangeCustomFirstDay",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=H(),{codeJs:a}=L(),o=u(void 0);return{codeHtml:e,codeJs:a,model:o}}};function U(e,a,o,m,E,c){const _=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_HEADER_",description:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_DESCRIPTION_",props:["v-model","label","firstDayOfWeek"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),label:"_PAGE_DATEPICKER_RANGE_CUSTOM_FIRST_DAY_EXAMPLE_","first-day-of-week":4},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const B=i($,[["render",U]]);function M(){return{codeHtml:`<a-datepicker-range
 v-model="model"
  :disabled="true">
</a-datepicker-range>
<a-datepicker-range
...
};`}}const F={name:"PageDatepickerRangeDisabledVariants",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=M(),{codeJs:a}=v(),o=u(void 0);return{codeHtml:e,codeJs:a,model:o}}};function V(e,a,o,m,E,c){const _=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_DISABLED_VARIANTS_HEADER_",description:"_PAGE_DATEPICKER_RANGE_DISABLED_VARIANTS_DESCRIPTION_",props:["v-model","disabled","disabledFrom","disabledUntil"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),disabled:!0},null,8,["modelValue"]),r(_,{modelValue:e.model,"onUpdate:modelValue":a[1]||(a[1]=n=>e.model=n),"disabled-from":!0},null,8,["modelValue"]),r(_,{modelValue:e.model,"onUpdate:modelValue":a[2]||(a[2]=n=>e.model=n),"disabled-until":!0},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const Y=i(F,[["render",V]]);function J(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  format="DD.MM.YY"
...
};`}}const x={name:"PageDatepickerRangeFormatCustomization",components:{ADatepickerRange:A,AlohaExample:R},setup(){const{codeHtml:e}=J(),{codeJs:a}=j(),o=u(void 0);return{codeHtml:e,codeJs:a,model:o}}};function X(e,a,o,m,E,c){const _=t("a-datepicker-range"),d=t("aloha-example");return s(),l(d,{"code-html":e.codeHtml,"code-js":e.codeJs,header:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_HEADER_",description:"_PAGE_DATEPICKER_RANGE_FORMAT_CUSTOMIZATION_DESCRIPTION_",props:["v-model","format","formatSave"]},{default:p(()=>[r(_,{modelValue:e.model,"onUpdate:modelValue":a[0]||(a[0]=n=>e.model=n),format:"DD.MM.YY","format-save":"YY-MM-DD"},null,8,["modelValue"])]),_:1},8,["code-html","code-js"])}const W=i(x,[["render",X]]);function z(){return{codeHtml:`<a-datepicker-range
  v-model="model"
  label="Aloha"
